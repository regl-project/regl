...
module.exports = function wrapReadPixels (gl, glState) {
  function readPixels (input) {
    ...
    var viewportShape = glState.viewport
    var x = options.x || 0
    var y = options.y || 0
    var width = options.width || viewportShape.width
    var height = options.height || viewportShape.height
    ...
    check(data.length >= size, 'data buffer too small')
