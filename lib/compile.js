...
module.exports = function reglCompiler (
  ...
  function compileShaderDraw (program) {
    ...
    var DRAW_STATE = {
      ...
      elements: link(drawState.elements)
    }
    ...
    var CUR_ELEMENTS = stackTop(DRAW_STATE.elements)
  ...
  function compileCommand (
    ...
    Object.keys(staticOptions).forEach(function (param) {
      ...
      switch (param) {
        ...
        case 'elements':
          var elements = drawState.getElements(value)
          check(!!elements, 'invalid element buffer')
          entry(DRAW_STATE.elements, '.push(', elements, ');')
          entry(DRAW_STATE.elements, '.pop();')
          break
