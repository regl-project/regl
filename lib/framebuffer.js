...
module.exports = function wrapFBOState (
  ...
  function checkFormat (attachment, texFormats, rbFormats) {
    if (attachment.texture) {
      check.oneOf(attachment.texture._texture.internalformat, texFormats,
      ...
      if (!(depthBuffer || stencilBuffer || depthStencilBuffer)) {
        ...
        if (depth || stencil) {
          if (useTexture) {
            ...
            if (this.ownsDepthStencil && curDepthStencil.texture) {
            ...
            if (this.ownsDepthStencil && curDepthStencil.renderbuffer) {
