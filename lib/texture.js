...
textureFormatChannels[GL_RGBA4] = 4

// SPECIAL CASE
//textureFormatChannels[GL_RGB5_A1] = 4

textureFormatChannels[GL_RGB5] = 3
textureFormatChannels[GL_SRGB_EXT] = 3
textureFormatChannels[GL_SRGB_ALPHA_EXT] = 4
textureFormatChannels[GL_DEPTH_COMPONENT] = 1
textureFormatChannels[GL_DEPTH_STENCIL] = 2
*/
// NEXT THE COMPRESSED TEXTURE FORMAT(special cases)
...
FORMAT_SIZES_SPECIAL[COMPRESSED_RGB_PVRTC_4BPPV1_IMG] = 0.5
FORMAT_SIZES_SPECIAL[COMPRESSED_RGB_PVRTC_2BPPV1_IMG] = 0.25
FORMAT_SIZES_SPECIAL[COMPRESSED_RGBA_PVRTC_4BPPV1_IMG] = 0.5
FORMAT_SIZES_SPECIAL[COMPRESSED_RGBA_PVRTC_2BPPV1_IMG] = 0.25
...
// replace blocks of 4x4 RGB8 colors with blocks of 8bytes
// so every pixel takes this many bytes
// 8 / (4 * 4) = 0.5bytes per pixel

// ext.COMPRESSED_RGB_S3TC_DXT3_EXT
// replace blocks of 4x4 RGBA8 colors with blocks of 16bytes
// so every pixel takes this many bytes
// 16 / (4 * 4) = 1.0bytes per pixel

// ext.COMPRESSED_RGB_S3TC_DXT5_EXT
// replace blocks of 4x4 RGBA8 colors with blocks of 16bytes
// so every pixel takes this many bytes
// 16 / (4 * 4) = 1.0bytes per pixel

// COMPRESSED_ATC_RGB_WEBGL
// 0.5bytes per pixel.
...
function getTextureSize (format, type, width, height, isMipmap) {
  var s
    ...
    function reglTexture2D (a, b) {
      ...
      if (config.profile) {
        texture.stats.size = getTextureSize(
          texture.internalformat, texture.type, mipData.width, mipData.height, texInfo.genMipmaps)
      }
