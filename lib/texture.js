...
function isNonPow2CubeSupported (gl) {
  var data = new Uint8Array(36)

  var texture = gl.createTexture()
  gl.activeTexture(gl.TEXTURE0)
  gl.bindTexture(gl.TEXTURE_CUBE_MAP, texture)
  gl.texImage2D(gl.TEXTURE_CUBE_MAP_POSITIVE_X, 0, gl.RGBA, 3, 3, 0, gl.RGBA, gl.UNSIGNED_BYTE, data)
...
module.exports = function createTextureSet (
  ...
  var supportsNonPow2CubeTexture = isNonPow2CubeSupported(gl)
  ...
  function createTextureCube (a0, a1, a2, a3, a4, a5) {
    ...
    function reglTextureCube (a0, a1, a2, a3, a4, a5) {
      ...
      if (!supportsNonPow2CubeTexture) {
        check(isPow2(texture.width) && isPow2(texture.height), 'texture dimensions must be power of two')
      }
