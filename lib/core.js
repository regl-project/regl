...
module.exports = function reglCore (
  ...
  var enableGpuTimerDefault = 'true'
  ...
  function emitBeginTimerQuery (env, draw, args) {
    ...
    if (timer) {
      ...
      if(args.enableGpuTimer === null) {
        draw('if(', shared.enableGpuTimerDefault, '){',
  ...
  */
  ...
  function emitScopeProc (env, args) {
    ...
    if (timer && defn) {
      ...
      ENABLE_GPU_TIMER_DEAULT_TEMP = scope.def(ENABLE_GPU_TIMER_DEFAULT)

      var AAA = defn.append(env, scope) + ''

//      emitEnableGpuTimer(env, scope, args)
      scope(ENABLE_GPU_TIMER_DEFAULT, "=", /*env.shared.enableGpuTimer*/ AAA, ";")

      scope.exit(ENABLE_GPU_TIMER_DEFAULT, '=', ENABLE_GPU_TIMER_DEAULT_TEMP, ";")
