...
module.exports = function reglCore (
  ...
  var enableGpuTimerDefault = createStaticEnableGpuTimer(true)
  ...
  function emitEnableGpuTimer (env, scope, args) {
    var defn = args.enableGpuTimer ? args.enableGpuTimer : enableGpuTimerDefault
