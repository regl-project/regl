...
module.exports = function reglCore (
  ...
  function createREGLEnvironment () {
    ...
    check.optional(function () {
      ...
      shared.command = link(check.guessCommand())
    })
  ...
  function emitDraw (env, outer, inner, args) {
    ...
    function emitRegular () {
      function drawElements () {
        inner(GL + '.drawElements(' + [PRIMITIVE, COUNT, ELEMENT_TYPE, OFFSET] + ');')
      }
  ...
  function emitBatchBody (env, scope, args, program) {
    ...
    emitSetOptions(env, outer, args.state, function (defn) {
      return !defn.static && defn.batchStatic
    })
    emitSetOptions(env, loop, args.state, function (defn) {
      return !defn.static && !defn.batchStatic
    })
