...
c),0,c);break;case 5126:g=new Float32Array(a(4*c),0,c);break;default:return null}return g.length!==c?g.subarray(0,c):g},freeType:function(a){b(a.buffer)}}}function X(a){return!!a&&"object"===typeof a&&Array.isArray(a.shape)&&Array.isArray(a.stride)&&"number"===typeof a.offset&&a.shape.length===a.stride.length&&(Array.isArray(a.data)||G(a.data))}function gb(a,b,c,e,d,g){for(var r=0;r<b;++r)for(var n=a[r],u=0;u<c;++u)for(var p=n[u],v=0;v<e;++v)d[g++]=p[v]}function hb(a,b,c,e,d){for(var g=1,r=c+1;r<
b.length;++r)g*=b[r];var n=b[c];if(4===b.length-c){var u=b[c+1],p=b[c+2];b=b[c+3];for(r=0;r<n;++r)gb(a[r],u,p,b,e,d),d+=g}else for(r=0;r<n;++r)hb(a[r],b,c+1,e,d),d+=g}function Ga(a){return Ha[Object.prototype.toString.call(a)]|0}function ib(a,b){for(var c=0;c<b.length;++c)a[c]=b[c]}function jb(a,b,c,e,d,g,r){for(var n=0,u=0;u<c;++u)for(var p=0;p<e;++p)a[n++]=b[d*u+g*p+r]}function Hb(a,b,c,e){function d(b){this.id=u++;this.buffer=a.createBuffer();this.type=b;this.usage=35044;this.byteLength=0;this.dimension=
1;this.dtype=5121;this.persistentData=null;c.profile&&(this.stats={size:0})}function g(b,c,k){b.byteLength=c.byteLength;a.bufferData(b.type,c,k)}function r(a,b,c,h,f,t){a.usage=c;if(Array.isArray(b)){if(a.dtype=h||5126,0<b.length)if(Array.isArray(b[0])){f=kb(b);for(var m=h=1;m<f.length;++m)h*=f[m];a.dimension=h;b=Ra(b,f,a.dtype);g(a,b,c);t?a.persistentData=b:z.freeType(b)}else"number"===typeof b[0]?(a.dimension=f,f=z.allocType(a.dtype,b.length),ib(f,b),g(a,f,c),t?a.persistentData=f:z.freeType(f)):
G(b[0])&&(a.dimension=b[0].length,a.dtype=h||Ga(b[0])||5126,b=Ra(b,[b.length,b[0].length],a.dtype),g(a,b,c),t?a.persistentData=b:z.freeType(b))}else if(G(b))a.dtype=h||Ga(b),a.dimension=f,g(a,b,c),t&&(a.persistentData=new Uint8Array(new Uint8Array(b.buffer)));else if(X(b)){f=b.shape;var q=b.stride,m=b.offset,e=0,d=0,p=0,n=0;1===f.length?(e=f[0],d=1,p=q[0],n=0):2===f.length&&(e=f[0],d=f[1],p=q[0],n=q[1]);a.dtype=h||Ga(b.data)||5126;a.dimension=d;f=z.allocType(a.dtype,e*d);jb(f,b.data,e,d,p,n,m);g(a,
f,c);t?a.persistentData=f:z.freeType(f)}else b instanceof ArrayBuffer&&(a.dtype=5121,a.dimension=f,g(a,b,c),t&&(a.persistentData=new Uint8Array(new Uint8Array(b))))}function n(c){b.bufferCount--;e(c);a.deleteBuffer(c.buffer);c.buffer=null;delete p[c.id]}var u=0,p={};d.prototype.bind=function(){a.bindBuffer(this.type,this.buffer)};d.prototype.destroy=function(){n(this)};var v=[];c.profile&&(b.getTotalBufferSize=function(){var a=0;Object.keys(p).forEach(function(b){a+=p[b].stats.size});return a});return{create:function(l,
e,k,h){function f(b){var l=35044,e=null,d=0,k=0,g=1;Array.isArray(b)||G(b)||X(b)||b instanceof ArrayBuffer?e=b:"number"===typeof b?d=b|0:b&&("data"in b&&(e=b.data),"usage"in b&&(l=lb[b.usage]),"type"in b&&(k=Ia[b.type]),"dimension"in b&&(g=b.dimension|0),"length"in b&&(d=b.length|0));t.bind();e?r(t,e,l,k,g,h):(d&&a.bufferData(t.type,d,l),t.dtype=k||5121,t.usage=l,t.dimension=g,t.byteLength=d);c.profile&&(t.stats.size=t.byteLength*ia[t.dtype]);return f}b.bufferCount++;var t=new d(e);p[t.id]=t;k||f(l);
f._reglType="buffer";f._buffer=t;f.subdata=function(b,c){var l=(c||0)|0,h;t.bind();if(G(b)||b instanceof ArrayBuffer)a.bufferSubData(t.type,l,b);else if(Array.isArray(b)){if(0<b.length)if("number"===typeof b[0]){var e=z.allocType(t.dtype,b.length);ib(e,b);a.bufferSubData(t.type,l,e);z.freeType(e)}else if(Array.isArray(b[0])||G(b[0]))h=kb(b),e=Ra(b,h,t.dtype),a.bufferSubData(t.type,l,e),z.freeType(e)}else if(X(b)){h=b.shape;var d=b.stride,k=e=0,g=0,p=0;1===h.length?(e=h[0],k=1,g=d[0],p=0):2===h.length&&
(e=h[0],k=h[1],g=d[0],p=d[1]);h=Array.isArray(b.data)?t.dtype:Ga(b.data);h=z.allocType(h,e*k);jb(h,b.data,e,k,g,p,b.offset);a.bufferSubData(t.type,l,h);z.freeType(h)}return f};c.profile&&(f.stats=t.stats);f.destroy=function(){n(t)};return f},createStream:function(a,b){var c=v.pop();c||(c=new d(a));c.bind();r(c,b,35040,0,1,!1);return c},destroyStream:function(a){v.push(a)},clear:function(){J(p).forEach(n);v.forEach(n)},getBuffer:function(a){return a&&a._buffer instanceof d?a._buffer:null},restore:function(){J(p).forEach(function(b){b.buffer=
a.createBuffer();a.bindBuffer(b.type,b.buffer);a.bufferData(b.type,b.persistentData||b.byteLength,b.usage)})},_initBuffer:r}}function Ib(a,b,c,e){function d(a){this.id=u++;n[this.id]=this;this.buffer=a;this.primType=4;this.type=this.vertCount=0}function g(e,d,g,h,f,t,m){e.buffer.bind();var q;d?((q=m)||G(d)&&(!X(d)||G(d.data))||(q=b.oes_element_index_uint?5125:5123),c._initBuffer(e.buffer,d,g,q,3)):(a.bufferData(34963,t,g),e.buffer.dtype=q||5121,e.buffer.usage=g,e.buffer.dimension=3,e.buffer.byteLength=
t);q=m;if(!m){switch(e.buffer.dtype){case 5121:case 5120:q=5121;break;case 5123:case 5122:q=5123;break;case 5125:case 5124:q=5125}e.buffer.dtype=q}e.type=q;d=f;0>d&&(d=e.buffer.byteLength,5123===q?d>>=1:5125===q&&(d>>=2));e.vertCount=d;d=h;0>h&&(d=4,h=e.buffer.dimension,1===h&&(d=0),2===h&&(d=1),3===h&&(d=4));e.primType=d}function r(a){e.elementsCount--;delete n[a.id];a.buffer.destroy();a.buffer=null}var n={},u=0,p={uint8:5121,uint16:5123};b.oes_element_index_uint&&(p.uint32=5125);d.prototype.bind=
function(){this.buffer.bind()};var v=[];return{create:function(a,b){function k(a){if(a)if("number"===typeof a)h(a),f.primType=4,f.vertCount=a|0,f.type=5121;else{var b=null,c=35044,e=-1,d=-1,l=0,n=0;if(Array.isArray(a)||G(a)||X(a))b=a;else if("data"in a&&(b=a.data),"usage"in a&&(c=lb[a.usage]),"primitive"in a&&(e=Ta[a.primitive]),"count"in a&&(d=a.count|0),"type"in a&&(n=p[a.type]),"length"in a)l=a.length|0;else if(l=d,5123===n||5122===n)l*=2;else if(5125===n||5124===n)l*=4;g(f,b,c,e,d,l,n)}else h(),
f.primType=4,f.vertCount=0,f.type=5121;return k}var h=c.create(null,34963,!0),f=new d(h._buffer);e.elementsCount++;k(a);k._reglType="elements";k._elements=f;k.subdata=function(a,b){h.subdata(a,b);return k};k.destroy=function(){r(f)};return k},createStream:function(a){var b=v.pop();b||(b=new d(c.create(null,34963,!0,!1)._buffer));g(b,a,35040,-1,-1,0,0);return b},destroyStream:function(a){v.push(a)},getElements:function(a){return"function"===typeof a&&a._elements instanceof d?a._elements:null},clear:function(){J(n).forEach(r)}}}
...
(a.type=K[c]),c in V&&(a.compressed=!0),c=!0);!d&&c?a.channels=S[a.format]:d&&!c&&a.channels!==Ma[a.format]&&(a.format=a.internalformat=Ma[a.channels])}}function v(b){a.pixelStorei(37440,b.flipY);a.pixelStorei(37441,b.premultiplyAlpha);a.pixelStorei(37443,b.colorSpace);a.pixelStorei(3317,b.unpackAlignment)}function l(){n.call(this);this.yOffset=this.xOffset=0;this.data=null;this.needsFree=!1;this.element=null;this.needsCopy=!1}function F(a,b){var c=null;Ua(b)?c=b:b&&(p(a,b),"x"in b&&(a.xOffset=b.x|
...
e);e.set(f);a.data=e;break;case 36193:a.data=nb(f)}a.alignment=1;a.needsFree=!0}else if(X(c)){f=c.data;Array.isArray(f)||5121!==a.type||(a.type=Ha[Object.prototype.toString.call(f)]|0);var e=c.shape,h=c.stride,g,m,k,q;3===e.length?(k=e[2],q=h[2]):q=k=1;g=e[0];m=e[1];e=h[0];h=h[1];a.alignment=1;a.width=g;a.height=m;a.channels=k;a.format=a.internalformat=Ma[k];a.needsFree=!0;g=q;c=c.offset;k=a.width;q=a.height;m=a.channels;for(var y=z.allocType(36193===a.type?5126:a.type,k*q*m),I=0,U=0;U<q;++U)for(var ea=
...
c[0].length;e=a.height||c.length;h=a.channels;h=oa(c[0][0])?h||c[0][0].length:h||1;g=Na.shape(c);k=1;for(q=0;q<g.length;++q)k*=g[q];k=z.allocType(36193===a.type?5126:a.type,k);Na.flatten(c,g,"",k);rb(a,k);a.alignment=1;a.width=f;a.height=e;a.channels=h;a.format=a.internalformat=Ma[h];a.needsFree=!0}}function k(b,c,f,h,d){var g=b.element,m=b.data,k=b.internalformat,q=b.format,t=b.type,y=b.width,I=b.height;v(b);g?a.texSubImage2D(c,d,f,h,q,t,g):b.compressed?a.compressedTexSubImage2D(c,d,f,h,k,y,I,m):
b.needsCopy?(e(),a.copyTexSubImage2D(c,d,f,h,b.xOffset,b.yOffset,y,I)):a.texSubImage2D(c,d,f,h,y,I,q,t,m)}function h(){return L.pop()||new l}function f(a){a.needsFree&&z.freeType(a.data);l.call(a);L.push(a)}function t(){n.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function m(a,b,c){var f=a.images[0]=h();a.mipmask=1;f.width=a.width=b;f.height=a.height=c;f.channels=a.channels=4}function q(a,b){var c=null;if(Ua(b))c=a.images[0]=h(),u(c,a),F(c,b),a.mipmask=
1;else if(p(a,b),Array.isArray(b.mipmap))for(var f=b.mipmap,e=0;e<f.length;++e)c=a.images[e]=h(),u(c,a),c.width>>=e,c.height>>=e,F(c,f[e]),a.mipmask|=1<<e;else c=a.images[0]=h(),u(c,a),F(c,b),a.mipmask=1;u(a,a.images[0])}function Q(b,c){for(var f=b.images,h=0;h<f.length&&f[h];++h){var d=f[h],g=c,m=h,k=d.element,q=d.data,t=d.internalformat,y=d.format,I=d.type,U=d.width,ea=d.height;v(d);k?a.texImage2D(g,m,y,y,I,k):d.compressed?a.compressedTexImage2D(g,m,t,U,ea,0,q):d.needsCopy?(e(),a.copyTexImage2D(g,
m,y,d.xOffset,d.yOffset,U,ea,0)):a.texImage2D(g,m,y,U,ea,0,y,I,q||null)}}function C(){var a=A.pop()||new t;n.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function wa(a){for(var b=a.images,c=0;c<b.length;++c)b[c]&&f(b[c]),b[c]=null;A.push(a)}function fa(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;this.mipmapHint=4352}function mb(a,b){"min"in b&&(a.minFilter=O[b.min],0<=Nb.indexOf(a.minFilter)&&!("faces"in b)&&(a.genMipmaps=
...
function u(a,b,c){a&&(a.texture?a.texture._texture.refCount+=1:a.renderbuffer._renderbuffer.refCount+=1)}function p(b,c){c&&(c.texture?a.framebufferTexture2D(36160,b,c.target,c.texture._texture.texture,0):a.framebufferRenderbuffer(36160,b,36161,c.renderbuffer._renderbuffer.renderbuffer))}function v(a){var b=3553,c=null,f=null,e=a;"object"===typeof a&&(e=a.data,"target"in a&&(b=a.target|0));a=e._reglType;"texture2d"===a?c=e:"textureCube"===a?c=e:"renderbuffer"===a&&(f=e,b=36161);return new r(b,c,f)}
...
[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=null}function f(a){a.colorAttachments.forEach(n);n(a.depthAttachment);n(a.stencilAttachment);n(a.depthStencilAttachment)}function t(b){a.deleteFramebuffer(b.framebuffer);b.framebuffer=null;g.framebufferCount--;delete w[b.id]}function m(b){var f;a.bindFramebuffer(36160,b.framebuffer);var e=b.colorAttachments;for(f=0;f<e.length;++f)p(36064+f,e[f]);for(f=e.length;f<c.maxColorAttachments;++f)a.framebufferTexture2D(36160,36064+
f,3553,null,0);a.framebufferTexture2D(36160,33306,3553,null,0);a.framebufferTexture2D(36160,36096,3553,null,0);a.framebufferTexture2D(36160,36128,3553,null,0);p(36096,b.depthAttachment);p(36128,b.stencilAttachment);p(33306,b.depthStencilAttachment);a.checkFramebufferStatus(36160);a.isContextLost();a.bindFramebuffer(36160,Q.next?Q.next.framebuffer:null);Q.cur=Q.next;a.getError()}function q(a,b){function c(a,b){var d,h=0,g=0,k=!0,q=!0;d=null;var t=!0,n="rgba",p="uint8",r=1,fa=null,ca=null,Q=null,ga=
!1;if("number"===typeof a)h=a|0,g=b|0||h;else if(a){"shape"in a?(g=a.shape,h=g[0],g=g[1]):("radius"in a&&(h=g=a.radius),"width"in a&&(h=a.width),"height"in a&&(g=a.height));if("color"in a||"colors"in a)d=a.color||a.colors,Array.isArray(d);if(!d){"colorCount"in a&&(r=a.colorCount|0);"colorTexture"in a&&(t=!!a.colorTexture,n="rgba4");if("colorType"in a&&(p=a.colorType,!t))if("half float"===p||"float16"===p)n="rgba16f";else if("float"===p||"float32"===p)n="rgba32f";"colorFormat"in a&&(n=a.colorFormat,
0<=C.indexOf(n)?t=!0:0<=wa.indexOf(n)&&(t=!1))}if("depthTexture"in a||"depthStencilTexture"in a)ga=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?k=a.depth:(fa=a.depth,q=!1));"stencil"in a&&("boolean"===typeof a.stencil?q=a.stencil:(ca=a.stencil,k=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?k=q=a.depthStencil:(Q=a.depthStencil,q=k=!1))}else h=g=1;var M=null,z=null,w=null,R=null;if(Array.isArray(d))M=d.map(v);else if(d)M=[v(d)];else for(M=Array(r),
d=0;d<r;++d)M[d]=l(h,g,t,n,p);h=h||M[0].width;g=g||M[0].height;fa?z=v(fa):k&&!q&&(z=l(h,g,ga,"depth","uint32"));ca?w=v(ca):q&&!k&&(w=l(h,g,!1,"stencil","uint8"));Q?R=v(Q):!fa&&!ca&&q&&k&&(R=l(h,g,ga,"depth stencil","depth stencil"));k=null;for(d=0;d<M.length;++d)u(M[d],h,g),M[d]&&M[d].texture&&(q=Xa[M[d].texture._texture.format]*Oa[M[d].texture._texture.type],null===k&&(k=q));u(z,h,g);u(w,h,g);u(R,h,g);f(e);e.width=h;e.height=g;e.colorAttachments=M;e.depthAttachment=z;e.stencilAttachment=w;e.depthStencilAttachment=
...
destroy:function(){t(e);f(e)},use:function(a){Q.setFBO({framebuffer:c},a)}})}var Q={cur:null,next:null,dirty:!1,setFBO:null},C=["rgba"],wa=["rgba4","rgb565","rgb5 a1"];b.ext_srgb&&wa.push("srgba");b.ext_color_buffer_half_float&&wa.push("rgba16f","rgb16f");b.webgl_color_buffer_float&&wa.push("rgba32f");var fa=["uint8"];b.oes_texture_half_float&&fa.push("half float","float16");b.oes_texture_float&&fa.push("float","float32");var z=0,w={};return H(Q,{getFramebuffer:function(a){return"function"===typeof a&&
"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof h)?a:null},create:q,createCube:function(a){function b(a){var f,d={color:null},h=0,g=null;f="rgba";var m="uint8",k=1;if("number"===typeof a)h=a|0;else if(a){"shape"in a?h=a.shape[0]:("radius"in a&&(h=a.radius|0),"width"in a?h=a.width|0:"height"in a&&(h=a.height|0));if("color"in a||"colors"in a)g=a.color||a.colors,Array.isArray(g);g||("colorCount"in a&&(k=a.colorCount|0),"colorType"in a&&(m=a.colorType),"colorFormat"in a&&(f=a.colorFormat));
...
d.depthStencil=c[0].depthStencil);if(c[f])c[f](d);else c[f]=q(d)}return H(b,{width:h,height:h,color:a})}var c=Array(6);b(a);return H(b,{faces:c,resize:function(a){var f=a|0;if(f===b.width)return b;var d=b.color;for(a=0;a<d.length;++a)d[a].resize(f);for(a=0;6>a;++a)c[a].resize(f);b.width=b.height=f;return b},_reglType:"framebufferCube",destroy:function(){c.forEach(function(a){a.destroy()})}})},clear:function(){J(w).forEach(t)},restore:function(){Q.cur=null;Q.next=null;Q.dirty=!0;J(w).forEach(function(b){b.framebuffer=
...
a.vertexAttribPointer(e,g.size,g.type,g.normalized,g.stride,g.offfset),d&&d.vertexAttribDivisorANGLE(e,g.divisor)):(a.disableVertexAttribArray(e),a.vertexAttrib4f(e,g.x,g.y,g.z,g.w))}h.currentVAO=c}}function n(a){J(k).forEach(function(a){a.destroy()})}function u(){this.id=++F;this.attributes=[];var a=b.oes_vertex_array_object;this.vao=a?a.createVertexArrayOES():null;k[this.id]=this;this.buffers=[]}function p(){b.oes_vertex_array_object&&J(k).forEach(function(a){a.refresh()})}var v=c.maxAttributes,
l=Array(v);for(c=0;c<v;++c)l[c]=new Ya;var F=0,k={},h={Record:Ya,scope:{},state:l,currentVAO:null,targetVAO:null,restore:b.oes_vertex_array_object?p:function(){},createVAO:function(a){function b(a){for(var f=0;f<c.buffers.length;++f)c.buffers[f].destroy();c.buffers.length=0;f=c.attributes;f.length=a.length;for(var e=0;e<a.length;++e){var h=a[e],g=f[e]=new Ya;Array.isArray(h)||G(h)||X(h)?(h=d.create(h,34962,!1,!0),g.buffer=d.getBuffer(h),g.size=g.buffer.dimension|0,g.normalized=!1,g.type=g.buffer.dtype,
...
0,g.z=+h.z||0,g.w=+h.w||0,g.state=2)}c.refresh();return b}var c=new u;e.vaoCount+=1;b.destroy=function(){c.destroy()};b._vao=c;return b(a)},getVAO:function(a){return"function"===typeof a&&a._vao?a._vao:null},destroyBuffer:function(b){for(var c=0;c<l.length;++c){var e=l[c];e.buffer===b&&(a.disableVertexAttribArray(c),e.buffer=null)}},setVAO:b.oes_vertex_array_object?g:r,clear:b.oes_vertex_array_object?n:function(){}};u.prototype.bindAttrs=function(){for(var c=b.angle_instanced_arrays,e=this.attributes,
h=0;h<e.length;++h){var d=e[h];d.buffer?(a.enableVertexAttribArray(h),a.bindBuffer(34962,d.buffer.buffer),a.vertexAttribPointer(h,d.size,d.type,d.normalized,d.stride,d.offset),c&&c.vertexAttribDivisorANGLE(h,d.divisor)):(a.disableVertexAttribArray(h),a.vertexAttrib4f(h,d.x,d.y,d.z,d.w))}for(c=e.length;c<v;++c)a.disableVertexAttribArray(c)};u.prototype.refresh=function(){var a=b.oes_vertex_array_object;a&&(a.bindVertexArrayOES(this.vao),this.bindAttrs(),h.currentVAO=this)};u.prototype.destroy=function(){if(this.vao){var a=
b.oes_vertex_array_object;this===h.currentVAO&&(h.currentVAO=null,a.bindVertexArrayOES(null));a.deleteVertexArrayOES(this.vao);this.vao=null}k[this.id]&&(delete k[this.id],--e.vaoCount)};return h}function Qb(a,b,c,e){function d(a,b,c,e){this.name=a;this.id=b;this.location=c;this.info=e}function g(a,b){for(var c=0;c<a.length;++c)if(a[c].id===b.id){a[c].location=b.location;return}a.push(b)}function r(c,f,e){e=35632===c?p:v;var d=e[f];if(!d){var g=b.str(f),d=a.createShader(c);a.shaderSource(d,g);a.compileShader(d);
e[f]=d}return d}function n(a,b){this.id=k++;this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[];e.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function u(c,f,k){var l;l=r(35632,c.fragId);var n=r(35633,c.vertId);f=c.program=a.createProgram();a.attachShader(f,l);a.attachShader(f,n);if(k)for(l=0;l<k.length;++l)n=k[l],a.bindAttribLocation(f,n[0],n[1]);a.linkProgram(f);n=a.getProgramParameter(f,35718);e.profile&&(c.stats.uniformsCount=n);var p=c.uniforms;for(k=
0;k<n;++k)if(l=a.getActiveUniform(f,k))if(1<l.size)for(var u=0;u<l.size;++u){var v=l.name.replace("[0]","["+u+"]");g(p,new d(v,b.id(v),a.getUniformLocation(f,v),l))}else g(p,new d(l.name,b.id(l.name),a.getUniformLocation(f,l.name),l));n=a.getProgramParameter(f,35721);e.profile&&(c.stats.attributesCount=n);c=c.attributes;for(k=0;k<n;++k)(l=a.getActiveAttrib(f,k))&&g(c,new d(l.name,b.id(l.name),a.getAttribLocation(f,l.name),l))}var p={},v={},l={},F=[],k=0;e.profile&&(c.getMaxUniformsCount=function(){var a=
0;F.forEach(function(b){b.stats.uniformsCount>a&&(a=b.stats.uniformsCount)});return a},c.getMaxAttributesCount=function(){var a=0;F.forEach(function(b){b.stats.attributesCount>a&&(a=b.stats.attributesCount)});return a});return{clear:function(){var b=a.deleteShader.bind(a);J(p).forEach(b);p={};J(v).forEach(b);v={};F.forEach(function(b){a.deleteProgram(b.program)});F.length=0;l={};c.shaderCount=0},program:function(a,b,e,d){var g=l[b];g||(g=l[b]={});var k=g[a];if(k&&!d)return k;b=new n(b,a);c.shaderCount++;
u(b,e,d);k||(g[a]=b);F.push(b);return b},restore:function(){p={};v={};for(var a=0;a<F.length;++a)u(F[a],null,F[a].attributes.map(function(a){return[a.location,a.name]}))},shader:r,frag:-1,vert:-1}}function Rb(a,b,c,e,d,g,r){function n(d){var g;g=null===b.next?5121:b.next.colorAttachments[0].texture._texture.type;var l=0,n=0,k=e.framebufferWidth,h=e.framebufferHeight,f=null;G(d)?f=d:d&&(l=d.x|0,n=d.y|0,k=(d.width||e.framebufferWidth-l)|0,h=(d.height||e.framebufferHeight-n)|0,f=d.data||null);c();d=
k*h*4;f||(5121===g?f=new Uint8Array(d):5126===g&&(f=f||new Float32Array(d)));a.pixelStorei(3333,4);a.readPixels(l,n,k,h,6408,g,f);return f}function u(a){var c;b.setFBO({framebuffer:a.framebuffer},function(){c=n(a)});return c}return function(a){return a&&"framebuffer"in a?u(a):n(a)}}function ua(a){return Array.prototype.slice.call(a)}function Ba(a){return ua(a).join("")}function Sb(){function a(){var a=[],b=[];return H(function(){a.push.apply(a,ua(arguments))},{def:function(){var d="v"+c++;b.push(d);
0<arguments.length&&(a.push(d,"="),a.push.apply(a,ua(arguments)),a.push(";"));return d},toString:function(){return Ba([0<b.length?"var "+b.join(",")+";":"",Ba(a)])}})}function b(){function b(a,e){d(a,e,"=",c.def(a,e),";")}var c=a(),d=a(),e=c.toString,g=d.toString;return H(function(){c.apply(c,ua(arguments))},{def:c.def,entry:c,exit:d,save:b,set:function(a,d,e){b(a,d);c(a,d,"=",e,";")},toString:function(){return e()+g()}})}var c=0,e=[],d=[],g=a(),r={};return{global:g,link:function(a){for(var b=0;b<
d.length;++b)if(d[b]===a)return e[b];b="g"+c++;e.push(b);d.push(a);return b},block:a,proc:function(a,c){function d(){var a="a"+e.length;e.push(a);return a}var e=[];c=c||0;for(var g=0;g<c;++g)d();var g=b(),F=g.toString;return r[a]=H(g,{arg:d,toString:function(){return Ba(["function(",e.join(),"){",F(),"}"])}})},scope:b,cond:function(){var a=Ba(arguments),c=b(),d=b(),e=c.toString,g=d.toString;return H(c,{then:function(){c.apply(c,ua(arguments));return this},"else":function(){d.apply(d,ua(arguments));
...
0,d[f]]);return e}}return null}function E(a,c,d){function e(a){if(a in f){var c=b.id(f[a]);a=C(function(){return c});a.id=c;return a}if(a in g){var d=g[a];return L(d,function(a,b){var c=a.invoke(b,d);return b.def(a.shared.strings,".id(",c,")")})}return null}var f=a["static"],g=a.dynamic,h=e("frag"),da=e("vert"),za=null;va(h)&&va(da)?(za=v.program(da.id,h.id,null,d),a=C(function(a,b){return a.link(za)})):a=new P(h&&h.thisDep||da&&da.thisDep,h&&h.contextDep||da&&da.contextDep,h&&h.propDep||da&&da.propDep,
...
"if(",h,"(",e,".buffer)){",k,"=",f,".createStream(",34962,",",e,".buffer);","}else{",k,"=",f,".getBuffer(",e,".buffer);","}",U,'="type" in ',e,"?",g.glTypes,"[",e,".type]:",k,".dtype;",y.normalized,"=!!",e,".normalized;");d("size");d("offset");d("stride");d("divisor");c("}}");c.exit("if(",y.isStream,"){",f,".destroyStream(",k,");","}");return y})});return g}function D(a,b){var c=a["static"],d=a.dynamic;if("vao"in c){var e=c.vao;null===e||e._vao||(e=p.createVAO(e));return C(function(a){return a.link(p.getVAO(e))})}if("vao"in
...
g),Za=R(a,g),q=E(a,g,k);h("viewport");h(f("scissor.box"));var r=0<Object.keys(Za).length,l={framebuffer:l,draw:m,shader:q,state:Za,dirty:r,scopeVAO:null,drawVAO:null,useVAO:!1,attributes:{}};l.profile=Q(a,g);l.uniforms=ta(d,g);l.drawVAO=l.scopeVAO=D(a,g);if(!l.drawVAO&&q.program&&!k&&c.angle_instanced_arrays){var t=!0;a=q.program.attributes.map(function(a){a=b["static"][a];t=t&&!!a;return a});if(t&&0<a.length){var v=p.getVAO(p.createVAO(a));l.drawVAO=new P(null,null,null,function(a,b){return a.link(v)});
...
function g(a){p=b.def();a(p,"=",f(),";");"string"===typeof e?a(m,".count+=",e,";"):a(m,".count++;");k&&(d?(t=b.def(),a(t,"=",r,".getNumPendingQueries();")):a(r,".beginQuery(",m,");"))}function h(a){a(m,".cpuTime+=",f(),"-",p,";");k&&(d?a(r,".pushScopeStats(",t,",",r,".getNumPendingQueries(),",m,");"):a(r,".endQuery();"))}function l(a){var c=b.def(q,".profile");b(q,".profile=",a,";");b.exit(q,".profile=",c,";")}var n=a.shared,m=a.stats,q=n.current,r=n.timer;c=c.profile;var p,t;if(c){if(va(c)){c.enable?
(g(b),h(b.exit),l("true")):l("false");return}c=c.append(a,b);l(c)}else c=b.def(q,".profile");n=a.block();g(n);b("if(",c,"){",n,"}");a=a.block();h(a);b.exit("if(",c,"){",a,"}")}function N(a,b,c,d,e){function f(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function g(c,d,e){function f(){b("if(!",m,".buffer){",l,".enableVertexAttribArray(",n,");}");var c=e.type,g;g=e.size?b.def(e.size,"||",
...
n,");",m,".buffer=null;","}if(",Ca.map(function(a,b){return m+"."+a+"!=="+q[b]}).join("||"),"){",l,".vertexAttrib4f(",n,",",q,");",Ca.map(function(a,b){return m+"."+a+"="+q[b]+";"}).join(""),"}")}var l=h.gl,n=b.def(c,".location"),m=b.def(h.attributes,"[",n,"]");c=e.state;var U=e.buffer,q=[e.x,e.y,e.z,e.w],ea=["buffer","normalized","offset","stride"];1===c?f():2===c?k():(b("if(",c,"===",1,"){"),f(),b("}else{"),k(),b("}"))}var h=a.shared;d.forEach(function(d){var h=d.name,k=c.attributes[h],l;if(k){if(!e(k))return;
l=k.append(a,b)}else{if(!e(yb))return;var n=a.scopeAttrib(h);l={};Object.keys(new ja).forEach(function(a){l[a]=b.def(n,".",a)})}g(a.link(d),f(d.info.type),l)})}function xa(a,c,d,e,f){for(var g=a.shared,h=g.gl,k,l=0;l<e.length;++l){var n=e[l],m=n.name,q=n.info.type,r=d.uniforms[m],n=a.link(n)+".location",p;if(r){if(!f(r))continue;if(va(r)){m=r.value;if(35678===q||35680===q)q=a.link(m._texture||m.color[0]._texture),c(h,".uniform1i(",n,",",q+".bind());"),c.exit(q,".unbind();");else if(35674===q||35675===
q||35676===q)m=a.global.def("new Float32Array(["+Array.prototype.slice.call(m)+"])"),r=2,35675===q?r=3:35676===q&&(r=4),c(h,".uniformMatrix",r,"fv(",n,",false,",m,");");else{switch(q){case 5126:k="1f";break;case 35664:k="2f";break;case 35665:k="3f";break;case 35666:k="4f";break;case 35670:k="1i";break;case 5124:k="1i";break;case 35671:k="2i";break;case 35667:k="2i";break;case 35672:k="3i";break;case 35668:k="3i";break;case 35673:k="4i";break;case 35669:k="4i"}c(h,".uniform",k,"(",n,",",oa(m)?Array.prototype.slice.call(m):
m,");")}continue}else p=r.append(a,c)}else{if(!f(yb))continue;p=c.def(g.uniforms,"[",b.id(m),"]")}35678===q?c("if(",p,"&&",p,'._reglType==="framebuffer"){',p,"=",p,".color[0];","}"):35680===q&&c("if(",p,"&&",p,'._reglType==="framebufferCube"){',p,"=",p,".color[0];","}");m=1;switch(q){case 35678:case 35680:q=c.def(p,"._texture");c(h,".uniform1i(",n,",",q,".bind());");c.exit(q,".unbind();");continue;case 5124:case 35670:k="1i";break;case 35667:case 35671:k="2i";m=2;break;case 35668:case 35672:k="3i";
m=3;break;case 35669:case 35673:k="4i";m=4;break;case 5126:k="1f";break;case 35664:k="2f";m=2;break;case 35665:k="3f";m=3;break;case 35666:k="4f";m=4;break;case 35674:k="Matrix2fv";break;case 35675:k="Matrix3fv";break;case 35676:k="Matrix4fv"}c(h,".uniform",k,"(",n,",");if("M"===k.charAt(0)){var n=Math.pow(q-35674+2,2),t=a.global.def("new Float32Array(",n,")");c("false,(Array.isArray(",p,")||",p," instanceof Float32Array)?",p,":(",A(n,function(a){return t+"["+a+"]="+p+"["+a+"]"}),",",t,")")}else 1<
m?c(A(m,function(a){return p+"["+a+"]"})):c(p);c(");")}}function ba(a,b,c,d){function e(f){var g=m[f];return g?g.contextDep&&d.contextDynamic||g.propDep?g.append(a,c):g.append(a,b):b.def(l,".",f)}function f(){function a(){c(v,".drawElementsInstancedANGLE(",[q,r,u,p+"<<(("+u+"-5121)>>1)",t],");")}function b(){c(v,".drawArraysInstancedANGLE(",[q,p,r,t],");")}n?ca?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}function g(){function a(){c(k+".drawElements("+[q,r,u,p+"<<(("+u+"-5121)>>1)"]+");")}
function b(){c(k+".drawArrays("+[q,p,r]+");")}n?ca?a():(c("if(",n,"){"),a(),c("}else{"),b(),c("}")):b()}var h=a.shared,k=h.gl,l=h.draw,m=d.draw,n=function(){var e=m.elements,f=b;if(e){if(e.contextDep&&d.contextDynamic||e.propDep)f=c;e=e.append(a,f)}else e=f.def(l,".","elements");e&&f("if("+e+")"+k+".bindBuffer(34963,"+e+".buffer.buffer);");return e}(),q=e("primitive"),p=e("offset"),r=function(){var e=m.count,f=b;if(e){if(e.contextDep&&d.contextDynamic||e.propDep)f=c;e=e.append(a,f)}else e=f.def(l,
".","count");return e}();if("number"===typeof r){if(0===r)return}else c("if(",r,"){"),c.exit("}");var t,v;pa&&(t=e("instances"),v=a.instancing);var u=n+".type",ca=m.elements&&va(m.elements);pa&&("number"!==typeof t||0<=t)?"string"===typeof t?(c("if(",t,">0){"),f(),c("}else if(",t,"<0){"),g(),c("}")):f():g()}function ya(a,b,c,d,e){b=q();e=b.proc("body",e);pa&&(b.instancing=e.def(b.shared.extensions,".angle_instanced_arrays"));a(b,e,c,d);return b.compile().body}function ca(a,b,c,d){B(a,b);c.useVAO?
...
f("[",c.join(),"]");break;default:f(a.link(c))}f(";")}});b.dynamic[c]=new ha.DynamicVariable(4,{thisDep:h,contextDep:k,propDep:l,ref:m,append:d});delete b["static"][c]}}var ja=p.Record,W={add:32774,subtract:32778,"reverse subtract":32779};c.ext_blend_minmax&&(W.min=32775,W.max=32776);var pa=c.angle_instanced_arrays,Ka=c.webgl_draw_buffers,qa={dirty:!0,profile:h.profile},Da={},La=[],ra={},sa={};t("dither",3024);t("blend.enable",3042);m("blend.color","blendColor",[0,0,0,0]);m("blend.equation","blendEquationSeparate",
[32774,32774]);m("blend.func","blendFuncSeparate",[1,0,1,0]);t("depth.enable",2929,!0);m("depth.func","depthFunc",513);m("depth.range","depthRange",[0,1]);m("depth.mask","depthMask",!0);m("colorMask","colorMask",[!0,!0,!0,!0]);t("cull.enable",2884);m("cull.face","cullFace",1029);m("frontFace","frontFace",2305);m("lineWidth","lineWidth",1);t("polygonOffset.enable",32823);m("polygonOffset.offset","polygonOffset",[0,0]);t("sample.alpha",32926);t("sample.enable",32928);m("sample.coverage","sampleCoverage",
[1,!1]);t("stencil.enable",2960);m("stencil.mask","stencilMask",-1);m("stencil.func","stencilFunc",[519,0,-1]);m("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);m("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);t("scissor.enable",3089);m("scissor.box","scissor",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);m("viewport","viewport",[0,0,a.drawingBufferWidth,a.drawingBufferHeight]);var la={gl:a,context:F,strings:b,next:Da,current:qa,draw:l,elements:g,buffer:d,shader:v,attributes:p.state,
vao:p,uniforms:u,framebuffer:n,extensions:c,timer:k,isBufferArgs:Pa},Z={primTypes:Ta,compareFuncs:$a,blendFuncs:Fa,blendEquations:W,stencilOps:Qa,glTypes:Ia,orientationType:xb};Ka&&(Z.backBuffer=[1029],Z.drawBuffer=A(e.maxDrawbuffers,function(a){return 0===a?[0]:A(a,function(a){return 36064+a})}));var ua=0;return{next:Da,current:qa,procs:function(){var a=q(),b=a.proc("poll"),d=a.proc("refresh"),f=a.block();b(f);d(f);var g=a.shared,h=g.gl,k=g.next,l=g.current;f(l,".dirty=false;");O(a,b);O(a,d,null,
!0);var m;pa&&(m=a.link(pa));c.oes_vertex_array_object&&d(a.link(c.oes_vertex_array_object),".bindVertexArrayOES(null);");for(var n=0;n<e.maxAttributes;++n){var p=d.def(g.attributes,"[",n,"]"),r=a.cond(p,".buffer");r.then(h,".enableVertexAttribArray(",n,");",h,".bindBuffer(",34962,",",p,".buffer.buffer);",h,".vertexAttribPointer(",n,",",p,".size,",p,".type,",p,".normalized,",p,".stride,",p,".offset);")["else"](h,".disableVertexAttribArray(",n,");",h,".vertexAttrib4f(",n,",",p,".x,",p,".y,",p,".z,",
p,".w);",p,".buffer=null;");d(r);pa&&d(m,".vertexAttribDivisorANGLE(",n,",",p,".divisor);")}d(a.shared.vao,".currentVAO=null;",a.shared.vao,".setVAO(",a.shared.vao,".targetVAO);");Object.keys(ra).forEach(function(c){var e=ra[c],g=f.def(k,".",c),m=a.block();m("if(",g,"){",h,".enable(",e,")}else{",h,".disable(",e,")}",l,".",c,"=",g,";");d(m);b("if(",g,"!==",l,".",c,"){",m,"}")});Object.keys(sa).forEach(function(c){var e=sa[c],g=qa[c],m,n,q=a.block();q(h,".",e,"(");oa(g)?(e=g.length,m=a.global.def(k,
".",c),n=a.global.def(l,".",c),q(A(e,function(a){return m+"["+a+"]"}),");",A(e,function(a){return n+"["+a+"]="+m+"["+a+"];"}).join("")),b("if(",A(e,function(a){return m+"["+a+"]!=="+n+"["+a+"]"}).join("||"),"){",q,"}")):(m=f.def(k,".",c),n=f.def(l,".",c),q(m,");",l,".",c,"=",m,";"),b("if(",m,"!==",n,"){",q,"}"));d(q)});return a.compile()}(),compile:function(a,b,c,d,e){var f=q();f.stats=f.link(e);Object.keys(b["static"]).forEach(function(a){ka(f,b,a)});Ub.forEach(function(b){ka(f,a,b)});c=ma(a,b,c,
...
4;Z[36193]=2;Z[5123]=2;Z[5125]=4;var w=[];w[32854]=2;w[32855]=2;w[36194]=2;w[34041]=4;w[33776]=.5;w[33777]=.5;w[33778]=1;w[33779]=1;w[35986]=.5;w[35987]=1;w[34798]=1;w[35840]=.5;w[35841]=.25;w[35842]=.5;w[35843]=.25;w[36196]=.5;var E=[];E[32854]=2;E[32855]=2;E[36194]=2;E[33189]=2;E[36168]=1;E[34041]=4;E[35907]=4;E[34836]=16;E[34842]=8;E[34843]=6;var Wb=function(a,b,c,e,d){function g(a){this.id=p++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;d.profile&&(this.stats=
{size:0})}function r(b){var c=b.renderbuffer;a.bindRenderbuffer(36161,null);a.deleteRenderbuffer(c);b.renderbuffer=null;b.refCount=0;delete v[b.id];e.renderbufferCount--}var n={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};b.ext_srgb&&(n.srgba=35907);b.ext_color_buffer_half_float&&(n.rgba16f=34842,n.rgb16f=34843);b.webgl_color_buffer_float&&(n.rgba32f=34836);var u=[];Object.keys(n).forEach(function(a){u[n[a]]=a});var p=0,v={};g.prototype.decRef=function(){0>=
--this.refCount&&r(this)};d.profile&&(e.getTotalRenderbufferSize=function(){var a=0;Object.keys(v).forEach(function(b){a+=v[b].stats.size});return a});return{create:function(b,c){function k(b,c){var e=0,g=0,l=32854;"object"===typeof b&&b?("shape"in b?(g=b.shape,e=g[0]|0,g=g[1]|0):("radius"in b&&(e=g=b.radius|0),"width"in b&&(e=b.width|0),"height"in b&&(g=b.height|0)),"format"in b&&(l=n[b.format])):"number"===typeof b?(e=b|0,g="number"===typeof c?c|0:e):b||(e=g=1);if(e!==h.width||g!==h.height||l!==
h.format)return k.width=h.width=e,k.height=h.height=g,h.format=l,a.bindRenderbuffer(36161,h.renderbuffer),a.renderbufferStorage(36161,l,e,g),d.profile&&(h.stats.size=E[h.format]*h.width*h.height),k.format=u[h.format],k}var h=new g(a.createRenderbuffer());v[h.id]=h;e.renderbufferCount++;k(b,c);k.resize=function(b,c){var e=b|0,g=c|0||e;if(e===h.width&&g===h.height)return k;k.width=h.width=e;k.height=h.height=g;a.bindRenderbuffer(36161,h.renderbuffer);a.renderbufferStorage(36161,h.format,e,g);d.profile&&
(h.stats.size=E[h.format]*h.width*h.height);return k};k._reglType="renderbuffer";k._renderbuffer=h;d.profile&&(k.stats=h.stats);k.destroy=function(){h.decRef()};return k},clear:function(){J(v).forEach(r)},restore:function(){J(v).forEach(function(b){b.renderbuffer=a.createRenderbuffer();a.bindRenderbuffer(36161,b.renderbuffer);a.renderbufferStorage(36161,b.format,b.width,b.height)});a.bindRenderbuffer(36161,null)}}},Xa=[];Xa[6408]=4;Xa[6407]=3;var Oa=[];Oa[5121]=1;Oa[5126]=4;Oa[36193]=2;var Ca=["x",
...
b;e.sum=0;e.stats=d;n.push(e)}if(!b.ext_disjoint_timer_query)return null;var d=[],g=[],r=[],n=[],u=[],p=[];return{beginQuery:function(a){var c=d.pop()||b.ext_disjoint_timer_query.createQueryEXT();b.ext_disjoint_timer_query.beginQueryEXT(35007,c);g.push(c);e(g.length-1,g.length,a)},endQuery:function(){b.ext_disjoint_timer_query.endQueryEXT(35007)},pushScopeStats:e,update:function(){var a,c;a=g.length;if(0!==a){p.length=Math.max(p.length,a+1);u.length=Math.max(u.length,a+1);u[0]=0;var e=p[0]=0;for(c=
a=0;c<g.length;++c){var k=g[c];b.ext_disjoint_timer_query.getQueryObjectEXT(k,34919)?(e+=b.ext_disjoint_timer_query.getQueryObjectEXT(k,34918),d.push(k)):g[a++]=k;u[c+1]=e;p[c+1]=a}g.length=a;for(c=a=0;c<n.length;++c){var e=n[c],h=e.startQueryIndex,k=e.endQueryIndex;e.sum+=u[k]-u[h];h=p[h];k=p[k];k===h?(e.stats.gpuTime+=e.sum/1E6,r.push(e)):(e.startQueryIndex=h,e.endQueryIndex=k,n[a++]=e)}n.length=a}},getNumPendingQueries:function(){return g.length},clear:function(){d.push.apply(d,g);for(var a=0;a<
d.length;a++)b.ext_disjoint_timer_query.deleteQueryEXT(d[a]);g.length=0;d.length=0},restore:function(){g.length=0;d.length=0}}};return function(a){function b(){if(0===B.length)w&&w.update(),ba=null;else{ba=ab.next(b);v();for(var a=B.length-1;0<=a;--a){var c=B[a];c&&c(A,null,0)}k.flush();w&&w.update()}}function c(){!ba&&0<B.length&&(ba=ab.next(b))}function e(){ba&&(ab.cancel(b),ba=null)}function d(a){a.preventDefault();e();V.forEach(function(a){a()})}function g(a){k.getError();f.restore();D.restore();
...
256);"stencil"in b&&(k.clearStencil(b.stencil|0),c|=1024);k.clear(c)}function u(a){B.push(a);c();return{cancel:function(){function b(){var a=zb(B,b);B[a]=B[B.length-1];--B.length;0>=B.length&&e()}var c=zb(B,a);B[c]=b}}}function p(){var a=S.viewport,b=S.scissor_box;a[0]=a[1]=b[0]=b[1]=0;A.viewportWidth=A.framebufferWidth=A.drawingBufferWidth=a[2]=b[2]=k.drawingBufferWidth;A.viewportHeight=A.framebufferHeight=A.drawingBufferHeight=a[3]=b[3]=k.drawingBufferHeight}function v(){A.tick+=1;A.time=z();p();
O.procs.poll()}function l(){p();O.procs.refresh();w&&w.update()}function z(){return(Ab()-C)/1E3}a=Fb(a);if(!a)return null;var k=a.gl,h=k.getContextAttributes();k.isContextLost();var f=Gb(k,a);if(!f)return null;var t=Cb(),m={vaoCount:0,bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0},q=f.extensions,w=Xb(k,q),C=Ab(),E=k.drawingBufferWidth,L=k.drawingBufferHeight,A={tick:0,time:0,viewportWidth:E,viewportHeight:L,framebufferWidth:E,
framebufferHeight:L,drawingBufferWidth:E,drawingBufferHeight:L,pixelRatio:a.pixelRatio},G=Vb(k,q),R=Hb(k,m,a,function(a){return J.destroyBuffer(a)}),J=Pb(k,q,G,m,R),P=Ib(k,q,R,m),D=Qb(k,t,m,a),x=Lb(k,q,G,function(){O.procs.poll()},A,m,a),N=Wb(k,q,G,m,a),T=Ob(k,q,G,x,N,m),O=Tb(k,t,q,G,R,P,x,T,{},J,D,{elements:null,primitive:4,count:-1,offset:0,instances:-1},A,w,a),t=Rb(k,T,O.procs.poll,A,h,q,G),S=O.next,K=k.canvas,B=[],V=[],X=[],Y=[a.onDestroy],ba=null;K&&(K.addEventListener("webglcontextlost",d,!1),
