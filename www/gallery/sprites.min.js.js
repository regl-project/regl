...
1],depth:1});h({count:Math.min(d,262144)})})},{"../regl":35,"mouse-change":33}],2:[function(f,n,q){function k(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}n.exports=function(a,p,f,h,d){a=f.maxAttributes;p=Array(a);for(f=0;f<a;++f)p[f]=new k;return{Record:k,scope:{},state:p}}},{}],3:[function(f,n,q){function k(a){return I[Object.prototype.toString.call(a)]|0}function a(a,d){for(var h=0;h<d.length;++h)a[h]=
d[h]}function p(a,d,h,b,l,k,p){for(var m=0,c=0;c<h;++c)for(var f=0;f<b;++f)a[m++]=d[l*c+k*f+p]}function E(a,d,h){for(var b=0,l=0;l<d.length;++l)for(var k=d[l],p=0;p<h;++p)a[b++]=k[p]}var h=f("./util/is-typed-array"),d=f("./util/is-ndarray"),b=f("./util/values"),u=f("./util/pool"),I=f("./constants/arraytypes.json"),F=f("./constants/dtypes.json"),r=f("./constants/usage.json"),m=[];m[5120]=1;m[5122]=2;m[5124]=4;m[5121]=1;m[5123]=2;m[5125]=4;m[5126]=4;n.exports=function(f,y,C){function g(a){this.id=A++;
...
m,g=u.allocType(c.dtype,b.length),a(g,b),l(c,g,f),A?c.persistentData=g:u.freeType(g)):h(b[0])&&(c.dimension=b[0].length,c.dtype=g||k(b[0])||5126,g=u.allocType(c.dtype,b.length*c.dimension),E(g,b,c.dimension),l(c,g,f),A?c.persistentData=g:u.freeType(g)));else if(h(b))c.dtype=g||k(b),c.dimension=m,l(c,b,f),A&&(c.persistentData=new Uint8Array(new Uint8Array(b.buffer)));else if(d(b)){var O=b.shape,Q=b.stride;m=b.offset;var r=0,y=0,t=0,Z=0;1===O.length?(r=O[0],y=1,t=Q[0],Z=0):2===O.length&&(r=O[0],y=O[1],
t=Q[0],Z=Q[1]);c.dtype=g||k(b.data)||5126;c.dimension=y;g=u.allocType(c.dtype,r*y);p(g,b.data,r,y,t,Z,m);l(c,g,f);A?c.persistentData=g:u.freeType(g)}}function D(a){y.bufferCount--;f.deleteBuffer(a.buffer);a.buffer=null;delete c[a.id]}var A=0,c={};g.prototype.bind=function(){f.bindBuffer(this.type,this.buffer)};g.prototype.destroy=function(){D(this)};var O=[];C.profile&&(y.getTotalBufferSize=function(){var a=0;Object.keys(c).forEach(function(d){a+=c[d].stats.size});return a});return{create:function(b,
l,A,O){function I(a){var c=35044,b=null,g=0,l=0,k=1;Array.isArray(a)||h(a)||d(a)?b=a:"number"===typeof a?g=a|0:a&&("data"in a&&(b=a.data),"usage"in a&&(c=r[a.usage]),"type"in a&&(l=F[a.type]),"dimension"in a&&(k=a.dimension|0),"length"in a&&(g=a.length|0));q.bind();b?n(q,b,c,l,k,O):(f.bufferData(q.type,g,c),q.dtype=l||5121,q.usage=c,q.dimension=k,q.byteLength=g);C.profile&&(q.stats.size=q.byteLength*m[q.dtype]);return I}y.bufferCount++;var q=new g(l);c[q.id]=q;A||I(b);I._reglType="buffer";I._buffer=
q;I.subdata=function(c,b){var g=(b||0)|0;q.bind();if(Array.isArray(c)){if(0<c.length)if("number"===typeof c[0]){var l=u.allocType(q.dtype,c.length);a(l,c);f.bufferSubData(q.type,g,l);u.freeType(l)}else if(Array.isArray(c[0])||h(c[0])){var l=c[0].length,t=u.allocType(q.dtype,c.length*l);E(t,c,l);f.bufferSubData(q.type,g,t);u.freeType(t)}}else if(h(c))f.bufferSubData(q.type,g,c);else if(d(c)){var m=c.shape,A=c.stride,O=t=l=0,r=0;1===m.length?(l=m[0],t=1,O=A[0],r=0):2===m.length&&(l=m[0],t=m[1],O=A[0],
r=A[1]);m=Array.isArray(c.data)?q.dtype:k(c.data);m=u.allocType(m,l*t);p(m,c.data,l,t,O,r,c.offset);f.bufferSubData(q.type,g,m);u.freeType(m)}return I};C.profile&&(I.stats=q.stats);I.destroy=function(){D(q)};return I},createStream:function(a,c){var d=O.pop();d||(d=new g(a));d.bind();n(d,c,35040,0,1,!1);return d},destroyStream:function(a){O.push(a)},clear:function(){b(c).forEach(D);O.forEach(D)},getBuffer:function(a){return a&&a._buffer instanceof g?a._buffer:null},restore:function(){b(c).forEach(function(a){a.buffer=
...
n,q,I,F,ma,na,M,Q,oa,ta,t,Z,aa,ia){function V(a){return a.replace(".","_")}function L(a,e,c){var d=V(a);Ha.push(a);Ba[d]=ua[d]=!!c;va[d]=e}function B(a,e,c){var d=V(a);Ha.push(a);Array.isArray(c)?(ua[d]=c.slice(),Ba[d]=c.slice()):ua[d]=Ba[d]=c;wa[d]=e}function xa(){var a=b(),e=a.link,c=a.global;a.id=Na++;a.batchId="0";var d=e(Ma),h=a.shared={props:"a0"};Object.keys(Ma).forEach(function(a){h[a]=c.def(d,".",a)});var l=a.next={},T=a.current={};Object.keys(wa).forEach(function(a){Array.isArray(ua[a])&&
(l[a]=c.def(h.next,".",a),T[a]=c.def(h.current,".",a))});var Oa=a.constants={};Object.keys(Ia).forEach(function(a){Oa[a]=c.def(JSON.stringify(Ia[a]))});a.invoke=function(z,J){switch(J.type){case 0:var c=["this",h.context,h.props,a.batchId];return z.def(e(J.data),".call(",c.slice(0,Math.max(J.data.length+1,4)),")");case 1:return z.def(h.props,J.data);case 2:return z.def(h.context,J.data);case 3:return z.def("this",J.data);case 4:return J.data.append(a,z),J.data.ref}};a.attribCache={};var z={};a.scopeAttrib=
function(a){a=n.id(a);if(a in z)return z[a];var x=oa.scope[a];x||(x=oa.scope[a]=new w);return z[a]=e(x)};return a}function pa(a){var e=a["static"];a=a.dynamic;var c;if("profile"in e){var b=!!e.profile;c=h(function(a,e){return b});c.enable=b}else if("profile"in a){var l=a.profile;c=d(l,function(a,e){return a.invoke(e,l)})}return c}function ya(a,e){var c=a["static"],b=a.dynamic;if("framebuffer"in c){var l=c.framebuffer;return l?(l=M.getFramebuffer(l),h(function(a,e){var z=a.link(l),c=a.shared;e.set(c.framebuffer,
".next",z);c=c.context;e.set(c,".framebufferWidth",z+".width");e.set(c,".framebufferHeight",z+".height");return z})):h(function(a,e){var z=a.shared;e.set(z.framebuffer,".next","null");z=z.context;e.set(z,".framebufferWidth",z+".drawingBufferWidth");e.set(z,".framebufferHeight",z+".drawingBufferHeight");return"null"})}if("framebuffer"in b){var g=b.framebuffer;return d(g,function(a,e){var z=a.invoke(e,g),c=a.shared,x=c.framebuffer,z=e.def(x,".getFramebuffer(",z,")");e.set(x,".next",z);c=c.context;e.set(c,
".framebufferWidth",z+"?"+z+".width:"+c+".drawingBufferWidth");e.set(c,".framebufferHeight",z+"?"+z+".height:"+c+".drawingBufferHeight");return z})}return null}function P(a,e,c){function b(a){if(a in h){var z=h[a];a=!0;var c=z.x|0,J=z.y|0,x,g;"width"in z?x=z.width|0:a=!1;"height"in z?g=z.height|0:a=!1;return new p(!a&&e&&e.thisDep,!a&&e&&e.contextDep,!a&&e&&e.propDep,function(a,e){var d=a.shared.context,R=x;"width"in z||(R=e.def(d,".","framebufferWidth","-",c));var b=g;"height"in z||(b=e.def(d,".",
"framebufferHeight","-",J));return[c,J,R,b]})}if(a in l){var T=l[a];a=d(T,function(a,e){var z=a.invoke(e,T),c=a.shared.context,J=e.def(z,".x|0"),x=e.def(z,".y|0"),d=e.def('"width" in ',z,"?",z,".width|0:","(",c,".","framebufferWidth","-",J,")"),z=e.def('"height" in ',z,"?",z,".height|0:","(",c,".","framebufferHeight","-",x,")");return[J,x,d,z]});e&&(a.thisDep=a.thisDep||e.thisDep,a.contextDep=a.contextDep||e.contextDep,a.propDep=a.propDep||e.propDep);return a}return e?new p(e.thisDep,e.contextDep,
e.propDep,function(a,e){var z=a.shared.context;return[0,0,e.def(z,".","framebufferWidth"),e.def(z,".","framebufferHeight")]}):null}var h=a["static"],l=a.dynamic;if(a=b("viewport")){var g=a;a=new p(a.thisDep,a.contextDep,a.propDep,function(a,e){var c=g.append(a,e),J=a.shared.context;e.set(J,".viewportWidth",c[2]);e.set(J,".viewportHeight",c[3]);return c})}return{viewport:a,scissor_box:b("scissor.box")}}function ca(a){function e(a){if(a in c){var z=n.id(c[a]);a=h(function(){return z});a.id=z;return a}if(a in
b){var x=b[a];return d(x,function(a,e){var z=a.invoke(e,x);return e.def(a.shared.strings,".id(",z,")")})}return null}var c=a["static"],b=a.dynamic,l=e("frag"),g=e("vert"),T=null;E(l)&&E(g)?(T=ta.program(g.id,l.id),a=h(function(a,e){return a.link(T)})):a=new p(l&&l.thisDep||g&&g.thisDep,l&&l.contextDep||g&&g.contextDep,l&&l.propDep||g&&g.propDep,function(a,e){var c=a.shared.shader,J;J=l?l.append(a,e):e.def(c,".","frag");var x;x=g?g.append(a,e):e.def(c,".","vert");return e.def(c+".program("+x+","+J+
")")});return{frag:l,vert:g,progVar:a,program:T}}function da(a,e){function c(a,e){if(a in b){var x=b[a]|0;return h(function(a,c){e&&(a.OFFSET=x);return x})}if(a in l){var J=l[a];return d(J,function(a,c){var x=a.invoke(c,J);e&&(a.OFFSET=x);return x})}return e&&g?h(function(a,e){a.OFFSET="0";return 0}):null}var b=a["static"],l=a.dynamic,g=function(){if("elements"in b){var a=b.elements;k(a)?a=ma.getElements(ma.create(a,!0)):a&&(a=ma.getElements(a));var e=h(function(e,c){if(a){var z=e.link(a);return e.ELEMENTS=
z}return e.ELEMENTS=null});e.value=a;return e}if("elements"in l){var c=l.elements;return d(c,function(a,e){var z=a.shared,x=z.isBufferArgs,z=z.elements,d=a.invoke(e,c),b=e.def("null"),x=e.def(x,"(",d,")"),d=a.cond(x).then(b,"=",z,".createStream(",d,");")["else"](b,"=",z,".getElements(",d,");");e.entry(d);e.exit(a.cond(x).then(z,".destroyStream(",b,");"));return a.ELEMENTS=b})}return null}(),T=c("offset",!0);return{elements:g,primitive:function(){if("primitive"in b){var a=b.primitive;return h(function(e,
c){return H[a]})}if("primitive"in l){var e=l.primitive;return d(e,function(a,c){var x=a.constants.primTypes,d=a.invoke(c,e);return c.def(x,"[",d,"]")})}return g?E(g)?g.value?h(function(a,e){return e.def(a.ELEMENTS,".primType")}):h(function(){return 4}):new p(g.thisDep,g.contextDep,g.propDep,function(a,e){var c=a.ELEMENTS;return e.def(c,"?",c,".primType:",4)}):null}(),count:function(){if("count"in b){var a=b.count|0;return h(function(){return a})}if("count"in l){var e=l.count;return d(e,function(a,
...
b=a.dynamic,g={};Ha.forEach(function(a){function e(z,R){if(a in c){var J=z(c[a]);g[x]=h(function(){return J})}else if(a in b){var l=b[a];g[x]=d(l,function(a,e){return R(a,e,a.invoke(e,l))})}}var x=V(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return e(function(a){return a},function(a,e,c){return c});case "depth.func":return e(function(a){return G[a]},
function(a,e,c){return e.def(a.constants.compareFuncs,"[",c,"]")});case "depth.range":return e(function(a){return a},function(a,e,c){a=e.def("+",c,"[0]");e=e.def("+",c,"[1]");return[a,e]});case "blend.func":return e(function(a){return[l["srcRGB"in a?a.srcRGB:a.src],l["dstRGB"in a?a.dstRGB:a.dst],l["srcAlpha"in a?a.srcAlpha:a.src],l["dstAlpha"in a?a.dstAlpha:a.dst]]},function(a,e,c){function x(a,z){return e.def('"',a,z,'" in ',c,"?",c,".",a,z,":",c,".",a)}a=a.constants.blendFuncs;var d=x("src","RGB"),
b=x("dst","RGB"),d=e.def(a,"[",d,"]"),R=e.def(a,"[",x("src","Alpha"),"]"),b=e.def(a,"[",b,"]");a=e.def(a,"[",x("dst","Alpha"),"]");return[d,b,R,a]});case "blend.equation":return e(function(a){if("string"===typeof a)return[ea[a],ea[a]];if("object"===typeof a)return[ea[a.rgb],ea[a.alpha]]},function(a,e,c){var x=a.constants.blendEquations,d=e.def(),b=e.def();a=a.cond("typeof ",c,'==="string"');a.then(d,"=",b,"=",x,"[",c,"];");a["else"](d,"=",x,"[",c,".rgb];",b,"=",x,"[",c,".alpha];");e(a);return[d,b]});
case "blend.color":return e(function(a){return u(4,function(e){return+a[e]})},function(a,e,c){return u(4,function(a){return e.def("+",c,"[",a,"]")})});case "stencil.mask":return e(function(a){return a|0},function(a,e,c){return e.def(c,"|0")});case "stencil.func":return e(function(a){return[G[a.cmp||"keep"],a.ref||0,"mask"in a?a.mask:-1]},function(a,e,c){a=e.def('"cmp" in ',c,"?",a.constants.compareFuncs,"[",c,".cmp]",":",7680);var x=e.def(c,".ref|0");e=e.def('"mask" in ',c,"?",c,".mask|0:-1");return[a,
x,e]});case "stencil.opFront":case "stencil.opBack":return e(function(e){return["stencil.opBack"===a?1029:1028,D[e.fail||"keep"],D[e.zfail||"keep"],D[e.zpass||"keep"]]},function(e,c,x){function d(a){return c.def('"',a,'" in ',x,"?",b,"[",x,".",a,"]:",7680)}var b=e.constants.stencilOps;return["stencil.opBack"===a?1029:1028,d("fail"),d("zfail"),d("zpass")]});case "polygonOffset.offset":return e(function(a){return[a.factor|0,a.units|0]},function(a,e,c){a=e.def(c,".factor|0");e=e.def(c,".units|0");return[a,
...
a?a.value:1,!!a.invert]},function(a,e,c){a=e.def('"value" in ',c,"?+",c,".value:1");e=e.def("!!",c,".invert");return[a,e]})}});return g}function fa(a,e){var c=a["static"],b=a.dynamic,g={};Object.keys(c).forEach(function(a){var e=c[a],x;if("number"===typeof e||"boolean"===typeof e)x=h(function(){return e});else if("function"===typeof e){var d=e._reglType;if("texture2d"===d||"textureCube"===d)x=h(function(a){return a.link(e)});else if("framebuffer"===d||"framebufferCube"===d)x=h(function(a){return a.link(e.color[0])})}else r(e)&&
(x=h(function(a){return a.global.def("[",u(e.length,function(a){return e[a]}),"]")}));x.value=e;g[a]=x});Object.keys(b).forEach(function(a){var e=b[a];g[a]=d(e,function(a,c){return a.invoke(c,e)})});return g}function W(a,e){var c=a["static"],b=a.dynamic,g={};Object.keys(c).forEach(function(a){var e=c[a],x=n.id(a),d=new w;if(k(e))d.state=1,d.buffer=F.getBuffer(F.create(e,34962,!1,!0)),d.type=d.buffer.dtype;else{var b=F.getBuffer(e);if(b)d.state=1,d.buffer=b,d.type=b.dtype;else if(e.constant){var R=
e.constant;d.buffer="null";d.state=2;"number"===typeof R?d.x=R:C.forEach(function(a,e){e<R.length&&(d[a]=R[e])})}else{var b=k(e.buffer)?F.getBuffer(F.create(e.buffer,34962,!1,!0)):F.getBuffer(e.buffer),l=e.offset|0,f=e.stride|0,v=e.size|0,t=!!e.normalized,m=0;"type"in e&&(m=y[e.type]);e=e.divisor|0;d.buffer=b;d.state=1;d.size=v;d.normalized=t;d.type=m||b.dtype;d.offset=l;d.stride=f;d.divisor=e}}g[a]=h(function(a,e){var c=a.attribCache;if(x in c)return c[x];var b={isStream:!1};Object.keys(d).forEach(function(a){b[a]=
d[a]});d.buffer&&(b.buffer=a.link(d.buffer));return c[x]=b})});Object.keys(b).forEach(function(a){var e=b[a];g[a]=d(e,function(a,c){function d(a){c(l[a],"=",x,".",a,"|0;")}var x=a.invoke(c,e),b=a.shared,R=b.isBufferArgs,g=b.buffer,l={isStream:c.def(!1)},h=new w;h.state=1;Object.keys(h).forEach(function(a){l[a]=c.def(""+h[a])});var f=l.buffer,v=l.type;c("if(",R,"(",x,")){",l.isStream,"=true;",f,"=",g,".createStream(",34962,",",x,");",v,"=",f,".dtype;","}else{",f,"=",g,".getBuffer(",x,");","if(",f,
"){",v,"=",f,".dtype;",'}else if("constant" in ',x,"){",l.state,"=",2,";","if(typeof "+x+'.constant === "number"){',l[C[0]],"=",x,".constant;",C.slice(1).map(function(a){return l[a]}).join("="),"=0;","}else{",C.map(function(a,e){return l[a]+"="+x+".constant.length>="+e+"?"+x+".constant["+e+"]:0;"}).join(""),"}}else{","if(",R,"(",x,".buffer)){",f,"=",g,".createStream(",34962,",",x,".buffer);","}else{",f,"=",g,".getBuffer(",x,".buffer);","}",v,'="type" in ',x,"?",b.glTypes,"[",x,".type]:",f,".dtype;",
l.normalized,"=!!",x,".normalized;");d("size");d("offset");d("stride");d("divisor");c("}}");c.exit("if(",l.isStream,"){",g,".destroyStream(",f,");","}");return l})});return g}function sa(a){var e=a["static"],c=a.dynamic,b={};Object.keys(e).forEach(function(a){var c=e[a];b[a]=h(function(a,e){return"number"===typeof c||"boolean"===typeof c?""+c:a.link(c)})});Object.keys(c).forEach(function(a){var e=c[a];b[a]=d(e,function(a,c){return a.invoke(c,e)})});return b}function qa(a,e,c,d,b){var l=ya(a,b),g=
...
f.drawingBufferHeight]);B("viewport","viewport",[0,0,f.drawingBufferWidth,f.drawingBufferHeight]);var Ma={gl:f,context:Z,strings:n,next:Ba,current:ua,draw:t,elements:ma,buffer:F,shader:ta,attributes:oa.state,uniforms:Q,framebuffer:M,extensions:q,timer:aa,isBufferArgs:k},Ia={primTypes:H,compareFuncs:G,blendFuncs:l,blendEquations:ea,stencilOps:D,glTypes:y,orientationType:A};Ja&&(Ia.backBuffer=[1029],Ia.drawBuffer=u(I.maxDrawbuffers,function(a){return 0===a?[0]:u(a,function(a){return 36064+a})}));var Na=
0;return{next:Ba,current:ua,procs:function(){var a=xa(),e=a.proc("poll"),c=a.proc("refresh"),b=a.block();e(b);c(b);var d=a.shared,l=d.gl,g=d.next,h=d.current;b(h,".dirty=false;");ga(a,e);ga(a,c,null,!0);var w=f.getExtension("angle_instanced_arrays"),v;w&&(v=a.link(w));for(var k=0;k<I.maxAttributes;++k){var m=c.def(d.attributes,"[",k,"]"),t=a.cond(m,".buffer");t.then(l,".enableVertexAttribArray(",k,");",l,".bindBuffer(",34962,",",m,".buffer.buffer);",l,".vertexAttribPointer(",k,",",m,".size,",m,".type,",
...
b;var d=a=0;c?(a=c.width,d=c.height):b&&(a=b.width,d=b.height);this.width=a;this.height=d}function m(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function H(a,c,b){a&&(a.texture?a.texture._texture.refCount+=1:a.renderbuffer._renderbuffer.refCount+=1)}function y(a,c){c?c.texture?f.framebufferTexture2D(36160,a,c.target,c.texture._texture.texture,0):f.framebufferRenderbuffer(36160,a,36161,c.renderbuffer._renderbuffer.renderbuffer):f.framebufferTexture2D(36160,
...
function O(a){var c;f.bindFramebuffer(36160,a.framebuffer);var d=a.colorAttachments;for(c=0;c<d.length;++c)y(36064+c,d[c]);for(c=d.length;c<b.maxColorAttachments;++c)y(36064+c,null);y(36096,a.depthAttachment);y(36128,a.stencilAttachment);y(33306,a.depthStencilAttachment);f.checkFramebufferStatus(36160);f.bindFramebuffer(36160,la.next);la.cur=la.next;f.getError()}function S(b,d){function f(a,c){var b,d=0,k=0,m=!0,u=!0;b=null;var r=!0,y="rgba",n="uint8",q=1,D=null,F=null,I=null,G=!1;if("number"===typeof a)d=
a|0,k=c|0||d;else if(a){"shape"in a?(k=a.shape,d=k[0],k=k[1]):("radius"in a&&(d=k=a.radius),"width"in a&&(d=a.width),"height"in a&&(k=a.height));if("color"in a||"colors"in a)b=a.color||a.colors,Array.isArray(b);if(!b){"colorCount"in a&&(q=a.colorCount|0);"colorTexture"in a&&(r=!!a.colorTexture,y="rgba4");if("colorType"in a&&(n=a.colorType,!r))if("half float"===n||"float16"===n)y="rgba16f";else if("float"===n||"float32"===n)y="rgba32f";"colorFormat"in a&&(y=a.colorFormat,0<=Ga.indexOf(y)?r=!0:0<=za.indexOf(y)&&
(r=!1))}if("depthTexture"in a||"depthStencilTexture"in a)G=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?m=a.depth:(D=a.depth,u=!1));"stencil"in a&&("boolean"===typeof a.stencil?u=a.stencil:(F=a.stencil,m=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?m=u=a.depthStencil:(I=a.depthStencil,u=m=!1))}else d=k=1;var S=null,Q=null,K=null,la=null;if(Array.isArray(b))S=b.map(C);else if(b)S=[C(b)];else for(S=Array(q),b=0;b<q;++b)S[b]=g(d,k,r,y,n);d=d||S[0].width;
k=k||S[0].height;D?Q=C(D):m&&!u&&(Q=g(d,k,G,"depth","uint32"));F?K=C(F):u&&!m&&(K=g(d,k,!1,"stencil","uint8"));I?la=C(I):!D&&!F&&u&&m&&(la=g(d,k,G,"depth stencil","depth stencil"));m=null;for(b=0;b<S.length;++b)H(S[b],d,k),S[b]&&S[b].texture&&(u=p[S[b].texture._texture.format]*E[S[b].texture._texture.type],null===m&&(m=u));H(Q,d,k);H(K,d,k);H(la,d,k);A(h);h.width=d;h.height=k;h.colorAttachments=S;h.depthAttachment=Q;h.stencilAttachment=K;h.depthStencilAttachment=la;f.color=S.map(l);f.depth=l(Q);f.stencil=
...
{}],14:[function(f,n,q){var k=f("./util/is-typed-array");n.exports=function(a,f,n,h,d,b){return function(b){var d;d=null===f.next?5121:f.next.colorAttachments[0].texture._texture.type;var q=0,r=0,m=h.framebufferWidth,H=h.framebufferHeight,y=null;k(b)?y=b:b&&(q=b.x|0,r=b.y|0,m=(b.width||h.framebufferWidth-q)|0,H=(b.height||h.framebufferHeight-r)|0,y=b.data||null);n();b=m*H*4;y||(5121===d?y=new Uint8Array(b):5126===d&&(y=y||new Float32Array(b)));a.pixelStorei(3333,4);a.readPixels(q,r,m,H,6408,d,y);
return y}}},{"./util/is-typed-array":26}],15:[function(f,n,q){var k=f("./util/values"),a=[];a[32854]=2;a[32855]=2;a[36194]=2;a[33189]=2;a[36168]=1;a[34041]=4;a[35907]=4;a[34836]=16;a[34842]=8;a[34843]=6;n.exports=function(f,n,h,d,b){function u(a){this.id=r++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0;b.profile&&(this.stats={size:0})}function q(a){var b=a.renderbuffer;f.bindRenderbuffer(36161,null);f.deleteRenderbuffer(b);a.renderbuffer=null;a.refCount=0;delete m[a.id];
...
m))if(1<k.size)for(var q=0;q<k.size;++q){var y=k.name.replace("[0]","["+q+"]");b(n,new d(y,f.id(y),a.getUniformLocation(r,y),k))}else b(n,new d(k.name,f.id(k.name),a.getUniformLocation(r,k.name),k));c=a.getProgramParameter(r,35721);h.profile&&(g.stats.attributesCount=c);n=g.attributes;for(m=0;m<c;++m)(k=a.getActiveAttrib(r,m))&&b(n,new d(k.name,f.id(k.name),a.getAttribLocation(r,k.name),k))}var r={},m={},H={},y=[],C=0;h.profile&&(n.getMaxUniformsCount=function(){var a=0;y.forEach(function(b){b.stats.uniformsCount>
a&&(a=b.stats.uniformsCount)});return a},n.getMaxAttributesCount=function(){var a=0;y.forEach(function(b){b.stats.attributesCount>a&&(a=b.stats.attributesCount)});return a});return{clear:function(){var b=a.deleteShader.bind(a);k(r).forEach(b);r={};k(m).forEach(b);m={};y.forEach(function(b){a.deleteProgram(b.program)});y.length=0;H={};n.shaderCount=0},program:function(a,b,d){n.shaderCount++;var f=H[b];f||(f=H[b]={});var h=f[a];h||(h=new q(b,a),F(h,d),f[a]=h,y.push(h));return h},restore:function(){r=
{};m={};for(var a=0;a<y.length;++a)F(y[a])},shader:u,frag:-1,vert:-1}}},{"./util/values":31}],17:[function(f,n,q){n.exports=function(){return{bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],18:[function(f,n,q){n.exports=function(){var f={"":0},a=[""];return{id:function(p){var n=f[p];if(n)return n;n=f[p]=a.length;a.push(p);return n},str:function(f){return a[f]}}}},{}],19:[function(f,n,q){function k(a){return Array.isArray(a)&&
(0===a.length||"number"===typeof a[0])}function a(a){return Array.isArray(a)&&0!==a.length&&H(a[0])?!0:!1}function p(a){return Object.prototype.toString.call(a)}function E(c){if(!c)return!1;var b=p(c);return 0<=G.indexOf(b)?!0:k(c)||a(c)||F(c)}function h(a,b){36193===a.type?(a.data=m(b),r.freeType(b)):a.data=b}function d(a,b,d,f,g,h){a="undefined"!==typeof A[a]?A[a]:l[a]*D[b];h&&(a*=6);if(g){for(f=0;1<=d;)f+=a*d*d,d/=2;return f}return a*d*f}var b=f("./util/extend"),u=f("./util/values"),I=f("./util/is-typed-array"),
F=f("./util/is-ndarray"),r=f("./util/pool"),m=f("./util/to-half-float"),H=f("./util/is-array-like");q=f("./constants/arraytypes.json");var y=f("./constants/arraytypes.json"),C=[9984,9986,9985,9987],g=[0,6409,6410,6407,6408],l={};l[6409]=l[6406]=l[6402]=1;l[34041]=l[6410]=2;l[6407]=l[35904]=3;l[6408]=l[35906]=4;var G=Object.keys(q).concat(["[object HTMLCanvasElement]","[object CanvasRenderingContext2D]","[object HTMLImageElement]","[object HTMLVideoElement]"]),D=[];D[5121]=1;D[5126]=4;D[36193]=2;D[5123]=
...
f-e.yOffset;e.needsCopy=!0}else if(!b)e.width=e.width||1,e.height=e.height||1;else if(I(b))e.data=b,"type"in c||5121!==e.type||(e.type=y[Object.prototype.toString.call(b)]|0);else if(k(b)){d=b;f=e.width*e.height*e.channels;switch(e.type){case 5121:case 5123:case 5125:case 5126:f=r.allocType(e.type,f);f.set(d);e.data=f;break;case 36193:e.data=m(d)}e.alignment=1;e.needsFree=!0}else if(F(b)){d=b.data;Array.isArray(d)||5121!==e.type||(e.type=y[Object.prototype.toString.call(d)]|0);var f=b.shape,l=b.stride,
n,u,q,t;3===f.length?(q=f[2],t=l[2]):t=q=1;n=f[0];u=f[1];f=l[0];l=l[1];e.alignment=1;e.width=n;e.height=u;e.channels=q;e.format=e.internalformat=g[q];e.needsFree=!0;n=t;b=b.offset;q=e.width;t=e.height;u=e.channels;for(var C=r.allocType(36193===e.type?5126:e.type,q*t*u),ha=0,B=0;B<t;++B)for(var D=0;D<q;++D)for(var x=0;x<u;++x)C[ha++]=d[f*D+l*B+n*x+b];h(e,C)}else if("[object HTMLCanvasElement]"===p(b)||"[object CanvasRenderingContext2D]"===p(b))"[object HTMLCanvasElement]"===p(b)?e.element=b:e.element=
...
f;else b=a.images[0]=aa(),M(b,a),t(b,c),a.mipmask=1;M(a,a.images[0])}function xa(a,b){for(var d=a.images,f=0;f<d.length&&d[f];++f){var g=d[f],h=b,l=f,m=g.element,k=g.data,p=g.internalformat,n=g.format,r=g.type,u=g.width,y=g.height;oa(g);m?c.texImage2D(h,l,n,n,r,m):g.compressed?c.compressedTexImage2D(h,l,p,u,y,0,k):g.needsCopy?(q(),c.copyTexImage2D(h,l,n,g.xOffset,g.yOffset,u,y,0)):c.texImage2D(h,l,n,u,y,0,n,r,k)}}function pa(){var a=Ka.pop()||new V;na.call(a);for(var c=a.mipmask=0;16>c;++c)a.images[c]=
...
k(a).getBoundingClientRect();return a.clientY-f.top}return 0}},{}],35:[function(f,n,q){function k(a,b){for(var d=0;d<a.length;++d)if(a[d]===b)return d;return-1}var a=f("./lib/util/extend"),p=f("./lib/dynamic"),E=f("./lib/util/raf"),h=f("./lib/util/clock"),d=f("./lib/strings"),b=f("./lib/webgl"),u=f("./lib/extension"),I=f("./lib/limits"),F=f("./lib/buffer"),r=f("./lib/elements"),m=f("./lib/texture"),H=f("./lib/renderbuffer"),y=f("./lib/framebuffer"),C=f("./lib/attribute"),g=f("./lib/shader"),l=f("./lib/read"),
...
framebufferWidth:pa,framebufferHeight:ya,drawingBufferWidth:pa,drawingBufferHeight:ya,pixelRatio:c.pixelRatio},ca=I(t,L),da=F(t,V,c),ra=r(t,L,da,V),pa=C(t,L,ca,da,ia),fa=g(t,ia,V,c),W=m(t,L,ca,function(){K.procs.poll()},P,V,c),sa=H(t,L,ca,V,c),qa=y(t,L,ca,W,sa,V),K=G(t,ia,L,ca,da,ra,W,qa,{},pa,fa,{elements:null,primitive:4,count:-1,offset:0,instances:-1},P,B,c),ia=l(t,qa,K.procs.poll,P,Z,L),ga=K.next,ja=t.canvas,N=[],U=[],X=[],Y=[c.onDestroy],ba=null;ja&&(ja.addEventListener("webglcontextlost",Ga,
