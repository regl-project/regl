...
A,c,h,I,O,E,p,B,S,U,la,V){function ja(c,l,g,A,W){function I(t){var a=qa[t];return a?a:a=qa[t]=y(Z[t])}function C(t){var a=t.id,c=ca[a];if(c)return c;switch(t.type){case 0:c=q.def(y(t.data),".call(this,",N,",",L,")");break;case 1:c=q.def(N,t.data);break;case 2:c=q.def(L,t.data);break;case 3:c=q.def("this",t.data)}return ca[a]=c}function ha(t,a){for(var c=0;c<t.length;++c)if(t[c].name===a)return t[c];return null}function v(t){return J&&!(t in l||t in W)}var E=M(),y=E.link,q=E.proc("batch"),u=E.block(),
F=q.def,fa=q.arg,x=y(e),r=y(c.program),Q=y(B.bind),na=y(B.bindRecord),L=y(la),Y=y(O),ba=y(U.count),ia=y(U.offset),pa=y(U.instances),R=y(U.primitive),qa={},w=y(h.elements),ba=F(a(ba)),ia=F(a(ia)),R=F(a(R)),w=F(a(w)),H,ga,S=m.angle_instanced_arrays;S&&(H=F(a(pa)),ga=y(S));var J="elements"in l,pa=fa(),fa=fa(),N=F(),V=F(),ca={};q(x,".useProgram(",r,");");c.uniforms.forEach(function(t){if(!(t.name in g)){var a=y(t.location),c=y(p.def(t.name)),c=c+"["+c+".length-1]";t=t.info.type;35678===t||35680===t?(t=
F(c+"._texture"),q(n(x,5124,a,t+".bind()")),u(t,".unbind();")):q(n(x,t,a,c))}});c.attributes.forEach(function(t){if(!(t.name in A)){var a=y(B.def(t.name));q(Q,"(",t.location,",",y(B.bindings[t.location]),",",a,",",d(t.info.type),");")}});J||q("if(",w,")",x,".bindBuffer(",34963,",",w,".buffer.buffer);");q("for(",V,"=0;",V,"<",pa,";++",V,"){",N,"=",fa,"[",V,"];",L,".batchId=",V,";");Object.keys(l).sort(b).forEach(function(t){function a(t){q("if(",c,"){",x,".enable(",t,");}else{",x,".disable(",t,");}")}
var c=C(l[t]);switch(t){case "framebuffer":t=I("viewport");var b=I("scissor.box");q("if(",Y,".push(",c,"&&",c,"._framebuffer)){",Y,".poll();",t,".setDirty();",b,".setDirty();","}");break;case "cull.enable":a(2884);break;case "blend.enable":a(3042);break;case "dither":a(3024);break;case "stencil.enable":a(2960);break;case "depth.enable":a(2929);break;case "scissor.enable":a(3089);break;case "polygonOffset.enable":a(32823);break;case "sample.alpha":a(32926);break;case "sample.enable":a(32928);break;
case "depth.mask":q(x,".depthMask(",c,");");break;case "depth.func":t=y(k);q(x,".depthFunc(",t,"[",c,"]);");break;case "depth.range":q(x,".depthRange(",c,"[0],",c,"[1]);");break;case "blend.color":q(x,".blendColor(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "blend.equation":t=y(K);q("if(typeof ",c,'==="string"){',x,".blendEquation(",t,"[",c,"]);","}else{",x,".blendEquationSeparate(",t,"[",c,".rgb],",t,"[",c,".alpha]);","}");break;case "blend.func":t=y(z);q(x,".blendFuncSeparate(",t,'["srcRGB" in ',
c,"?",c,".srcRGB:",c,".src],",t,'["dstRGB" in ',c,"?",c,".dstRGB:",c,".dst],",t,'["srcAlpha" in ',c,"?",c,".srcAlpha:",c,".src],",t,'["dstAlpha" in ',c,"?",c,".dstAlpha:",c,".dst]);");break;case "stencil.mask":q(x,".stencilMask(",c,");");break;case "stencil.func":t=y(k);q(x,".stencilFunc(",t,"[",c,'.cmp||"always"],',c,".ref|0,",'"mask" in ',c,"?",c,".mask:-1);");break;case "stencil.opFront":case "stencil.opBack":b=y(D);q(x,".stencilOpSeparate(","stencil.opFront"===t?1028:1029,",",b,"[",c,'.fail||"keep"],',
b,"[",c,'.zfail||"keep"],',b,"[",c,'.pass||"keep"]);');break;case "polygonOffset.offset":q(x,".polygonOffset(",c,".factor||0,",c,".units||0);");break;case "cull.face":q(x,".cullFace(",c,'==="front"?',1028,":",1029,");");break;case "lineWidth":q(x,".lineWidth(",c,");");break;case "frontFace":q(x,".frontFace(",c,'==="cw"?',2304,":",2305,");");break;case "colorMask":q(x,".colorMask(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "sample.coverage":q(x,".sampleCoverage(",c,".value,",c,".invert);");
break;case "scissor.box":case "viewport":t=I(t),q(t,".push(",c,".x||0,",c,".y||0,",c,".w||-1,",c,".h||-1);")}});("viewport"in l||"framebuffer"in l)&&q(I("viewport"),".poll();");("scissor.box"in l||"framebuffer"in l)&&q(I("scissor.box"),".poll();");"framebuffer"in l&&q(Y,".pop();");var da=c.uniforms,sa=[];Object.keys(g).forEach(function(t){var c=ha(da,t);if(c){var a=c.info.type,b=y(c.location);t=C(g[t]);35678===c.info.type||35680===c.info.type?(c=F(t+"._texture"),sa.push(c),q(n(x,5124,b,c+".bind()"))):
q(n(x,a,b,t))}});sa.forEach(function(t){q(t,".unbind();")});var oa=c.attributes;Object.keys(A).forEach(function(t){var c=ha(oa,t);if(c){var a=y(B.box(t));t=C(A[t]);t=F(a+".alloc("+t+")");q(na,"(",c.location,",",y(B.bindings[c.location]),",",t,",",d(c.info.type),");");u(a,".free(",t,");")}});l.count&&q(ba,"=",C(l.count),";");l.offset&&q(ia,"=",C(l.offset),";");l.primitive&&q(R,"=",y(f),"[",C(l.primitive),"];");S&&l.instances&&q(H,"=",C(l.instances),";");J&&(c=C(l.elements),q(w,"=",c,"?",c,"._elements:null;"));
v("offset")&&q(ia,"=0;");q("if(",w,"){");v("count")&&q(ba,"=",w,".vertCount;");q("if(",ba,">0){");v("primitive")&&q(R,"=",w,".primType;");J&&q(x,".bindBuffer(",34963,",",w,".buffer.buffer);");S&&q("if(",H,">0){",ga,".drawElementsInstancedANGLE(",R,",",ba,",",w,".type,",ia,",",H,");}else ");q(x,".drawElements(",R,",",ba,",",w,".type,",ia,");");q("}}else if(",ba,">0){");v("count")||(v("primitive")&&q(R,"=",4,";"),S&&q("if(",H,">0){",ga,".drawArraysInstancedANGLE(",R,",",ia,",",ba,",",H,");}else{"),
q(x,".drawArrays(",R,",",ia,",",ba,");"),S&&q("}"));q("}}",u);return E.compile().batch}var Z=E.contextState,K={add:32774,subtract:32778,"reverse subtract":32779};m.ext_blend_minmax&&(K.min=32775,K.max=32776);var l=0;return{draw:function(c){var b=M(),f=b.link,k=b.proc("draw"),l=k.def,g=f(e),z=f(c.program),A=f(B.bind),v=f(U.count),I=f(U.offset),y=f(U.instances),q=f(U.primitive),u=f(h.elements),C=[];k(g,".useProgram(",z,");");c.attributes.forEach(function(c){var a=f(B.def(c.name));k(A,"(",c.location,
",",f(B.bindings[c.location]),",",a,",",d(c.info.type),");")});c.uniforms.forEach(function(c){var a=f(c.location),b=f(p.def(c.name)),b=b+"["+b+".length-1]";c=c.info.type;35678===c||35680===c?(c=l(b+"._texture"),C.push(c),k(n(g,5124,a,c+".bind()"))):k(n(g,c,a,b))});C.forEach(function(c){k(c,".unbind();")});c=l(a(q));v=l(a(v));I=l(a(I));u=l(a(u));k("if(",v,"){");(z=m.angle_instanced_arrays)?(y=l(a(y)),z=f(z),k("if(",u,"){",u,".bind();","if(",y,">0){",z,".drawElementsInstancedANGLE(",c,",",v,",",u,".type,",
I,",",y,");}else{",g,".drawElements(",c,",",v,",",u,".type,",I,");}","}else if(",y,">0){",z,".drawArraysInstancedANGLE(",c,",",I,",",v,",",y,");}else{",g,".drawArrays(",c,",",I,",",v,");}}")):k("if(",u,"){",u,".bind();",g,".drawElements(",c,",",v,",",u,".type,",I,");","}else{",g,".drawArrays(",c,",",I,",",v,");}}");return b.compile().draw},command:function(c,a,d,m,n,e,A,I){function v(c){var a=qa[c];return a?a:a=qa[c]=u(Z[c])}function E(c,a){var b=v(c);w(b,".push(",a,");");H(b,".pop();")}function y(c){var a=
c.id,b=ua[a];if(b)return b;switch(c.type){case 0:b=J.def(u(c.data),".call(this,",ga,",",R,")");break;case 1:b=J.def(ga,c.data);break;case 2:b=J.def(R,c.data);break;case 3:b=J.def("this",c.data)}return ua[a]=b}var q=M(),u=q.link,F=q.block,G=q.proc,x=l++,r=u(V),Q=u(S),na=u(O),L={count:u(U.count),offset:u(U.offset),instances:u(U.instances),primitive:u(U.primitive)},Y=u(h.elements),ba=u(f),ia=u(k),pa=u(D),R=u(la),qa={},w=F(),H=F(),ga;I&&(ga=w.def());w(R,".batchId=0;");var ta=F();Object.keys(A["static"]).forEach(function(c){var a=
w.def(R,".",c);ta(R,".",c,"=",u(A["static"][c]),";");H(R,".",c,"=",a,";")});Object.keys(A.dynamic).forEach(function(c){var a=w.def(R,".",c),b=w.def(),r=A.dynamic[c];ta(R,".",c,"=",b,";");switch(r.type){case 0:w(b,"=",u(r.data),".call(this,",ga,",",R,");");break;case 1:w(b,"=",ga,r.data,";");break;case 2:w(b,"=",R,r.data,";");break;case 3:w(b,"=","this",r.data,";")}H(R,".",c,"=",a,";")});w(ta);Object.keys(c).sort(b).forEach(function(a){var b=c[a];switch(a){case "frag":case "vert":b=g.id(b);S.shader("frag"===
a?35632:35633,b);w(Q,".",a,".push(",b,");");H(Q,".",a,".pop();");break;case "framebuffer":O.getFramebuffer(b);a=v("viewport");var r=v("scissor.box");w("if(",na,".push(",u(b&&b._framebuffer),")){",a,".setDirty();",r,".setDirty();","}");H("if(",na,".pop()){",a,".setDirty();",r,".setDirty();","}");break;case "count":case "offset":case "instances":w(L[a],".push(",b,");");H(L[a],".pop();");break;case "primitive":w(L.primitive,".push(",f[b],");");H(L.primitive,".pop();");break;case "elements":r=h.getElements(b);
b=!("primitive"in c);a=!("count"in c);r?(r=u(r),w(Y,".push(",r,");"),b&&w(L.primitive,".push(",r,".primType);"),a&&w(L.count,".push(",r,".vertCount);")):(w(Y,".push(null);"),b&&w(L.primitive,".push(",4,");"),a&&w(L.count,".push(0);"));b&&H(L.primitive,".pop();");a&&H(L.count,".pop();");"offset"in c||(w(L.offset,".push(0);"),H(L.offset,".pop();"));H(Y,".pop();");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":E(a,
b);break;case "depth.func":E(a,k[b]);break;case "depth.range":a=v(a);w(a,".push(",b[0],",",b[1],");");H(a,".pop();");break;case "blend.func":a=v(a);w(a,".push(",z["srcRGB"in b?b.srcRGB:b.src],",",z["dstRGB"in b?b.dstRGB:b.dst],",",z["srcAlpha"in b?b.srcAlpha:b.src],",",z["dstAlpha"in b?b.dstAlpha:b.dst],");");H(a,".pop();");break;case "blend.equation":a=v(a);"string"===typeof b?w(a,".push(",K[b],",",K[b],");"):"object"===typeof b&&w(a,".push(",K[b.rgb],",",K[b.alpha],");");H(a,".pop();");break;case "blend.color":a=
v(a);w(a,".push(",b[0],",",b[1],",",b[2],",",b[3],");");H(a,".pop();");break;case "stencil.mask":a=v(a);w(a,".push(",b,");");H(a,".pop();");break;case "stencil.func":var r=b.cmp||"keep",d=b.ref||0,b="mask"in b?b.mask:-1;a=v(a);w(a,".push(",k[r],",",d,",",b,");");H(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":r=b.fail||"keep";d=b.zfail||"keep";b=b.pass||"keep";a=v(a);w(a,".push(",D[r],",",D[d],",",D[b],");");H(a,".pop();");break;case "polygonOffset.offset":r=b.factor||0;b=b.units||
0;a=v(a);w(a,".push(",r,",",b,");");H(a,".pop();");break;case "cull.face":r=0;"front"===b?r=1028:"back"===b&&(r=1029);b=v(a);w(b,".push(",r,");");H(b,".pop();");break;case "lineWidth":E(a,b);break;case "frontFace":r=0;"cw"===b?r=2304:"ccw"===b&&(r=2305);b=v(a);w(b,".push(",r,");");H(b,".pop();");break;case "colorMask":a=v(a);w(a,".push(",b.map(function(c){return!!c}).join(),");");H(a,".pop();");break;case "sample.coverage":r="value"in b?b.value:1;b=!!b.invert;a=v(a);w(a,".push(",r,",",b,");");H(a,
".pop();");break;case "viewport":case "scissor.box":var r=b.x||0,d=b.y||0,m=-1,l=-1;"w"in b&&(m=b.w);"h"in b&&(l=b.h);b=v(a);w(b,".push(",r,",",d,",",m,",",l,");");H(b,".pop();")}});Object.keys(a).forEach(function(c){var b=u(p.def(c));c=a[c];c="function"===typeof c&&c._reglType?u(c):Array.isArray(c)?u(c.slice()):+c;w(b,".push(",c,");");H(b,".pop();")});Object.keys(d).forEach(function(c){var a=d[c],b=u(B.def(c));c=u(B.box(c).alloc(a));w(b,".records.push(",c,");");H(b,".records.pop();")});var J=q.block(),
N=q.block(),ua={};Object.keys(m).sort(b).forEach(function(a){var b=y(m[a]);switch(a){case "framebuffer":a=v("viewport");var r=v("scissor.box");J("if(",na,".push(",b,"&&",b,"._framebuffer)){",a,".setDirty();",r,".setDirty();","}");N("if(",na,".pop()){",a,".setDirty();",r,".setDirty();","}");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "lineWidth":case "depth.mask":a=
...
h,");",a?L.primitive+".push("+h+".primType);":"",r?L.count+".push("+h+".vertCount);":"",d?L.offset+".push("+h+".offset);":"","}else{",Y,".push(null);","}");N(Y,".pop();","if(",b,"){",a?L.primitive+".pop();":"",r?L.count+".pop();":"",d?L.offset+".pop();":"","}")}});Object.keys(n).forEach(function(a){var b=u(p.def(a));a=y(n[a]);J(b,".push(",a,");");N(b,".pop();")});Object.keys(e).forEach(function(a){var b=u(B.def(a)),c=y(e[a]);a=u(B.box(a));J(b,".records.push(",a,".alloc(",c,"));");N(a,".free(",b,".records.pop());")});
...
else if("[object HTMLVideoElement]"===a(f))this.video=f,1<f.readyState?(this.width=f.width,this.height=f.height):(this.width=this.width||f.width,this.height=this.height||f.height,this.needsListeners=!0),this.needsPoll=!0,this.setDefaultFormat();else if("[object XMLHttpRequest]"===a(f))this.xhr=f,this.needsListeners=!0;else if(n(f)){var h=f[0].length,l=f.length,m=1,q,z,u,w;if(Array.isArray(f[0][0]))for(m=f[0][0].length,g=Array(h*l*m),z=w=0;z<l;++z)for(q=0;q<h;++q)for(u=0;u<m;++u)g[w++]=f[z][q][u];
else for(g=Array(h*l),z=w=0;z<l;++z)for(q=0;q<h;++q)g[w++]=f[z][q];this.width=h;this.height=l;this.channels=m;h=!0}else c.copy&&(this.copy=!0,this.x|=0,this.y|=0,this.width=(this.width||E.width)|0,this.height=(this.height||E.height)|0,this.setDefaultFormat());!this.type&&this.data&&(6402===this.format?this.data instanceof Uint16Array?this.type=5123:this.data instanceof Uint32Array&&(this.type=5125):this.data instanceof Float32Array&&(this.type=5126));this.internalformat||(this.internalformat=[6409,
...
new Float32Array(g);break;case 36193:this.data=C(g)}if(this.data&&this.needsTranspose){g=this.data;f=this.width;h=this.height;l=this.channels;m=this.strideX;q=this.strideY;z=this.strideC;u=this.offset;w=new g.constructor(f*h*l);for(var v=0,p=0;p<h;++p)for(var y=0;y<f;++y)for(var x=0;x<l;++x)w[v++]=g[q*p+m*y+z*x+u];this.data=w}this.needsTranspose=!1},setDefaultFormat:function(){this.format=this.internalformat=6408;this.type=5121;this.channels=4;this.compressed=!1},upload:function(a){c.pixelStorei(37440,
this.flipY);c.pixelStorei(37441,this.premultiplyAlpha);c.pixelStorei(37443,this.colorSpace);c.pixelStorei(3317,this.unpackAlignment);var b=this.target,d=this.miplevel,e=this.image,f=this.canvas,g=this.video,k=this.data,h=this.internalformat,n=this.format,l=this.type,m=this.width||Math.max(1,a.width>>d);a=this.height||Math.max(1,a.height>>d);g&&2<g.readyState?c.texImage2D(b,d,n,n,l,g):e&&e.complete?c.texImage2D(b,d,n,n,l,e):f?c.texImage2D(b,d,n,n,l,f):this.compressed?c.compressedTexImage2D(b,d,h,m,
