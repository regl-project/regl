(function e$$0(h,l,c){function q(a,f){if(!l[a]){if(!h[a]){var A="function"==typeof require&&require;if(!f&&A)return A(a,!0);if(b)return b(a,!0);A=Error("Cannot find module '"+a+"'");throw A.code="MODULE_NOT_FOUND",A;}A=l[a]={exports:{}};h[a][0].call(A.exports,function(b){var c=h[a][1][b];return q(c?c:b)},A,A.exports,e$$0,h,l,c)}return l[a].exports}for(var b="function"==typeof require&&require,a=0;a<c.length;a++)q(c[a]);return q})({1:[function(e,h,l){e=e("../regl")();var c=e({frag:"\n  precision mediump float;\n  uniform sampler2D texture;\n  uniform vec2 screenShape;\n  uniform float time;\n\n  varying vec2 uv;\n\n  vec4 background () {\n    vec2 pos = 0.5 - gl_FragCoord.xy / screenShape;\n    float r = length(pos);\n    float theta = atan(pos.y, pos.x);\n    return vec4(\n      cos(pos.x * time) + sin(pos.y * pos.x * time),\n      cos(100.0 * r * cos(0.3 * time) + theta),\n      sin(time / r + pos.x * cos(10.0 * time + 3.0)),\n      1);\n  }\n\n  void main () {\n    vec4 color = texture2D(texture, uv);\n    float chromakey = step(0.15 + max(color.r, color.b), color.g);\n    gl_FragColor = mix(color, background(), chromakey);\n  }",
vert:"\n  precision mediump float;\n  attribute vec2 position;\n  varying vec2 uv;\n  void main () {\n    uv = position;\n    gl_Position = vec4(1.0 - 2.0 * position, 0, 1);\n  }",attributes:{position:e.buffer([-2,0,0,-2,2,2])},uniforms:{texture:e.texture("assets/doggie-chromakey.ogv"),screenShape:function(c,b,a){return[a.width,a.height]},time:function(c,b,a){return.01*a.count}},count:3});e.frame(function(){c()})},{"../regl":33}],2:[function(e,h,l){var c=e("./constants/dtypes.json");h.exports=function(q,
b,a,e,f){function A(){this.pointer=!1;this.w=this.z=this.y=this.x=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}function n(a){this.records=[];this.name=a}function h(a,d,p,c){c=p.size||c;var g;g=d.pointer?p.pointer&&d.buffer===p.buffer&&d.size===c&&d.normalized===p.normalized&&d.type===p.type&&d.offset===p.offset&&d.stride===p.stride&&d.divisor===p.divisor:!p.pointer&&d.x===p.x&&d.y===p.y&&d.z===p.z&&d.w===p.w;g||(p.pointer?(d.pointer||q.enableVertexAttribArray(a),
d.buffer!==p.buffer&&p.buffer.bind(),q.vertexAttribPointer(a,c,p.type,p.normalized,p.stride,p.offset),(g=b.angle_instanced_arrays)&&g.vertexAttribDivisorANGLE(a,p.divisor)):(d.pointer&&q.disableVertexAttribArray(a),q.vertexAttrib4f(a,p.x,p.y,p.z,p.w)),(d.pointer=p.pointer)?(d.buffer=p.buffer,d.size=c,d.normalized=p.normalized,d.type=p.type,d.offset=p.offset,d.stride=p.stride,d.divisor=p.divisor):(d.x=p.x,d.y=p.y,d.z=p.z,d.w=p.w))}var z={};a=a.maxAttributes;for(var t=Array(a),g=0;g<a;++g)t[g]=new A;
return{bindings:t,bind:function(a,d,b,c){b=b.records;h(a,d,b[b.length-1],c)},bindRecord:h,def:function(a){var d=f.id(a),b=z[d];b||(b=z[d]=new n(a));return b},box:function(a){var d=[new A];return{alloc:function(a){var b;b=0>=d.length?new A:d.pop();if("number"===typeof a)b.pointer=!1,b.x=a,b.y=0,b.z=0,b.w=0;else if(Array.isArray(a))b.pointer=!1,b.x=a[0],b.y=a[1],b.z=a[2],b.w=a[3];else{var g=e.getBuffer(a),q=0,n=0,f=0,h=0,v=!1,H=5126;g?H=g.dtype:(g=e.getBuffer(a.buffer),q=a.size||0,n=a.stride||0,f=a.offset||
0,h=a.divisor||0,v=a.normalized||!1,H=g.dtype,"type"in a&&(H=c[a.type]));b.pointer=!0;b.buffer=g;b.size=q;b.offset=f;b.stride=n;b.divisor=h;b.normalized=v;b.type=H}return b},free:function(a){d.push(a)}}},state:z}}},{"./constants/dtypes.json":6}],3:[function(e,h,l){function c(a,b){switch(a){case 5121:return new Uint8Array(b);case 5123:return new Uint16Array(b);case 5125:return new Uint32Array(b);case 5120:return new Int8Array(b);case 5122:return new Int16Array(b);case 5124:return new Int32Array(b);
case 5126:return new Float32Array(b);default:return null}}var q=e("./util/is-typed-array"),b=e("./util/is-ndarray"),a=e("./constants/arraytypes.json"),L=e("./constants/dtypes.json"),f=e("./util/values"),A={"static":35044,dynamic:35048,stream:35040};h.exports=function(n){function e(a,b){this.id=g++;this.buffer=a;this.type=b;this.usage=35044;this.byteLength=0;this.dimension=1;this.data=null;this.dtype=5121}function h(a){n.isBuffer(a.buffer)||(a.buffer=n.createBuffer());a.bind();n.bufferData(a.type,
a.data||a.byteLength,a.usage)}function t(a){var b=a.buffer;n.isBuffer(b)&&n.deleteBuffer(b);a.buffer=null;delete v[a.id]}var g=0,v={};e.prototype.bind=function(){n.bindBuffer(this.type,this.buffer)};return{create:function(d,g,f){function E(d){var g=d||{};if(Array.isArray(g)||q(g)||b(g))g={data:g};else if("number"===typeof g)g={length:g|0};else if(null===g||void 0===g)g={};l.usage="usage"in g?A[g.usage]:35044;d=0;"type"in g&&(d=L[g.type]);var p=g.dimension|0||1,n=0,f=null;if("data"in g)if(f=g.data,
null===f)n=g.length|0;else{if(b(f)){var p=f.shape,n=f.stride,g=f.offset,e=0,v=0,t=0,m=0;1===p.length?(e=p[0],v=1,t=n[0],m=0):2===p.length&&(e=p[0],v=p[1],t=n[0],m=n[1]);d=d||a[Object.prototype.toString.call(f)]|0||5126;for(var p=v,n=c(d,e*v),f=f.data,R=0,ga=0;ga<e;++ga)for(var N=0;N<v;++N)n[R++]=f[t*ga+m*N+g];f=n}else if(Array.isArray(f))if(0<f.length&&Array.isArray(f[0])){p=f[0].length;d=d||5126;g=c(d,f.length*p);n=f;f=p;for(e=m=0;e<n.length;++e)for(t=n[e],v=0;v<f;++v)g[m++]=t[v];f=g}else d=d||5126,
f=c(d,f);else d=d||a[Object.prototype.toString.call(f)]|0;n=f.byteLength}else"length"in g&&(n=g.length|0);l.data=f;l.dtype=d||5121;l.byteLength=n;l.dimension=p;h(l);return E}var B=n.createBuffer(),l=new e(B,g);v[l.id]=l;f||E(d);E._reglType="buffer";E._buffer=l;E.destroy=function(){t(l)};return E},clear:function(){f(v).forEach(t)},refresh:function(){f(v).forEach(h)},getBuffer:function(a){return a&&a._buffer instanceof e?a._buffer:null}}}},{"./constants/arraytypes.json":5,"./constants/dtypes.json":6,
"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/values":32}],4:[function(e,h,l){function c(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function q(a,b,g,c){var d,p=",";switch(b){case 5126:d="1f";break;case 35664:d="2fv";break;case 35665:d="3fv";break;case 35666:d="4fv";break;case 35670:case 5124:d="1i";break;case 35671:case 35667:d="2iv";break;case 35672:case 35668:d="3iv";break;
case 35673:case 35669:d="4iv";break;case 35674:d="Matrix2fv";p=",false,";break;case 35675:d="Matrix3fv";p=",false,";break;case 35676:d="Matrix4fv",p=",false,"}return a+".uniform"+d+"("+g+p+c+");"}function b(a){return a+"["+a+".length-1]"}function a(a,b){return"framebuffer"===a||a<b?-1:a>b?1:0}var L=e("./util/codegen"),f=e("./constants/primitives.json"),A={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,
...
v,d,p,u,E,l,Q,x,U,P,ka,X){function ja(d,m,h,v,S){function u(a){var b=J[a];return b?b:b=J[a]=r(V[a])}function t(a){var b=a.id,d=U[b];if(d)return d;d=a.func?k.def(r(a.data),"(",W,",",Z,",",ba,")"):k.def(W,".",a.data);return U[b]=d}function ha(a,b){for(var d=0;d<a.length;++d)if(a[d].name===b)return a[d];return null}function l(a){return la&&!(a in m||a in S)}var ia=L(),r=ia.link,k=ia.proc("batch"),ca=ia.block(),D=k.def,M=k.arg,y=r(e),w=r(d.program),O=r(x.bind),G=r(x.bindRecord),ba=r(ka),pa=r(E),da=r(P.count),
fa=r(P.offset),ma=r(P.instances),C=r(P.primitive),J={},F=r(p.elements),da=D(b(da)),fa=D(b(fa)),C=D(b(C)),F=D(b(F)),K,B,ea=g.angle_instanced_arrays;ea&&(K=D(b(ma)),B=r(ea));var la="elements"in m,ma=M(),M=M(),W=D(),Z=D(),U={};k(y,".useProgram(",w,");");d.uniforms.forEach(function(a){if(!(a.name in h)){var b=r(a.location),d=r(Q.def(a.name)),d=d+"["+d+".length-1]";a=a.info.type;35678===a||35680===a?(a=D(d+"._texture"),k(q(y,5124,b,a+".bind()")),ca(a,".unbind();")):k(q(y,a,b,d))}});d.attributes.forEach(function(a){if(!(a.name in
v)){var b=r(x.def(a.name));k(O,"(",a.location,",",r(x.bindings[a.location]),",",b,",",c(a.info.type),");")}});la||k("if(",F,")",y,".bindBuffer(",34963,",",F,".buffer.buffer);");k("for(",Z,"=0;",Z,"<",ma,";++",Z,"){",W,"=",M,"[",Z,"];");Object.keys(m).sort(a).forEach(function(a){function b(a){k("if(",d,"){",y,".enable(",a,");}else{",y,".disable(",a,");}")}var d=t(m[a]);switch(a){case "framebuffer":a=u("viewport");var w=u("scissor.box");k("if(",pa,".push(",d,"&&",d,"._framebuffer)){",pa,".poll();",
a,".setDirty();",w,".setDirty();","}");break;case "cull.enable":b(2884);break;case "blend.enable":b(3042);break;case "dither":b(3024);break;case "stencil.enable":b(2960);break;case "depth.enable":b(2929);break;case "scissor.enable":b(3089);break;case "polygonOffset.enable":b(32823);break;case "sample.alpha":b(32926);break;case "sample.enable":b(32928);break;case "depth.mask":k(y,".depthMask(",d,");");break;case "depth.func":a=r(n);k(y,".depthFunc(",a,"[",d,"]);");break;case "depth.range":k(y,".depthRange(",
d,"[0],",d,"[1]);");break;case "blend.color":k(y,".blendColor(",d,"[0],",d,"[1],",d,"[2],",d,"[3]);");break;case "blend.equation":a=r(I);k("if(typeof ",d,'==="string"){',y,".blendEquation(",a,"[",d,"]);","}else{",y,".blendEquationSeparate(",a,"[",d,".rgb],",a,"[",d,".alpha]);","}");break;case "blend.func":a=r(A);k(y,".blendFuncSeparate(",a,'["srcRGB" in ',d,"?",d,".srcRGB:",d,".src],",a,'["dstRGB" in ',d,"?",d,".dstRGB:",d,".dst],",a,'["srcAlpha" in ',d,"?",d,".srcAlpha:",d,".src],",a,'["dstAlpha" in ',
d,"?",d,".dstAlpha:",d,".dst]);");break;case "stencil.mask":k(y,".stencilMask(",d,");");break;case "stencil.func":a=r(n);k(y,".stencilFunc(",a,"[",d,'.cmp||"always"],',d,".ref|0,",'"mask" in ',d,"?",d,".mask:-1);");break;case "stencil.opFront":case "stencil.opBack":w=r(H);k(y,".stencilOpSeparate(","stencil.opFront"===a?1028:1029,",",w,"[",d,'.fail||"keep"],',w,"[",d,'.zfail||"keep"],',w,"[",d,'.pass||"keep"]);');break;case "polygonOffset.offset":k(y,".polygonOffset(",d,".factor||0,",d,".units||0);");
break;case "cull.face":k(y,".cullFace(",d,'==="front"?',1028,":",1029,");");break;case "lineWidth":k(y,".lineWidth(",d,");");break;case "frontFace":k(y,".frontFace(",d,'==="cw"?',2304,":",2305,");");break;case "colorMask":k(y,".colorMask(",d,"[0],",d,"[1],",d,"[2],",d,"[3]);");break;case "sample.coverage":k(y,".sampleCoverage(",d,".value,",d,".invert);");break;case "scissor.box":case "viewport":a=u(a),k(a,".push(",d,".x||0,",d,".y||0,",d,".w||-1,",d,".h||-1);")}});("viewport"in m||"framebuffer"in
m)&&k(u("viewport"),".poll();");("scissor.box"in m||"framebuffer"in m)&&k(u("scissor.box"),".poll();");"framebuffer"in m&&k(pa,".pop();");var X=d.uniforms,ra=[];Object.keys(h).forEach(function(a){var d=ha(X,a);if(d){var b=d.info.type,w=r(d.location);a=t(h[a]);35678===d.info.type||35680===d.info.type?(d=D(a+"._texture"),ra.push(d),k(q(y,5124,w,d+".bind()"))):k(q(y,b,w,a))}});ra.forEach(function(a){k(a,".unbind();")});var ta=d.attributes;Object.keys(v).forEach(function(a){var d=ha(ta,a);if(d){var b=
r(x.box(a));a=t(v[a]);a=D(b+".alloc("+a+")");k(G,"(",d.location,",",r(x.bindings[d.location]),",",a,",",c(d.info.type),");");ca(b,".free(",a,");")}});m.count&&k(da,"=",t(m.count),";");m.offset&&k(fa,"=",t(m.offset),";");m.primitive&&k(C,"=",r(f),"[",t(m.primitive),"];");ea&&m.instances&&k(K,"=",t(m.instances),";");la&&(d=t(m.elements),k(F,"=",d,"?",d,"._elements:null;"));l("offset")&&k(fa,"=0;");k("if(",F,"){");l("count")&&k(da,"=",F,".vertCount;");k("if(",da,">0){");l("primitive")&&k(C,"=",F,".primType;");
la&&k(y,".bindBuffer(",34963,",",F,".buffer.buffer);");ea&&k("if(",K,">0){",B,".drawElementsInstancedANGLE(",C,",",da,",",F,".type,",fa,",",K,");}else ");k(y,".drawElements(",C,",",da,",",F,".type,",fa,");");k("}}else if(",da,">0){");l("count")||(l("primitive")&&k(C,"=",4,";"),ea&&k("if(",K,">0){",B,".drawArraysInstancedANGLE(",C,",",fa,",",da,",",K,");}else{"),k(y,".drawArrays(",C,",",fa,",",da,");"),ea&&k("}"));k("}}",ca);return ia.compile().batch}var V=l.contextState,I={add:32774,subtract:32778,
"reverse subtract":32779};g.ext_blend_minmax&&(I.min=32775,I.max=32776);var m=0;return{draw:function(a){var d=L(),m=d.link,f=d.proc("draw"),n=f.def,A=m(e),h=m(a.program),v=m(x.bind),t=m(P.count),u=m(P.offset),r=m(P.instances),k=m(P.primitive),E=m(p.elements),H=[];f(A,".useProgram(",h,");");a.attributes.forEach(function(a){var d=m(x.def(a.name));f(v,"(",a.location,",",m(x.bindings[a.location]),",",d,",",c(a.info.type),");")});a.uniforms.forEach(function(a){var d=m(a.location),b=m(Q.def(a.name)),b=
b+"["+b+".length-1]";a=a.info.type;35678===a||35680===a?(a=n(b+"._texture"),H.push(a),f(q(A,5124,d,a+".bind()"))):f(q(A,a,d,b))});H.forEach(function(a){f(a,".unbind();")});a=n(b(k));t=n(b(t));u=n(b(u));E=n(b(E));f("if(",t,"){");(h=g.angle_instanced_arrays)?(r=n(b(r)),h=m(h),f("if(",E,"){",E,".bind();","if(",r,">0){",h,".drawElementsInstancedANGLE(",a,",",t,",",E,".type,",u,",",r,");}else{",A,".drawElements(",a,",",t,",",E,".type,",u,");}","}else if(",r,">0){",h,".drawArraysInstancedANGLE(",a,",",
u,",",t,",",r,");}else{",A,".drawArrays(",a,",",u,",",t,");}}")):f("if(",E,"){",E,".bind();",A,".drawElements(",a,",",t,",",E,".type,",u,");","}else{",A,".drawArrays(",a,",",u,",",t,");}}");return d.compile().draw},command:function(d,b,g,c,q,e,v){function u(a){var d=ma[a];return d?d:d=ma[a]=k(V[a])}function l(a,d){var b=u(a);C(b,".push(",d,");");J(b,".pop();")}function z(a){var d=a.id,b=la[d];if(b)return b;b=a.func?F.def(k(a.data),"(",ea,",0,",qa,")"):F.def(ea,".",a.data);return la[d]=b}var r=L(),
k=r.link,B=r.block,D=r.proc,M=m++,y=k(X),w=k(U),O=k(E),G={count:k(P.count),offset:k(P.offset),instances:k(P.instances),primitive:k(P.primitive)},ba=k(p.elements),pa=k(f),da=k(n),fa=k(H),ma={},C=B(),J=B();Object.keys(d).sort(a).forEach(function(a){var b=d[a];switch(a){case "frag":case "vert":b=h.id(b);U.shader("frag"===a?35632:35633,b);C(w,".",a,".push(",b,");");J(w,".",a,".pop();");break;case "framebuffer":E.getFramebuffer(b);a=u("viewport");var c=u("scissor.box");C("if(",O,".push(",k(b&&b._framebuffer),
")){",a,".setDirty();",c,".setDirty();","}");J("if(",O,".pop()){",a,".setDirty();",c,".setDirty();","}");break;case "count":case "offset":case "instances":C(G[a],".push(",b,");");J(G[a],".pop();");break;case "primitive":C(G.primitive,".push(",f[b],");");J(G.primitive,".pop();");break;case "elements":c=p.getElements(b);b=!("primitive"in d);a=!("count"in d);c?(c=k(c),C(ba,".push(",c,");"),b&&C(G.primitive,".push(",c,".primType);"),a&&C(G.count,".push(",c,".vertCount);")):(C(ba,".push(null);"),b&&C(G.primitive,
".push(",4,");"),a&&C(G.count,".push(0);"));b&&J(G.primitive,".pop();");a&&J(G.count,".pop();");"offset"in d||(C(G.offset,".push(0);"),J(G.offset,".pop();"));J(ba,".pop();");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":l(a,b);break;case "depth.func":l(a,n[b]);break;case "depth.range":a=u(a);C(a,".push(",b[0],",",b[1],");");J(a,".pop();");
break;case "blend.func":a=u(a);C(a,".push(",A["srcRGB"in b?b.srcRGB:b.src],",",A["dstRGB"in b?b.dstRGB:b.dst],",",A["srcAlpha"in b?b.srcAlpha:b.src],",",A["dstAlpha"in b?b.dstAlpha:b.dst],");");J(a,".pop();");break;case "blend.equation":a=u(a);"string"===typeof b?C(a,".push(",I[b],",",I[b],");"):"object"===typeof b&&C(a,".push(",I[b.rgb],",",I[b.alpha],");");J(a,".pop();");break;case "blend.color":a=u(a);C(a,".push(",b[0],",",b[1],",",b[2],",",b[3],");");J(a,".pop();");break;case "stencil.mask":a=
u(a);C(a,".push(",b,");");J(a,".pop();");break;case "stencil.func":var c=b.cmp||"keep",g=b.ref||0,b="mask"in b?b.mask:-1;a=u(a);C(a,".push(",n[c],",",g,",",b,");");J(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":c=b.fail||"keep";g=b.zfail||"keep";b=b.pass||"keep";a=u(a);C(a,".push(",H[c],",",H[g],",",H[b],");");J(a,".pop();");break;case "polygonOffset.offset":c=b.factor||0;b=b.units||0;a=u(a);C(a,".push(",c,",",b,");");J(a,".pop();");break;case "cull.face":c=0;"front"===b?c=1028:
"back"===b&&(c=1029);b=u(a);C(b,".push(",c,");");J(b,".pop();");break;case "lineWidth":l(a,b);break;case "frontFace":c=0;"cw"===b?c=2304:"ccw"===b&&(c=2305);b=u(a);C(b,".push(",c,");");J(b,".pop();");break;case "colorMask":a=u(a);C(a,".push(",b.map(function(a){return!!a}).join(),");");J(a,".pop();");break;case "sample.coverage":c="value"in b?b.value:1;b=!!b.invert;a=u(a);C(a,".push(",c,",",b,");");J(a,".pop();");break;case "viewport":case "scissor.box":var c=b.x||0,g=b.y||0,m=-1,q=-1;"w"in b&&(m=
b.w);"h"in b&&(q=b.h);b=u(a);C(b,".push(",c,",",g,",",m,",",q,");");J(b,".pop();")}});Object.keys(b).forEach(function(a){var d=k(Q.def(a));a=b[a];a="function"===typeof a&&a._reglType?k(a):Array.isArray(a)?k(a.slice()):+a;C(d,".push(",a,");");J(d,".pop();")});Object.keys(g).forEach(function(a){var b=g[a],d=k(x.def(a));a=k(x.box(a).alloc(b));C(d,".records.push(",a,");");J(d,".records.pop();")});var F=r.block(),K=r.block(),qa,ea;v&&(qa=k(ka),ea=C.def());var la={};Object.keys(c).sort(a).forEach(function(a){var b=
z(c[a]);switch(a){case "framebuffer":a=u("viewport");var w=u("scissor.box");F("if(",O,".push(",b,"&&",b,"._framebuffer)){",a,".setDirty();",w,".setDirty();","}");K("if(",O,".pop()){",a,".setDirty();",w,".setDirty();","}");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "lineWidth":case "depth.mask":a=u(a);F(a,".push(",b,");");K(a,".pop();");break;case "count":case "offset":case "instances":a=
G[a];F(a,".push(",b,");");K(a,".pop();");break;case "primitive":a=G.primitive;F(a,".push(",pa,"[",b,"]);");K(a,".pop();");break;case "depth.func":a=u(a);F(a,".push(",da,"[",b,"]);");K(a,".pop();");break;case "blend.func":a=u(a);w=k(A);F(a,".push(",w,'["srcRGB" in ',b,"?",b,".srcRGB:",b,".src],",w,'["dstRGB" in ',b,"?",b,".dstRGB:",b,".dst],",w,'["srcAlpha" in ',b,"?",b,".srcAlpha:",b,".src],",w,'["dstAlpha" in ',b,"?",b,".dstAlpha:",b,".dst]);");K(a,".pop();");break;case "blend.equation":a=u(a);w=
k(I);F("if(typeof ",b,'==="string"){',a,".push(",w,"[",b,"],",w,"[",b,"]);","}else{",a,".push(",w,"[",b,".rgb],",w,"[",b,".alpha]);","}");K(a,".pop();");break;case "blend.color":a=u(a);F(a,".push(",b,"[0],",b,"[1],",b,"[2],",b,"[3]);");K(a,".pop();");break;case "stencil.mask":a=u(a);F(a,".push(",b,");");K(a,".pop();");break;case "stencil.func":a=u(a);F(a,".push(",da,"[",b,".cmp],",b,".ref|0,",'"mask" in ',b,"?",b,".mask:-1);");K(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":a=u(a);
F(a,".push(",fa,"[",b,'.fail||"keep"],',fa,"[",b,'.zfail||"keep"],',fa,"[",b,'.pass||"keep"]);');K(a,".pop();");break;case "polygonOffset.offset":a=u(a);F(a,".push(",b,".factor||0,",b,".units||0);");K(a,".pop();");break;case "cull.face":a=u(a);F(a,".push(",b,'==="front"?',1028,":",1029,");");K(a,".pop();");break;case "frontFace":a=u(a);F(a,".push(",b,'==="cw"?',2304,":",2305,");");K(a,".pop();");break;case "colorMask":a=u(a);F(a,".push(",b,"[0],",b,"[1],",b,"[2],",b,"[3]);");K(a,".pop();");break;
case "sample.coverage":a=u(a);F(a,".push(",b,".value,",b,".invert);");K(a,".pop();");break;case "scissor.box":case "viewport":a=u(a);F(a,".push(",b,".x||0,",b,".y||0,",'"w" in ',b,"?",b,".w:-1,",'"h" in ',b,"?",b,".h:-1);");K(a,".pop();");break;case "elements":a=!("primitive"in c)&&!("primitive"in d);var w=!("count"in c)&&!("count"in d),g=!("offset"in c)&&!("offset"in d),m=F.def();F("if(",b,"){",m,"=",b,"._elements;",ba,".push(",m,");",a?G.primitive+".push("+m+".primType);":"",w?G.count+".push("+
m+".vertCount);":"",g?G.offset+".push("+m+".offset);":"","}else{",ba,".push(null);","}");K(ba,".pop();","if(",b,"){",a?G.primitive+".pop();":"",w?G.count+".pop();":"",g?G.offset+".pop();":"","}")}});Object.keys(q).forEach(function(a){var b=k(Q.def(a));a=z(q[a]);F(b,".push(",a,");");K(b,".pop();")});Object.keys(e).forEach(function(a){var b=k(x.def(a)),d=z(e[a]);a=k(x.box(a));F(b,".records.push(",a,".alloc(",d,"));");K(a,".free(",b,".records.pop());")});var W=D("scope"),Z=W.arg(),sa=W.arg();W(C);v&&
W(ea,"=",Z,";",F);W(sa,"();",v?K:"",J);W=B();B=W.def();d.frag&&d.vert?(Z=d.frag,W(B,"=",k(U.program(h.id(d.vert),h.id(Z))),";")):W(B,"=",w,".program","(",w,".vert[",w,".vert.length-1]",",",w,".frag[",w,".frag.length-1]",");");Z=D("draw");Z(C,W);v&&Z(ea,"=",Z.arg(),";",F);Z(y,"();","if(",B,")",B,".draw(",v?ea:"",");",v?K:"",J);var na=D("batch");na(C,W);v=k(function(a,b,w){var g=a.batchCache[M];g||(g=a.batchCache[M]=ja(a,c,q,e,d));return g(b,w)});na("if(",B,"){",y,"();",v,"(",B,",",na.arg(),",",na.arg(),
");");Object.keys(c).forEach(function(a){(a=ma[a])&&na(a,".setDirty();")});na("}",J);return r.compile()}}}},{"./constants/primitives.json":7,"./util/codegen":23}],5:[function(e,h,l){h.exports={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,"[object Float32Array]":5126,"[object Float64Array]":5121,"[object ArrayBuffer]":5121}},{}],6:[function(e,h,l){h.exports=
{int8:5120,int16:5122,int32:5124,uint8:5121,uint16:5123,uint32:5125,"float":5126}},{}],7:[function(e,h,l){h.exports={points:0,lines:1,"line loop":2,"line strip":3,triangles:4,"triangle strip":5,"triangle fan":6}},{}],8:[function(e,h,l){function c(a,c){function f(){var c=window.innerWidth,g=window.innerHeight;a!==document.body&&(g=a.getBoundingClientRect(),c=g.right-g.left,g=g.top-g.bottom);e.width=h*c;e.height=h*g;b(e.style,{width:c+"px",height:g+"px"})}var e=document.createElement("canvas"),n=q(e,
c);b(e.style,{border:0,margin:0,padding:0,top:0,left:0});a.appendChild(e);a===document.body&&(e.style.position="absolute",b(a.style,{margin:0,padding:0}));var h=+n.options.pixelRatio;window.addEventListener("resize",f,!1);var l=n.options.onDestroy;n.options=b(b({},n.options),{onDestroy:function(){window.removeEventListener("resize",f);a.removeChild(e);l&&l()}});f();return n}function q(a,c){function f(b){try{return a.getContext(b,e)}catch(c){return null}}var e=c.glOptions||{};return{gl:f("webgl")||
f("experimental-webgl")||f("webgl-experimental"),options:b({pixelRatio:window.devicePixelRatio},c)}}var b=e("./util/extend");h.exports=function(a){if("undefined"===typeof document||"undefined"===typeof HTMLElement)return{gl:a[0],options:a[1]||{}};var e=document.body,f=a[1]||{};if("string"===typeof a[0])e=document.querySelector(a[0])||document.body;else if("object"===typeof a[0])if(a[0]instanceof HTMLElement)e=a[0];else{if(a[0]instanceof WebGLRenderingContext)return{gl:a[0],options:b({pixelRatio:1},
f)};f=a[0]}return e.nodeName&&"CANVAS"===e.nodeName.toUpperCase()?q(e,f):c(e,f)}},{"./util/extend":24}],9:[function(e,h,l){h.exports=function(c){return{primitive:[4],count:[-1],offset:[0],instances:[0]}}},{}],10:[function(e,h,l){function c(a,c){this.id=b++;this.func=a;this.data=c}function q(a,b){switch(typeof a){case "boolean":case "number":case "string":return new c(!1,a);case "function":return new c(!0,a);default:return q}}var b=0;h.exports={define:q,isDynamic:function(a){return"function"===typeof a&&
!a._reglType||a instanceof c},unbox:function(a,b){return a instanceof c?a:"function"===typeof a&&a!==q?new c(!0,a):new c(!1,b)}}},{}],11:[function(e,h,l){var c=e("./util/is-typed-array"),q=e("./util/is-ndarray"),b=e("./constants/primitives.json");h.exports=function(a,e,f){function h(){this.buffer=null;this.primType=4;this.type=this.vertCount=0}h.prototype.bind=function(){this.buffer.bind()};return{create:function(a){function l(a){var f=e.oes_element_index_uint;if(a)if("number"===typeof a)t(a);else{var d=
null,p="static",n=0;Array.isArray(a)||c(a)||q(a)?d=a:("data"in a&&(d=a.data),"usage"in a&&(p=a.usage),"length"in a&&(n=a.length));Array.isArray(d)||q(d)&&"array"===d.dtype||"type"in a?t({type:a.type||(f?"uint32":"uint16"),usage:p,data:d,length:n}):t({usage:p,data:d,length:n});if(Array.isArray(d)||c(d))t.dimension=3}else t();f=z.buffer.byteLength;d=0;switch(z.buffer.dtype){case 5121:case 5120:d=5121;break;case 5123:case 5122:d=5123;f>>=1;break;case 5125:case 5124:d=5125,f>>=2}p=4;n=z.buffer.dimension;
1===n&&(p=0);2===n&&(p=1);3===n&&(p=4);"object"===typeof a&&("primitive"in a&&(p=b[a.primitive]),"count"in a&&(f=a.vertCount|0));z.primType=p;z.vertCount=f;z.type=d;return l}var z=new h,t=f.create(null,34963,!0);z.buffer=t._buffer;l(a);l._reglType="elements";l._elements=z;l.destroy=function(){t.destroy();z.buffer=null};return l},elements:[null],getElements:function(a){return a&&a._elements instanceof h?a._elements:null}}}},{"./constants/primitives.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26}],
...
c.getExtension(a)}catch(e){}})}var b={};e();return{extensions:b,refresh:e}}},{}],13:[function(e,h,l){var c=e("./util/values"),q=e("./util/extend"),b=[1029];h.exports=function(a,e,f,h,n){function l(a,b,d,c){this.target=a;this.level=b;this.texture=d;this.renderbuffer=c}function z(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function t(a,b){var d=b.width,c=b.height;if(a.texture)var g=a.texture._texture,e=Math.max(1,g.params.width>>a.level),f=Math.max(1,
...
c=0;c<d.length;++c)g(36064+c,d[c]);for(c=d.length;c<f.maxColorAttachments;++c)g(36064+c,null);g(36096,b.depthAttachment);g(36128,b.stencilAttachment);g(33306,b.depthStencilAttachment);e.webgl_draw_buffers&&e.webgl_draw_buffers.drawBuffersWEBGL(ka[d.length]);a.checkFramebufferStatus(36160)}function E(b){b=b.framebuffer;a.isFramebuffer(b)&&a.deleteFramebuffer(b)}function B(){return V[V.length-1]}var Q={rgba:6408},x={rgba4:32854,rgb565:36194,"rgb5 a1":32855};e.ext_srgb&&(x.srgba=35907);e.ext_color_buffer_half_float&&
(x.rgba16f=34842,x.rgb16f=34843);e.webgl_color_buffer_float&&(x.rgba32f=34836);var U=[],P=[];e.webgl_depth_texture&&(U.push(6402),P.push(34041));q(q({},Q),x);c(Q);c(x);x=5121;U={uint8:5121};e.oes_texture_half_float&&(x=U["half float"]=36193);e.oes_texture_float&&(x=U["float"]=5126);U.best=x;var ka=function(){for(var a=Array(f.maxDrawbuffers),b=0;b<=f.maxDrawbuffers;++b)for(var d=a[b]=Array(b),c=0;c<b;++c)d[c]=36064+c;return a}(),X=0,ja={},V=[null],I=!0;return{top:B,dirty:function(){return I},push:function(a){a=
...
f&&(k=f.colorCount|0);if(g.ownsColor)for(m=g.colorAttachments;m.length>k;)z(m.pop());else m=[];for(e=0;e<m.length;++e){var L;a:{L=m[e];var D=E,x=B,y=b,w=p;if(L.texture){var O=L.texture;if(D){O({format:x,type:r,width:y,height:w});O._texture.refCount+=1;L=!0;break a}}else if(O=L.renderbuffer,!D){O({format:x,width:y,height:w});O._renderbuffer.refCount+=1;L=!0;break a}z(L);L=!1}L||(m[e--]=m[m.length-1],m.pop())}for(;m.length<k;)E?m.push(new l(3553,0,h.create({format:B,type:r,width:b,height:p},3553),null)):
...
f.texture?(f.texture({format:D,width:b,height:p}),f.texture._texture.refCount+=1,x=f):x=new l(3553,0,h.create({format:D,width:b,height:p},3553),null)):(D=k?L?"depth stencil":"depth":"stencil",g.ownsDepthStencil&&f.renderbuffer?(f.renderbuffer({format:D,width:b,height:p}),f.renderbuffer._renderbuffer.refCount+=1,x=f):x=new l(36161,0,null,n.create({format:D,width:b,height:p}))),k?L?B=x:e=x:E=x;b=g;b.colorAttachments.forEach(z);z(b.depthAttachment);z(b.stencilAttachment);z(b.depthStencilAttachment);
...
version:c.getParameter(7938)}}},{}],15:[function(e,h,l){var c=e("./util/is-typed-array");h.exports=function(e,b,a){return function(h){var f=h||{};c(h)?f={data:f}:2===arguments.length?f={width:arguments[0]|0,height:arguments[1]|0}:"object"!==typeof h&&(f={});b();var A=f.x||0,n=f.y||0,l=f.width||a.width,z=f.height||a.height,f=f.data||new Uint8Array(l*z*4);e.pixelStorei(3333,4);e.readPixels(A,n,l,z,6408,5121,f);return f}}},{"./util/is-typed-array":26}],16:[function(e,h,l){var c=e("./util/values");h.exports=
function(e,b,a){function h(){this.id=H++;this.refCount=1;this.renderbuffer=null;this.format=32854;this.height=this.width=0}function f(a){e.isRenderbuffer(a.renderbuffer)||(a.renderbuffer=e.createRenderbuffer());e.bindRenderbuffer(36161,a.renderbuffer);e.renderbufferStorage(36161,a.format,a.width,a.height)}function l(a){var b=a.renderbuffer;e.bindRenderbuffer(36161,null);e.isRenderbuffer(b)&&e.deleteRenderbuffer(b);a.renderbuffer=null;a.refCount=0;delete z[a.id]}var n={rgba4:32854,rgb565:36194,"rgb5 a1":32855,
depth:33189,stencil:36168,"depth stencil":34041};b.ext_srgb&&(n.srgba=35907);b.ext_color_buffer_half_float&&(n.rgba16f=34842,n.rgb16f=34843);b.webgl_color_buffer_float&&(n.rgba32f=34836);var H=0,z={};h.prototype.decRef=function(){0===--this.refCount&&l(this)};return{create:function(a){function b(a){a=a||{};var e=0,h=0;"shape"in a?(h=a.shape,e=h[0]|0,h=h[1]|0):("radius"in a&&(e=h=a.radius|0),"width"in a&&(e=a.width|0),"height"in a&&(h=a.height|0));b.width=c.width=Math.max(e,1);b.height=c.height=Math.max(h,
1);c.format=32854;"format"in a&&(c.format=n[a.format]);f(c);return b}var c=new h;z[c.id]=c;b(a);b._reglType="renderbuffer";b._renderbuffer=c;b.destroy=function(){c.decRef()};return b},refresh:function(){c(z).forEach(f)},clear:function(){c(z).forEach(l)}}}},{"./util/values":32}],17:[function(e,h,l){function c(b,a,c,e){this.name=b;this.id=a;this.location=c;this.info=e}var q=e("./util/values");h.exports=function(b,a,e,f,h){function n(a,d){var c=35632===a?t:g,e=c[d];if(!e){var f=h.str(d),e=b.createShader(a);
b.shaderSource(e,f);b.compileShader(e);c[d]=e}return e}function l(a,b){this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[];this.draw=function(){};this.batchCache={}}function z(d){var g,q;g=n(35632,d.fragId);q=n(35633,d.vertId);var l=d.program=b.createProgram();b.attachShader(l,g);b.attachShader(l,q);b.linkProgram(l);var v=b.getProgramParameter(l,35718),t=d.uniforms=[];for(g=0;g<v;++g)if(q=b.getActiveUniform(l,g))if(1<q.size)for(var z=0;z<q.size;++z){var H=q.name.replace("[0]",
"["+z+"]");e.def(H);t.push(new c(H,h.id(H),b.getUniformLocation(l,H),q))}else e.def(q.name),t.push(new c(q.name,h.id(q.name),b.getUniformLocation(l,q.name),q));v=b.getProgramParameter(l,35721);t=d.attributes=[];for(g=0;g<v;++g)if(q=b.getActiveAttrib(l,g))a.def(q.name),t.push(new c(q.name,h.id(q.name),b.getAttribLocation(l,q.name),q));d.draw=f(d);d.batchCache={}}var t={},g={},v={},d=[];return{clear:function(){var a=b.deleteShader.bind(b);q(t).forEach(a);t={};q(g).forEach(a);g={};d.forEach(function(a){b.deleteProgram(a.program)});
d.length=0;v={}},refresh:function(){t={};g={};d.forEach(z)},program:function(a,b){var c=v[b];c||(c=v[b]={});var e=c[a];e||(e=new l(b,a),z(e),c[a]=e,d.push(e));return e},shader:n,frag:[-1],vert:[-1]}}},{"./util/values":32}],18:[function(e,h,l){var c=e("./util/stack"),q=e("./util/codegen");h.exports=function(b,a,e){function f(a,e){var d=c([!!e],function(d){d?b.enable(a):b.disable(a)});d.flag=a;return d}var h={dither:f(3024),"blend.enable":f(3042),"blend.color":c([0,0,0,0],function(a,c,d,e){b.blendColor(a,
...
e)}function P(a){this.id=k++;this.refCount=1;this.target=a;this.texture=null;this.unit=this.pollId=-1;this.bindCount=0;this.cancelPending=null;this.params=new x(a);this.pixels=[]}function ka(a,b){function d(a,c){var e=c.mipmap,w;if(Array.isArray(e))for(var g=0;g<e.length;++g)w=new Q(a),w.parseFlags(b),w.parseFlags(c),w.parse(e[g],g),f.push(w);else w=new Q(a),w.parseFlags(b),w.parse(c,0),f.push(w)}var c;V(a);var e=a.params;x.call(e,a.target);var f=a.pixels;f.length=0;e.parse(b);if(3553===a.target)d(3553,
b);else{var g=b.faces||b;if(Array.isArray(g))for(c=0;6>c;++c)d(34069+c,g[c]);else if("string"!==typeof g)for(c=0;6>c;++c)d(34069+c,{})}U(e,f);e.needsListeners&&ja(a);e.needsPoll&&(a.pollId=D.length,D.push(a));X(a)}function X(a){d.isTexture(a.texture)||(a.texture=d.createTexture());var b=a.target,c=a.unit;0<=c?(d.activeTexture(33984+c),r=c):d.bindTexture(b,a.texture);for(var b=a.pixels,e=a.params,f=0;f<b.length;++f)b[f].upload(e);e.upload();0>c&&((c=y[r])?d.bindTexture(c.target,c.texture):(a.unit=
r,y[r]=a))}function ja(a){function b(a,d,c){var f=g(c);f.pixels.forEach(function(b){var c=new Q(f.cube?b.target:a);c.channels=f.channels;c.compressed=f.compressed;c.type=f.type;c.internalformat=f.format;c.format=ia[f.format];c.width=b.width;c.height=b.height;c.miplevel=b.miplevel||d;c.data=b.data;e.push(c)})}function d(){for(var f=0;f<e.length;++f){var g=e[f],h=g.image,n=g.video,G=g.xhr;h&&h.complete?(g.width=h.naturalWidth,g.height=h.naturalHeight):n&&2<n.readyState?(g.width=n.width,g.height=n.height):
...
"rgba pvrtc 2bppv1":35843});e.webgl_compressed_texture_etc1&&(Y["rgb etc1"]=36196);var ha=Array.prototype.slice.call(d.getParameter(34467));Object.keys(Y).forEach(function(a){var b=Y[a];0<=ha.indexOf(b)&&(T[a]=b)});var oa=Object.keys(T);h.textureFormats=oa;var ia=oa.reduce(function(a,b){var c=T[b];6409===c||6406===c||6409===c||6410===c||6402===c||34041===c?a[c]=c:32855===c||0<=b.indexOf("rgba")?a[c]=6408:a[c]=6407;return a},{});f(Q.prototype,{parseFlags:function(a){if("object"===typeof a&&a){"premultiplyAlpha"in
...
"height"in a&&(c=a.height),"channels"in a&&(d=a.channels));this.width=b|0;this.height=c|0;this.channels=d|0;"stride"in a?(b=a.stride,this.strideX=b[0],this.strideY=b[1],this.strideC=3===b.length?b[2]:1,this.needsTranspose=!0):(this.strideC=1,this.strideX=this.strideC*d,this.strideY=this.strideX*b);"offset"in a&&(this.offset=a.offset|0,this.needsTranspose=!0);"crossOrigin"in a&&(this.crossOrigin=a.crossOrigin)}},parse:function(d,e){this.miplevel=e;this.width>>=e;this.height>>=e;var f=d;switch(typeof d){case "object":if(!d)return;
this.parseFlags(d);var g=d.data;if("string"===typeof g||g&&(n(g)||c(g)||H(g)||a(g)||L(g)||"[object HTMLImageElement]"===b(g)||"[object HTMLVideoElement]"===b(g)||q(g)))f=d.data;break;case "undefined":return}"string"===typeof f&&(f=z(f,this.crossOrigin));var g=null,h=!1;if(null!==f)if(n(f))this.data=f;else if(c(f))g=f,h=!0;else if(H(f)){Array.isArray(f.data)?(g=f.data,h=!0):this.data=f.data;var k=f.shape;this.width=k[0];this.height=k[1];this.channels=3===k.length?k[2]:1;k=f.stride;this.strideX=f.stride[0];
...
new Float32Array(g);break;case 36193:this.data=t(g)}if(this.data&&this.needsTranspose){g=this.data;f=this.width;h=this.height;k=this.channels;m=this.strideX;l=this.strideY;p=this.strideC;A=this.offset;r=new g.constructor(f*h*k);for(var u=0,v=0;v<h;++v)for(var x=0;x<f;++x)for(var y=0;y<k;++y)r[u++]=g[l*v+m*x+p*y+A];this.data=r}this.needsTranspose=!1},setDefaultFormat:function(){this.format=this.internalformat=6408;this.type=5121;this.channels=4;this.compressed=!1},upload:function(a){d.pixelStorei(37440,
this.flipY);d.pixelStorei(37441,this.premultiplyAlpha);d.pixelStorei(37443,this.colorSpace);d.pixelStorei(3317,this.unpackAlignment);var b=this.target,c=this.miplevel,e=this.image,f=this.canvas,g=this.video,h=this.data,n=this.internalformat,k=this.format,q=this.type,m=this.width||Math.max(1,a.width>>c);a=this.height||Math.max(1,a.height>>c);g&&2<g.readyState?d.texImage2D(b,c,k,k,q,g):e&&e.complete?d.texImage2D(b,c,k,k,q,e):f?d.texImage2D(b,c,k,k,q,f):this.compressed?d.compressedTexImage2D(b,c,n,m,
a,0,h):this.copy?(l(),d.copyTexImage2D(b,c,k,this.x,this.y,m,a,0)):h?d.texImage2D(b,c,k,m,a,0,k,q,h):d.texImage2D(b,c,k,m||1,a||1,0,k,q,null)}});f(x.prototype,{parse:function(a){if("object"===typeof a&&a){"min"in a&&(this.minFilter=N[a.min]);"mag"in a&&(this.magFilter=ga[a.mag]);var b=this.wrapS,c=this.wrapT;if("wrap"in a){var d=a.wrap;"string"===typeof d?b=c=R[d]:Array.isArray(d)&&(b=R[d[0]],c=R[d[1]])}else"wrapS"in a&&(b=R[a.wrapS]),"wrapT"in a&&(c=R[a.wrapT]);this.wrapS=b;this.wrapT=c;"anisotropic"in
...
var r=0,k=0,ca={},D=[],M=h.maxTextureUnits,y=Array(M).map(function(){return null});f(P.prototype,{bind:function(){this.bindCount+=1;var a=this.unit;if(0>a){for(var b=0;b<M;++b){var c=y[b];if(c){if(0<c.bindCount)continue;c.unit=-1}y[b]=this;a=b;break}this.unit=a;d.activeTexture(33984+a);d.bindTexture(this.target,this.texture);r=a}return a},unbind:function(){--this.bindCount},decRef:function(){0===--this.refCount&&I(this)}});return{create:function(a,b){function c(a,e,f,g,h,k){var n=a||{};34067===b&&
6===arguments.length&&(n=[a,e,f,g,h,k]);ka(d,n);c.width=d.params.width;c.height=d.params.height;return c}var d=new P(b);ca[d.id]=d;c(a);c._reglType="texture";c._texture=d;c.destroy=function(){d.decRef()};return c},refresh:function(){A(ca).forEach(X);for(var a=0;a<M;++a)y[a]=null;r=0;d.activeTexture(33984)},clear:function(){for(var a=0;a<M;++a)d.activeTexture(33984+a),d.bindTexture(3553,null),y[a]=null;d.activeTexture(33984);r=0;A(ca).forEach(I)},poll:function(){D.forEach(X)},getTexture:function(a){return null}}}},
...
b+3>>2)*Math.max(1,c+3>>2)*aa;ha.pixels.push({target:a,miplevel:d,width:b,height:c,data:new Uint8Array(e,Y,f)});Y+=f;b>>=1;c>>=1}}var l=new Int32Array(e),I=l[E],m=l[Q],R=l[B],ga=n,N=0,aa=0,S=4;switch(l[P]){case g:aa=8;I&t?(S=3,N=b):N=a;break;case v:aa=16;N=L;break;case d:aa=16;N=f;break;case p:aa=8,N=A}var T=1;l[U]&H&&(T=Math.max(1,l[x]));var Y=l[u]+4,ha={width:m,height:R,channels:S,format:N,type:ga,compressed:!0,cube:!1,pixels:[]};if(l[ka]&z)for(ha.cube=!0,l=0;6>l;++l)h(q+l);else h(c);return ha};
var c=3553,q=34069,b=33776,a=33777,L=33778,f=33779,A=36196,n=5121,H=131072,z=512,t=64,g=827611204,v=861165636,d=894720068,p=826496069,u=1,E=2,B=3,Q=4,x=7,U=20,P=21,ka=28},{}],29:[function(e,h,l){h.exports="function"===typeof requestAnimationFrame&&"function"===typeof cancelAnimationFrame?{next:function(c){return requestAnimationFrame(c)},cancel:function(c){return cancelAnimationFrame(c)}}:{next:function(c){setTimeout(c,30)},cancel:clearTimeout}},{}],30:[function(e,h,l){h.exports=function(c,e){var b=
...
k.refresh();ca.refresh();D.refresh();ia.refresh();y.refresh();if(R.onContextRestored)R.onContextRestored();e()}function ja(a){function b(a){var c={},e={};Object.keys(a).forEach(function(b){var f=a[b];B.isDynamic(f)?(d=!0,e[b]=B.unbox(f,b)):c[b]=f});return{dynamic:e,"static":c}}var d=!1,e=b(a.uniforms||{}),f=b(a.attributes||{});a=b(function(a){function b(a){if(a in d){var c=d[a];delete d[a];Object.keys(c).forEach(function(b){d[a+"."+b]=c[b]})}}var d=c({},a);delete d.uniforms;delete d.attributes;b("blend");
b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");return d}(a));var e=w.command(a["static"],e["static"],f["static"],a.dynamic,e.dynamic,f.dynamic,d),g=e.draw,h=e.batch,k=e.scope,l=[];return function(a,b){if("function"===typeof a)return k(null,a);if("function"===typeof b)return k(a,b);if("number"===typeof a){for(var c=a|0;l.length<c;)l.push(null);return h(a|0,l)}return Array.isArray(a)?h(a.length,a):g(a)}}function V(){D.poll();y.poll()}var I=q(Array.prototype.slice.call(arguments)),
m=I.gl,R=I.options,I=b(),ga=a(m),N=ga.extensions,aa={width:m.drawingBufferWidth,height:m.drawingBufferHeight},S=L(m,N),T=f(m),Y=A(m,N,T),ha=t(I),oa=g(m,N,S,T,I),ia=v(m,oa,ha,function(a){return w.draw(a)},I),r=d(m,N,T),k=n(m,N,S,V,aa),ca=H(m,N,S),D=z(m,N,S,k,ca),M={count:0,start:x(),dt:0,t:x(),renderTime:0,width:m.drawingBufferWidth,height:m.drawingBufferHeight,pixelRatio:R.pixelRatio},y=p(m,D,aa),aa=E(m,V,aa),w=u(m,I,N,S,T,Y,k,D,y,ha,oa,ia,r,M,V),O=m.canvas,G=[],ba=0;O&&(O.addEventListener("webglcontextlost",
