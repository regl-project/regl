...
0}function d(c,f){for(var b=0;b<f.length;++b)c[b]=f[b]}function C(c,f,b,d,g,n,u){for(var x=0,a=0;a<b;++a)for(var p=0;p<d;++p)c[x++]=f[g*a+n*p+u]}function x(c,f,b){for(var d=0,g=0;g<f.length;++g)for(var n=f[g],u=0;u<b;++u)c[d++]=n[u]}var f=h("./util/is-typed-array"),c=h("./util/is-ndarray"),b=h("./util/values"),u=h("./util/pool"),A=h("./constants/arraytypes.json"),I=h("./constants/dtypes.json"),z=h("./constants/usage.json"),n=[];n[5120]=1;n[5122]=2;n[5124]=4;n[5121]=1;n[5123]=2;n[5125]=4;n[5126]=4;
l.exports=function(q,h,E){function k(a){this.id=G++;this.buffer=q.createBuffer();this.type=a;this.usage=35044;this.byteLength=0;this.dimension=1;this.dtype=5121;this.persistentData=null;E.profile&&(this.stats={size:0})}function m(a,c,f){a.byteLength=c.byteLength;q.bufferData(a.type,c,f)}function L(a,b,p,k,n,q){a.usage=p;if(Array.isArray(b))a.dtype=k||5126,0<b.length&&(Array.isArray(b[0])?(a.dimension=b[0].length,k=u.allocType(a.dtype,b.length*a.dimension),x(k,b,a.dimension),m(a,k,p),q?a.persistentData=
k:u.freeType(k)):"number"===typeof b[0]?(a.dimension=n,k=u.allocType(a.dtype,b.length),d(k,b),m(a,k,p),q?a.persistentData=k:u.freeType(k)):f(b[0])&&(a.dimension=b[0].length,a.dtype=k||g(b[0])||5126,k=u.allocType(a.dtype,b.length*a.dimension),x(k,b,a.dimension),m(a,k,p),q?a.persistentData=k:u.freeType(k)));else if(f(b))a.dtype=k||g(b),a.dimension=n,m(a,b,p),q&&(a.persistentData=new Uint8Array(new Uint8Array(b.buffer)));else if(c(b)){var h=b.shape,N=b.stride;n=b.offset;var F=0,z=0,r=0,aa=0;1===h.length?
(F=h[0],z=1,r=N[0],aa=0):2===h.length&&(F=h[0],z=h[1],r=N[0],aa=N[1]);a.dtype=k||g(b.data)||5126;a.dimension=z;k=u.allocType(a.dtype,F*z);C(k,b.data,F,z,r,aa,n);m(a,k,p);q?a.persistentData=k:u.freeType(k)}}function F(b){h.bufferCount--;q.deleteBuffer(b.buffer);b.buffer=null;delete a[b.id]}var G=0,a={};k.prototype.bind=function(){q.bindBuffer(this.type,this.buffer)};k.prototype.destroy=function(){F(this)};var p=[];E.profile&&(h.getTotalBufferSize=function(){var b=0;Object.keys(a).forEach(function(c){b+=
a[c].stats.size});return b});return{create:function(b,p,m,G){function l(a){var b=35044,d=null,k=0,g=0,p=1;Array.isArray(a)||f(a)||c(a)?d=a:"number"===typeof a?k=a|0:a&&("data"in a&&(d=a.data),"usage"in a&&(b=z[a.usage]),"type"in a&&(g=I[a.type]),"dimension"in a&&(p=a.dimension|0),"length"in a&&(k=a.length|0));A.bind();d?L(A,d,b,g,p,G):(q.bufferData(A.type,k,b),A.dtype=g||5121,A.usage=b,A.dimension=p,A.byteLength=k);E.profile&&(A.stats.size=A.byteLength*n[A.dtype]);return l}h.bufferCount++;var A=new k(p);
a[A.id]=A;m||l(b);l._reglType="buffer";l._buffer=A;l.subdata=function(a,b){var k=(b||0)|0;A.bind();if(Array.isArray(a)){if(0<a.length)if("number"===typeof a[0]){var p=u.allocType(A.dtype,a.length);d(p,a);q.bufferSubData(A.type,k,p);u.freeType(p)}else if(Array.isArray(a[0])||f(a[0])){var p=a[0].length,r=u.allocType(A.dtype,a.length*p);x(r,a,p);q.bufferSubData(A.type,k,r);u.freeType(r)}}else if(f(a))q.bufferSubData(A.type,k,a);else if(c(a)){var m=a.shape,n=a.stride,h=r=p=0,V=0;1===m.length?(p=m[0],
r=1,h=n[0],V=0):2===m.length&&(p=m[0],r=m[1],h=n[0],V=n[1]);m=Array.isArray(a.data)?A.dtype:g(a.data);m=u.allocType(m,p*r);C(m,a.data,p,r,h,V,a.offset);q.bufferSubData(A.type,k,m);u.freeType(m)}return l};E.profile&&(l.stats=A.stats);l.destroy=function(){F(A)};return l},createStream:function(a,b){var c=p.pop();c||(c=new k(a));c.bind();L(c,b,35040,0,1,!1);return c},destroyStream:function(a){p.push(a)},clear:function(){b(a).forEach(F);p.forEach(F)},getBuffer:function(a){return a&&a._buffer instanceof
k?a._buffer:null},restore:function(){b(a).forEach(function(a){a.buffer=q.createBuffer();q.bindBuffer(a.type,a.buffer);q.bufferData(a.type,a.persistentData||a.byteLength,a.usage)})},_initBuffer:L}}},{"./constants/arraytypes.json":4,"./constants/dtypes.json":5,"./constants/usage.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/pool":28,"./util/values":31}],4:[function(h,l,w){l.exports={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,
...
".enable(",sa[e],");")["else"](d,".disable(",sa[e],");"),g,".",e,"=",c,";"):m(d,".",ta[e],"(",c,");",g,".",e,"=",c,";")}});0===Object.keys(b.state).length&&v(g,".dirty=false;");e(v)}function Q(a,e,b,c){var f=a.shared,k=a.current,g=f.current,t=f.gl;d(Object.keys(b)).forEach(function(d){var f=b[d];if(!c||c(f)){var v=f.append(a,e);if(sa[d]){var m=sa[d];x(f)?v?e(t,".enable(",m,");"):e(t,".disable(",m,");"):e(a.cond(v).then(t,".enable(",m,");")["else"](t,".disable(",m,");"));e(g,".",d,"=",v,";")}else if(z(v)){var p=
k[d];e(t,".",ta[d],"(",v,");",v.map(function(a,e){return p+"["+e+"]="+a}).join(";"),";")}else e(t,".",ta[d],"(",v,");",g,".",d,"=",v,";")}})}function U(a,e){Aa&&!a.instancing&&(a.instancing=e.def(a.shared.extensions,".angle_instanced_arrays"))}function Y(a,e,b,c,d){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function k(a){n=e.def();a(n,"=",f(),";");"string"===typeof d?a(m,".count+=",d,";"):a(m,".count++;");ba&&(c?(h=e.def(),a(h,"=",r,".getNumPendingQueries();")):
a(r,".beginQuery(",m,");"))}function g(a){a(m,".cpuTime+=",f(),"-",n,";");ba&&(c?a(r,".pushScopeStats(",h,",",r,".getNumPendingQueries(),",m,");"):a(r,".endQuery();"))}function t(a){var b=e.def(p,".profile");e(p,".profile=",a,";");e.exit(p,".profile=",b,";")}var v=a.shared,m=a.stats,p=v.current,r=v.timer;b=b.profile;var n,h;if(b){if(x(b)){b.enable?(k(e),g(e.exit),t("true")):t("false");return}b=b.append(a,e);t(b)}else b=e.def(p,".profile");v=a.block();k(v);e("if(",b,"){",v,"}");a=a.block();g(a);e.exit("if(",
b,"){",a,"}")}function Z(e,b,c,d,f){function k(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function g(a,c,d){function f(){b("if(!",p,".buffer){",t,".enableVertexAttribArray(",m,");}");var a=d.type,k;k=d.size?b.def(d.size,"||",c):c;b("if(",p,".type!==",a,"||",p,".size!==",k,"||",h.map(function(a){return p+"."+a+"!=="+d[a]}).join("||"),"){",t,".bindBuffer(",34962,",",r,".buffer);",t,".vertexAttribPointer(",
[m,k,a,d.normalized,d.stride,d.offset],");",p,".type=",a,";",p,".size=",k,";",h.map(function(a){return p+"."+a+"="+d[a]+";"}).join(""),"}");Aa&&(a=d.divisor,b("if(",p,".divisor!==",a,"){",e.instancing,".vertexAttribDivisorANGLE(",[m,a],");",p,".divisor=",a,";}"))}function k(){b("if(",p,".buffer){",t,".disableVertexAttribArray(",m,");","}if(",E.map(function(a,e){return p+"."+a+"!=="+n[e]}).join("||"),"){",t,".vertexAttrib4f(",m,",",n,");",E.map(function(a,e){return p+"."+a+"="+n[e]+";"}).join(""),
"}")}var t=v.gl,m=b.def(a,".location"),p=b.def(v.attributes,"[",m,"]");a=d.state;var r=d.buffer,n=[d.x,d.y,d.z,d.w],h=["buffer","normalized","offset","stride"];1===a?f():2===a?k():(b("if(",a,"===",1,"){"),f(),b("}else{"),k(),b("}"))}var v=e.shared;d.forEach(function(d){var v=d.name,m=c.attributes[v],p;if(m){if(!f(m))return;p=m.append(e,b)}else{if(!f(a))return;var r=e.scopeAttrib(v);p={};Object.keys(new t).forEach(function(a){p[a]=b.def(r,".",a)})}g(e.link(d),k(d.info.type),p)})}function ca(e,b,c,
d,f){for(var k=e.shared,g=k.gl,t,v=0;v<d.length;++v){var m=d[v],p=m.name,r=m.info.type,n=c.uniforms[p],m=e.link(m)+".location",q;if(n){if(!f(n))continue;if(x(n)){p=n.value;if(35678===r||35680===r)r=e.link(p._texture||p.color[0]._texture),b(g,".uniform1i(",m,",",r+".bind());"),b.exit(r,".unbind();");else if(35674===r||35675===r||35676===r)p=e.global.def("new Float32Array(["+Array.prototype.slice.call(p)+"])"),n=2,35675===r?n=3:35676===r&&(n=4),b(g,".uniformMatrix",n,"fv(",m,",false,",p,");");else{switch(r){case 5126:t=
"1f";break;case 35664:t="2f";break;case 35665:t="3f";break;case 35666:t="4f";break;case 35670:t="1i";break;case 5124:t="1i";break;case 35671:t="2i";break;case 35667:t="2i";break;case 35672:t="3i";break;case 35668:t="3i";break;case 35673:t="4i";break;case 35669:t="4i"}b(g,".uniform",t,"(",m,",",z(p)?Array.prototype.slice.call(p):p,");")}continue}else q=n.append(e,b)}else{if(!f(a))continue;q=b.def(k.uniforms,"[",h.id(p),"]")}35678===r?b("if(",q,"&&",q,'._reglType==="framebuffer"){',q,"=",q,".color[0];",
"}"):35680===r&&b("if(",q,"&&",q,'._reglType==="framebufferCube"){',q,"=",q,".color[0];","}");p=1;switch(r){case 35678:case 35680:r=b.def(q,"._texture");b(g,".uniform1i(",m,",",r,".bind());");b.exit(r,".unbind();");continue;case 5124:case 35670:t="1i";break;case 35667:case 35671:t="2i";p=2;break;case 35668:case 35672:t="3i";p=3;break;case 35669:case 35673:t="4i";p=4;break;case 5126:t="1f";break;case 35664:t="2f";p=2;break;case 35665:t="3f";p=3;break;case 35666:t="4f";p=4;break;case 35674:t="Matrix2fv";
break;case 35675:t="Matrix3fv";break;case 35676:t="Matrix4fv"}b(g,".uniform",t,"(",m,",");if("M"===t.charAt(0)){var m=Math.pow(r-35674+2,2),N=e.global.def("new Float32Array(",m,")");b("false,(Array.isArray(",q,")||",q," instanceof Float32Array)?",q,":(",u(m,function(a){return N+"["+a+"]="+q+"["+a+"]"}),",",N,")")}else 1<p?b(u(p,function(a){return q+"["+a+"]"})):b(q);b(");")}}function ya(a,e,b,c){function d(f){var k=v[f];return k?k.contextDep&&c.contextDynamic||k.propDep?k.append(a,b):k.append(a,e):
e.def(m,".",f)}function f(){function a(){b(u,".drawElementsInstancedANGLE(",[r,q,N,n+"<<(("+N+"-5121)>>1)",h],");")}function e(){b(u,".drawArraysInstancedANGLE(",[r,n,q,h],");")}p?ma?a():(b("if(",p,"){"),a(),b("}else{"),e(),b("}")):e()}function k(){function a(){b(g+".drawElements("+[r,q,N,n+"<<(("+N+"-5121)>>1)"]+");")}function e(){b(g+".drawArrays("+[r,n,q]+");")}p?ma?a():(b("if(",p,"){"),a(),b("}else{"),e(),b("}")):e()}var t=a.shared,g=t.gl,m=t.draw,v=c.draw,p=function(){var d=v.elements,f=e;if(d){if(d.contextDep&&
c.contextDynamic||d.propDep)f=b;d=d.append(a,f)}else d=f.def(m,".","elements");d&&f("if("+d+")"+g+".bindBuffer(34963,"+d+".buffer.buffer);");return d}(),r=d("primitive"),n=d("offset"),q=function(){var d=v.count,f=e;if(d){if(d.contextDep&&c.contextDynamic||d.propDep)f=b;d=d.append(a,f)}else d=f.def(m,".","count");return d}();if("number"===typeof q){if(0===q)return}else b("if(",q,"){"),b.exit("}");var h,u;Aa&&(h=d("instances"),u=a.instancing);var N=p+".type",ma=v.elements&&x(v.elements);Aa&&("number"!==
...
e("if(",m,"!==",t,".",d,"){",v,"}")});Object.keys(ta).forEach(function(d){var g=ta[d],m=ra[d],v,p,r=a.block();r(f,".",g,"(");z(m)?(g=m.length,v=a.global.def(k,".",d),p=a.global.def(t,".",d),r(u(g,function(a){return v+"["+a+"]"}),");",u(g,function(a){return p+"["+a+"]="+v+"["+a+"];"}).join("")),e("if(",u(g,function(a){return v+"["+a+"]!=="+p+"["+a+"]"}).join("||"),"){",r,"}")):(v=c.def(k,".",d),p=c.def(t,".",d),r(v,");",t,".",d,"=",v,";"),e("if(",v,"!==",p,"){",r,"}"));b(r)});return a.compile()}(),
...
0;l.exports={DynamicVariable:g,define:function(d,c){return new g(d,C(c+""))},isDynamic:function(d){return"function"===typeof d&&!d._reglType||d instanceof g},unbox:function(d,c){return"function"===typeof d?new g(0,d):d},accessor:C}},{}],10:[function(h,l,w){var g=h("./util/is-typed-array"),d=h("./util/is-ndarray"),C=h("./util/values"),x=h("./constants/primitives.json"),f=h("./constants/usage.json");l.exports=function(c,b,h,A){function l(b){this.id=J++;q[this.id]=this;this.buffer=b;this.primType=4;
this.type=this.vertCount=0}function z(c,f,k,n,a,p,q){(p=q)||g(f)&&(!d(f)||g(f.data))||(p=b.oes_element_index_uint?5125:5123);c.buffer.bind();h._initBuffer(c.buffer,f,k,p,3);f=q;if(!q){switch(c.buffer.dtype){case 5121:case 5120:f=5121;break;case 5123:case 5122:f=5123;break;case 5125:case 5124:f=5125}c.buffer.dtype=f}c.type=f;0>a&&(a=c.buffer.byteLength,5123===f?a>>=1:5125===f&&(a>>=2));c.vertCount=a;a=n;0>n&&(a=4,n=c.buffer.dimension,1===n&&(a=0),2===n&&(a=1),3===n&&(a=4));c.primType=a}function n(b){A.elementsCount--;
delete q[b.id];b.buffer.destroy();b.buffer=null}var q={},J=0,E={uint8:5121,uint16:5123};b.oes_element_index_uint&&(E.uint32=5125);l.prototype.bind=function(){this.buffer.bind()};var k=[];return{create:function(b,k){function q(b){if(b)if("number"===typeof b)C(b),a.primType=4,a.vertCount=b|0,a.type=5121;else{var k=null,m=35044,n=-1,h=-1,u=0,A=0;Array.isArray(b)||g(b)||d(b)?k=b:("data"in b&&(k=b.data),"usage"in b&&(m=f[b.usage]),"primitive"in b&&(n=x[b.primitive]),"count"in b&&(h=b.count|0),"length"in
b&&(u=b.length|0),"type"in b&&(A=E[b.type]));k?z(a,k,m,n,h,u,A):(b=a.buffer,b.bind(),c.bufferData(34963,u,m),b.dtype=A||5121,b.usage=m,b.dimension=3,b.byteLength=u,a.primType=0>n?4:n,a.vertCount=0>h?0:h,a.type=b.dtype)}else C(),a.primType=4,a.vertCount=0,a.type=5121;return q}var C=h.create(null,34963,!0),a=new l(C._buffer);A.elementsCount++;q(b);q._reglType="elements";q._elements=a;q.subdata=function(a,b){C.subdata(a,b);return q};q.destroy=function(){n(a)};return q},createStream:function(b){var c=
k.pop();c||(c=new l(h.create(null,34963,!0,!1)._buffer));z(c,b,35040,-1,-1,0,0);return c},destroyStream:function(b){k.push(b)},getElements:function(b){return"function"===typeof b&&b._elements instanceof l?b._elements:null},clear:function(){C(q).forEach(n)}}}},{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/values":31}],11:[function(h,l,w){l.exports=function(g,d){function h(b){b=b.toLowerCase();var c;try{c=x[b]=g.getExtension(b)}catch(d){}return!!c}
...
1;x[5126]=4;x[36193]=2;l.exports=function(f,c,b,h,A,l){function z(a,b,c){this.target=a;this.texture=b;this.renderbuffer=c;var d=a=0;b?(a=b.width,d=b.height):c&&(a=c.width,d=c.height);this.width=a;this.height=d}function n(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function q(a,b,c){a&&(a.texture?a.texture._texture.refCount+=1:a.renderbuffer._renderbuffer.refCount+=1)}function J(a,b){b?b.texture?f.framebufferTexture2D(36160,a,b.target,b.texture._texture.texture,
...
a instanceof F)?a:null},create:V,createCube:function(a){function b(a){var f,k={color:null},g=0,m=null;f="rgba";var n="uint8",p=1;if("number"===typeof a)g=a|0;else if(a){"shape"in a?g=a.shape[0]:("radius"in a&&(g=a.radius|0),"width"in a?g=a.width|0:"height"in a&&(g=a.height|0));if("color"in a||"colors"in a)m=a.color||a.colors,Array.isArray(m);m||("colorCount"in a&&(p=a.colorCount|0),"colorType"in a&&(n=a.colorType),"colorFormat"in a&&(f=a.colorFormat));"depth"in a&&(k.depth=a.depth);"stencil"in a&&
(k.stencil=a.stencil);"depthStencil"in a&&(k.depthStencil=a.depthStencil)}else g=1;if(m)if(Array.isArray(m))for(a=[],f=0;f<m.length;++f)a[f]=m[f];else a=[m];else for(a=Array(p),m={radius:g,format:f,type:n},f=0;f<p;++f)a[f]=h.createCube(m);k.color=Array(a.length);for(f=0;f<a.length;++f)p=a[f],g=g||p.width,k.color[f]={target:34069,data:a[f]};for(f=0;6>f;++f){for(p=0;p<a.length;++p)k.color[p].target=34069+f;0<f&&(k.depth=c[0].depth,k.stencil=c[0].stencil,k.depthStencil=c[0].depthStencil);if(c[f])c[f](k);
else c[f]=V(k)}return d(b,{width:g,height:g,color:a})}var c=Array(6);b(a);return d(b,{faces:c,resize:function(a){var d=a|0;if(d===b.width)return b;var f=b.color;for(a=0;a<f.length;++a)f[a].resize(d);for(a=0;6>a;++a)c[a].resize(d);b.width=b.height=d;return b},_reglType:"framebufferCube",destroy:function(){c.forEach(function(a){a.destroy()})}})},clear:function(){g(M).forEach(a)},restore:function(){g(M).forEach(function(a){a.framebuffer=f.createFramebuffer();p(a)})}})}},{"./util/extend":23,"./util/values":31}],
...
0;d<b.length;++d)if(b[d].id===c.id){b[d].location=c.location;return}b.push(c)}function u(b,c,f){f=35632===b?z:n;var g=f[c];if(!g){var q=h.str(c),g=d.createShader(b);d.shaderSource(g,q);d.compileShader(g);f[c]=g}return g}function A(b,c){this.id=E++;this.fragId=b;this.vertId=c;this.program=null;this.uniforms=[];this.attributes=[];f.profile&&(this.stats={uniformsCount:0,attributesCount:0})}function I(g,n){var q,l;q=u(35632,g.fragId);l=u(35633,g.vertId);var x=g.program=d.createProgram();d.attachShader(x,
q);d.attachShader(x,l);d.linkProgram(x);var a=d.getProgramParameter(x,35718);f.profile&&(g.stats.uniformsCount=a);var p=g.uniforms;for(q=0;q<a;++q)if(l=d.getActiveUniform(x,q))if(1<l.size)for(var z=0;z<l.size;++z){var A=l.name.replace("[0]","["+z+"]");b(p,new c(A,h.id(A),d.getUniformLocation(x,A),l))}else b(p,new c(l.name,h.id(l.name),d.getUniformLocation(x,l.name),l));a=d.getProgramParameter(x,35721);f.profile&&(g.stats.attributesCount=a);p=g.attributes;for(q=0;q<a;++q)(l=d.getActiveAttrib(x,q))&&
b(p,new c(l.name,h.id(l.name),d.getAttribLocation(x,l.name),l))}var z={},n={},q={},J=[],E=0;f.profile&&(l.getMaxUniformsCount=function(){var b=0;J.forEach(function(c){c.stats.uniformsCount>b&&(b=c.stats.uniformsCount)});return b},l.getMaxAttributesCount=function(){var b=0;J.forEach(function(c){c.stats.attributesCount>b&&(b=c.stats.attributesCount)});return b});return{clear:function(){var b=d.deleteShader.bind(d);g(z).forEach(b);z={};g(n).forEach(b);n={};J.forEach(function(b){d.deleteProgram(b.program)});
J.length=0;q={};l.shaderCount=0},program:function(b,c,d){l.shaderCount++;var f=q[c];f||(f=q[c]={});var g=f[b];g||(g=new A(c,b),I(g,d),f[b]=g,J.push(g));return g},restore:function(){z={};n={};for(var b=0;b<J.length;++b)I(J[b])},shader:u,frag:-1,vert:-1}}},{"./util/values":31}],17:[function(h,l,w){l.exports=function(){return{bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0,maxTextureUnits:0}}},{}],18:[function(h,l,w){l.exports=function(){var g=
{"":0},d=[""];return{id:function(h){var l=g[h];if(l)return l;l=g[h]=d.length;d.push(h);return l},str:function(g){return d[g]}}}},{}],19:[function(h,l,w){function g(a){return Array.isArray(a)&&(0===a.length||"number"===typeof a[0])}function d(a){return Array.isArray(a)&&0!==a.length&&q(a[0])?!0:!1}function C(a){return Object.prototype.toString.call(a)}function x(a){if(!a)return!1;var b=C(a);return 0<=L.indexOf(b)?!0:g(a)||d(a)||I(a)}function f(a,b){36193===a.type?(a.data=n(b),z.freeType(b)):a.data=
b}function c(a,b,c,d,f,g){a="undefined"!==typeof G[a]?G[a]:m[a]*F[b];g&&(a*=6);if(f){for(d=0;1<=c;)d+=a*c*c,c/=2;return d}return a*c*d}var b=h("./util/extend"),u=h("./util/values"),A=h("./util/is-typed-array"),I=h("./util/is-ndarray"),z=h("./util/pool"),n=h("./util/to-half-float"),q=h("./util/is-array-like");w=h("./constants/arraytypes.json");var J=h("./constants/arraytypes.json"),E=[9984,9986,9985,9987],k=[0,6409,6410,6407,6408],m={};m[6409]=m[6406]=m[6402]=1;m[34041]=m[6410]=2;m[6407]=m[35904]=
...
a.data=m;break;case 36193:a.data=n(h)}a.alignment=1;a.needsFree=!0}else if(I(c)){h=c.data;Array.isArray(h)||5121!==a.type||(a.type=J[Object.prototype.toString.call(h)]|0);var m=c.shape,p=c.stride,l,u,r,D;3===m.length?(r=m[2],D=p[2]):D=r=1;l=m[0];u=m[1];m=p[0];p=p[1];a.alignment=1;a.width=l;a.height=u;a.channels=r;a.format=a.internalformat=k[r];a.needsFree=!0;l=D;c=c.offset;r=a.width;D=a.height;u=a.channels;for(var E=z.allocType(36193===a.type?5126:a.type,r*D*u),w=0,V=0;V<D;++V)for(var M=0;M<r;++M)for(var y=
0;y<u;++y)E[w++]=h[m*M+p*V+l*y+c];f(a,E)}else if("[object HTMLCanvasElement]"===C(c)||"[object CanvasRenderingContext2D]"===C(c))"[object HTMLCanvasElement]"===C(c)?a.element=c:a.element=c.canvas,a.width=a.element.width,a.height=a.element.height;else if("[object HTMLImageElement]"===C(c))a.element=c,a.width=c.naturalWidth,a.height=c.naturalHeight;else if("[object HTMLVideoElement]"===C(c))a.element=c,a.width=c.videoWidth,a.height=c.videoHeight,a.needsPoll=!0;else if(d(c)){h=c[0].length;m=c.length;
p=1;if(q(c[0][0])){l=p=c[0][0].length;r=z.allocType(36193===a.type?5126:a.type,h*m*l);for(u=D=0;u<m;++u)for(E=c[u],w=0;w<h;++w)for(V=E[w],M=0;M<l;++M)r[D++]=V[M];f(a,r)}else{l=z.allocType(36193===a.type?5126:a.type,h*m);for(D=r=0;D<m;++D)for(u=c[D],E=0;E<h;++E)l[r++]=u[E];f(a,l)}a.alignment=1;a.width=h;a.height=m;a.channels=p;a.format=a.internalformat=k[p];a.needsFree=!0}}function aa(b,c,d,f,g){var k=b.element,h=b.data,n=b.internalformat,m=b.format,p=b.type,l=b.width,q=b.height;ka(b);k?a.texSubImage2D(c,
g,d,f,m,p,k):b.compressed?a.compressedTexSubImage2D(c,g,d,f,n,l,q,h):b.needsCopy?(w(),a.copyTexSubImage2D(c,g,d,f,b.xOffset,b.yOffset,l,q)):a.texSubImage2D(c,g,d,f,l,q,m,p,h)}function ba(){return Ca.pop()||new qa}function ha(a){a.needsFree&&z.freeType(a.data);qa.call(a);Ca.push(a)}function W(){L.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function P(a,b,c){var d=a.images[0]=ba();a.mipmask=1;d.width=a.width=b;d.height=a.height=c}function H(a,b){var c=null;
if(x(b))c=a.images[0]=ba(),M(c,a),r(c,b),a.mipmask=1;else if(N(a,b),Array.isArray(b.mipmap))for(var d=b.mipmap,f=0;f<d.length;++f)c=a.images[f]=ba(),M(c,a),c.width>>=f,c.height>>=f,r(c,d[f]),a.mipmask|=1<<f;else c=a.images[0]=ba(),M(c,a),r(c,b),a.mipmask=1;M(a,a.images[0])}function ua(b,c){for(var d=b.images,f=0;f<d.length&&d[f];++f){var g=d[f],k=c,h=f,n=g.element,m=g.data,p=g.internalformat,l=g.format,q=g.type,r=g.width,u=g.height;ka(g);n?a.texImage2D(k,h,l,l,q,n):g.compressed?a.compressedTexImage2D(k,
h,p,r,u,0,m):g.needsCopy?(w(),a.copyTexImage2D(k,h,l,g.xOffset,g.yOffset,r,u,0)):a.texImage2D(k,h,l,r,u,0,l,q,m)}}function la(){var a=Ja.pop()||new W;L.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function va(a){for(var b=a.images,c=0;c<b.length;++c)b[c]&&ha(b[c]),b[c]=null;Ja.push(a)}function R(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;this.mipmapHint=4352}function da(a,b){"min"in b&&(a.minFilter=ia[b.min],0<=E.indexOf(a.minFilter)&&
...
(f.stats=g.stats);f.destroy=function(){g.decRef()};return f},createCube:function(b,d,f,g,k,h){function n(a,b,d,e,f,g){var k,h=m.texInfo;R.call(h);for(k=0;6>k;++k)p[k]=la();if("number"===typeof a||!a)for(a=a|0||1,k=0;6>k;++k)P(p[k],a,a);else if("object"===typeof a)if(b)H(p[0],a),H(p[1],b),H(p[2],d),H(p[3],e),H(p[4],f),H(p[5],g);else if(da(h,a),N(m,a),"faces"in a)for(a=a.faces,k=0;6>k;++k)M(p[k],m),H(p[k],a[k]);else for(k=0;6>k;++k)H(p[k],a);M(m,p[0]);m.mipmask=h.genMipmaps?(p[0].width<<1)-1:p[0].mipmask;
m.internalformat=p[0].internalformat;n.width=p[0].width;n.height=p[0].height;fa(m);for(k=0;6>k;++k)ua(p[k],34069+k);ea(h,34067);X();D.profile&&(m.stats.size=c(m.internalformat,m.type,n.width,n.height,h.genMipmaps,!0));for(k=0;6>k;++k)va(p[k]);return n}var m=new oa(34067);ja[m.id]=m;G.cubeCount++;var p=Array(6);n(b,d,f,g,k,h);n.subimage=function(a,b,c,d,e){c|=0;d|=0;e|=0;var f=ba();M(f,m);f.width>>=e;f.height>>=e;f.width-=c;f.height-=d;r(f,b);fa(m);aa(f,34069+a,c,d,e);X();ha(f);return n};n.resize=
...
c);break;default:throw Error("Unsupported FourCC code: "+String.fromCharCode(h&255,h>>8&255,h>>16&255,h>>24&255));}var l=b[2],z=1;l&131072&&(z=Math.max(1,b[7]));var n=!1;b[28]&512&&(n=!0);var q=b[4],w=b[3],b=b[1]+4,E=q,k=w,m=[];h===f&&(b+=20);if(n)for(g=0;6>g;g++){if("rgba32f"!==c)throw Error("Only RGBA32f cubemaps are supported");for(var q=E,w=k,L=Math.log(q)/Math.log(2)+1,F=0;F<L;F++)h=q*w*16,m.push({offset:b,length:h,shape:[q,w]}),F<z&&(b+=h),q=Math.floor(q/2),w=Math.floor(w/2)}else for(F=0;F<
z;F++)h=Math.max(4,q)/4*Math.max(4,w)/4*g,m.push({offset:b,length:h,shape:[q,w]}),b+=h,q=Math.floor(q/2),w=Math.floor(w/2);return{shape:[E,k],images:m,format:c,flags:l,cubemap:n}}},{}],34:[function(h,l,w){function g(b){throw Error("resl: "+b);}function d(b,c,d){Object.keys(b).forEach(function(b){0>c.indexOf(b)&&g('invalid parameter "'+b+'" in '+d)})}function C(b,c){this.state=0;this.ready=!1;this.progress=0;this.name=b;this.cancel=c}var x=["manifest","onDone","onProgress","onError"],f=["type","src",
"stream","credentials","parser"],c=["onData","onDone"];l.exports=function(b){function h(a,c){if(a in b){var d=b[a];"function"!==typeof d&&g('invalid callback "'+a+'"');return d}return null}function l(a){function b(){if(!(2>h.readyState||1===q.state||-1===q.state)){if(200!==h.status)return z('error loading resource "'+a.name+'"');if(2<h.readyState&&0===q.state){var d;d="binary"===a.type?h.response:h.responseText;if(g.data)try{k=g.data(d)}catch(f){return z(f)}else k=d}if(3<h.readyState&&0===q.state){if(g.done)try{k=
g.done()}catch(f){return z(f)}q.state=1}m[c]=k;q.progress=.75*q.progress+.25;q.ready=a.stream&&!!k||1===q.state;n()}}var c=a.name,d=a.stream,f="binary"===a.type,g=a.parser,h=new XMLHttpRequest,k=null,q=new C(c,function(){1!==q.state&&-1!==q.state&&(h.onreadystatechange=null,h.abort(),q.state=-1)});h.onreadystatechange=d?b:function(){4===h.readyState&&b()};f&&(h.responseType="arraybuffer");a.credentials&&(h.withCredentials=!0);h.open("GET",a.src,!0);h.send();return q}function w(a,b){function c(){if(0===
q.state)if(l.data)try{u=l.data(b)}catch(a){return z(a)}else u=b}function d(b){c();m[k]=u;q.progress=b.lengthComputable?Math.max(q.progress,b.loaded/b.total):.75*q.progress+.25;q.ready=a.stream;n(k)}function f(){c();if(0===q.state){if(l.done)try{u=l.done()}catch(a){return z(a)}q.state=1}q.progress=1;q.ready=!0;m[k]=u;h();n("finish "+k)}function g(){z('error loading asset "'+k+'"')}function h(){a.stream&&b.removeEventListener("progress",d);"image"===a.type?b.addEventListener("load",f):b.addEventListener("canplay",
f);b.removeEventListener("error",g)}var k=a.name,l=a.parser,q=new C(k,function(){1!==q.state&&-1!==q.state&&(q.state=-1,h(),b.src="")}),u=b;a.stream&&b.addEventListener("progress",d);if("image"===a.type)b.addEventListener("load",f);else{var x=!1,r=!1;b.addEventListener("loadedmetadata",function(){r=!0;x&&f()});b.addEventListener("canplay",function(){x=!0;r&&f()})}b.addEventListener("error",g);b.crossOrigin=a.credentials?"use-credentials":"anonymous";b.src=a.src;return q}function z(a){-1!==L&&1!==
L&&(L=-1,G.forEach(function(a){a.cancel()}),k?"string"===typeof a?k(Error("resl: "+a)):k(a):console.error("resl error:",a))}function n(a){if(-1!==L&&1!==L){var b=0,c=0;G.forEach(function(a){a.ready&&(c+=1);b+=a.progress});c===G.length?(L=1,J(m)):E&&E(b/G.length,a)}}"object"===typeof b&&b||g("invalid or missing configuration");d(b,x,"config");var q=b.manifest;"object"===typeof q&&q||g("missing manifest");var J=h("onDone");J||g("missing onDone() callback");var E=h("onProgress"),k=h("onError"),m={},
L=0,F={text:l,binary:function(a){return l(a)},image:function(a){return w(a,document.createElement("img"))},video:function(a){return w(a,document.createElement("video"))},audio:function(a){return w(a,document.createElement("audio"))}},G=Object.keys(q).map(function(a){function b(a,c){if(a in h.parser){var d=h.parser[a];"function"!==typeof d&&g("invalid parser callback "+a+' for asset "'+a+'"');return d}return c}var h=q[a];"string"===typeof h?h={src:h}:"object"===typeof h&&h||g('invalid asset definition "'+
a+'"');d(h,f,'asset "'+a+'"');var k={};"parser"in h&&("function"===typeof h.parser?k={data:h.parser}:"object"===typeof h.parser&&h.parser?(d(k,c,'parser for asset "'+a+'"'),"onData"in k||g('missing onData callback for parser in asset "'+a+'"'),k={data:b("onData"),done:b("onDone")}):g('invalid parser for asset "'+a+'"'));return{name:a,type:function(b,c,d){b in h&&(d=h[b]);0>c.indexOf(d)&&g("invalid "+b+' "'+d+'" for asset "'+a+'", possible values: '+c);return d}("type",Object.keys(F),"text"),stream:!!h.stream,
credentials:!!h.credentials,src:function(b,c,d){b in h?d=h[b]:c&&g("missing "+b+' for asset "'+a+'"');"string"!==typeof d&&g("invalid "+b+' for asset "'+a+'", must be a string');return d}("src",!0,""),parser:k}}).map(function(a){return F[a.type](a)})}},{}],35:[function(h,l,w){function g(a,b){for(var c=0;c<a.length;++c)if(a[c]===b)return c;return-1}var d=h("./lib/util/extend"),C=h("./lib/dynamic"),x=h("./lib/util/raf"),f=h("./lib/util/clock"),c=h("./lib/strings"),b=h("./lib/webgl"),u=h("./lib/extension"),
A=h("./lib/limits"),I=h("./lib/buffer"),z=h("./lib/elements"),n=h("./lib/texture"),q=h("./lib/renderbuffer"),J=h("./lib/framebuffer"),E=h("./lib/attribute"),k=h("./lib/shader"),m=h("./lib/read"),L=h("./lib/core"),F=h("./lib/stats"),G=h("./lib/timer");l.exports=function(a){function h(){if(0===Q.length)H&&H.update(),ca=null;else{ca=x.next(h);N();for(var a=Q.length-1;0<=a;--a){var b=Q[a];b&&b(R,null,0)}r.flush();H&&H.update()}}function l(){!ca&&0<Q.length&&(ca=x.next(h))}function w(){ca&&(x.cancel(h),
ca=null)}function Ea(a){a.preventDefault();w();U.forEach(function(a){a()})}function wa(a){r.getError();ba.restore();fa.restore();ea.restore();X.restore();pa.restore();na.restore();H&&H.restore();S.procs.refresh();l();Y.forEach(function(a){a()})}function D(a){function b(a){var c={},d={};Object.keys(a).forEach(function(b){var e=a[b];C.isDynamic(e)?d[b]=C.unbox(e,b):c[b]=e});return{dynamic:d,"static":c}}function c(a){for(;n.length<a;)n.push(null);return n}var f=b(a.context||{}),g=b(a.uniforms||{}),h=
b(a.attributes||{}),k=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}var c=d({},a);delete c.uniforms;delete c.attributes;delete c.context;"stencil"in c&&c.stencil.op&&(c.stencil.opBack=c.stencil.opFront=c.stencil.op,delete c.stencil.op);b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");return c}(a));a={gpuTime:0,cpuTime:0,count:0};var f=S.compile(k,h,g,f,a),l=f.draw,e=f.batch,m=f.scope,n=[];
return d(function(a,b){var d;if("function"===typeof a)return m.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(d=0;d<a;++d)m.call(this,null,b,d);else if(Array.isArray(a))for(d=0;d<a.length;++d)m.call(this,a[d],b,d);else return m.call(this,a,b,0);else if("number"===typeof a){if(0<a)return e.call(this,c(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return e.call(this,a,a.length)}else return l.call(this,a)},{stats:a})}function Fa(a){Q.push(a);l();return{cancel:function(){function b(){var a=
g(Q,b);Q[a]=Q[Q.length-1];--Q.length;0>=Q.length&&w()}var c=g(Q,a);Q[c]=b}}}function M(){var a=ga.viewport,b=ga.scissor_box;a[0]=a[1]=b[0]=b[1]=0;R.viewportWidth=R.framebufferWidth=R.drawingBufferWidth=a[2]=b[2]=r.drawingBufferWidth;R.viewportHeight=R.framebufferHeight=R.drawingBufferHeight=a[3]=b[3]=r.drawingBufferHeight}function N(){R.tick+=1;R.time=qa();M();S.procs.poll()}function ka(){M();S.procs.refresh();H&&H.update()}function qa(){return(f()-ua)/1E3}a=b(a);if(!a)return null;var r=a.gl,aa=r.getContextAttributes();
r.isContextLost();var ba=u(r,a);if(!ba)return null;var ha=c(),W=F(),P=ba.extensions,H=G(r,P),ua=f(),la=r.drawingBufferWidth,va=r.drawingBufferHeight,R={tick:0,time:0,viewportWidth:la,viewportHeight:va,framebufferWidth:la,framebufferHeight:va,drawingBufferWidth:la,drawingBufferHeight:va,pixelRatio:a.pixelRatio},da=A(r,P),ea=I(r,W,a),oa=z(r,P,ea,W),la=E(r,P,da,ea,ha),fa=k(r,ha,W,a),X=n(r,P,da,function(){S.procs.poll()},R,W,a),pa=q(r,P,da,W,a),na=J(r,P,da,X,pa,W),S=L(r,ha,P,da,ea,oa,X,na,{},la,fa,{elements:null,
primitive:4,count:-1,offset:0,instances:-1},R,H,a),ha=m(r,na,S.procs.poll,R,aa,P),ga=S.next,ia=r.canvas,Q=[],U=[],Y=[],Z=[a.onDestroy],ca=null;ia&&(ia.addEventListener("webglcontextlost",Ea,!1),ia.addEventListener("webglcontextrestored",wa,!1));ka();aa=d(D,{clear:function(a){var b=0;S.procs.poll();var c=a.color;c&&(r.clearColor(+c[0]||0,+c[1]||0,+c[2]||0,+c[3]||0),b|=16384);"depth"in a&&(r.clearDepth(+a.depth),b|=256);"stencil"in a&&(r.clearStencil(a.stencil|0),b|=1024);r.clear(b)},prop:C.define.bind(null,
1),context:C.define.bind(null,2),"this":C.define.bind(null,3),draw:D({}),buffer:function(a){return ea.create(a,34962,!1,!1)},elements:function(a){return oa.create(a,!1)},texture:X.create2D,cube:X.createCube,renderbuffer:pa.create,framebuffer:na.create,framebufferCube:na.createCube,attributes:aa,frame:Fa,on:function(a,b){var c;switch(a){case "frame":return Fa(b);case "lost":c=U;break;case "restore":c=Y;break;case "destroy":c=Z}c.push(b);return{cancel:function(){for(var a=0;a<c.length;++a)if(c[a]===
b){c[a]=c[c.length-1];c.pop();break}}}},limits:da,hasExtension:function(a){return 0<=da.extensions.indexOf(a.toLowerCase())},read:ha,destroy:function(){Q.length=0;w();ia&&(ia.removeEventListener("webglcontextlost",Ea),ia.removeEventListener("webglcontextrestored",wa));fa.clear();na.clear();pa.clear();X.clear();oa.clear();ea.clear();H&&H.clear();Z.forEach(function(a){a()})},_gl:r,_refresh:ka,poll:function(){N();H&&H.update()},now:qa,stats:W});a.onDone(null,aa);return aa}},{"./lib/attribute":2,"./lib/buffer":3,
