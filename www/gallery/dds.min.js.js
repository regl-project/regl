...
k:u.freeType(k)):"number"===typeof b[0]?(a.dimension=n,k=u.allocType(a.dtype,b.length),d(k,b),m(a,k,q),p?a.persistentData=k:u.freeType(k)):f(b[0])&&(a.dimension=b[0].length,a.dtype=k||g(b[0])||5126,k=u.allocType(a.dtype,b.length*a.dimension),x(k,b,a.dimension),m(a,k,q),p?a.persistentData=k:u.freeType(k)));else if(f(b))a.dtype=k||g(b),a.dimension=n,m(a,b,q),p&&(a.persistentData=new Uint8Array(new Uint8Array(b.buffer)));else if(c(b)){var h=b.shape,O=b.stride;n=b.offset;var F=0,y=0,r=0,aa=0;1===h.length?
(F=h[0],y=1,r=O[0],aa=0):2===h.length&&(F=h[0],y=h[1],r=O[0],aa=O[1]);a.dtype=k||g(b.data)||5126;a.dimension=y;k=u.allocType(a.dtype,F*y);C(k,b.data,F,y,r,aa,n);m(a,k,q);p?a.persistentData=k:u.freeType(k)}}function F(b){h.bufferCount--;p.deleteBuffer(b.buffer);b.buffer=null;delete a[b.id]}var G=0,a={};k.prototype.bind=function(){p.bindBuffer(this.type,this.buffer)};k.prototype.destroy=function(){F(this)};var q=[];E.profile&&(h.getTotalBufferSize=function(){var b=0;Object.keys(a).forEach(function(c){b+=
a[c].stats.size});return b});return{create:function(b,q,m,G){function l(a){var b=35044,d=null,k=0,g=0,q=1;Array.isArray(a)||f(a)||c(a)?d=a:"number"===typeof a?k=a|0:a&&("data"in a&&(d=a.data),"usage"in a&&(b=y[a.usage]),"type"in a&&(g=I[a.type]),"dimension"in a&&(q=a.dimension|0),"length"in a&&(k=a.length|0));z.bind();d?L(z,d,b,g,q,G):(p.bufferData(z.type,k,b),z.dtype=g||5121,z.usage=b,z.dimension=q,z.byteLength=k);E.profile&&(z.stats.size=z.byteLength*n[z.dtype]);return l}h.bufferCount++;var z=new k(q);
a[z.id]=z;m||l(b);l._reglType="buffer";l._buffer=z;l.subdata=function(a,b){var k=(b||0)|0;z.bind();if(Array.isArray(a)){if(0<a.length)if("number"===typeof a[0]){var q=u.allocType(z.dtype,a.length);d(q,a);p.bufferSubData(z.type,k,q);u.freeType(q)}else if(Array.isArray(a[0])||f(a[0])){var q=a[0].length,r=u.allocType(z.dtype,a.length*q);x(r,a,q);p.bufferSubData(z.type,k,r);u.freeType(r)}}else if(f(a))p.bufferSubData(z.type,k,a);else if(c(a)){var m=a.shape,n=a.stride,h=r=q=0,V=0;1===m.length?(q=m[0],
r=1,h=n[0],V=0):2===m.length&&(q=m[0],r=m[1],h=n[0],V=n[1]);m=Array.isArray(a.data)?z.dtype:g(a.data);m=u.allocType(m,q*r);C(m,a.data,q,r,h,V,a.offset);p.bufferSubData(z.type,k,m);u.freeType(m)}return l};E.profile&&(l.stats=z.stats);l.destroy=function(){F(z)};return l},createStream:function(a,b){var c=q.pop();c||(c=new k(a));c.bind();L(c,b,35040,0,1,!1);return c},destroyStream:function(a){q.push(a)},clear:function(){b(a).forEach(F);q.forEach(F)},getBuffer:function(a){return a&&a._buffer instanceof
...
invert:5386},G={cw:2304,ccw:2305},a=new C(!1,!1,!1,function(){});l.exports=function(q,h,z,l,I,D,w,M,O,ka,qa,r,aa,ba,ha){function W(a){return a.replace(".","_")}function P(a,e,b){var c=W(a);Ga.push(a);za[c]=ra[c]=!!b;sa[c]=e}function H(a,e,b){var c=W(a);Ga.push(a);Array.isArray(b)?(ra[c]=b.slice(),za[c]=b.slice()):ra[c]=za[c]=b;ta[c]=e}function ua(){var a=b(),e=a.link,c=a.global;a.id=Ma++;a.batchId="0";var f=e(La),k=a.shared={props:"a0"};Object.keys(La).forEach(function(a){k[a]=c.def(f,".",a)});var d=
a.next={},T=a.current={};Object.keys(ta).forEach(function(a){Array.isArray(ra[a])&&(d[a]=c.def(k.next,".",a),T[a]=c.def(k.current,".",a))});var Na=a.constants={};Object.keys(Ha).forEach(function(a){Na[a]=c.def(JSON.stringify(Ha[a]))});a.invoke=function(B,N){switch(N.type){case 0:var b=["this",k.context,k.props,a.batchId];return B.def(e(N.data),".call(",b.slice(0,Math.max(N.data.length+1,4)),")");case 1:return B.def(k.props,N.data);case 2:return B.def(k.context,N.data);case 3:return B.def("this",N.data);
case 4:return N.data.append(a,B),N.data.ref}};a.attribCache={};var B={};a.scopeAttrib=function(a){a=h.id(a);if(a in B)return B[a];var b=ka.scope[a];b||(b=ka.scope[a]=new t);return B[a]=e(b)};return a}function la(a){var e=a["static"];a=a.dynamic;var b;if("profile"in e){var k=!!e.profile;b=f(function(a,e){return k});b.enable=k}else if("profile"in a){var d=a.profile;b=c(d,function(a,e){return a.invoke(e,d)})}return b}function va(a,e){var b=a["static"],k=a.dynamic;if("framebuffer"in b){var d=b.framebuffer;
...
b=a.shared,N=b.framebuffer,B=e.def(N,".getFramebuffer(",B,")");e.set(N,".next",B);b=b.context;e.set(b,".framebufferWidth",B+"?"+B+".width:"+b+".drawingBufferWidth");e.set(b,".framebufferHeight",B+"?"+B+".height:"+b+".drawingBufferHeight");return B})}return null}function R(a,e,b){function f(a){if(a in k){var B=k[a];a=!0;var b=B.x|0,N=B.y|0,A,g;"width"in B?A=B.width|0:a=!1;"height"in B?g=B.height|0:a=!1;return new C(!a&&e&&e.thisDep,!a&&e&&e.contextDep,!a&&e&&e.propDep,function(a,e){var c=a.shared.context,
K=A;"width"in B||(K=e.def(c,".","framebufferWidth","-",b));var f=g;"height"in B||(f=e.def(c,".","framebufferHeight","-",N));return[b,N,K,f]})}if(a in d){var T=d[a];a=c(T,function(a,e){var B=a.invoke(e,T),b=a.shared.context,N=e.def(B,".x|0"),c=e.def(B,".y|0"),A=e.def('"width" in ',B,"?",B,".width|0:","(",b,".","framebufferWidth","-",N,")"),B=e.def('"height" in ',B,"?",B,".height|0:","(",b,".","framebufferHeight","-",c,")");return[N,c,A,B]});e&&(a.thisDep=a.thisDep||e.thisDep,a.contextDep=a.contextDep||
e.contextDep,a.propDep=a.propDep||e.propDep);return a}return e?new C(e.thisDep,e.contextDep,e.propDep,function(a,e){var B=a.shared.context;return[0,0,e.def(B,".","framebufferWidth"),e.def(B,".","framebufferHeight")]}):null}var k=a["static"],d=a.dynamic;if(a=f("viewport")){var g=a;a=new C(a.thisDep,a.contextDep,a.propDep,function(a,e){var b=g.append(a,e),N=a.shared.context;e.set(N,".viewportWidth",b[2]);e.set(N,".viewportHeight",b[3]);return b})}return{viewport:a,scissor_box:f("scissor.box")}}function da(a){function e(a){if(a in
b){var B=h.id(b[a]);a=f(function(){return B});a.id=B;return a}if(a in k){var A=k[a];return c(A,function(a,e){var B=a.invoke(e,A);return e.def(a.shared.strings,".id(",B,")")})}return null}var b=a["static"],k=a.dynamic,d=e("frag"),g=e("vert"),T=null;x(d)&&x(g)?(T=qa.program(g.id,d.id),a=f(function(a,e){return a.link(T)})):a=new C(d&&d.thisDep||g&&g.thisDep,d&&d.contextDep||g&&g.contextDep,d&&d.propDep||g&&g.propDep,function(a,e){var b=a.shared.shader,N;N=d?d.append(a,e):e.def(b,".","frag");var c;c=
g?g.append(a,e):e.def(b,".","vert");return e.def(b+".program("+c+","+N+")")});return{frag:d,vert:g,progVar:a,program:T}}function ea(a,e){function b(a,e){if(a in d){var A=d[a]|0;return f(function(a,b){e&&(a.OFFSET=A);return A})}if(a in k){var N=k[a];return c(N,function(a,b){var c=a.invoke(b,N);e&&(a.OFFSET=c);return c})}return e&&t?f(function(a,e){a.OFFSET="0";return 0}):null}var d=a["static"],k=a.dynamic,t=function(){if("elements"in d){var a=d.elements;g(a)?a=D.getElements(D.create(a,!0)):a&&(a=D.getElements(a));
var e=f(function(e,b){if(a){var B=e.link(a);return e.ELEMENTS=B}return e.ELEMENTS=null});e.value=a;return e}if("elements"in k){var b=k.elements;return c(b,function(a,e){var B=a.shared,c=B.isBufferArgs,B=B.elements,A=a.invoke(e,b),K=e.def("null"),c=e.def(c,"(",A,")"),A=a.cond(c).then(K,"=",B,".createStream(",A,");")["else"](K,"=",B,".getElements(",A,");");e.entry(A);e.exit(a.cond(c).then(B,".destroyStream(",K,");"));return a.ELEMENTS=K})}return null}(),T=b("offset",!0);return{elements:t,primitive:function(){if("primitive"in
d){var a=d.primitive;return f(function(e,b){return p[a]})}if("primitive"in k){var e=k.primitive;return c(e,function(a,b){var c=a.constants.primTypes,A=a.invoke(b,e);return b.def(c,"[",A,"]")})}return t?x(t)?t.value?f(function(a,e){return e.def(a.ELEMENTS,".primType")}):f(function(){return 4}):new C(t.thisDep,t.contextDep,t.propDep,function(a,e){var b=a.ELEMENTS;return e.def(b,"?",b,".primType:",4)}):null}(),count:function(){if("count"in d){var a=d.count|0;return f(function(){return a})}if("count"in
...
offset:T}}function oa(a,e){var b=a["static"],d=a.dynamic,k={};Ga.forEach(function(a){function e(B,K){if(a in b){var N=B(b[a]);k[A]=f(function(){return N})}else if(a in d){var g=d[a];k[A]=c(g,function(a,e){return K(a,e,a.invoke(e,g))})}}var A=W(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return e(function(a){return a},function(a,
e,b){return b});case "depth.func":return e(function(a){return L[a]},function(a,e,b){return e.def(a.constants.compareFuncs,"[",b,"]")});case "depth.range":return e(function(a){return a},function(a,e,b){a=e.def("+",b,"[0]");e=e.def("+",b,"[1]");return[a,e]});case "blend.func":return e(function(a){return[m["srcRGB"in a?a.srcRGB:a.src],m["dstRGB"in a?a.dstRGB:a.dst],m["srcAlpha"in a?a.srcAlpha:a.src],m["dstAlpha"in a?a.dstAlpha:a.dst]]},function(a,e,b){function c(a,B){return e.def('"',a,B,'" in ',b,"?",
b,".",a,B,":",b,".",a)}a=a.constants.blendFuncs;var A=c("src","RGB"),K=c("dst","RGB"),A=e.def(a,"[",A,"]"),d=e.def(a,"[",c("src","Alpha"),"]"),K=e.def(a,"[",K,"]");a=e.def(a,"[",c("dst","Alpha"),"]");return[A,K,d,a]});case "blend.equation":return e(function(a){if("string"===typeof a)return[ma[a],ma[a]];if("object"===typeof a)return[ma[a.rgb],ma[a.alpha]]},function(a,e,b){var c=a.constants.blendEquations,A=e.def(),K=e.def();a=a.cond("typeof ",b,'==="string"');a.then(A,"=",K,"=",c,"[",b,"];");a["else"](A,
"=",c,"[",b,".rgb];",K,"=",c,"[",b,".alpha];");e(a);return[A,K]});case "blend.color":return e(function(a){return u(4,function(e){return+a[e]})},function(a,e,b){return u(4,function(a){return e.def("+",b,"[",a,"]")})});case "stencil.mask":return e(function(a){return a|0},function(a,e,b){return e.def(b,"|0")});case "stencil.func":return e(function(a){return[L[a.cmp||"keep"],a.ref||0,"mask"in a?a.mask:-1]},function(a,e,b){a=e.def('"cmp" in ',b,"?",a.constants.compareFuncs,"[",b,".cmp]",":",7680);var c=
e.def(b,".ref|0");e=e.def('"mask" in ',b,"?",b,".mask|0:-1");return[a,c,e]});case "stencil.opFront":case "stencil.opBack":return e(function(e){return["stencil.opBack"===a?1029:1028,F[e.fail||"keep"],F[e.zfail||"keep"],F[e.zpass||"keep"]]},function(e,b,c){function A(a){return b.def('"',a,'" in ',c,"?",K,"[",c,".",a,"]:",7680)}var K=e.constants.stencilOps;return["stencil.opBack"===a?1029:1028,A("fail"),A("zfail"),A("zpass")]});case "polygonOffset.offset":return e(function(a){return[a.factor|0,a.units|
...
e,b){return u(4,function(a){return"!!"+b+"["+a+"]"})});case "sample.coverage":return e(function(a){return["value"in a?a.value:1,!!a.invert]},function(a,e,b){a=e.def('"value" in ',b,"?+",b,".value:1");e=e.def("!!",b,".invert");return[a,e]})}});return k}function fa(a,e){var b=a["static"],d=a.dynamic,k={};Object.keys(b).forEach(function(a){var e=b[a],c;if("number"===typeof e||"boolean"===typeof e)c=f(function(){return e});else if("function"===typeof e){var A=e._reglType;if("texture2d"===A||"textureCube"===
A)c=f(function(a){return a.link(e)});else if("framebuffer"===A||"framebufferCube"===A)c=f(function(a){return a.link(e.color[0])})}else y(e)&&(c=f(function(a){return a.global.def("[",u(e.length,function(a){return e[a]}),"]")}));c.value=e;k[a]=c});Object.keys(d).forEach(function(a){var e=d[a];k[a]=c(e,function(a,b){return a.invoke(b,e)})});return k}function X(a,e){var b=a["static"],d=a.dynamic,k={};Object.keys(b).forEach(function(a){var e=b[a],c=h.id(a),A=new t;if(g(e))A.state=1,A.buffer=I.getBuffer(I.create(e,
34962,!1,!0)),A.type=A.buffer.dtype;else{var K=I.getBuffer(e);if(K)A.state=1,A.buffer=K,A.type=K.dtype;else if(e.constant){var d=e.constant;A.buffer="null";A.state=2;"number"===typeof d?A.x=d:E.forEach(function(a,e){e<d.length&&(A[a]=d[e])})}else{var K=g(e.buffer)?I.getBuffer(I.create(e.buffer,34962,!1,!0)):I.getBuffer(e.buffer),v=e.offset|0,m=e.stride|0,q=e.size|0,r=!!e.normalized,n=0;"type"in e&&(n=J[e.type]);e=e.divisor|0;A.buffer=K;A.state=1;A.size=q;A.normalized=r;A.type=n||K.dtype;A.offset=
v;A.stride=m;A.divisor=e}}k[a]=f(function(a,e){var b=a.attribCache;if(c in b)return b[c];var K={isStream:!1};Object.keys(A).forEach(function(a){K[a]=A[a]});A.buffer&&(K.buffer=a.link(A.buffer));return b[c]=K})});Object.keys(d).forEach(function(a){var e=d[a];k[a]=c(e,function(a,b){function A(a){b(f[a],"=",c,".",a,"|0;")}var c=a.invoke(b,e),K=a.shared,d=K.isBufferArgs,k=K.buffer,f={isStream:b.def(!1)},g=new t;g.state=1;Object.keys(g).forEach(function(a){f[a]=b.def(""+g[a])});var v=f.buffer,m=f.type;
b("if(",d,"(",c,")){",f.isStream,"=true;",v,"=",k,".createStream(",34962,",",c,");",m,"=",v,".dtype;","}else{",v,"=",k,".getBuffer(",c,");","if(",v,"){",m,"=",v,".dtype;",'}else if("constant" in ',c,"){",f.state,"=",2,";","if(typeof "+c+'.constant === "number"){',f[E[0]],"=",c,".constant;",E.slice(1).map(function(a){return f[a]}).join("="),"=0;","}else{",E.map(function(a,e){return f[a]+"="+c+".constant.length>="+e+"?"+c+".constant["+e+"]:0;"}).join(""),"}}else{","if(",d,"(",c,".buffer)){",v,"=",k,
".createStream(",34962,",",c,".buffer);","}else{",v,"=",k,".getBuffer(",c,".buffer);","}",m,'="type" in ',c,"?",K.glTypes,"[",c,".type]:",v,".dtype;",f.normalized,"=!!",c,".normalized;");A("size");A("offset");A("stride");A("divisor");b("}}");b.exit("if(",f.isStream,"){",k,".destroyStream(",v,");","}");return f})});return k}function pa(a){var e=a["static"],b=a.dynamic,d={};Object.keys(e).forEach(function(a){var b=e[a];d[a]=f(function(a,e){return"number"===typeof b||"boolean"===typeof b?""+b:a.link(b)})});
...
".enable(",sa[e],");")["else"](d,".disable(",sa[e],");"),g,".",e,"=",c,";"):m(d,".",ta[e],"(",c,");",g,".",e,"=",c,";")}});0===Object.keys(b.state).length&&v(g,".dirty=false;");e(v)}function Q(a,e,b,c){var f=a.shared,k=a.current,g=f.current,t=f.gl;d(Object.keys(b)).forEach(function(d){var f=b[d];if(!c||c(f)){var v=f.append(a,e);if(sa[d]){var m=sa[d];x(f)?v?e(t,".enable(",m,");"):e(t,".disable(",m,");"):e(a.cond(v).then(t,".enable(",m,");")["else"](t,".disable(",m,");"));e(g,".",d,"=",v,";")}else if(y(v)){var q=
k[d];e(t,".",ta[d],"(",v,");",v.map(function(a,e){return q+"["+e+"]="+a}).join(";"),";")}else e(t,".",ta[d],"(",v,");",g,".",d,"=",v,";")}})}function U(a,e){Aa&&(a.instancing=e.def(a.shared.extensions,".angle_instanced_arrays"))}function Y(a,e,b,c,d){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function k(a){n=e.def();a(n,"=",f(),";");"string"===typeof d?a(m,".count+=",d,";"):a(m,".count++;");ba&&(c?(h=e.def(),a(h,"=",r,".getNumPendingQueries();")):a(r,".beginQuery(",
m,");"))}function g(a){a(m,".cpuTime+=",f(),"-",n,";");ba&&(c?a(r,".pushScopeStats(",h,",",r,".getNumPendingQueries(),",m,");"):a(r,".endQuery();"))}function t(a){var b=e.def(q,".profile");e(q,".profile=",a,";");e.exit(q,".profile=",b,";")}var v=a.shared,m=a.stats,q=v.current,r=v.timer;b=b.profile;var n,h;if(b){if(x(b)){b.enable?(k(e),g(e.exit),t("true")):t("false");return}b=b.append(a,e);t(b)}else b=e.def(q,".profile");v=a.block();k(v);e("if(",b,"){",v,"}");a=a.block();g(a);e.exit("if(",b,"){",a,
...
"1f";break;case 35664:t="2f";break;case 35665:t="3f";break;case 35666:t="4f";break;case 35670:t="1i";break;case 5124:t="1i";break;case 35671:t="2i";break;case 35667:t="2i";break;case 35672:t="3i";break;case 35668:t="3i";break;case 35673:t="4i";break;case 35669:t="4i"}b(g,".uniform",t,"(",m,",",y(q)?Array.prototype.slice.call(q):q,");")}continue}else p=n.append(e,b)}else{if(!f(a))continue;p=b.def(k.uniforms,"[",h.id(q),"]")}35678===r?b("if(",p,"&&",p,'._reglType==="framebuffer"){',p,"=",p,".color[0];",
...
break;case 35675:t="Matrix3fv";break;case 35676:t="Matrix4fv"}b(g,".uniform",t,"(",m,",");if("M"===t.charAt(0)){var m=Math.pow(r-35674+2,2),O=e.global.def("new Float32Array(",m,")");b("false,(Array.isArray(",p,")||",p," instanceof Float32Array)?",p,":(",u(m,function(a){return O+"["+a+"]="+p+"["+a+"]"}),",",O,")")}else 1<q?b(u(q,function(a){return p+"["+a+"]"})):b(p);b(");")}}function ya(a,e,b,c){function d(f){var k=v[f];return k?k.contextDep&&c.contextDynamic||k.propDep?k.append(a,b):k.append(a,e):
e.def(m,".",f)}function f(){function a(){b(u,".drawElementsInstancedANGLE(",[r,p,O,n+"<<(("+O+"-5121)>>1)",h],");")}function e(){b(u,".drawArraysInstancedANGLE(",[r,n,p,h],");")}q?ma?a():(b("if(",q,"){"),a(),b("}else{"),e(),b("}")):e()}function k(){function a(){b(g+".drawElements("+[r,p,O,n+"<<(("+O+"-5121)>>1)"]+");")}function e(){b(g+".drawArrays("+[r,n,p]+");")}q?ma?a():(b("if(",q,"){"),a(),b("}else{"),e(),b("}")):e()}var t=a.shared,g=t.gl,m=t.draw,v=c.draw,q=function(){var d=v.elements,f=e;if(d){if(d.contextDep&&
c.contextDynamic||d.propDep)f=b;d=d.append(a,f)}else d=f.def(m,".","elements");d&&f("if("+d+")"+g+".bindBuffer(34963,"+d+".buffer.buffer);");return d}(),r=d("primitive"),n=d("offset"),p=function(){var d=v.count,f=e;if(d){if(d.contextDep&&c.contextDynamic||d.propDep)f=b;d=d.append(a,f)}else d=f.def(m,".","count");return d}();if("number"===typeof p){if(0===p)return}else b("if(",p,"){"),b.exit("}");var h,u;Aa&&(h=d("instances"),u=a.instancing);var O=q+".type",ma=v.elements&&x(v.elements);Aa&&("number"!==
...
[1029,7680,7680,7680]);P("scissor.enable",3089);H("scissor.box","scissor",[0,0,q.drawingBufferWidth,q.drawingBufferHeight]);H("viewport","viewport",[0,0,q.drawingBufferWidth,q.drawingBufferHeight]);var La={gl:q,context:aa,strings:h,next:za,current:ra,draw:r,elements:D,buffer:I,shader:qa,attributes:ka.state,uniforms:O,framebuffer:M,extensions:z,timer:ba,isBufferArgs:g},Ha={primTypes:p,compareFuncs:L,blendFuncs:m,blendEquations:ma,stencilOps:F,glTypes:J,orientationType:G};Ia&&(Ha.backBuffer=[1029],
...
0;l.exports={DynamicVariable:g,define:function(d,c){return new g(d,C(c+""))},isDynamic:function(d){return"function"===typeof d&&!d._reglType||d instanceof g},unbox:function(d,c){return"function"===typeof d?new g(0,d):d},accessor:C}},{}],10:[function(h,l,w){var g=h("./util/is-typed-array"),d=h("./util/is-ndarray"),C=h("./util/values"),x=h("./constants/primitives.json"),f=h("./constants/usage.json");l.exports=function(c,b,h,z){function l(b){this.id=J++;p[this.id]=this;this.buffer=b;this.primType=4;
this.type=this.vertCount=0}function y(c,f,k,n,a,q,p){(q=p)||g(f)&&(!d(f)||g(f.data))||(q=b.oes_element_index_uint?5125:5123);c.buffer.bind();h._initBuffer(c.buffer,f,k,q,3);f=p;if(!p){switch(c.buffer.dtype){case 5121:case 5120:f=5121;break;case 5123:case 5122:f=5123;break;case 5125:case 5124:f=5125}c.buffer.dtype=f}c.type=f;0>a&&(a=c.buffer.byteLength,5123===f?a>>=1:5125===f&&(a>>=2));c.vertCount=a;a=n;0>n&&(a=4,n=c.buffer.dimension,1===n&&(a=0),2===n&&(a=1),3===n&&(a=4));c.primType=a}function n(b){z.elementsCount--;
delete p[b.id];b.buffer.destroy();b.buffer=null}var p={},J=0,E={uint8:5121,uint16:5123};b.oes_element_index_uint&&(E.uint32=5125);l.prototype.bind=function(){this.buffer.bind()};var k=[];return{create:function(b,k){function p(b){if(b)if("number"===typeof b)C(b),a.primType=4,a.vertCount=b|0,a.type=5121;else{var k=null,m=35044,n=-1,h=-1,u=0,z=0;Array.isArray(b)||g(b)||d(b)?k=b:("data"in b&&(k=b.data),"usage"in b&&(m=f[b.usage]),"primitive"in b&&(n=x[b.primitive]),"count"in b&&(h=b.count|0),"length"in
b&&(u=b.length|0),"type"in b&&(z=E[b.type]));k?y(a,k,m,n,h,u,z):(b=a.buffer,b.bind(),c.bufferData(34963,u,m),b.dtype=z||5121,b.usage=m,b.dimension=3,b.byteLength=u,a.primType=0>n?4:n,a.vertCount=0>h?0:h,a.type=b.dtype)}else C(),a.primType=4,a.vertCount=0,a.type=5121;return p}var C=h.create(null,34963,!0),a=new l(C._buffer);z.elementsCount++;p(b);p._reglType="elements";p._elements=a;p.subdata=function(a,b){C.subdata(a,b);return p};p.destroy=function(){n(a)};return p},createStream:function(b){var c=
k.pop();c||(c=new l(h.create(null,34963,!0,!1)._buffer));y(c,b,35040,-1,-1,0,0);return c},destroyStream:function(b){k.push(b)},getElements:function(b){return"function"===typeof b&&b._elements instanceof l?b._elements:null},clear:function(){C(p).forEach(n)}}}},{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/values":31}],11:[function(h,l,w){l.exports=function(g,d){function h(b){b=b.toLowerCase();var c;try{c=x[b]=g.getExtension(b)}catch(d){}return!!c}
...
1;x[5126]=4;x[36193]=2;l.exports=function(f,c,b,h,z,l){function y(a,b,c){this.target=a;this.texture=b;this.renderbuffer=c;var d=a=0;b?(a=b.width,d=b.height):c&&(a=c.width,d=c.height);this.width=a;this.height=d}function n(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function p(a,b,c){a&&(a.texture?a.texture._texture.refCount+=1:a.renderbuffer._renderbuffer.refCount+=1)}function J(a,b){b?b.texture?f.framebufferTexture2D(36160,a,b.target,b.texture._texture.texture,
0):f.framebufferRenderbuffer(36160,a,36161,b.renderbuffer._renderbuffer.renderbuffer):f.framebufferTexture2D(36160,a,3553,null,0)}function E(a){var b=3553,c=null,d=null,f=a;"object"===typeof a&&(f=a.data,"target"in a&&(b=a.target|0));a=f._reglType;"texture2d"===a?c=f:"textureCube"===a?c=f:"renderbuffer"===a&&(d=f,b=36161);return new y(b,c,d)}function k(a,b,c,d,f){if(c)return a=h.create2D({width:a,height:b,format:d,type:f}),a._texture.refCount=0,new y(3553,a,null);a=z.create({width:a,height:b,format:d});
a._renderbuffer.refCount=0;return new y(36161,null,a)}function m(a){return a&&(a.texture||a.renderbuffer)}function L(a,b,c){a&&(a.texture?a.texture.resize(b,c):a.renderbuffer&&a.renderbuffer.resize(b,c))}function F(){this.id=Fa++;M[this.id]=this;this.framebuffer=f.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=null}function G(a){a.colorAttachments.forEach(n);n(a.depthAttachment);n(a.stencilAttachment);n(a.depthStencilAttachment)}
...
d=0,n=0,h=!0,u=!0;c=null;var z=!0,l="rgba",y="uint8",J=1,F=null,I=null,V=null,L=!1;if("number"===typeof a)d=a|0,n=b|0||d;else if(a){"shape"in a?(n=a.shape,d=n[0],n=n[1]):("radius"in a&&(d=n=a.radius),"width"in a&&(d=a.width),"height"in a&&(n=a.height));if("color"in a||"colors"in a)c=a.color||a.colors,Array.isArray(c);if(!c){"colorCount"in a&&(J=a.colorCount|0);"colorTexture"in a&&(z=!!a.colorTexture,l="rgba4");if("colorType"in a&&(y=a.colorType,!z))if("half float"===y||"float16"===y)l="rgba16f";else if("float"===
y||"float32"===y)l="rgba32f";"colorFormat"in a&&(l=a.colorFormat,0<=Ea.indexOf(l)?z=!0:0<=wa.indexOf(l)&&(z=!1))}if("depthTexture"in a||"depthStencilTexture"in a)L=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?h=a.depth:(F=a.depth,u=!1));"stencil"in a&&("boolean"===typeof a.stencil?u=a.stencil:(I=a.stencil,h=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?h=u=a.depthStencil:(V=a.depthStencil,u=h=!1))}else d=n=1;var D=null,O=null,w=null,M=null;if(Array.isArray(c))D=
c.map(E);else if(c)D=[E(c)];else for(D=Array(J),c=0;c<J;++c)D[c]=k(d,n,z,l,y);d=d||D[0].width;n=n||D[0].height;F?O=E(F):h&&!u&&(O=k(d,n,L,"depth","uint32"));I?w=E(I):u&&!h&&(w=k(d,n,!1,"stencil","uint8"));V?M=E(V):!F&&!I&&u&&h&&(M=k(d,n,L,"depth stencil","depth stencil"));h=null;for(c=0;c<D.length;++c)p(D[c],d,n),D[c]&&D[c].texture&&(u=C[D[c].texture._texture.format]*x[D[c].texture._texture.type],null===h&&(h=u));p(O,d,n);p(w,d,n);p(M,d,n);G(g);g.width=d;g.height=n;g.colorAttachments=D;g.depthAttachment=
O;g.stencilAttachment=w;g.depthStencilAttachment=M;f.color=D.map(m);f.depth=m(O);f.stencil=m(w);f.depthStencil=m(M);f.width=g.width;f.height=g.height;q(g);return f}var g=new F;l.framebufferCount++;f(b,c);return d(f,{resize:function(a,b){var c=a|0,d=b|0||c;if(c===g.width&&d===g.height)return f;for(var k=g.colorAttachments,m=0;m<k.length;++m)L(k[m],c,d);L(g.depthAttachment,c,d);L(g.stencilAttachment,c,d);L(g.depthStencilAttachment,c,d);g.width=f.width=c;g.height=f.height=d;q(g);return f},_reglType:"framebuffer",
...
glsl:g.getParameter(35724),renderer:g.getParameter(7937),vendor:g.getParameter(7936),version:g.getParameter(7938)}}},{}],14:[function(h,l,w){var g=h("./util/is-typed-array");l.exports=function(d,h,x,f,c,b){return function(b){var c;c=null===h.next?5121:h.next.colorAttachments[0].texture._texture.type;var l=0,y=0,n=f.framebufferWidth,p=f.framebufferHeight,J=null;g(b)?J=b:b&&(l=b.x|0,y=b.y|0,n=(b.width||f.framebufferWidth-l)|0,p=(b.height||f.framebufferHeight-y)|0,J=b.data||null);x();b=n*p*4;J||(5121===
c?J=new Uint8Array(b):5126===c&&(J=J||new Float32Array(b)));d.pixelStorei(3333,4);d.readPixels(l,y,n,p,6408,c,J);return J}}},{"./util/is-typed-array":26}],15:[function(h,l,w){var g=h("./util/values"),d=[];d[32854]=2;d[32855]=2;d[36194]=2;d[33189]=2;d[36168]=1;d[34041]=4;d[35907]=4;d[34836]=16;d[34842]=8;d[34843]=6;l.exports=function(h,x,f,c,b){function u(c){this.id=y++;this.refCount=1;this.renderbuffer=c;this.format=32854;this.height=this.width=0;b.profile&&(this.stats={size:0})}function l(b){var d=
b.renderbuffer;h.bindRenderbuffer(36161,null);h.deleteRenderbuffer(d);b.renderbuffer=null;b.refCount=0;delete n[b.id];c.renderbufferCount--}var I={rgba4:32854,rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};x.ext_srgb&&(I.srgba=35907);x.ext_color_buffer_half_float&&(I.rgba16f=34842,I.rgb16f=34843);x.webgl_color_buffer_float&&(I.rgba32f=34836);var y=0,n={};u.prototype.decRef=function(){0>=--this.refCount&&l(this)};b.profile&&(c.getTotalRenderbufferSize=function(){var b=
...
x(b)?c=b:b&&(O(a,b),"x"in b&&(a.xOffset=b.x|0),"y"in b&&(a.yOffset=b.y|0),x(b.data)&&(c=b.data));if(b.copy){var h=F.viewportWidth,m=F.viewportHeight;a.width=a.width||h-a.xOffset;a.height=a.height||m-a.yOffset;a.needsCopy=!0}else if(!c)a.width=a.width||1,a.height=a.height||1;else if(z(c))a.data=c,"type"in b||5121!==a.type||(a.type=J[Object.prototype.toString.call(c)]|0);else if(g(c)){h=c;m=a.width*a.height*a.channels;switch(a.type){case 5121:case 5123:case 5125:case 5126:m=y.allocType(a.type,m);m.set(h);
a.data=m;break;case 36193:a.data=n(h)}a.alignment=1;a.needsFree=!0}else if(I(c)){h=c.data;Array.isArray(h)||5121!==a.type||(a.type=J[Object.prototype.toString.call(h)]|0);var m=c.shape,q=c.stride,l,u,r,D;3===m.length?(r=m[2],D=q[2]):D=r=1;l=m[0];u=m[1];m=q[0];q=q[1];a.alignment=1;a.width=l;a.height=u;a.channels=r;a.format=a.internalformat=k[r];a.needsFree=!0;l=D;c=c.offset;r=a.width;D=a.height;u=a.channels;for(var E=y.allocType(36193===a.type?5126:a.type,r*D*u),w=0,V=0;V<D;++V)for(var M=0;M<r;++M)for(var A=
0;A<u;++A)E[w++]=h[m*M+q*V+l*A+c];f(a,E)}else if("[object HTMLCanvasElement]"===C(c)||"[object CanvasRenderingContext2D]"===C(c))"[object HTMLCanvasElement]"===C(c)?a.element=c:a.element=c.canvas,a.width=a.element.width,a.height=a.element.height;else if("[object HTMLImageElement]"===C(c))a.element=c,a.width=c.naturalWidth,a.height=c.naturalHeight;else if("[object HTMLVideoElement]"===C(c))a.element=c,a.width=c.videoWidth,a.height=c.videoHeight,a.needsPoll=!0;else if(d(c)){h=c[0].length;m=c.length;
q=1;if(p(c[0][0])){l=q=c[0][0].length;r=y.allocType(36193===a.type?5126:a.type,h*m*l);for(u=D=0;u<m;++u)for(E=c[u],w=0;w<h;++w)for(V=E[w],M=0;M<l;++M)r[D++]=V[M];f(a,r)}else{l=y.allocType(36193===a.type?5126:a.type,h*m);for(D=r=0;D<m;++D)for(u=c[D],E=0;E<h;++E)l[r++]=u[E];f(a,l)}a.alignment=1;a.width=h;a.height=m;a.channels=q;a.format=a.internalformat=k[q];a.needsFree=!0}}function aa(b,c,d,f,g){var k=b.element,h=b.data,n=b.internalformat,m=b.format,q=b.type,l=b.width,p=b.height;ka(b);k?a.texSubImage2D(c,
g,d,f,m,q,k):b.compressed?a.compressedTexSubImage2D(c,g,d,f,n,l,p,h):b.needsCopy?(w(),a.copyTexSubImage2D(c,g,d,f,b.xOffset,b.yOffset,l,p)):a.texSubImage2D(c,g,d,f,l,p,m,q,h)}function ba(){return Ca.pop()||new qa}function ha(a){a.needsFree&&y.freeType(a.data);qa.call(a);Ca.push(a)}function W(){L.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function P(a,b,c){var d=a.images[0]=ba();a.mipmask=1;d.width=a.width=b;d.height=a.height=c}function H(a,b){var c=null;
if(x(b))c=a.images[0]=ba(),M(c,a),r(c,b),a.mipmask=1;else if(O(a,b),Array.isArray(b.mipmap))for(var d=b.mipmap,f=0;f<d.length;++f)c=a.images[f]=ba(),M(c,a),c.width>>=f,c.height>>=f,r(c,d[f]),a.mipmask|=1<<f;else c=a.images[0]=ba(),M(c,a),r(c,b),a.mipmask=1;M(a,a.images[0])}function ua(b,c){for(var d=b.images,f=0;f<d.length&&d[f];++f){var g=d[f],k=c,h=f,n=g.element,m=g.data,q=g.internalformat,l=g.format,p=g.type,u=g.width,r=g.height;ka(g);n?a.texImage2D(k,h,l,l,p,n):g.compressed?a.compressedTexImage2D(k,
...
"./util/extend":23,"./util/is-array-like":24,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/pool":28,"./util/to-half-float":30,"./util/values":31}],20:[function(h,l,w){l.exports=function(g,d){function h(){this.endQueryIndex=this.startQueryIndex=-1;this.sum=0;this.stats=null}function l(b,c,d){var f=u.pop()||new h;f.startQueryIndex=b;f.endQueryIndex=c;f.sum=0;f.stats=d;z.push(f)}var f=d.ext_disjoint_timer_query;if(!f)return null;var c=[],b=[],u=[],z=[],I=[],y=[];return{beginQuery:function(d){var g=
c.pop()||f.createQueryEXT();f.beginQueryEXT(35007,g);b.push(g);l(b.length-1,b.length,d)},endQuery:function(){f.endQueryEXT(35007)},pushScopeStats:l,update:function(){var d,g;d=b.length;if(0!==d){y.length=Math.max(y.length,d+1);I.length=Math.max(I.length,d+1);I[0]=0;var h=y[0]=0;for(g=d=0;g<b.length;++g){var l=b[g];f.getQueryObjectEXT(l,34919)?(h+=f.getQueryObjectEXT(l,34918),c.push(l)):b[d++]=l;I[g+1]=h;y[g+1]=d}b.length=d;for(g=d=0;g<z.length;++g){var h=z[g],k=h.startQueryIndex,l=h.endQueryIndex;
h.sum+=I[l]-I[k];k=y[k];l=y[l];l===k?(h.stats.gpuTime+=h.sum/1E6,u.push(h)):(h.startQueryIndex=k,h.endQueryIndex=l,z[d++]=h)}z.length=d}},getNumPendingQueries:function(){return b.length},clear:function(){c.push.apply(c,b);for(var d=0;d<c.length;d++)f.deleteQueryEXT(c[d]);b.length=0;c.length=0},restore:function(){b.length=0;c.length=0}}}},{}],21:[function(h,l,w){l.exports="undefined"!==typeof performance&&performance.now?function(){return performance.now()}:function(){return+new Date}},{}],22:[function(h,
...
g(arguments))},{def:c.def,entry:c,exit:d,save:b,set:function(d,f,g){b(d,f);c(d,f,"=",g,";")},toString:function(){return f()+l()}})}var c=0,b=[],l=[],z=h(),I={};return{global:z,link:function(d){for(var f=0;f<l.length;++f)if(l[f]===d)return b[f];f="g"+c++;b.push(f);l.push(d);return f},block:h,proc:function(b,c){function g(){var b="a"+h.length;h.push(b);return b}var h=[];c=c||0;for(var l=0;l<c;++l)g();var l=f(),k=l.toString;return I[b]=C(l,{arg:g,toString:function(){return d(["function(",h.join(),"){",
k(),"}"])}})},scope:f,cond:function(){var b=d(arguments),c=f(),h=f(),l=c.toString,u=h.toString;return C(c,{then:function(){c.apply(c,g(arguments));return this},"else":function(){h.apply(h,g(arguments));return this},toString:function(){var c=u();c&&(c="else{"+c+"}");return d(["if(",b,"){",l(),"}",c])}})},compile:function(){var c=['"use strict";',z,"return {"];Object.keys(I).forEach(function(b){c.push('"',b,'":',I[b].toString(),",")});c.push("}");var f=d(c).replace(/;/g,";\n").replace(/}/g,"}\n").replace(/{/g,
...
c);break;default:throw Error("Unsupported FourCC code: "+String.fromCharCode(h&255,h>>8&255,h>>16&255,h>>24&255));}var l=b[2],y=1;l&131072&&(y=Math.max(1,b[7]));var n=!1;b[28]&512&&(n=!0);var p=b[4],w=b[3],b=b[1]+4,E=p,k=w,m=[];h===f&&(b+=20);if(n)for(g=0;6>g;g++){if("rgba32f"!==c)throw Error("Only RGBA32f cubemaps are supported");for(var p=E,w=k,L=Math.log(p)/Math.log(2)+1,F=0;F<L;F++)h=p*w*16,m.push({offset:b,length:h,shape:[p,w]}),F<y&&(b+=h),p=Math.floor(p/2),w=Math.floor(w/2)}else for(F=0;F<
y;F++)h=Math.max(4,p)/4*Math.max(4,w)/4*g,m.push({offset:b,length:h,shape:[p,w]}),b+=h,p=Math.floor(p/2),w=Math.floor(w/2);return{shape:[E,k],images:m,format:c,flags:l,cubemap:n}}},{}],34:[function(h,l,w){function g(b){throw Error("resl: "+b);}function d(b,c,d){Object.keys(b).forEach(function(b){0>c.indexOf(b)&&g('invalid parameter "'+b+'" in '+d)})}function C(b,c){this.state=0;this.ready=!1;this.progress=0;this.name=b;this.cancel=c}var x=["manifest","onDone","onProgress","onError"],f=["type","src",
"stream","credentials","parser"],c=["onData","onDone"];l.exports=function(b){function h(a,c){if(a in b){var d=b[a];"function"!==typeof d&&g('invalid callback "'+a+'"');return d}return null}function l(a){function b(){if(!(2>h.readyState||1===p.state||-1===p.state)){if(200!==h.status)return y('error loading resource "'+a.name+'"');if(2<h.readyState&&0===p.state){var d;d="binary"===a.type?h.response:h.responseText;if(g.data)try{k=g.data(d)}catch(f){return y(f)}else k=d}if(3<h.readyState&&0===p.state){if(g.done)try{k=
g.done()}catch(f){return y(f)}p.state=1}m[c]=k;p.progress=.75*p.progress+.25;p.ready=a.stream&&!!k||1===p.state;n()}}var c=a.name,d=a.stream,f="binary"===a.type,g=a.parser,h=new XMLHttpRequest,k=null,p=new C(c,function(){1!==p.state&&-1!==p.state&&(h.onreadystatechange=null,h.abort(),p.state=-1)});h.onreadystatechange=d?b:function(){4===h.readyState&&b()};f&&(h.responseType="arraybuffer");a.credentials&&(h.withCredentials=!0);h.open("GET",a.src,!0);h.send();return p}function w(a,b){function c(){if(0===
p.state)if(l.data)try{u=l.data(b)}catch(a){return y(a)}else u=b}function d(b){c();m[k]=u;p.progress=b.lengthComputable?Math.max(p.progress,b.loaded/b.total):.75*p.progress+.25;p.ready=a.stream;n(k)}function f(){c();if(0===p.state){if(l.done)try{u=l.done()}catch(a){return y(a)}p.state=1}p.progress=1;p.ready=!0;m[k]=u;h();n("finish "+k)}function g(){y('error loading asset "'+k+'"')}function h(){a.stream&&b.removeEventListener("progress",d);"image"===a.type?b.addEventListener("load",f):b.addEventListener("canplay",
f);b.removeEventListener("error",g)}var k=a.name,l=a.parser,p=new C(k,function(){1!==p.state&&-1!==p.state&&(p.state=-1,h(),b.src="")}),u=b;a.stream&&b.addEventListener("progress",d);"image"===a.type?b.addEventListener("load",f):b.addEventListener("canplay",f);b.addEventListener("error",g);b.crossOrigin=a.credentials?"use-credentials":"anonymous";b.src=a.src;return p}function y(a){-1!==L&&1!==L&&(L=-1,G.forEach(function(a){a.cancel()}),k?"string"===typeof a?k(Error("resl: "+a)):k(a):console.error("resl error:",
...
0;R.viewportWidth=R.framebufferWidth=R.drawingBufferWidth=a[2]=b[2]=r.drawingBufferWidth;R.viewportHeight=R.framebufferHeight=R.drawingBufferHeight=a[3]=b[3]=r.drawingBufferHeight}function O(){R.tick+=1;R.time=qa();M();S.procs.poll()}function ka(){M();S.procs.refresh();H&&H.update()}function qa(){return(f()-ua)/1E3}a=b(a);if(!a)return null;var r=a.gl,aa=r.getContextAttributes();r.isContextLost();var ba=u(r,a);if(!ba)return null;var ha=c(),W=F(),P=ba.extensions,H=G(r,P),ua=f(),la=r.drawingBufferWidth,
va=r.drawingBufferHeight,R={tick:0,time:0,viewportWidth:la,viewportHeight:va,framebufferWidth:la,framebufferHeight:va,drawingBufferWidth:la,drawingBufferHeight:va,pixelRatio:a.pixelRatio},da=z(r,P),ea=I(r,W,a),oa=y(r,P,ea,W),la=E(r,P,da,ea,ha),fa=k(r,ha,W,a),X=n(r,P,da,function(){S.procs.poll()},R,W,a),pa=p(r,P,da,W,a),na=J(r,P,da,X,pa,W),S=L(r,ha,P,da,ea,oa,X,na,{},la,fa,{elements:null,primitive:4,count:-1,offset:0,instances:-1},R,H,a),ha=m(r,na,S.procs.poll,R,aa,P),ga=S.next,ia=r.canvas,Q=[],U=
...
read:ha,destroy:function(){Q.length=0;w();ia&&(ia.removeEventListener("webglcontextlost",Ea),ia.removeEventListener("webglcontextrestored",wa));fa.clear();na.clear();pa.clear();X.clear();oa.clear();ea.clear();H&&H.clear();Z.forEach(function(a){a()})},_gl:r,_refresh:ka,poll:function(){O();H&&H.update()},now:qa,stats:W});a.onDone(null,aa);return aa}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,"./lib/elements":10,"./lib/extension":11,"./lib/framebuffer":12,"./lib/limits":13,
