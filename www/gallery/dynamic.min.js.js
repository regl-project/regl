...
vert:"\n    precision mediump float;\n    attribute vec2 position;\n    uniform float angle;\n    void main() {\n      gl_Position = vec4(\n        cos(angle) * position.x + sin(angle) * position.y,\n        -sin(angle) * position.x + cos(angle) * position.y, 0, 1);\n    }",attributes:{position:b.buffer([-1,0,0,-1,1,1])},uniforms:{color:b.prop("color"),angle:function(a,b,e){return.01*e.count}},depth:{enable:!1},count:3});b.frame(function(a){b.clear({color:[0,0,0,1]});t({color:[Math.sin(.001*a),Math.cos(.02*
a),Math.sin(.3*a),1]})})},{"../regl":32}],2:[function(d,h,k){function b(){this.pointer=!1;this.w=this.z=this.y=this.x=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}var t=d("./constants/dtypes.json");Object.assign(b.prototype,{equals:function(a,b){return this.pointer?a.pointer&&this.buffer===a.buffer&&this.size===b&&this.normalized===a.normalized&&this.type===a.type&&this.offset===a.offset&&this.stride===a.stride&&this.divisor===a.divisor:!a.pointer&&
this.x===a.x&&this.y===a.y&&this.z===a.z&&this.w===a.w},set:function(a,b){(this.pointer=a.pointer)?(this.buffer=a.buffer,this.size=b,this.normalized=a.normalized,this.type=a.type,this.offset=a.offset,this.stride=a.stride,this.divisor=a.divisor):(this.x=a.x,this.y=a.y,this.z=a.z,this.w=a.w)}});h.exports=function(a,c,e,g){function p(){for(var a=Array(16),c=0;16>c;++c)a[c]=new b;this.records=a;this.top=0}function d(a){for(var c=a.records,n=a.top;c.length-1<=n;)c.push(new b);return c[++a.top]}var C={};
e=e.maxAttributes;for(var h=Array(e),J=0;J<e;++J)h[J]=new b;Object.assign(p.prototype,{pushVec:function(a,b,c,g){var e=d(this);e.pointer=!1;e.x=a;e.y=b;e.z=c;e.w=g},pushPtr:function(a,b,c,e,g,t,p){var C=d(this);C.pointer=!0;C.buffer=a;C.size=b;C.offset=c;C.stride=e;C.divisor=g;C.normalized=t;C.type=p},pushDyn:function(a){if("number"===typeof a)this.pushVec(a,0,0,0);else if(Array.isArray(a))this.pushVec(a[0],a[1],a[2],a[3]);else{var b=g.getBuffer(a),c=0,e=0,z=0,p=0,d=!1,A=5126;b?A=b.dtype:(b=g.getBuffer(a.buffer),
c=a.size||0,e=a.stride||0,z=a.offset||0,p=a.divisor||0,d=a.normalized||!1,A=b.dtype,"type"in a&&(A=t[a.type]));this.pushPtr(b,c,z,e,p,d,A)}},pop:function(){--this.top}});return{bindings:h,attributes:C,bind:function(b,e,g,v){v=g.size||v;if(!e.equals(g,v)){if(g.pointer){e.pointer||a.enableVertexAttribArray(b);e.buffer!==g.buffer&&g.buffer.bind();a.vertexAttribPointer(b,v,g.type,g.normalized,g.stride,g.offset);var t=c.angle_instanced_arrays;t&&t.vertexAttribDivisorANGLE(b,g.divisor)}else e.pointer&&
a.disableVertexAttribArray(b),a.vertexAttrib4f(b,g.x,g.y,g.z,g.w);e.set(g,v)}},def:function(a){a in C||(C[a]=new p)}}}},{"./constants/dtypes.json":9}],3:[function(d,h,k){function b(a,b){switch(a){case 5121:return new Uint8Array(b);case 5123:return new Uint16Array(b);case 5125:return new Uint32Array(b);case 5120:return new Int8Array(b);case 5122:return new Int16Array(b);case 5124:return new Int32Array(b);case 5126:return new Float32Array(b);default:return null}}var t=d("./check"),a=d("./is-typed-array"),
...
d.isBuffer(b)&&d.deleteBuffer(b);a.buffer=null;delete n[a.id]}var m=0,n={};h.prototype.bind=function(){d.bindBuffer(this.type,this.buffer)};return{create:function(p,m,D){function ba(n){var q=n||{};if(Array.isArray(q)||a(q)||c(q))q={data:q};else if("number"===typeof q)q={length:q|0};else if(null===q||void 0===q)q={};t.type(q,"object","buffer arguments must be an object, a number or an array");"usage"in q?(t.parameter(q.usage,A,"invalid buffer usage"),S.usage=A[q.usage]):S.usage=35044;n=0;"type"in q&&
(t.parameter(q.type,g,"invalid buffer type"),n=g[q.type]);var d=q.dimension|0||1,p=0,m=null;if("data"in q)if(m=q.data,null===m)p=q.length|0;else{if(c(m)){var d=m.shape,p=m.stride,q=m.offset,v=0,z=0,D=0,h=0;1===d.length?(v=d[0],z=1,D=p[0],h=0):2===d.length?(v=d[0],z=d[1],D=p[0],h=p[1]):t.raise("invalid shape");n=n||e[Object.prototype.toString.call(m)]|0||5126;for(var d=z,p=b(n,v*z),m=m.data,C=0,ea=0;ea<v;++ea)for(var Z=0;Z<z;++Z)p[C++]=m[D*ea+h*Z+q];m=p}else if(Array.isArray(m))if(0<m.length&&Array.isArray(m[0])){d=
m[0].length;n=n||5126;q=b(n,m.length*d);p=m;m=d;for(v=h=0;v<p.length;++v)for(D=p[v],z=0;z<m;++z)q[h++]=D[z];m=q}else n=n||5126,m=b(n,m);else t.isTypedArray(m,"invalid data type buffer data"),n=n||e[Object.prototype.toString.call(m)]|0;p=m.byteLength}else"length"in q&&(p=q.length|0,t.nni(p,"buffer length must be a nonnegative integer"));S.data=m;S.dtype=n||5121;S.byteLength=p;S.dimension=d;J(S);return ba}var N=d.createBuffer(),S=new h(N,m);n[S.id]=S;D||ba(p);ba._reglType="buffer";ba._buffer=S;ba.destroy=
function(){q(S)};return ba},clear:function(){p(n).forEach(q)},refresh:function(){p(n).forEach(J)},getBuffer:function(a){return a&&a._buffer instanceof h?a._buffer:null}}}},{"./check":4,"./constants/arraytypes.json":8,"./constants/dtypes.json":9,"./is-ndarray":17,"./is-typed-array":18,"./values":31}],4:[function(d,h,k){function b(a){a=Error("(regl) "+a);console.error(a);throw a;}var t=d("./is-typed-array");h.exports=Object.assign(function(a,c){a||b(c)},{raise:b,parameter:function(a,c,e){a in c||b("unknown parameter ("+
a+")"+(e?": "+e:"")+". possible values: "+Object.keys(c).join())},type:function(a,c,e){typeof a!==c&&b("invalid parameter type"+(e?": "+e:"")+". expected "+c+", got "+typeof a)},isTypedArray:function(a,c){t(a)||b("invalid parameter type"+(c?": "+c:"")+". must be a typed array")},nni:function(a,c){0<=a&&(a|0)===a||b("invalid parameter type, ("+a+")"+(c?": "+c:"")+". must be a nonnegative integer")},oneOf:function(a,c,e){0>c.indexOf(a)&&b("invalid value"+(e?": "+e:"")+". must be one of: "+c)}})},{"./is-typed-array":18}],
...
";":"",a.join("")].join("")}})}var d=0,a=[],c=[],e={};return{link:function(b){var e="g"+d++;a.push(e);c.push(b);return e},block:b,proc:function(a){var c=[],A=b(),h=A.toString;return e[a]=Object.assign(A,{arg:function(){var a="a"+d++;c.push(a);return a},toString:function(){return["function(",c.join(),"){",h(),"}"].join("")}})},compile:function(){var b=['"use strict";return {'];Object.keys(e).forEach(function(a){b.push('"',a,'":',e[a].toString(),",")});b.push("}");return Function.apply(null,a.concat([b.join("")])).apply(null,
c)}}}},{}],7:[function(d,h,k){function b(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function t(a,b,c,g){var d,p=",";switch(b){case 5126:d="1f";break;case 35664:d="2fv";break;case 35665:d="3fv";break;case 35666:d="4fv";break;case 35670:case 5124:d="1i";break;case 35671:case 35667:d="2iv";break;case 35672:case 35668:d="3iv";break;case 35673:case 35669:d="4iv";break;case 35674:d="Matrix2fv";
p=",false,";break;case 35675:d="Matrix3fv";p=",false,";break;case 35676:d="Matrix4fv";p=",false,";break;default:e.raise("unsupported uniform type")}return a+".uniform"+d+"("+c+p+g+");"}function a(a){return a+"["+a+".length-1]"}function c(a,b){return"framebuffer"===a||a<b?-1:a>b?1:0}var e=d("./check"),g=d("./codegen"),p=d("./constants/primitives.json"),A=d("./constants/dtypes.json"),C={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,
...
h.exports=function(d,m,n,v,h,D,ba,N,S,k,T,ca,ja,la){function W(n,v,D,A,N){function P(a){var f=ra[a];return f?f:f=ra[a]=x(H[a])}function Q(a){var f=a.id,y=V[f];if(y)return y;y=a.func?l.def(x(a.data),"(",T,",",I,",",E,")"):l.def(T,".",a.data);return V[f]=y}function u(a,f){return a.find(function(a){return a.name===f})}function K(a){return na&&!(a in v||a in N)}var L=g(),x=L.link,l=L.proc("batch"),F=L.block(),R=l.def,aa=l.arg,f=x(d),G=x(n.program),r=x(k.bind),E=x(ja),ia=x(ba),B=x(ca.count),O=x(ca.offset),
ga=x(ca.instances),X=x(ca.primitive),ra={},fa=x(h.elements),B=R(a(B)),O=R(a(O)),X=R(a(X)),fa=R(a(fa)),w,M,oa=m.angle_instanced_arrays;oa&&(w=R(a(ga)),M=x(oa));var na="elements"in v,ga=aa(),aa=aa(),T=R(),I=R(),V={};l(f,".useProgram(",G,");");n.uniforms.forEach(function(a){if(!(a.name in D)){var ua=x(a.location),y=x(S.uniforms[a.name]),y=y+"["+y+".length-1]";35678===a.info.type||35680===a.info.type?(a=R(y+"._texture"),l(t(f,5124,ua,a+".bind()")),F(a,".unbind();")):l(t(f,a.info.type,ua,y))}});n.attributes.forEach(function(a){if(!(A.name in
A)){var f=x(k.attributes[a.name]);l(r,"(",a.location,",",x(k.bindings[a.location]),",",f,".records[",f,".top]",",",b(a.info.type),");")}});na||l("if(",fa,"){",f,".bindBuffer(",34963,",",fa,".buffer.buffer);","}else{",f,".bindBuffer(",34963,",null);","}");l("for(",I,"=0;",I,"<",ga,";++",I,"){",T,"=",aa,"[",I,"];");Object.keys(v).sort(c).forEach(function(a){function b(a){l("if(",y,"){",f,".enable(",a,");}else{",f,".disable(",a,");}")}var y=Q(v[a]);switch(a){case "framebuffer":a=P("viewport");var r=
P("scissor.box");l("if(",ia,".push(",y,"&&",y,"._framebuffer)){",ia,".poll();",a,".setDirty();",r,".setDirty();","}");break;case "cull.enable":b(2884);break;case "blend.enable":b(3042);break;case "dither":b(3024);break;case "stencil.enable":b(2960);break;case "depth.enable":b(2929);break;case "scissor.enable":b(3089);break;case "polygonOffset.enable":b(32823);break;case "sample.alpha":b(32926);break;case "sample.enable":b(32928);break;case "depth.mask":l(f,".depthMask(",y,");");break;case "depth.func":a=
x(Y);l(f,".depthFunc(",a,"[",y,"]);");break;case "depth.range":l(f,".depthRange(",y,"[0],",y,"[1]);");break;case "blend.color":l(f,".blendColor(",y,"[0],",y,"[1],",y,"[2],",y,"[3]);");break;case "blend.equation":a=x(U);l("if(typeof ",y,'==="string"){',f,".blendEquation(",a,"[",y,"]);","}else{",f,".blendEquationSeparate(",a,"[",y,".rgb],",a,"[",y,".alpha]);","}");break;case "blend.func":a=x(C);l(f,".blendFuncSeparate(",a,'["srcRGB" in ',y,"?",y,".srcRGB:",y,".src],",a,'["dstRGB" in ',y,"?",y,".dstRGB:",
y,".dst],",a,'["srcAlpha" in ',y,"?",y,".srcAlpha:",y,".src],",a,'["dstAlpha" in ',y,"?",y,".dstAlpha:",y,".dst]);");break;case "stencil.mask":l(f,".stencilMask(",y,");");break;case "stencil.func":a=x(Y);l(f,".stencilFunc(",a,"[",y,'.cmp||"always"],',y,".ref|0,",'"mask" in ',y,"?",y,".mask:-1);");break;case "stencil.opFront":case "stencil.opBack":r=x(J);l(f,".stencilOpSeparate(","stencil.opFront"===a?1028:1029,",",r,"[",y,'.fail||"keep"],',r,"[",y,'.zfail||"keep"],',r,"[",y,'.pass||"keep"]);');break;
case "polygonOffset.offset":l(f,".polygonOffset(",y,".factor||0,",y,".units||0);");break;case "cull.face":l(f,".cullFace(",y,'==="front"?',1028,":",1029,");");break;case "lineWidth":l(f,".lineWidth(",y,");");break;case "frontFace":l(f,".frontFace(",y,'==="cw"?',2304,":",2305,");");break;case "colorMask":l(f,".colorMask(",y,"[0],",y,"[1],",y,"[2],",y,"[3]);");break;case "sample.coverage":l(f,".sampleCoverage(",y,".value,",y,".invert);");break;case "scissor.box":case "viewport":a=P(a);l(a,".push(",
y,".x||0,",y,".y||0,",y,".w||-1,",y,".h||-1);");break;case "primitives":case "offset":case "count":case "elements":break;default:e.raise("unsupported option for batch",a)}});("viewport"in v||"framebuffer"in v)&&l(P("viewport"),".poll();");("scissor.box"in v||"framebuffer"in v)&&l(P("scissor.box"),".poll();");"framebuffer"in v&&l(ia,".pop();");var W=n.uniforms,da=[];Object.keys(D).forEach(function(a){var b=u(W,a);if(b){var y=b.info.type,r=x(b.location);a=Q(D[a]);35678===b.info.type||35680===b.info.type?
(b=R(a+"._texture"),da.push(b),l(t(f,5124,r,b+".bind()"))):l(t(f,y,r,a))}});da.forEach(function(a){l(a,".unbind();")});var la=n.attributes;Object.keys(A).forEach(function(a){var f=u(la,a);f&&l(r,"(",f.location,",",x(a.bindings[f.location]),",",Q(A[a]),",",b(f.info.type),");")});v.count?l(B,"=",Q(v.count),";"):K("count")||l("if(",B,"){");v.offset&&l(O,"=",Q(v.offset),";");v.primitive&&(n=x(p),l(X,"=",n,"[",Q(v.primitive),"];"));na&&(n=Q(v.elements),l(fa,"=",n,"?",n,"._elements:null;"));K("offset")&&
l(O,"=0;");l("if(",fa,"){");K("count")&&l(B,"=",fa,".vertCount;","if(",B,">0){");K("primitive")&&l(X,"=",fa,".primType;");na&&l(f,".bindBuffer(",34963,",",fa,".buffer.buffer);");oa&&(v.instances&&l(w,"=",Q(v.instances),";"),l("if(",w,">0){",M,".drawElementsInstancedANGLE(",X,",",B,",",fa,".type,",O,",",w,");}else{"));l(f,".drawElements(",X,",",B,",",fa,".type,",O,");");oa&&l("}");K("count")&&l("}");l("}else{");K("count")||(K("primitive")&&l(X,"=",4,";"),oa&&l("if(",w,">0){",M,".drawArraysInstancedANGLE(",
X,",",O,",",B,",",w,");}else{"),l(f,".drawArrays(",X,",",O,",",B,");}"),oa&&l("}"));l("}}",F);return L.compile().batch}var H=N.contextState,U={add:32774,subtract:32778,"reverse subtract":32779};m.ext_blend_minmax&&(U.min=32775,U.max=32776);var da=0;return{draw:function(c){var e=g(),n=e.link,v=e.proc("draw"),p=v.def,A=n(d),D=n(c.program),C=n(k.bind),K=n(ca.count),L=n(ca.offset),x=n(ca.instances),l=n(ca.primitive),F=n(h.elements),R=[];v(A,".useProgram(",D,");");c.attributes.forEach(function(a){var f=
n(k.attributes[a.name]);v(C,"(",a.location,",",n(k.bindings[a.location]),",",f,".records[",f,".top]",",",b(a.info.type),");")});c.uniforms.forEach(function(a){var f=n(a.location),b=n(S.uniforms[a.name]),b=b+"["+b+".length-1]";35678===a.info.type||35680===a.info.type?(a=p(b+"._texture"),R.push(a),v(t(A,5124,f,a+".bind()"))):v(t(A,a.info.type,f,b))});R.forEach(function(a){v(a,".unbind();")});c=p(a(l));K=p(a(K));L=p(a(L));F=p(a(F));v("if(",K,"){");(D=m.angle_instanced_arrays)?(x=p(a(x)),D=n(D),v("if(",
F,"){",F,".bind();","if(",x,">0){",D,".drawElementsInstancedANGLE(",c,",",K,",",F,".type,",L,",",x,");}else{",A,".drawElements(",c,",",K,",",F,".type,",L,");}","}else if(",x,">0){",D,".drawArraysInstancedANGLE(",c,",",L,",",K,",",x,");}else{",A,".drawArrays(",c,",",L,",",K,");}}")):v("if(",F,"){",A,".drawElements(",c,",",K,",",F,".type,",L,");}","}else{",A,".drawArrays(",c,",",L,",",K,");}");return e.compile().draw},command:function(b,d,q,m,t,D,N){function u(a){var b=fa[a];return b?b:b=fa[a]=l(H[a])}
function K(a,b){var f=u(a);w(f,".push(",b,");");M(f,".pop();")}function L(a){var b=a.id,f=wa[b];if(f)return f;f=a.func?I.def(l(a.data),"(",sa,",0,",va,")"):I.def(sa,".",a.data);return wa[b]=f}var x=g(),l=x.link,F=x.block,R=x.proc,aa=da++,f=l(la),G=l(T.fragShaders),r=l(T.vertShaders),E=l(T.programs),ia=l(ba),B={count:l(ca.count),offset:l(ca.offset),instances:l(ca.instances),primitive:l(ca.primitive)},O=l(h.elements),ga=l(p),X=l(Y),ra=l(J),fa={},w=F(),M=F(),oa=!1;Object.keys(b).sort(c).forEach(function(a){var f=
b[a];switch(a){case "frag":oa=!0;w(G,".push(",l(f),");");M(G,".pop();");break;case "vert":oa=!0;w(r,".push(",l(f),");");M(r,".pop();");break;case "framebuffer":a=ba.getFramebuffer(f);e(null===f||a,"invalid framebuffer object");a=u("viewport");var c=u("scissor.box");w("if(",ia,".push(",l(f&&f._framebuffer),")){",a,".setDirty();",c,".setDirty();","}");M("if(",ia,".pop()){",a,".setDirty();",c,".setDirty();","}");break;case "count":case "offset":case "instances":e.nni(f,a);w(B[a],".push(",f,");");M(B[a],
".pop();");break;case "primitive":e.parameter(f,p,"not a valid drawing primitive");w(B.primitive,".push(",p[f],");");M(B.primitive,".pop();");break;case "elements":c=h.getElements(f);f=!("primitive"in b);a=!("count"in b);c?(c=l(c),w(O,".push(",c,");"),f&&w(B.primitive,".push(",c,".primType);"),a&&w(B.count,".push(",c,".vertCount);")):(w(O,".push(null);"),f&&w(B.primitive,".push(",4,");"),a&&w(B.count,".push(0);"));f&&M(B.primitive,".pop();");a&&M(B.count,".pop();");"offset"in b||(w(B.offset,".push(0);"),
M(B.offset,".pop();"));M(O,".pop();");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":e.type(f,"boolean",a);K(a,f);break;case "depth.func":e.parameter(f,Y,a);K(a,Y[f]);break;case "depth.range":e(Array.isArray(f)&&2===f.length&&f[0]<=f[1],"depth range is 2d array");a=u(a);w(a,".push(",f[0],",",f[1],");");M(a,".pop();");break;case "blend.func":a=
u(a);e.type(f,"object","blend func must be an object");var c="srcRGB"in f?f.srcRGB:f.src,E="srcAlpha"in f?f.srcAlpha:f.src,g="dstRGB"in f?f.dstRGB:f.dst,f="dstAlpha"in f?f.dstAlpha:f.dst;e.parameter(c,C);e.parameter(E,C);e.parameter(g,C);e.parameter(f,C);w(a,".push(",C[c],",",C[g],",",C[E],",",C[f],");");M(a,".pop();");break;case "blend.equation":a=u(a);"string"===typeof f?(e.parameter(f,U,"invalid blend equation"),w(a,".push(",U[f],",",U[f],");")):"object"===typeof f?(e.parameter(f.rgb,U,"invalid blend equation rgb"),
e.parameter(f.alpha,U,"invalid blend equation alpha"),w(a,".push(",U[f.rgb],",",U[f.alpha],");")):e.raise("invalid blend equation");M(a,".pop();");break;case "blend.color":e(Array.isArray(f)&&4===f.length,"blend color is a 4d array");a=u(a);w(a,".push(",f[0],",",f[1],",",f[2],",",f[3],");");M(a,".pop();");break;case "stencil.mask":e.type(f,"number","stencil mask must be an integer");a=u(a);w(a,".push(",f,");");M(a,".pop();");break;case "stencil.func":e.type(f,"object","stencil func must be an object");
c=f.cmp||"keep";E=f.ref||0;f="mask"in f?f.mask:-1;e.parameter(c,Y,"invalid stencil func cmp");e.type(E,"number","stencil func ref");e.type(f,"number","stencil func mask");a=u(a);w(a,".push(",Y[c],",",E,",",f,");");M(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":e.type(f,"object",a);c=f.fail||"keep";E=f.zfail||"keep";f=f.pass||"keep";e.parameter(c,J,a);e.parameter(E,J,a);e.parameter(f,J,a);a=u(a);w(a,".push(",J[c],",",J[E],",",J[f],");");M(a,".pop();");break;case "polygonOffset.offset":e.type(f,
"object",a);c=f.factor||0;f=f.units||0;e.type(c,"number","offset.factor");e.type(f,"number","offset.units");a=u(a);w(a,".push(",c,",",f,");");M(a,".pop();");break;case "cull.face":c=0;"front"===f?c=1028:"back"===f&&(c=1029);e(!!c,"cull.face");f=u(a);w(f,".push(",c,");");M(f,".pop();");break;case "lineWidth":c=n.lineWidthDims;e("number"===typeof f&&f>=c[0]&&f<=c[1],"invalid line width, must positive number between "+c[0]+" and "+c[1]);K(a,f);break;case "frontFace":c=0;"cw"===f?c=2304:"ccw"===f&&(c=
2305);e(!!c,"frontFace");f=u(a);w(f,".push(",c,");");M(f,".pop();");break;case "colorMask":e(Array.isArray(f)&&4===f.length,"color mask must be length 4 array");a=u(a);w(a,".push(",f.map(function(a){return!!a}).join(),");");M(a,".pop();");break;case "sample.coverage":e.type(f,"object",a);c="value"in f?f.value:1;f=!!f.invert;e("number"===typeof c&&0<=c&&1>=c,"sample value");a=u(a);w(a,".push(",c,",",f,");");M(a,".pop();");break;case "viewport":case "scissor.box":e("object"===typeof f&&f,a+" is an object");
var c=f.x||0,E=f.y||0,d=g=-1;e("number"===typeof c&&0<=c,a+".x must be a positive int");e("number"===typeof E&&0<=E,a+".y must be a positive int");"w"in f&&(g=f.w,e("number"===typeof g&&0<=g,a+".w must be a positive int"));"h"in f&&(d=f.h,e("number"===typeof d&&0<=d,a+".h must be a positive int"));f=u(a);w(f,".push(",c,",",E,",",g,",",d,");");M(f,".pop();");break;default:e.raise("unsupported parameter "+a)}});if(oa){if(b.frag&&b.vert)w(E,".push(",l(T.create(b.vert,b.frag)),");");else{var F=w.def(G,
"[",G,".length-1]"),na=w.def(r,"[",r,".length-1]"),ta=l(T.create);w(E,".push(",ta,"(",na,",",F,"));")}M(E,".pop();")}Object.keys(d).forEach(function(a){S.def(a);var f=l(S.uniforms[a]);a=d[a];a="function"===typeof a&&a._reglType?l(a):Array.isArray(a)?l(a.slice()):+a;w(f,".push(",a,");");M(f,".pop();")});Object.keys(q).forEach(function(a){k.def(a);var f=l(k.attributes[a]),b=q[a];if("number"===typeof b)w(f,".pushVec(",+b,",0,0,0);");else if(e(!!b,"invalid attribute: "+a),Array.isArray(b))w(f,".pushVec(",
[b[0]||0,b[1]||0,b[2]||0,b[3]||0],");");else{var c=v.getBuffer(b),r=0,E=0,n=0,g=0,d=!1,G=5126;c?G=c.dtype:(e.type(b,"object",'invalid attribute "'+a+'"'),c=v.getBuffer(b.buffer),r=b.size||0,E=b.stride||0,n=b.offset||0,g=b.divisor||0,d=b.normalized||!1,e(!!c,"invalid attribute "+a+".buffer"),G=c.dtype,"type"in b&&(e.parameter(b.type,A,"attribute type"),G=A[b.type]));e(!!c,"invalid attribute "+a+".buffer");e.nni(E,a+".stride");e.nni(n,a+".offset");e.nni(g,a+".divisor");e.type(d,"boolean",a+".normalized");
e.oneOf(r,[0,1,2,3,4],a+".size");w(f,".pushPtr(",[l(c),r,n,E,g,d,G].join(),");")}M(f,".pop();")});var I=x.block(),V=x.block(),va,sa;N&&(va=l(ja),sa=w.def());var wa={};Object.keys(m).sort(c).forEach(function(a){var f=L(m[a]);switch(a){case "framebuffer":a=u("viewport");var c=u("scissor.box");I("if(",ia,".push(",f,"&&",f,"._framebuffer)){",a,".setDirty();",c,".setDirty();","}");V("if(",ia,".pop()){",a,".setDirty();",c,".setDirty();","}");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "lineWidth":case "depth.mask":a=
u(a);I(a,".push(",f,");");V(a,".pop();");break;case "count":case "offset":case "instances":a=B[a];I(a,".push(",f,");");V(a,".pop();");break;case "primitive":a=B.primitive;I(a,".push(",ga,"[",f,"]);");V(a,".pop();");break;case "depth.func":a=u(a);I(a,".push(",X,"[",f,"]);");V(a,".pop();");break;case "blend.func":a=u(a);c=l(C);I(a,".push(",c,'["srcRGB" in ',f,"?",f,".srcRGB:",f,".src],",c,'["dstRGB" in ',f,"?",f,".dstRGB:",f,".dst],",c,'["srcAlpha" in ',f,"?",f,".srcAlpha:",f,".src],",c,'["dstAlpha" in ',
f,"?",f,".dstAlpha:",f,".dst]);");V(a,".pop();");break;case "blend.equation":a=u(a);c=l(U);I("if(typeof ",f,'==="string"){',a,".push(",c,"[",f,"],",c,"[",f,"]);","}else{",a,".push(",c,"[",f,".rgb],",c,"[",f,".alpha]);","}");V(a,".pop();");break;case "blend.color":a=u(a);I(a,".push(",f,"[0],",f,"[1],",f,"[2],",f,"[3]);");V(a,".pop();");break;case "stencil.mask":a=u(a);I(a,".push(",f,");");V(a,".pop();");break;case "stencil.func":a=u(a);I(a,".push(",X,"[",f,".cmp],",f,".ref|0,",'"mask" in ',f,"?",f,
".mask:-1);");V(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":a=u(a);I(a,".push(",ra,"[",f,'.fail||"keep"],',ra,"[",f,'.zfail||"keep"],',ra,"[",f,'.pass||"keep"]);');V(a,".pop();");break;case "polygonOffset.offset":a=u(a);I(a,".push(",f,".factor||0,",f,".units||0);");V(a,".pop();");break;case "cull.face":a=u(a);I(a,".push(",f,'==="front"?',1028,":",1029,");");V(a,".pop();");break;case "frontFace":a=u(a);I(a,".push(",f,'==="cw"?',2304,":",2305,");");V(a,".pop();");break;case "colorMask":a=
u(a);I(a,".push(",f,"[0],",f,"[1],",f,"[2],",f,"[3]);");V(a,".pop();");break;case "sample.coverage":a=u(a);I(a,".push(",f,".value,",f,".invert);");V(a,".pop();");break;case "scissor.box":case "viewport":a=u(a);I(a,".push(",f,".x||0,",f,".y||0,",'"w" in ',f,"?",f,".w:-1,",'"h" in ',f,"?",f,".h:-1);");V(a,".pop();");break;case "elements":a=!("primitive"in m)&&!("primitive"in b);var c=!("count"in m)&&!("count"in b),r=!("offset"in m)&&!("offset"in b),E=I.def();I("if(",f,"){",E,"=",f,"._elements;",O,".push(",
E,");",a?B.primitive+".push("+E+".primType);":"",c?B.count+".push("+E+".vertCount);":"",r?B.offset+".push("+E+".offset);":"","}else{",O,".push(null);","}");V(O,".pop();","if(",f,"){",a?B.primitive+".pop();":"",c?B.count+".pop();":"",r?B.offset+".pop();":"","}");break;default:e.raise("unsupported dynamic option: "+a)}});Object.keys(t).forEach(function(a){S.def(a);var f=l(S.uniforms[a]);a=L(t[a]);I(f,".push(",a,");");V(f,".pop();")});Object.keys(D).forEach(function(a){k.def(a);var f=l(k.attributes[a]);
a=L(D[a]);I(f,".pushDyn(",a,");");V(f,".pop();")});F=R("scope");na=F.arg();ta=F.arg();F(w);N&&F(sa,"=",na,";",I);F(ta,"();",N?V:"",M);F=R("draw");F(w);N&&F(sa,"=",F.arg(),";",I);na=a(E);F(f,"();","if(",na,")",na,".draw(",N?sa:"",");",N?V:"",M);var qa=R("batch");qa(w);N=qa.def(a(E));R=l(function(a,f,c){var r=a.batchCache[aa];r||(r=a.batchCache[aa]=W(a,m,t,D,b));return r(f,c)});qa("if(",N,"){",f,"();",R,"(",N,",",qa.arg(),",",qa.arg(),");");Object.keys(m).forEach(function(a){(a=fa[a])&&qa(a,".setDirty();")});
