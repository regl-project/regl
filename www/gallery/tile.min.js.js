...
r){var k=c("./lib/util/extend"),a=c("./lib/dynamic"),l=c("./lib/util/raf"),h=c("./lib/util/clock"),b=c("./lib/strings"),f=c("./lib/webgl"),q=c("./lib/extension"),z=c("./lib/limits"),M=c("./lib/buffer"),y=c("./lib/elements"),C=c("./lib/texture"),J=c("./lib/renderbuffer"),K=c("./lib/framebuffer"),w=c("./lib/attribute"),u=c("./lib/shader"),B=c("./lib/read"),t=c("./lib/core"),g=c("./lib/stats"),O=c("./lib/timer");m.exports=function(){function c(){U=l.next(c);F.tick+=1;F.time=(h()-ka)/1E3;P();for(var a=
0;a<T.length;++a)(0,T[a])(F,null,0);D.flush()}function e(a){}function m(a){}function r(b){function c(b){var e={},f={};Object.keys(b).forEach(function(c){var g=b[c];a.isDynamic(g)?f[c]=a.unbox(g,c):e[c]=g});return{dynamic:f,"static":e}}function e(a){for(;t.length<a;)t.push(null);return t}var f=c(b.context||{}),g=c(b.uniforms||{}),h=c(b.attributes||{}),l=c(function(a){function b(a){if(a in c){var e=c[a];delete c[a];Object.keys(e).forEach(function(b){c[a+"."+b]=e[b]})}}var c=k({},a);delete c.uniforms;
delete c.attributes;delete c.context;b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");return c}(b));b={gpuTime:0};var f=W.compile(l,h,g,f,b),m=f.draw,q=f.batch,v=f.scope,t=[];return k(function(a,b){var c;if("function"===typeof a)return v.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(c=0;c<a;++c)v.call(this,null,b,c);else if(Array.isArray(a))for(c=0;c<a.length;++c)v.call(this,a[c],b,c);else return v.call(this,a,b,0);else if("number"===
typeof a){if(0<a)return q.call(this,e(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return q.call(this,a,a.length)}else return m.call(this,a)},{stats:b})}function R(){var a=fa.viewport,b=fa.scissor_box;a[0]=a[1]=b[0]=b[1]=0;F.viewportWidth=F.framebufferWidth=F.drawingBufferWidth=a[2]=b[2]=D.drawingBufferWidth;F.viewportHeight=F.framebufferHeight=F.drawingBufferHeight=a[3]=b[3]=D.drawingBufferHeight}function P(){R();W.procs.poll()}function ga(){R();W.procs.refresh()}var v=f(Array.prototype.slice.call(arguments)),
D=v.gl,Q=v.options,v=b(),Y=g(),I=q(D).extensions,ea=O(D,I),ka=h(),S=D.drawingBufferWidth,L=D.drawingBufferHeight,F={tick:0,time:0,viewportWidth:S,viewportHeight:L,framebufferWidth:S,framebufferHeight:L,drawingBufferWidth:S,drawingBufferHeight:L,pixelRatio:Q.pixelRatio},V=z(D,I),ha=M(D,Y),pa=y(D,I,ha,Y),S=w(D,I,V,ha,v),sa=u(D,v,Y),ia=C(D,I,V,P,F,Y),qa=J(D,I,V,Y),ma=K(D,I,V,ia,qa,Y),L=B(D,P,F),W=t(D,v,I,V,ha,pa,ia,ma,{},S,sa,{elements:null,primitive:4,count:-1,offset:0,instances:-1},F,ea),fa=W.next,
X=D.canvas,T=[],U=0;X&&(X.addEventListener("webglcontextlost",e,!1),X.addEventListener("webglcontextrestored",m,!1));ga();return k(r,{clear:function(a){var b=0;W.procs.poll();var c=a.color;c&&(D.clearColor(+c[0]||0,+c[1]||0,+c[2]||0,+c[3]||0),b|=16384);"depth"in a&&(D.clearDepth(+a.depth),b|=256);"stencil"in a&&(D.clearStencil(a.stencil|0),b|=1024);D.clear(b)},prop:a.define.bind(null,1),context:a.define.bind(null,2),"this":a.define.bind(null,3),draw:r({}),buffer:function(a){return ha.create(a,34962)},
elements:pa.create,texture:ia.create2D,cube:ia.createCube,renderbuffer:qa.create,framebuffer:ma.create,framebufferCube:function(a){},attributes:D.getContextAttributes(),frame:function(a){T.push(a);!U&&0<T.length&&c();return{cancel:function(){var b=T.find(function(b){return b===a});0>b||(T.splice(b,1),0>=T.length&&U&&(l.cancel(c),U=0))}}},limits:V,hasExtension:function(a){return 0<=V.extensions.indexOf(a.toLowerCase())},read:L,destroy:function(){U&&(l.cancel(c),U=0);X&&(X.removeEventListener("webglcontextlost",
e),X.removeEventListener("webglcontextrestored",m));sa.clear();ma.clear();qa.clear();ia.clear();pa.clear();ha.clear();ea&&ea.clear();if(Q.onDestroy)Q.onDestroy()},_gl:D,_refresh:ga,stats:Y,updateTimer:function(){ea&&ea.update()}})}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,"./lib/elements":10,"./lib/extension":11,"./lib/framebuffer":12,"./lib/limits":13,"./lib/read":14,"./lib/renderbuffer":15,"./lib/shader":16,"./lib/stats":17,"./lib/strings":18,"./lib/texture":19,"./lib/timer":20,
"./lib/util/clock":21,"./lib/util/extend":23,"./lib/util/raf":29,"./lib/webgl":32}],36:[function(c,m,r){function k(a){throw Error("resl: "+a);}function a(a,b,c){Object.keys(a).forEach(function(a){0>b.indexOf(a)&&k('invalid parameter "'+a+'" in '+c)})}function l(a,b){this.state=0;this.ready=!1;this.progress=0;this.name=a;this.cancel=b}var h=["manifest","onDone","onProgress","onError"],b=["type","src","stream","credentials","parser"],f=["onData","onDone"];m.exports=function(c){function m(a,b){if(a in
c){var f=c[a];"function"!==typeof f&&k('invalid callback "'+a+'"');return f}return null}function r(a){function b(){if(!(2>k.readyState||1===q.state||-1===q.state)){if(200!==k.status)return C('error loading resource "'+a.name+'"');if(2<k.readyState&&0===q.state){var f;f="binary"===a.type?k.response:k.responseText;if(h.data)try{m=h.data(f)}catch(g){return C(g)}else m=f}if(3<k.readyState&&0===q.state){if(h.done)try{m=h.done()}catch(g){return C(g)}q.state=1}t[c]=m;q.progress=.75*q.progress+.25;q.ready=
a.stream&&!!m||1===q.state;J()}}var c=a.name,f=a.stream,g="binary"===a.type,h=a.parser,k=new XMLHttpRequest,m=null,q=new l(c,function(){1!==q.state&&-1!==q.state&&(k.onreadystatechange=null,k.abort(),q.state=-1)});k.onreadystatechange=f?b:function(){4===k.readyState&&b()};g&&(k.responseType="arraybuffer");a.credentials&&(k.withCredentials=!0);k.open("GET",a.src,!0);k.send();return q}function y(a,b){function c(){if(0===r.state)if(q.data)try{u=q.data(b)}catch(a){return C(a)}else u=b}function f(b){c();
t[m]=u;r.progress=b.lengthComputable?Math.max(r.progress,b.loaded/b.total):.75*r.progress+.25;r.ready=a.stream;J(m)}function g(){c();if(0===r.state){if(q.done)try{u=q.done()}catch(a){return C(a)}r.state=1}r.progress=1;r.ready=!0;t[m]=u;k();J("finish "+m)}function h(){C('error loading asset "'+m+'"')}function k(){a.stream&&b.removeEventListener("progress",f);"image"===a.type?b.addEventListener("load",g):b.addEventListener("canplay",g);b.removeEventListener("error",h)}var m=a.name,q=a.parser,r=new l(m,
function(){1!==r.state&&-1!==r.state&&(r.state=-1,k(),b.src="")}),u=b;a.stream&&b.addEventListener("progress",f);"image"===a.type?b.addEventListener("load",g):b.addEventListener("canplay",g);b.addEventListener("error",h);b.crossOrigin=a.credentials?"use-credentials":"anonymous";b.src=a.src;return r}function C(a){-1!==g&&1!==g&&(g=-1,x.forEach(function(a){a.cancel()}),B?"string"===typeof a?B(Error("resl: "+a)):B(a):console.error("resl error:",a))}function J(a){if(-1!==g&&1!==g){var b=0,c=0;x.forEach(function(a){a.ready&&
(c+=1);b+=a.progress});c===x.length?(g=1,w(t)):u&&u(b/x.length,a)}}"object"===typeof c&&c||k("invalid or missing configuration");a(c,h,"config");var K=c.manifest;"object"===typeof K&&K||k("missing manifest");var w=m("onDone");w||k("missing onDone() callback");var u=m("onProgress"),B=m("onError"),t={},g=0,O={text:r,binary:function(a){return r(a)},image:function(a){return y(a,document.createElement("img"))},video:function(a){return y(a,document.createElement("video"))},audio:function(a){return y(a,
document.createElement("audio"))}},x=Object.keys(K).map(function(c){function g(a,b){if(a in h.parser){var c=h.parser[a];"function"!==typeof c&&k("invalid parser callback "+a+' for asset "'+a+'"');return c}return b}var h=K[c];"string"===typeof h?h={src:h}:"object"===typeof h&&h||k('invalid asset definition "'+c+'"');a(h,b,'asset "'+c+'"');var l={};"parser"in h&&("function"===typeof h.parser?l={data:h.parser}:"object"===typeof h.parser&&h.parser?(a(l,f,'parser for asset "'+c+'"'),"onData"in l||k('missing onData callback for parser in asset "'+
c+'"'),l={data:g("onData"),done:g("onDone")}):k('invalid parser for asset "'+c+'"'));return{name:c,type:function(a,b,f){a in h&&(f=h[a]);0>b.indexOf(f)&&k("invalid "+a+' "'+f+'" for asset "'+c+'", possible values: '+b);return f}("type",Object.keys(O),"text"),stream:!!h.stream,credentials:!!h.credentials,src:function(a,b,f){a in h?f=h[a]:b&&k("missing "+a+' for asset "'+c+'"');"string"!==typeof f&&k("invalid "+a+' for asset "'+c+'", must be a string');return f}("src",!0,""),parser:l}}).map(function(a){return O[a.type](a)})}},
{}]},{},[1]);
