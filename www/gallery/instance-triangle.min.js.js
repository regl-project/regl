...
e,b,f){var g=a.shared,d=a.current,w=g.current,x=g.gl;c(Object.keys(b)).forEach(function(c){var g=b[c];if(!f||f(g)){var p=g.append(a,e);if(va[c]){var k=va[c];l(g)?p?e(x,".enable(",k,");"):e(x,".disable(",k,");"):e(a.cond(p).then(x,".enable(",k,");")["else"](x,".disable(",k,");"));e(w,".",c,"=",p,";")}else if(z(p)){var h=d[c];e(x,".",wa[c],"(",p,");",p.map(function(a,e){return h+"["+e+"]="+a}).join(";"),";")}else e(x,".",wa[c],"(",p,");",w,".",c,"=",p,";")}})}function W(a,e){Da&&(a.instancing=e.def(a.shared.extensions,
".angle_instanced_arrays"))}function Z(a,e,b,f,c){function g(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function d(a){m=e.def();a(m,"=",g(),";");"string"===typeof c?a(k,".count+=",c,";"):a(k,".count++;");ca&&(f?(I=e.def(),a(I,"=",q,".getNumPendingQueries();")):a(q,".beginQuery(",k,");"))}function w(a){a(k,".cpuTime+=",g(),"-",m,";");ca&&(f?a(q,".pushScopeStats(",I,",",q,".getNumPendingQueries(),",k,");"):a(q,".endQuery();"))}function x(a){var r=e.def(h,".profile");e(h,
".profile=",a,";");e.exit(h,".profile=",r,";")}var p=a.shared,k=a.stats,h=p.current,q=p.timer;b=b.profile;var m,I;if(b){if(l(b)){b.enable?(d(e),w(e.exit),x("true")):x("false");return}b=b.append(a,e);x(b)}else b=e.def(h,".profile");p=a.block();d(p);e("if(",b,"){",p,"}");a=a.block();w(a);e.exit("if(",b,"){",a,"}")}function aa(a,e,b,c,g){function d(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}
function p(b,f,c){function g(){e("if(!",h,".buffer){",w,".enableVertexAttribArray(",k,");}");var b=c.type,d;d=c.size?e.def(c.size,"||",f):f;e("if(",h,".type!==",b,"||",h,".size!==",d,"||",I.map(function(a){return h+"."+a+"!=="+c[a]}).join("||"),"){",w,".bindBuffer(",34962,",",q,".buffer);",w,".vertexAttribPointer(",[k,d,b,c.normalized,c.stride,c.offset],");",h,".type=",b,";",h,".size=",d,";",I.map(function(a){return h+"."+a+"="+c[a]+";"}).join(""),"}");Da&&(b=c.divisor,e("if(",h,".divisor!==",b,"){",
a.instancing,".vertexAttribDivisorANGLE(",[k,b],");",h,".divisor=",b,";}"))}function d(){e("if(",h,".buffer){",w,".disableVertexAttribArray(",k,");","}if(",H.map(function(a,e){return h+"."+a+"!=="+m[e]}).join("||"),"){",w,".vertexAttrib4f(",k,",",m,");",H.map(function(a,e){return h+"."+a+"="+m[e]+";"}).join(""),"}")}var w=x.gl,k=e.def(b,".location"),h=e.def(x.attributes,"[",k,"]");b=c.state;var q=c.buffer,m=[c.x,c.y,c.z,c.w],I=["buffer","normalized","offset","stride"];1===b?g():2===b?d():(e("if(",
b,"===",1,"){"),g(),e("}else{"),d(),e("}"))}var x=a.shared;c.forEach(function(c){var x=c.name,k=b.attributes[x],h;if(k){if(!g(k))return;h=k.append(a,e)}else{if(!g(f))return;var q=a.scopeAttrib(x);h={};Object.keys(new w).forEach(function(a){h[a]=e.def(q,".",a)})}p(a.link(c),d(c.info.type),h)})}function da(a,e,b,c,g){for(var d=a.shared,w=d.gl,x,p=0;p<c.length;++p){var k=c[p],h=k.name,q=k.info.type,m=b.uniforms[h],k=a.link(k)+".location",I;if(m){if(!g(m))continue;if(l(m)){h=m.value;if(35678===q||35680===
q)q=a.link(h._texture||h.color[0]._texture),e(w,".uniform1i(",k,",",q+".bind());"),e.exit(q,".unbind();");else if(35674===q||35675===q||35676===q)h=a.global.def("new Float32Array(["+Array.prototype.slice.call(h)+"])"),m=2,35675===q?m=3:35676===q&&(m=4),e(w,".uniformMatrix",m,"fv(",k,",false,",h,");");else{switch(q){case 5126:x="1f";break;case 35664:x="2f";break;case 35665:x="3f";break;case 35666:x="4f";break;case 35670:x="1i";break;case 5124:x="1i";break;case 35671:x="2i";break;case 35667:x="2i";
break;case 35672:x="3i";break;case 35668:x="3i";break;case 35673:x="4i";break;case 35669:x="4i"}e(w,".uniform",x,"(",k,",",z(h)?Array.prototype.slice.call(h):h,");")}continue}else I=m.append(a,e)}else{if(!g(f))continue;I=e.def(d.uniforms,"[",t.id(h),"]")}35678===q?e("if(",I,"&&",I,'._reglType==="framebuffer"){',I,"=",I,".color[0];","}"):35680===q&&e("if(",I,"&&",I,'._reglType==="framebufferCube"){',I,"=",I,".color[0];","}");h=1;switch(q){case 35678:case 35680:q=e.def(I,"._texture");e(w,".uniform1i(",
k,",",q,".bind());");e.exit(q,".unbind();");continue;case 5124:case 35670:x="1i";break;case 35667:case 35671:x="2i";h=2;break;case 35668:case 35672:x="3i";h=3;break;case 35669:case 35673:x="4i";h=4;break;case 5126:x="1f";break;case 35664:x="2f";h=2;break;case 35665:x="3f";h=3;break;case 35666:x="4f";h=4;break;case 35674:x="Matrix2fv";break;case 35675:x="Matrix3fv";break;case 35676:x="Matrix4fv"}e(w,".uniform",x,"(",k,",");if("M"===x.charAt(0)){var k=Math.pow(q-35674+2,2),u=a.global.def("new Float32Array(",
