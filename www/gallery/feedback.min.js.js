...
new Uint8Array(new Uint8Array(c.buffer)));else if(g(c)){var V=c.shape,K=c.stride;q=c.offset;var w=0,I=0,p=0,R=0;1===V.length?(w=V[0],I=1,p=K[0],R=0):2===V.length&&(w=V[0],I=V[1],p=K[0],R=K[1]);b.dtype=f||l(c.data)||5126;b.dimension=I;f=t.allocType(b.dtype,w*I);u(f,c.data,w,I,p,R,q);h(b,f,n);k?b.persistentData=f:t.freeType(f)}}function F(a){w.bufferCount--;k.deleteBuffer(a.buffer);a.buffer=null;delete b[a.id]}var q=0,b={};n.prototype.bind=function(){k.bindBuffer(this.type,this.buffer)};n.prototype.destroy=
...
decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386},q={cw:2304,ccw:2305},b=new u(!1,!1,!1,function(){});m.exports=function(k,m,D,G,x,U,ma,O,K,na,sa,p,R,aa,ha){function W(a){return a.replace(".","_")}function N(a,d,b){var e=W(a);Ha.push(a);Ba[e]=ta[e]=!!b;ua[e]=d}function E(a,d,b){var e=W(a);Ha.push(a);Array.isArray(b)?(ta[e]=b.slice(),Ba[e]=b.slice()):ta[e]=Ba[e]=b;va[e]=d}function wa(){var a=c(),d=a.link,b=a.global;a.id=Na++;a.batchId="0";var e=d(Ma),g=a.shared={props:"a0"};
Object.keys(Ma).forEach(function(a){g[a]=b.def(e,".",a)});var h=a.next={},S=a.current={};Object.keys(va).forEach(function(a){Array.isArray(ta[a])&&(h[a]=b.def(g.next,".",a),S[a]=b.def(g.current,".",a))});var Oa=a.constants={};Object.keys(Ia).forEach(function(a){Oa[a]=b.def(JSON.stringify(Ia[a]))});a.invoke=function(z,L){switch(L.type){case 0:var b=["this",g.context,g.props,a.batchId];return z.def(d(L.data),".call(",b.slice(0,Math.max(L.data.length+1,4)),")");case 1:return z.def(g.props,L.data);case 2:return z.def(g.context,
L.data);case 3:return z.def("this",L.data);case 4:return L.data.append(a,z),L.data.ref}};a.attribCache={};var z={};a.scopeAttrib=function(a){a=m.id(a);if(a in z)return z[a];var A=na.scope[a];A||(A=na.scope[a]=new v);return z[a]=d(A)};return a}function oa(a){var d=a["static"];a=a.dynamic;var b;if("profile"in d){var c=!!d.profile;b=e(function(a,d){return c});b.enable=c}else if("profile"in a){var h=a.profile;b=g(h,function(a,d){return a.invoke(d,h)})}return b}function xa(a,d){var b=a["static"],c=a.dynamic;
...
function(a,d){var z=a.invoke(d,f),b=a.shared,A=b.framebuffer,z=d.def(A,".getFramebuffer(",z,")");d.set(A,".next",z);b=b.context;d.set(b,".framebufferWidth",z+"?"+z+".width:"+b+".drawingBufferWidth");d.set(b,".framebufferHeight",z+"?"+z+".height:"+b+".drawingBufferHeight");return z})}return null}function Q(a,d,b){function e(a){if(a in c){var z=c[a];a=!0;var b=z.x|0,L=z.y|0,A,f;"width"in z?A=z.width|0:a=!1;"height"in z?f=z.height|0:a=!1;return new u(!a&&d&&d.thisDep,!a&&d&&d.contextDep,!a&&d&&d.propDep,
function(a,d){var e=a.shared.context,B=A;"width"in z||(B=d.def(e,".","framebufferWidth","-",b));var c=f;"height"in z||(c=d.def(e,".","framebufferHeight","-",L));return[b,L,B,c]})}if(a in h){var S=h[a];a=g(S,function(a,d){var z=a.invoke(d,S),b=a.shared.context,L=d.def(z,".x|0"),A=d.def(z,".y|0"),e=d.def('"width" in ',z,"?",z,".width|0:","(",b,".","framebufferWidth","-",L,")"),z=d.def('"height" in ',z,"?",z,".height|0:","(",b,".","framebufferHeight","-",A,")");return[L,A,e,z]});d&&(a.thisDep=a.thisDep||
d.thisDep,a.contextDep=a.contextDep||d.contextDep,a.propDep=a.propDep||d.propDep);return a}return d?new u(d.thisDep,d.contextDep,d.propDep,function(a,d){var z=a.shared.context;return[0,0,d.def(z,".","framebufferWidth"),d.def(z,".","framebufferHeight")]}):null}var c=a["static"],h=a.dynamic;if(a=e("viewport")){var f=a;a=new u(a.thisDep,a.contextDep,a.propDep,function(a,d){var b=f.append(a,d),L=a.shared.context;d.set(L,".viewportWidth",b[2]);d.set(L,".viewportHeight",b[3]);return b})}return{viewport:a,
scissor_box:e("scissor.box")}}function ca(a){function d(a){if(a in b){var z=m.id(b[a]);a=e(function(){return z});a.id=z;return a}if(a in c){var A=c[a];return g(A,function(a,d){var z=a.invoke(d,A);return d.def(a.shared.strings,".id(",z,")")})}return null}var b=a["static"],c=a.dynamic,h=d("frag"),f=d("vert"),S=null;y(h)&&y(f)?(S=sa.program(f.id,h.id),a=e(function(a,d){return a.link(S)})):a=new u(h&&h.thisDep||f&&f.thisDep,h&&h.contextDep||f&&f.contextDep,h&&h.propDep||f&&f.propDep,function(a,d){var b=
a.shared.shader,L;L=h?h.append(a,d):d.def(b,".","frag");var A;A=f?f.append(a,d):d.def(b,".","vert");return d.def(b+".program("+A+","+L+")")});return{frag:h,vert:f,progVar:a,program:S}}function da(a,d){function b(a,d){if(a in c){var A=c[a]|0;return e(function(a,b){d&&(a.OFFSET=A);return A})}if(a in h){var L=h[a];return g(L,function(a,b){var A=a.invoke(b,L);d&&(a.OFFSET=A);return A})}return d&&f?e(function(a,d){a.OFFSET="0";return 0}):null}var c=a["static"],h=a.dynamic,f=function(){if("elements"in c){var a=
c.elements;l(a)?a=U.getElements(U.create(a,!0)):a&&(a=U.getElements(a));var d=e(function(d,b){if(a){var z=d.link(a);return d.ELEMENTS=z}return d.ELEMENTS=null});d.value=a;return d}if("elements"in h){var b=h.elements;return g(b,function(a,d){var z=a.shared,A=z.isBufferArgs,z=z.elements,e=a.invoke(d,b),B=d.def("null"),A=d.def(A,"(",e,")"),e=a.cond(A).then(B,"=",z,".createStream(",e,");")["else"](B,"=",z,".getElements(",e,");");d.entry(e);d.exit(a.cond(A).then(z,".destroyStream(",B,");"));return a.ELEMENTS=
B})}return null}(),S=b("offset",!0);return{elements:f,primitive:function(){if("primitive"in c){var a=c.primitive;return e(function(d,b){return I[a]})}if("primitive"in h){var d=h.primitive;return g(d,function(a,b){var A=a.constants.primTypes,e=a.invoke(b,d);return b.def(A,"[",e,"]")})}return f?y(f)?f.value?e(function(a,d){return d.def(a.ELEMENTS,".primType")}):e(function(){return 4}):new u(f.thisDep,f.contextDep,f.propDep,function(a,d){var b=a.ELEMENTS;return d.def(b,"?",b,".primType:",4)}):null}(),
...
a.OFFSET,":-1"):d.def(b,"?",b,".vertCount:-1")}):null}(),instances:b("instances",!1),offset:S}}function qa(a,d){var b=a["static"],c=a.dynamic,f={};Ha.forEach(function(a){function d(z,B){if(a in b){var L=z(b[a]);f[A]=e(function(){return L})}else if(a in c){var h=c[a];f[A]=g(h,function(a,d){return B(a,d,a.invoke(d,h))})}}var A=W(a);switch(a){case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":return d(function(a){return a},
function(a,d,b){return b});case "depth.func":return d(function(a){return J[a]},function(a,d,b){return d.def(a.constants.compareFuncs,"[",b,"]")});case "depth.range":return d(function(a){return a},function(a,d,b){a=d.def("+",b,"[0]");d=d.def("+",b,"[1]");return[a,d]});case "blend.func":return d(function(a){return[h["srcRGB"in a?a.srcRGB:a.src],h["dstRGB"in a?a.dstRGB:a.dst],h["srcAlpha"in a?a.srcAlpha:a.src],h["dstAlpha"in a?a.dstAlpha:a.dst]]},function(a,d,b){function A(a,z){return d.def('"',a,z,
'" in ',b,"?",b,".",a,z,":",b,".",a)}a=a.constants.blendFuncs;var e=A("src","RGB"),B=A("dst","RGB"),e=d.def(a,"[",e,"]"),c=d.def(a,"[",A("src","Alpha"),"]"),B=d.def(a,"[",B,"]");a=d.def(a,"[",A("dst","Alpha"),"]");return[e,B,c,a]});case "blend.equation":return d(function(a){if("string"===typeof a)return[ia[a],ia[a]];if("object"===typeof a)return[ia[a.rgb],ia[a.alpha]]},function(a,d,b){var A=a.constants.blendEquations,e=d.def(),B=d.def();a=a.cond("typeof ",b,'==="string"');a.then(e,"=",B,"=",A,"[",
b,"];");a["else"](e,"=",A,"[",b,".rgb];",B,"=",A,"[",b,".alpha];");d(a);return[e,B]});case "blend.color":return d(function(a){return t(4,function(d){return+a[d]})},function(a,d,b){return t(4,function(a){return d.def("+",b,"[",a,"]")})});case "stencil.mask":return d(function(a){return a|0},function(a,d,b){return d.def(b,"|0")});case "stencil.func":return d(function(a){return[J[a.cmp||"keep"],a.ref||0,"mask"in a?a.mask:-1]},function(a,d,b){a=d.def('"cmp" in ',b,"?",a.constants.compareFuncs,"[",b,".cmp]",
":",7680);var A=d.def(b,".ref|0");d=d.def('"mask" in ',b,"?",b,".mask|0:-1");return[a,A,d]});case "stencil.opFront":case "stencil.opBack":return d(function(d){return["stencil.opBack"===a?1029:1028,F[d.fail||"keep"],F[d.zfail||"keep"],F[d.zpass||"keep"]]},function(d,b,A){function e(a){return b.def('"',a,'" in ',A,"?",B,"[",A,".",a,"]:",7680)}var B=d.constants.stencilOps;return["stencil.opBack"===a?1029:1028,e("fail"),e("zfail"),e("zpass")]});case "polygonOffset.offset":return d(function(a){return[a.factor|
...
function(a,d,b){return t(4,function(a){return"!!"+b+"["+a+"]"})});case "sample.coverage":return d(function(a){return["value"in a?a.value:1,!!a.invert]},function(a,d,b){a=d.def('"value" in ',b,"?+",b,".value:1");d=d.def("!!",b,".invert");return[a,d]})}});return f}function ea(a,d){var b=a["static"],c=a.dynamic,f={};Object.keys(b).forEach(function(a){var d=b[a],A;if("number"===typeof d||"boolean"===typeof d)A=e(function(){return d});else if("function"===typeof d){var B=d._reglType;if("texture2d"===B||
"textureCube"===B)A=e(function(a){return a.link(d)});else if("framebuffer"===B||"framebufferCube"===B)A=e(function(a){return a.link(d.color[0])})}else C(d)&&(A=e(function(a){return a.global.def("[",t(d.length,function(a){return d[a]}),"]")}));A.value=d;f[a]=A});Object.keys(c).forEach(function(a){var d=c[a];f[a]=g(d,function(a,b){return a.invoke(b,d)})});return f}function X(a,d){var b=a["static"],c=a.dynamic,f={};Object.keys(b).forEach(function(a){var d=b[a],A=m.id(a),B=new v;if(l(d))B.state=1,B.buffer=
x.getBuffer(x.create(d,34962,!1,!0)),B.type=B.buffer.dtype;else{var c=x.getBuffer(d);if(c)B.state=1,B.buffer=c,B.type=c.dtype;else if(d.constant){var h=d.constant;B.buffer="null";B.state=2;"number"===typeof h?B.x=h:H.forEach(function(a,d){d<h.length&&(B[a]=h[d])})}else{var c=l(d.buffer)?x.getBuffer(x.create(d.buffer,34962,!1,!0)):x.getBuffer(d.buffer),g=d.offset|0,r=d.stride|0,n=d.size|0,p=!!d.normalized,k=0;"type"in d&&(k=w[d.type]);d=d.divisor|0;B.buffer=c;B.state=1;B.size=n;B.normalized=p;B.type=
k||c.dtype;B.offset=g;B.stride=r;B.divisor=d}}f[a]=e(function(a,d){var b=a.attribCache;if(A in b)return b[A];var e={isStream:!1};Object.keys(B).forEach(function(a){e[a]=B[a]});B.buffer&&(e.buffer=a.link(B.buffer));return b[A]=e})});Object.keys(c).forEach(function(a){var d=c[a];f[a]=g(d,function(a,b){function A(a){b(h[a],"=",B,".",a,"|0;")}var B=a.invoke(b,d),e=a.shared,c=e.isBufferArgs,f=e.buffer,h={isStream:b.def(!1)},g=new v;g.state=1;Object.keys(g).forEach(function(a){h[a]=b.def(""+g[a])});var r=
h.buffer,n=h.type;b("if(",c,"(",B,")){",h.isStream,"=true;",r,"=",f,".createStream(",34962,",",B,");",n,"=",r,".dtype;","}else{",r,"=",f,".getBuffer(",B,");","if(",r,"){",n,"=",r,".dtype;",'}else if("constant" in ',B,"){",h.state,"=",2,";","if(typeof "+B+'.constant === "number"){',h[H[0]],"=",B,".constant;",H.slice(1).map(function(a){return h[a]}).join("="),"=0;","}else{",H.map(function(a,d){return h[a]+"="+B+".constant.length>="+d+"?"+B+".constant["+d+"]:0;"}).join(""),"}}else{","if(",c,"(",B,".buffer)){",
r,"=",f,".createStream(",34962,",",B,".buffer);","}else{",r,"=",f,".getBuffer(",B,".buffer);","}",n,'="type" in ',B,"?",e.glTypes,"[",B,".type]:",r,".dtype;",h.normalized,"=!!",B,".normalized;");A("size");A("offset");A("stride");A("divisor");b("}}");b.exit("if(",h.isStream,"){",f,".destroyStream(",r,");","}");return h})});return f}function ra(a){var d=a["static"],b=a.dynamic,c={};Object.keys(d).forEach(function(a){var b=d[a];c[a]=e(function(a,d){return"number"===typeof b||"boolean"===typeof b?""+
...
f,".cur=",a,";");e||d("}")}function ja(a,d,b){var e=a.shared,c=e.gl,h=a.current,f=a.next,g=e.current,r=e.next,v=a.cond(g,".dirty");Ha.forEach(function(d){d=W(d);if(!(d in b.state)){var e,B;if(d in f){e=f[d];B=h[d];var n=t(ta[d].length,function(a){return v.def(e,"[",a,"]")});v(a.cond(n.map(function(a,d){return a+"!=="+B+"["+d+"]"}).join("||")).then(c,".",va[d],"(",n,");",n.map(function(a,d){return B+"["+d+"]="+a}).join(";"),";"))}else e=v.def(r,".",d),n=a.cond(e,"!==",g,".",d),v(n),d in ua?n(a.cond(e).then(c,
...
f[a];b(r,".",va[a],"(",v,");",v.map(function(a,d){return p+"["+d+"]="+a}).join(";"),";")}else b(r,".",va[a],"(",v,");",g,".",a,"=",v,";")}})}function T(a,d){Ca&&!a.instancing&&(a.instancing=d.def(a.shared.extensions,".angle_instanced_arrays"))}function Y(a,d,b,e,c){function h(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function f(a){k=d.def();a(k,"=",h(),";");"string"===typeof c?a(n,".count+=",c,";"):a(n,".count++;");aa&&(e?(q=d.def(),a(q,"=",l,".getNumPendingQueries();")):
a(l,".beginQuery(",n,");"))}function g(a){a(n,".cpuTime+=",h(),"-",k,";");aa&&(e?a(l,".pushScopeStats(",q,",",l,".getNumPendingQueries(),",n,");"):a(l,".endQuery();"))}function r(a){var b=d.def(p,".profile");d(p,".profile=",a,";");d.exit(p,".profile=",b,";")}var v=a.shared,n=a.stats,p=v.current,l=v.timer;b=b.profile;var k,q;if(b){if(y(b)){b.enable?(f(d),g(d.exit),r("true")):r("false");return}b=b.append(a,d);r(b)}else b=d.def(p,".profile");v=a.block();f(v);d("if(",b,"){",v,"}");a=a.block();g(a);d.exit("if(",
b,"){",a,"}")}function Z(a,d,e,c,h){function f(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function g(b,e,c){function h(){d("if(!",p,".buffer){",v,".enableVertexAttribArray(",n,");}");var b=c.type,f;f=c.size?d.def(c.size,"||",e):e;d("if(",p,".type!==",b,"||",p,".size!==",f,"||",q.map(function(a){return p+"."+a+"!=="+c[a]}).join("||"),"){",v,".bindBuffer(",34962,",",l,".buffer);",v,".vertexAttribPointer(",
...
else if("float"===C||"float32"===C)w="rgba32f";"colorFormat"in a&&(w=a.colorFormat,0<=Ga.indexOf(w)?m=!0:0<=ya.indexOf(w)&&(m=!1))}if("depthTexture"in a||"depthStencilTexture"in a)Aa=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?k=a.depth:(F=a.depth,t=!1));"stencil"in a&&("boolean"===typeof a.stencil?t=a.stencil:(G=a.stencil,k=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?k=t=a.depthStencil:(J=a.depthStencil,t=k=!1))}else e=l=1;var K=null,la=null,
M=null,U=null;if(Array.isArray(c))K=c.map(H);else if(c)K=[H(c)];else for(K=Array(D),c=0;c<D;++c)K[c]=n(e,l,m,w,C);e=e||K[0].width;l=l||K[0].height;F?la=H(F):k&&!t&&(la=n(e,l,Aa,"depth","uint32"));G?M=H(G):t&&!k&&(M=n(e,l,!1,"stencil","uint8"));J?U=H(J):!F&&!G&&t&&k&&(U=n(e,l,Aa,"depth stencil","depth stencil"));k=null;for(c=0;c<K.length;++c)I(K[c],e,l),K[c]&&K[c].texture&&(t=u[K[c].texture._texture.format]*y[K[c].texture._texture.type],null===k&&(k=t));I(la,e,l);I(M,e,l);I(U,e,l);q(g);g.width=e;g.height=
l;g.colorAttachments=K;g.depthAttachment=la;g.stencilAttachment=M;g.depthStencilAttachment=U;f.color=K.map(h);f.depth=h(la);f.stencil=h(M);f.depthStencil=h(U);f.width=g.width;f.height=g.height;x(g);return f}var g=new F;G.framebufferCount++;f(c,e);return a(f,{resize:function(a,b){var c=a|0,e=b|0||c;if(c===g.width&&e===g.height)return f;for(var h=g.colorAttachments,n=0;n<h.length;++n)J(h[n],c,e);J(g.depthAttachment,c,e);J(g.stencilAttachment,c,e);J(g.depthStencilAttachment,c,e);g.width=f.width=c;g.height=
