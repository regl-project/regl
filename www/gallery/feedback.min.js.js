...
F.getBuffer(F.create(a,34962,!1,!0)),B.type=0;else{var c=F.getBuffer(a);if(c)B.state=1,B.buffer=c,B.type=0;else if(a.constant){var f=a.constant;B.buffer="null";B.state=2;"number"===typeof f?B.x=f:H.forEach(function(d,a){a<f.length&&(B[d]=f[a])})}else{var c=h(a.buffer)?F.getBuffer(F.create(a.buffer,34962,!1,!0)):F.getBuffer(a.buffer),l=a.offset|0,x=a.stride|0,u=a.size|0,p=!!a.normalized,k=0;"type"in a&&(k=v[a.type]);a=a.divisor|0;B.buffer=c;B.state=1;B.size=u;B.normalized=p;B.type=k||c.dtype;B.offset=
l;B.stride=x;B.divisor=a}}g[d]=e(function(d,a){var b=d.attribCache;if(w in b)return b[w];var e={isStream:!1};Object.keys(B).forEach(function(d){e[d]=B[d]});B.buffer&&(e.buffer=d.link(B.buffer),e.type=e.type||e.buffer+".dtype");return b[w]=e})});Object.keys(c).forEach(function(d){var a=c[d];g[d]=f(a,function(d,b){function w(d){b(f[d],"=",e,".",d,"|0;")}var e=d.invoke(b,a),B=d.shared,c=B.isBufferArgs,g=B.buffer,f={isStream:b.def(!1)},l=new da;l.state=1;Object.keys(l).forEach(function(d){f[d]=b.def(""+
l[d])});var x=f.buffer,u=f.type;b("if(",c,"(",e,")){",f.isStream,"=true;",x,"=",g,".createStream(",34962,",",e,");",u,"=",x,".dtype;","}else{",x,"=",g,".getBuffer(",e,");","if(",x,"){",u,"=",x,".dtype;",'}else if("constant" in ',e,"){",f.state,"=",2,";","if(typeof "+e+'.constant === "number"){',f[H[0]],"=",e,".constant;",H.slice(1).map(function(d){return f[d]}).join("="),"=0;","}else{",H.map(function(d,a){return f[d]+"="+e+".constant.length>="+a+"?"+e+".constant["+a+"]:0;"}).join(""),"}}else{","if(",
c,"(",e,".buffer)){",x,"=",g,".createStream(",34962,",",e,".buffer);","}else{",x,"=",g,".getBuffer(",e,".buffer);","}",u,'="type" in ',e,"?",B.glTypes,"[",e,".type]:",x,".dtype;",f.normalized,"=!!",e,".normalized;");w("size");w("offset");w("stride");w("divisor");b("}}");b.exit("if(",f.isStream,"){",g,".destroyStream(",x,");","}");return f})});return g}function ta(d){var a=d["static"],b=d.dynamic,c={};Object.keys(a).forEach(function(d){var b=a[d];c[d]=e(function(d,a){return"number"===typeof b||"boolean"===
typeof b?""+b:d.link(b)})});Object.keys(b).forEach(function(d){var a=b[d];c[d]=f(a,function(d,b){return d.invoke(b,a)})});return c}function ra(d,a,b,e,c){var g=Aa(d,c),f=R(d,g,c),x=ha(d,c),l=sa(d,c),u=ga(d,c),h=f.viewport;h&&(l.viewport=h);h=W("scissor.box");(f=f[h])&&(l[h]=f);f=0<Object.keys(l).length;g={framebuffer:g,draw:x,shader:u,state:l,dirty:f};g.profile=qa(d,c);g.uniforms=ia(b,c);g.attributes=X(a,c);g.context=ta(e,c);return g}function M(d,a,b){var e=d.shared.context,c=d.scope();Object.keys(b).forEach(function(g){a.save(e,
...
typeof q||0<=q)?"string"===typeof q?(b("if(",q,">0){"),g(),b("}else if(",q,"<0){"),f(),b("}")):g():f()}function Ca(d,a,b,e,c){a=ya();c=a.proc("body",c);la&&(a.instancing=c.def(a.shared.extensions,".angle_instanced_arrays"));d(a,c,b,e);return a.compile().body}function Da(d,a,b,e){S(d,a);Y(d,a,b,e.attributes,function(){return!0});fa(d,a,b,e.uniforms,function(){return!0});ca(d,a,a,b)}function Ea(d,a){var b=d.proc("draw",1);S(d,b);M(d,b,a.context);ba(d,b,a.framebuffer);ea(d,b,a);Q(d,b,a.state);V(d,b,
a,!1,!0);var e=a.shader.progVar.append(d,b);b(d.shared.gl,".useProgram(",e,".program);");if(a.shader.program)Da(d,b,a,a.shader.program);else{var c=d.global.def("{}"),g=b.def(e,".id"),f=b.def(c,"[",g,"]");b(d.cond(f).then(f,".call(this,a0);")["else"](f,"=",c,"[",g,"]=",d.link(function(b){return Ca(Da,d,a,b,1)}),"(",e,");",f,".call(this,a0);"))}0<Object.keys(a.state).length&&b(d.shared.current,".dirty=true;")}function Fa(d,a,b,e){function c(){return!0}d.batchId="a1";S(d,a);Y(d,a,b,e.attributes,c);fa(d,
a,b,e.uniforms,c);ca(d,a,a,b)}function ua(d,a,b,e){function c(d){return d.contextDep&&f||d.propDep}function g(d){return!c(d)}S(d,a);var f=b.contextDep,u=a.def(),l=a.def();d.shared.props=l;d.batchId=u;var x=d.scope(),p=d.scope();a(x.entry,"for(",u,"=0;",u,"<","a1",";++",u,"){",l,"=","a0","[",u,"];",p,"}",x.exit);b.needsContext&&M(d,p,b.context);b.needsFramebuffer&&ba(d,p,b.framebuffer);Q(d,p,b.state,c);b.profile&&c(b.profile)&&V(d,p,b,!1,!0);e?(Y(d,x,b,e.attributes,g),Y(d,p,b,e.attributes,c),fa(d,
x,b,e.uniforms,g),fa(d,p,b,e.uniforms,c),ca(d,x,p,b)):(a=d.global.def("{}"),e=b.shader.progVar.append(d,p),l=p.def(e,".id"),x=p.def(a,"[",l,"]"),p(d.shared.gl,".useProgram(",e,".program);","if(!",x,"){",x,"=",a,"[",l,"]=",d.link(function(a){return Ca(Fa,d,b,a,2)}),"(",e,");}",x,".call(this,a0[",u,"],",u,");"))}function Ma(d,a){function b(d){return d.contextDep&&c||d.propDep}var e=d.proc("batch",2);d.batchId="0";S(d,e);var c=!1,g=!0;Object.keys(a.context).forEach(function(d){c=c||a.context[d].propDep});
c||(M(d,e,a.context),g=!1);var f=a.framebuffer,u=!1;f?(f.propDep?c=u=!0:f.contextDep&&c&&(u=!0),u||ba(d,e,f)):ba(d,e,null);a.state.viewport&&a.state.viewport.propDep&&(c=!0);ea(d,e,a);Q(d,e,a.state,function(d){return!b(d)});a.profile&&b(a.profile)||V(d,e,a,!1,"a1");a.contextDep=c;a.needsContext=g;a.needsFramebuffer=u;g=a.shader.progVar;if(g.contextDep&&c||g.propDep)ua(d,e,a,null);else if(g=g.append(d,e),e(d.shared.gl,".useProgram(",g,".program);"),a.shader.program)ua(d,e,a,a.shader.program);else{var f=
d.global.def("{}"),u=e.def(g,".id"),l=e.def(f,"[",u,"]");e(d.cond(l).then(l,".call(this,a0,a1);")["else"](l,"=",f,"[",u,"]=",d.link(function(b){return Ca(ua,d,a,b,2)}),"(",g,");",l,".call(this,a0,a1);"))}0<Object.keys(a.state).length&&e(d.shared.current,".dirty=true;")}function Ja(d,b){function e(a){var f=b.shader[a];f&&c.set(g.shader,"."+a,f.append(d,c))}var c=d.proc("scope",3);d.batchId="a2";var g=d.shared,f=g.current;M(d,c,b.context);b.framebuffer&&b.framebuffer.append(d,c);a(Object.keys(b.state)).forEach(function(a){var e=
b.state[a].append(d,c);z(e)?e.forEach(function(b,e){c.set(d.next[a],"["+e+"]",b)}):c.set(g.next,"."+a,e)});V(d,c,b,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(a){var e=b.draw[a];e&&c.set(g.draw,"."+a,""+e.append(d,c))});Object.keys(b.uniforms).forEach(function(a){c.set(g.uniforms,"["+m.id(a)+"]",b.uniforms[a].append(d,c))});Object.keys(b.attributes).forEach(function(a){var e=b.attributes[a].append(d,c),g=d.scopeAttrib(a);Object.keys(new da).forEach(function(d){c.set(g,
"."+d,e[d])})});e("vert");e("frag");0<Object.keys(b.state).length&&(c(f,".dirty=true;"),c.exit(f,".dirty=true;"));c("a1(",d.shared.context,",a0,",d.batchId,");")}function Ka(d){if("object"===typeof d&&!z(d)){for(var a=Object.keys(d),b=0;b<a.length;++b)if(q.isDynamic(d[a[b]]))return!0;return!1}}function La(d,a,b){function e(d,a){u.forEach(function(b){var e=c[b];q.isDynamic(e)&&(e=d.invoke(a,e),a(h,".",b,"=",e,";"))})}var c=a["static"][b];if(c&&Ka(c)){var g=d.global,u=Object.keys(c),l=!1,x=!1,p=!1,
h=d.global.def("{}");u.forEach(function(a){var b=c[a];if(q.isDynamic(b))"function"===typeof b&&(b=c[a]=q.unbox(b)),a=f(b,null),l=l||a.thisDep,p=p||a.propDep,x=x||a.contextDep;else{g(h,".",a,"=");switch(typeof b){case "number":g(b);break;case "string":g('"',b,'"');break;case "object":Array.isArray(b)&&g("[",b.join(),"]");break;default:g(d.link(b))}g(";")}});a.dynamic[b]=new q.DynamicVariable(4,{thisDep:l,contextDep:x,propDep:p,ref:h,append:e});delete a["static"][b]}}var da=pa.Record,ka={add:32774,
...
[1029],Ia.drawBuffer=A(G.maxDrawbuffers,function(d){return 0===d?[0]:A(d,function(d){return 36064+d})}));var Pa=0;return{next:x,current:u,procs:function(){var d=ya(),a=d.proc("poll"),b=d.proc("refresh"),e=d.block();a(e);b(e);var c=d.shared,g=c.gl,f=c.next,l=c.current;e(l,".dirty=false;");ba(d,a);ba(d,b,null,!0);var x=k.getExtension("angle_instanced_arrays"),p;x&&(p=d.link(x));for(var h=0;h<G.maxAttributes;++h){var n=b.def(c.attributes,"[",h,"]"),t=d.cond(n,".buffer");t.then(g,".enableVertexAttribArray(",
h,");",g,".bindBuffer(",34962,",",n,".buffer.buffer);",g,".vertexAttribPointer(",h,",",n,".size,",n,".type,",n,".normalized,",n,".stride,",n,".offset);")["else"](g,".disableVertexAttribArray(",h,");",g,".vertexAttrib4f(",h,",",n,".x,",n,".y,",n,".z,",n,".w);",n,".buffer=null;");b(t);x&&b(p,".vertexAttribDivisorANGLE(",h,",",n,".divisor);")}Object.keys(wa).forEach(function(c){var u=wa[c],x=e.def(f,".",c),p=d.block();p("if(",x,"){",g,".enable(",u,")}else{",g,".disable(",u,")}",l,".",c,"=",x,";");b(p);
a("if(",x,"!==",l,".",c,"){",p,"}")});Object.keys(xa).forEach(function(c){var x=xa[c],p=u[c],h,n,k=d.block();k(g,".",x,"(");z(p)?(x=p.length,h=d.global.def(f,".",c),n=d.global.def(l,".",c),k(A(x,function(d){return h+"["+d+"]"}),");",A(x,function(d){return n+"["+d+"]="+h+"["+d+"];"}).join("")),a("if(",A(x,function(d){return h+"["+d+"]!=="+n+"["+d+"]"}).join("||"),"){",k,"}")):(h=e.def(f,".",c),n=e.def(l,".",c),k(h,");",l,".",c,"=",h,";"),a("if(",h,"!==",n,"){",k,"}"));b(k)});return d.compile()}(),
...
C=0;C<w;++C)for(var ca=0;ca<p;++ca)for(var K=0;K<m;++K)A[H++]=f[g*ca+k*C+l*K+c];e(d,A)}else if("[object HTMLCanvasElement]"===t(c)||"[object CanvasRenderingContext2D]"===t(c))"[object HTMLCanvasElement]"===t(c)?d.element=c:d.element=c.canvas,d.width=d.element.width,d.height=d.element.height;else if("[object HTMLImageElement]"===t(c))d.element=c,d.width=c.naturalWidth,d.height=c.naturalHeight;else if("[object HTMLVideoElement]"===t(c))d.element=c,d.width=c.videoWidth,d.height=c.videoHeight;else if(a(c)){f=
c[0].length;g=c.length;k=1;if(J(c[0][0])){l=k=c[0][0].length;p=z.allocType(36193===d.type?5126:d.type,f*g*l);for(m=w=0;m<g;++m)for(A=c[m],H=0;H<f;++H)for(C=A[H],ca=0;ca<l;++ca)p[w++]=C[ca];e(d,p)}else{l=z.allocType(36193===d.type?5126:d.type,f*g);for(w=p=0;w<g;++w)for(m=c[w],A=0;A<f;++A)l[p++]=m[A];e(d,l)}d.alignment=1;d.width=f;d.height=g;d.channels=k;d.format=d.internalformat=n[k];d.needsFree=!0}}function Z(a,c,e,f,g){var h=a.element,k=a.data,l=a.internalformat,q=a.format,p=a.type,n=a.width,t=a.height;
pa(a);h?b.texSubImage2D(c,g,e,f,q,p,h):a.compressed?b.compressedTexSubImage2D(c,g,e,f,l,n,t,k):a.needsCopy?(m(),b.copyTexSubImage2D(c,g,e,f,a.xOffset,a.yOffset,n,t)):b.texSubImage2D(c,g,e,f,n,t,q,p,k)}function aa(){return Ja.pop()||new va}function ja(a){a.needsFree&&z.freeType(a.data);va.call(a);Ja.push(a)}function W(){oa.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function N(a,b,c){var e=a.images[0]=aa();a.mipmask=1;e.width=a.width=b;e.height=a.height=
c}function E(a,b){var c=null;if(y(b))c=a.images[0]=aa(),P(c,a),p(c,b),a.mipmask=1;else if(T(a,b),Array.isArray(b.mipmap))for(var e=b.mipmap,f=0;f<e.length;++f)c=a.images[f]=aa(),P(c,a),c.width>>=f,c.height>>=f,p(c,e[f]),a.mipmask|=1<<f;else c=a.images[0]=aa(),P(c,a),p(c,b),a.mipmask=1;P(a,a.images[0])}function ya(a,c){for(var e=a.images,f=0;f<e.length&&e[f];++f){var g=e[f],h=c,k=f,l=g.element,q=g.data,p=g.internalformat,n=g.format,t=g.type,v=g.width,r=g.height;pa(g);l?b.texImage2D(h,k,n,n,t,l):g.compressed?
b.compressedTexImage2D(h,k,p,v,r,0,q):g.needsCopy?(m(),b.copyTexImage2D(h,k,n,g.xOffset,g.yOffset,v,r,0)):b.texImage2D(h,k,n,v,r,0,n,t,q)}}function qa(){var a=Ka.pop()||new W;oa.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function Aa(a){for(var b=a.images,c=0;c<b.length;++c)b[c]&&ja(b[c]),b[c]=null;Ka.push(a)}function R(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;this.mipmapHint=4352}function ga(a,b){"min"in b&&(a.minFilter=
ea[b.min],0<=H.indexOf(a.minFilter)&&(a.genMipmaps=!0));"mag"in b&&(a.magFilter=ba[b.mag]);var c=a.wrapS,e=a.wrapT;if("wrap"in b){var f=b.wrap;"string"===typeof f?c=e=M[f]:Array.isArray(f)&&(c=M[f[0]],e=M[f[1]])}else"wrapS"in b&&(c=M[b.wrapS]),"wrapT"in b&&(e=M[b.wrapT]);a.wrapS=c;a.wrapT=e;"anisotropic"in b&&(a.anisotropic=b.anisotropic);if("mipmap"in b){c=!1;switch(typeof b.mipmap){case "string":a.mipmapHint=ra[b.mipmap];c=a.genMipmaps=!0;break;case "boolean":c=a.genMipmaps=b.mipmap;break;case "object":a.genMipmaps=
!1,c=!0}!c||"min"in b||(a.minFilter=9984)}}function ha(a,c){b.texParameteri(c,10241,a.minFilter);b.texParameteri(c,10240,a.magFilter);b.texParameteri(c,10242,a.wrapS);b.texParameteri(c,10243,a.wrapT);k.ext_texture_filter_anisotropic&&b.texParameteri(c,34046,a.anisotropic);a.genMipmaps&&(b.hint(33170,a.mipmapHint),b.generateMipmap(c))}function sa(a){oa.call(this);this.mipmask=0;this.internalformat=6408;this.id=La++;this.refCount=1;this.target=a;this.texture=b.createTexture();this.unit=-1;this.bindCount=
0;this.texInfo=new R;I.profile&&(this.stats={size:0})}function ia(a){b.activeTexture(33984);b.bindTexture(a.target,a.texture)}function X(){var a=la[0];a?b.bindTexture(a.target,a.texture):b.bindTexture(3553,null)}function ta(a){var c=a.texture,e=a.unit,f=a.target;0<=e&&(b.activeTexture(33984+e),b.bindTexture(f,null),la[e]=null);b.deleteTexture(c);a.texture=null;a.params=null;a.pixels=null;a.refCount=0;delete da[a.id];C.textureCount--}var ra={"don't care":4352,"dont care":4352,nice:4354,fast:4353},
M={repeat:10497,clamp:33071,mirror:33648},ba={nearest:9728,linear:9729},ea=c({mipmap:9987,"nearest mipmap nearest":9984,"linear mipmap nearest":9985,"nearest mipmap linear":9986,"linear mipmap linear":9987},ba),Q={none:0,browser:37444},S={uint8:5121,rgba4:32819,rgb565:33635,"rgb5 a1":32820},V={alpha:6406,luminance:6409,"luminance alpha":6410,rgb:6407,rgba:6408,rgba4:32854,"rgb5 a1":32855,rgb565:36194},Y={};k.ext_srgb&&(V.srgb=35904,V.srgba=35906);k.oes_texture_float&&(S.float32=S["float"]=5126);k.oes_texture_half_float&&
