...
w(e.length,function(a){return e[a]}),"]")}));u.value=e;f[a]=u});Object.keys(c).forEach(function(a){var e=c[a];f[a]=m(e,function(a,b){return a.invoke(b,e)})});return f}function U(a,e){var b=a["static"],c=a.dynamic,f={};Object.keys(b).forEach(function(a){var e=b[a],u=n.id(a),c=new aa;if(l(e))c.state=1,c.buffer=G.getBuffer(G.create(e,34962,!1,!0)),c.type=c.buffer.dtype;else{var L=G.getBuffer(e);if(L)c.state=1,c.buffer=L,c.type=L.dtype;else if(e.constant){var k=e.constant;c.buffer="null";c.state=2;"number"===
typeof k?c.x=k:D.forEach(function(a,e){e<k.length&&(c[a]=k[e])})}else{var L=l(e.buffer)?G.getBuffer(G.create(e.buffer,34962,!1,!0)):G.getBuffer(e.buffer),m=e.offset|0,g=e.stride|0,x=e.size|0,y=!!e.normalized,p=0;"type"in e&&(p=v[e.type]);e=e.divisor|0;c.buffer=L;c.state=1;c.size=x;c.normalized=y;c.type=p||L.dtype;c.offset=m;c.stride=g;c.divisor=e}}f[a]=d(function(a,e){var b=a.attribCache;if(u in b)return b[u];var d={isStream:!1};Object.keys(c).forEach(function(a){d[a]=c[a]});c.buffer&&(d.buffer=a.link(c.buffer));
return b[u]=d})});Object.keys(c).forEach(function(a){var e=c[a];f[a]=m(e,function(a,b){function u(a){b(k[a],"=",d,".",a,"|0;")}var d=a.invoke(b,e),c=a.shared,L=c.isBufferArgs,f=c.buffer,k={isStream:b.def(!1)},m=new aa;m.state=1;Object.keys(m).forEach(function(a){k[a]=b.def(""+m[a])});var g=k.buffer,x=k.type;b("if(",L,"(",d,")){",k.isStream,"=true;",g,"=",f,".createStream(",34962,",",d,");",x,"=",g,".dtype;","}else{",g,"=",f,".getBuffer(",d,");","if(",g,"){",x,"=",g,".dtype;",'}else if("constant" in ',
d,"){",k.state,"=",2,";","if(typeof "+d+'.constant === "number"){',k[D[0]],"=",d,".constant;",D.slice(1).map(function(a){return k[a]}).join("="),"=0;","}else{",D.map(function(a,e){return k[a]+"="+d+".constant.length>="+e+"?"+d+".constant["+e+"]:0;"}).join(""),"}}else{","if(",L,"(",d,".buffer)){",g,"=",f,".createStream(",34962,",",d,".buffer);","}else{",g,"=",f,".getBuffer(",d,".buffer);","}",x,'="type" in ',d,"?",c.glTypes,"[",d,".type]:",g,".dtype;",k.normalized,"=!!",d,".normalized;");u("size");
u("offset");u("stride");u("divisor");b("}}");b.exit("if(",k.isStream,"){",f,".destroyStream(",g,");","}");return k})});return f}function qa(a){var e=a["static"],b=a.dynamic,c={};Object.keys(e).forEach(function(a){var b=e[a];c[a]=d(function(a,e){return"number"===typeof b||"boolean"===typeof b?""+b:a.link(b)})});Object.keys(b).forEach(function(a){var e=b[a];c[a]=m(e,function(a,b){return a.invoke(b,e)})});return c}function oa(a,e,b,d,c){var f=ya(a,c),k=Q(a,f,c),m=ea(a,c),g=pa(a,c),x=da(a,c),y=k.viewport;
y&&(g.viewport=y);y=T("scissor.box");(k=k[y])&&(g[y]=k);k=0<Object.keys(g).length;f={framebuffer:f,draw:m,shader:x,state:g,dirty:k};f.profile=na(a,c);f.uniforms=fa(b,c);f.attributes=U(e,c);f.context=qa(d,c);return f}function J(a,e,b){var d=a.shared.context,c=a.scope();Object.keys(b).forEach(function(f){e.save(d,"."+f);c(d,".",f,"=",b[f].append(a,e),";")});e(c)}function Y(a,b,d,c){var f=a.shared,k=f.gl,m=f.framebuffer,g;e&&(g=b.def(f.extensions,".webgl_draw_buffers"));var x=a.constants,f=x.drawBuffer,
x=x.backBuffer;a=d?d.append(a,b):b.def(m,".next");c||b("if(",a,"!==",m,".cur){");b("if(",a,"){",k,".bindFramebuffer(",36160,",",a,".framebuffer);");e&&b(g,".drawBuffersWEBGL(",f,"[",a,".colorAttachments.length]);");b("}else{",k,".bindFramebuffer(",36160,",null);");e&&b(g,".drawBuffersWEBGL(",x,");");b("}",m,".cur=",a,";");c||b("}")}function ba(a,e,b){var d=a.shared,c=d.gl,f=a.current,k=a.next,m=d.current,g=d.next,x=a.cond(m,".dirty");Ga.forEach(function(e){e=T(e);if(!(e in b.state)){var d,L;if(e in
k){d=k[e];L=f[e];var p=w(y[e].length,function(a){return x.def(d,"[",a,"]")});x(a.cond(p.map(function(a,e){return a+"!=="+L+"["+e+"]"}).join("||")).then(c,".",wa[e],"(",p,");",p.map(function(a,e){return L+"["+e+"]="+a}).join(";"),";"))}else d=x.def(g,".",e),p=a.cond(d,"!==",m,".",e),x(p),e in va?p(a.cond(d).then(c,".enable(",va[e],");")["else"](c,".disable(",va[e],");"),m,".",e,"=",d,";"):p(c,".",wa[e],"(",d,");",m,".",e,"=",d,";")}});0===Object.keys(b.state).length&&x(m,".dirty=false;");e(x)}function P(e,
b,d,c){var f=e.shared,k=e.current,m=f.current,g=f.gl;a(Object.keys(d)).forEach(function(a){var f=d[a];if(!c||c(f)){var x=f.append(e,b);if(va[a]){var y=va[a];C(f)?x?b(g,".enable(",y,");"):b(g,".disable(",y,");"):b(e.cond(x).then(g,".enable(",y,");")["else"](g,".disable(",y,");"));b(m,".",a,"=",x,";")}else if(z(x)){var p=k[a];b(g,".",wa[a],"(",x,");",x.map(function(a,e){return p+"["+e+"]="+a}).join(";"),";")}else b(g,".",wa[a],"(",x,");",m,".",a,"=",x,";")}})}function R(a,e){ia&&(a.instancing=e.def(a.shared.extensions,
".angle_instanced_arrays"))}function S(a,e,b,d,c){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function k(a){h=e.def();a(h,"=",f(),";");"string"===typeof c?a(y,".count+=",c,";"):a(y,".count++;");X&&(d?(q=e.def(),a(q,"=",l,".getNumPendingQueries();")):a(l,".beginQuery(",y,");"))}function m(a){a(y,".cpuTime+=",f(),"-",h,";");X&&(d?a(l,".pushScopeStats(",q,",",l,".getNumPendingQueries(),",y,");"):a(l,".endQuery();"))}function g(a){var b=e.def(p,".profile");e(p,
".profile=",a,";");e.exit(p,".profile=",b,";")}var x=a.shared,y=a.stats,p=x.current,l=x.timer;b=b.profile;var h,q;if(b){if(C(b)){b.enable?(k(e),m(e.exit),g("true")):g("false");return}b=b.append(a,e);g(b)}else b=e.def(p,".profile");x=a.block();k(x);e("if(",b,"){",x,"}");a=a.block();m(a);e.exit("if(",b,"){",a,"}")}function V(a,e,d,c,f){function k(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}
function m(b,d,c){function f(){e("if(!",p,".buffer){",g,".enableVertexAttribArray(",y,");}");var b=c.type,k;k=c.size?e.def(c.size,"||",d):d;e("if(",p,".type!==",b,"||",p,".size!==",k,"||",q.map(function(a){return p+"."+a+"!=="+c[a]}).join("||"),"){",g,".bindBuffer(",34962,",",l,".buffer);",g,".vertexAttribPointer(",[y,k,b,c.normalized,c.stride,c.offset],");",p,".type=",b,";",p,".size=",k,";",q.map(function(a){return p+"."+a+"="+c[a]+";"}).join(""),"}");ia&&(b=c.divisor,e("if(",p,".divisor!==",b,"){",
a.instancing,".vertexAttribDivisorANGLE(",[y,b],");",p,".divisor=",b,";}"))}function k(){e("if(",p,".buffer){",g,".disableVertexAttribArray(",y,");","}if(",D.map(function(a,e){return p+"."+a+"!=="+h[e]}).join("||"),"){",g,".vertexAttrib4f(",y,",",h,");",D.map(function(a,e){return p+"."+a+"="+h[e]+";"}).join(""),"}")}var g=x.gl,y=e.def(b,".location"),p=e.def(x.attributes,"[",y,"]");b=c.state;var l=c.buffer,h=[c.x,c.y,c.z,c.w],q=["buffer","normalized","offset","stride"];1===b?f():2===b?k():(e("if(",
b,"===",1,"){"),f(),e("}else{"),k(),e("}"))}var x=a.shared;c.forEach(function(c){var g=c.name,x=d.attributes[g],y;if(x){if(!f(x))return;y=x.append(a,e)}else{if(!f(b))return;var p=a.scopeAttrib(g);y={};Object.keys(new aa).forEach(function(a){y[a]=e.def(p,".",a)})}m(a.link(c),k(c.info.type),y)})}function ca(a,e,d,c,f){for(var k=a.shared,m=k.gl,g,x=0;x<c.length;++x){var y=c[x],p=y.name,l=y.info.type,h=d.uniforms[p],y=a.link(y)+".location",q;if(h){if(!f(h))continue;if(C(h)){p=h.value;if(35678===l||35680===
l)l=a.link(p._texture||p.color[0]._texture),e(m,".uniform1i(",y,",",l+".bind());"),e.exit(l,".unbind();");else if(35674===l||35675===l||35676===l)p=a.global.def("new Float32Array(["+Array.prototype.slice.call(p)+"])"),h=2,35675===l?h=3:35676===l&&(h=4),e(m,".uniformMatrix",h,"fv(",y,",false,",p,");");else{switch(l){case 5126:g="1f";break;case 35664:g="2f";break;case 35665:g="3f";break;case 35666:g="4f";break;case 35670:g="1i";break;case 5124:g="1i";break;case 35671:g="2i";break;case 35667:g="2i";
break;case 35672:g="3i";break;case 35668:g="3i";break;case 35673:g="4i";break;case 35669:g="4i"}e(m,".uniform",g,"(",y,",",z(p)?Array.prototype.slice.call(p):p,");")}continue}else q=h.append(a,e)}else{if(!f(b))continue;q=e.def(k.uniforms,"[",n.id(p),"]")}35678===l?e("if(",q,"&&",q,'._reglType==="framebuffer"){',q,"=",q,".color[0];","}"):35680===l&&e("if(",q,"&&",q,'._reglType==="framebufferCube"){',q,"=",q,".color[0];","}");p=1;switch(l){case 35678:case 35680:l=e.def(q,"._texture");e(m,".uniform1i(",
y,",",l,".bind());");e.exit(l,".unbind();");continue;case 5124:case 35670:g="1i";break;case 35667:case 35671:g="2i";p=2;break;case 35668:case 35672:g="3i";p=3;break;case 35669:case 35673:g="4i";p=4;break;case 5126:g="1f";break;case 35664:g="2f";p=2;break;case 35665:g="3f";p=3;break;case 35666:g="4f";p=4;break;case 35674:g="Matrix2fv";break;case 35675:g="Matrix3fv";break;case 35676:g="Matrix4fv"}e(m,".uniform",g,"(",y,",");if("M"===g.charAt(0)){var y=Math.pow(l-35674+2,2),t=a.global.def("new Float32Array(",
y,")");e("false,(Array.isArray(",q,")||",q," instanceof Float32Array)?",q,":(",w(y,function(a){return t+"["+a+"]="+q+"["+a+"]"}),",",t,")")}else 1<p?e(w(p,function(a){return q+"["+a+"]"})):e(q);e(");")}}function Z(a,e,b,d){function c(f){var k=y[f];return k?k.contextDep&&d.contextDynamic||k.propDep?k.append(a,b):k.append(a,e):e.def(x,".",f)}function f(){function a(){b(w,".drawElementsInstancedANGLE(",[l,q,v,h+"<<(("+v+"-5121)>>1)",t],");")}function e(){b(w,".drawArraysInstancedANGLE(",[l,h,q,t],");")}
p?F?a():(b("if(",p,"){"),a(),b("}else{"),e(),b("}")):e()}function k(){function a(){b(m+".drawElements("+[l,q,v,h+"<<(("+v+"-5121)>>1)"]+");")}function e(){b(m+".drawArrays("+[l,h,q]+");")}p?F?a():(b("if(",p,"){"),a(),b("}else{"),e(),b("}")):e()}var g=a.shared,m=g.gl,x=g.draw,y=d.draw,p=function(){var c=y.elements,f=e;if(c){if(c.contextDep&&d.contextDynamic||c.propDep)f=b;c=c.append(a,f)}else c=f.def(x,".","elements");c&&f("if("+c+")"+m+".bindBuffer(34963,"+c+".buffer.buffer);");return c}(),l=c("primitive"),
h=c("offset"),q=function(){var c=y.count,f=e;if(c){if(c.contextDep&&d.contextDynamic||c.propDep)f=b;c=c.append(a,f)}else c=f.def(x,".","count");return c}();if("number"===typeof q){if(0===q)return}else b("if(",q,"){"),b.exit("}");var t,w;ia&&(t=c("instances"),w=a.instancing);var v=p+".type",F=y.elements&&C(y.elements);ia&&("number"!==typeof t||0<=t)?"string"===typeof t?(b("if(",t,">0){"),f(),b("}else if(",t,"<0){"),k(),b("}")):f():k()}function Ba(a,e,b,c,d){e=xa();d=e.proc("body",d);ia&&(e.instancing=
d.def(e.shared.extensions,".angle_instanced_arrays"));a(e,d,b,c);return e.compile().body}function Ca(a,e,b,c){R(a,e);V(a,e,b,c.attributes,function(){return!0});ca(a,e,b,c.uniforms,function(){return!0});Z(a,e,e,b)}function Da(a,e){var b=a.proc("draw",1);R(a,b);J(a,b,e.context);Y(a,b,e.framebuffer);ba(a,b,e);P(a,b,e.state);S(a,b,e,!1,!0);var c=e.shader.progVar.append(a,b);b(a.shared.gl,".useProgram(",c,".program);");if(e.shader.program)Ca(a,b,e,e.shader.program);else{var d=a.global.def("{}"),f=b.def(c,
".id"),k=b.def(d,"[",f,"]");b(a.cond(k).then(k,".call(this,a0);")["else"](k,"=",d,"[",f,"]=",a.link(function(b){return Ba(Ca,a,e,b,1)}),"(",c,");",k,".call(this,a0);"))}0<Object.keys(e.state).length&&b(a.shared.current,".dirty=true;")}function Ea(a,e,b,c){function d(){return!0}a.batchId="a1";R(a,e);V(a,e,b,c.attributes,d);ca(a,e,b,c.uniforms,d);Z(a,e,e,b)}function ra(a,e,b,c){function d(a){return a.contextDep&&k||a.propDep}function f(a){return!d(a)}R(a,e);var k=b.contextDep,g=e.def(),m=e.def();a.shared.props=
m;a.batchId=g;var x=a.scope(),y=a.scope();e(x.entry,"for(",g,"=0;",g,"<","a1",";++",g,"){",m,"=","a0","[",g,"];",y,"}",x.exit);b.needsContext&&J(a,y,b.context);b.needsFramebuffer&&Y(a,y,b.framebuffer);P(a,y,b.state,d);b.profile&&d(b.profile)&&S(a,y,b,!1,!0);c?(V(a,x,b,c.attributes,f),V(a,y,b,c.attributes,d),ca(a,x,b,c.uniforms,f),ca(a,y,b,c.uniforms,d),Z(a,x,y,b)):(e=a.global.def("{}"),c=b.shader.progVar.append(a,y),m=y.def(c,".id"),x=y.def(e,"[",m,"]"),y(a.shared.gl,".useProgram(",c,".program);",
"if(!",x,"){",x,"=",e,"[",m,"]=",a.link(function(e){return Ba(Ea,a,b,e,2)}),"(",c,");}",x,".call(this,a0[",g,"],",g,");"))}function La(a,e){function b(a){return a.contextDep&&d||a.propDep}var c=a.proc("batch",2);a.batchId="0";R(a,c);var d=!1,f=!0;Object.keys(e.context).forEach(function(a){d=d||e.context[a].propDep});d||(J(a,c,e.context),f=!1);var k=e.framebuffer,g=!1;k?(k.propDep?d=g=!0:k.contextDep&&d&&(g=!0),g||Y(a,c,k)):Y(a,c,null);e.state.viewport&&e.state.viewport.propDep&&(d=!0);ba(a,c,e);P(a,
c,e.state,function(a){return!b(a)});e.profile&&b(e.profile)||S(a,c,e,!1,"a1");e.contextDep=d;e.needsContext=f;e.needsFramebuffer=g;f=e.shader.progVar;if(f.contextDep&&d||f.propDep)ra(a,c,e,null);else if(f=f.append(a,c),c(a.shared.gl,".useProgram(",f,".program);"),e.shader.program)ra(a,c,e,e.shader.program);else{var k=a.global.def("{}"),g=c.def(f,".id"),m=c.def(k,"[",g,"]");c(a.cond(m).then(m,".call(this,a0,a1);")["else"](m,"=",k,"[",g,"]=",a.link(function(b){return Ba(ra,a,e,b,2)}),"(",f,");",m,".call(this,a0,a1);"))}0<
Object.keys(e.state).length&&c(a.shared.current,".dirty=true;")}function Ia(e,b){function c(a){var k=b.shader[a];k&&d.set(f.shader,"."+a,k.append(e,d))}var d=e.proc("scope",3);e.batchId="a2";var f=e.shared,k=f.current;J(e,d,b.context);b.framebuffer&&b.framebuffer.append(e,d);a(Object.keys(b.state)).forEach(function(a){var c=b.state[a].append(e,d);z(c)?c.forEach(function(b,c){d.set(e.next[a],"["+c+"]",b)}):d.set(f.next,"."+a,c)});S(e,d,b,!0,!0);["elements","offset","count","instances","primitive"].forEach(function(a){var c=
b.draw[a];c&&d.set(f.draw,"."+a,""+c.append(e,d))});Object.keys(b.uniforms).forEach(function(a){d.set(f.uniforms,"["+n.id(a)+"]",b.uniforms[a].append(e,d))});Object.keys(b.attributes).forEach(function(a){var c=b.attributes[a].append(e,d),f=e.scopeAttrib(a);Object.keys(new aa).forEach(function(a){d.set(f,"."+a,c[a])})});c("vert");c("frag");0<Object.keys(b.state).length&&(d(k,".dirty=true;"),d.exit(k,".dirty=true;"));d("a1(",e.shared.context,",a0,",e.batchId,");")}function Ja(a){if("object"===typeof a&&
!z(a)){for(var e=Object.keys(a),b=0;b<e.length;++b)if(t.isDynamic(a[e[b]]))return!0;return!1}}function Ka(a,e,b){function c(a,e){k.forEach(function(b){var c=d[b];t.isDynamic(c)&&(c=a.invoke(e,c),e(p,".",b,"=",c,";"))})}var d=e["static"][b];if(d&&Ja(d)){var f=a.global,k=Object.keys(d),g=!1,y=!1,x=!1,p=a.global.def("{}");k.forEach(function(e){var b=d[e];if(t.isDynamic(b))"function"===typeof b&&(b=d[e]=t.unbox(b)),e=m(b,null),g=g||e.thisDep,x=x||e.propDep,y=y||e.contextDep;else{f(p,".",e,"=");switch(typeof b){case "number":f(b);
break;case "string":f('"',b,'"');break;case "object":Array.isArray(b)&&f("[",b.join(),"]");break;default:f(a.link(b))}f(";")}});e.dynamic[b]=new t.DynamicVariable(4,{thisDep:g,contextDep:y,propDep:x,ref:p,append:c});delete e["static"][b]}}var aa=ma.Record,ha={add:32774,subtract:32778,"reverse subtract":32779};r.ext_blend_minmax&&(ha.min=32775,ha.max=32776);var ia=r.angle_instanced_arrays,e=r.webgl_draw_buffers,y={dirty:!0,profile:ga.profile},x={},Ga=[],va={},wa={};K("dither",3024);K("blend.enable",
3042);E("blend.color","blendColor",[0,0,0,0]);E("blend.equation","blendEquationSeparate",[32774,32774]);E("blend.func","blendFuncSeparate",[1,0,1,0]);K("depth.enable",2929,!0);E("depth.func","depthFunc",513);E("depth.range","depthRange",[0,1]);E("depth.mask","depthMask",!0);E("colorMask","colorMask",[!0,!0,!0,!0]);K("cull.enable",2884);E("cull.face","cullFace",1029);E("frontFace","frontFace",2305);E("lineWidth","lineWidth",1);K("polygonOffset.enable",32823);E("polygonOffset.offset","polygonOffset",
[0,0]);K("sample.alpha",32926);K("sample.enable",32928);E("sample.coverage","sampleCoverage",[1,!1]);K("stencil.enable",2960);E("stencil.mask","stencilMask",-1);E("stencil.func","stencilFunc",[519,0,-1]);E("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);E("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);K("scissor.enable",3089);E("scissor.box","scissor",[0,0,h.drawingBufferWidth,h.drawingBufferHeight]);E("viewport","viewport",[0,0,h.drawingBufferWidth,h.drawingBufferHeight]);
var Na={gl:h,context:W,strings:n,next:x,current:y,draw:p,elements:ka,buffer:G,shader:ua,attributes:ma.state,uniforms:ta,framebuffer:N,extensions:r,timer:X,isBufferArgs:l},Ha={primTypes:H,compareFuncs:B,blendFuncs:f,blendEquations:ha,stencilOps:A,glTypes:v,orientationType:q};e&&(Ha.backBuffer=[1029],Ha.drawBuffer=w(I.maxDrawbuffers,function(a){return 0===a?[0]:w(a,function(a){return 36064+a})}));var Pa=0;return{next:x,current:y,procs:function(){var a=xa(),e=a.proc("poll"),b=a.proc("refresh"),c=a.block();
e(c);b(c);var d=a.shared,f=d.gl,k=d.next,g=d.current;c(g,".dirty=false;");Y(a,e);Y(a,b,null,!0);var m=h.getExtension("angle_instanced_arrays"),x;m&&(x=a.link(m));for(var p=0;p<I.maxAttributes;++p){var l=b.def(d.attributes,"[",p,"]"),q=a.cond(l,".buffer");q.then(f,".enableVertexAttribArray(",p,");",f,".bindBuffer(",34962,",",l,".buffer.buffer);",f,".vertexAttribPointer(",p,",",l,".size,",l,".type,",l,".normalized,",l,".stride,",l,".offset);")["else"](f,".disableVertexAttribArray(",p,");",f,".vertexAttrib4f(",
p,",",l,".x,",l,".y,",l,".z,",l,".w);",l,".buffer=null;");b(q);m&&b(x,".vertexAttribDivisorANGLE(",p,",",l,".divisor);")}Object.keys(va).forEach(function(d){var m=va[d],x=c.def(k,".",d),y=a.block();y("if(",x,"){",f,".enable(",m,")}else{",f,".disable(",m,")}",g,".",d,"=",x,";");b(y);e("if(",x,"!==",g,".",d,"){",y,"}")});Object.keys(wa).forEach(function(d){var m=wa[d],x=y[d],p,l,q=a.block();q(f,".",m,"(");z(x)?(m=x.length,p=a.global.def(k,".",d),l=a.global.def(g,".",d),q(w(m,function(a){return p+"["+
a+"]"}),");",w(m,function(a){return l+"["+a+"]="+p+"["+a+"];"}).join("")),e("if(",w(m,function(a){return p+"["+a+"]!=="+l+"["+a+"]"}).join("||"),"){",q,"}")):(p=c.def(k,".",d),l=c.def(g,".",d),q(p,");",g,".",d,"=",p,";"),e("if(",p,"!==",l,"){",q,"}"));b(q)});return a.compile()}(),compile:function(a,e,b,d,c){var f=xa();f.stats=f.link(c);Object.keys(e["static"]).forEach(function(a){Ka(f,e,a)});k.forEach(function(e){Ka(f,a,e)});b=oa(a,e,b,d,f);Da(f,b);Ia(f,b);La(f,b);return f.compile()}}}},{"./constants/dtypes.json":5,
"./constants/primitives.json":6,"./dynamic":9,"./util/codegen":22,"./util/is-array-like":24,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/loop":27}],9:[function(h,n,r){function l(a,g){this.id=C++;this.type=a;this.data=g}function a(d){if(0===d.length)return[];var g=d.charAt(0),c=d.charAt(d.length-1);if(1<d.length&&g===c&&('"'===g||"'"===g))return['"'+d.substr(1,d.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(g=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(d))return a(d.substr(0,
g.index)).concat(a(g[1])).concat(a(d.substr(g.index+g[0].length)));g=d.split(".");if(1===g.length)return['"'+d.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];d=[];for(c=0;c<g.length;++c)d=d.concat(a(g[c]));return d}function g(d){return"["+a(d).join("][")+"]"}var C=0;n.exports={DynamicVariable:l,define:function(a,m){return new l(a,g(m+""))},isDynamic:function(a){return"function"===typeof a&&!a._reglType||a instanceof l},unbox:function(a,g){return"function"===typeof a?new l(0,a):a},accessor:g}},{}],
10:[function(h,n,r){var l=h("./util/is-typed-array"),a=h("./util/is-ndarray"),g=h("./util/values"),C=h("./constants/primitives.json"),d=h("./constants/usage.json");n.exports=function(m,c,h,n){function r(a){this.id=v++;H[this.id]=this;this.buffer=a;this.primType=4;this.type=this.vertCount=0}function z(d,k,g,m,b,t,v){(t=v)||l(k)&&(!a(k)||l(k.data))||(t=c.oes_element_index_uint?5125:5123);d.buffer.bind();h._initBuffer(d.buffer,k,g,t,3);k=v;if(!v){switch(d.buffer.dtype){case 5121:case 5120:k=5121;break;
case 5123:case 5122:k=5123;break;case 5125:case 5124:k=5125}d.buffer.dtype=k}d.type=k;0>b&&(b=d.buffer.byteLength,5123===k?b>>=1:5125===k&&(b>>=2));d.vertCount=b;b=m;0>m&&(b=4,m=d.buffer.dimension,1===m&&(b=0),2===m&&(b=1),3===m&&(b=4));d.primType=b}function t(a){n.elementsCount--;delete H[a.id];a.buffer.destroy();a.buffer=null}var H={},v=0,D={uint8:5121,uint16:5123};c.oes_element_index_uint&&(D.uint32=5125);r.prototype.bind=function(){this.buffer.bind()};var k=[];return{create:function(c,k){function g(c){if(c)if("number"===
typeof c)q(c),b.primType=4,b.vertCount=c|0,b.type=5121;else{var f=null,k=35044,h=-1,t=-1,v=0,w=0;Array.isArray(c)||l(c)||a(c)?f=c:("data"in c&&(f=c.data),"usage"in c&&(k=d[c.usage]),"primitive"in c&&(h=C[c.primitive]),"count"in c&&(t=c.count|0),"length"in c&&(v=c.length|0),"type"in c&&(w=D[c.type]));f?z(b,f,k,h,t,v,w):(c=b.buffer,c.bind(),m.bufferData(34963,v,k),c.dtype=w||5121,c.usage=k,c.dimension=3,c.byteLength=v,b.primType=0>h?4:h,b.vertCount=0>t?0:t,b.type=c.dtype)}else q(),b.primType=4,b.vertCount=
0,b.type=5121;return g}var q=h.create(null,34963,!0),b=new r(q._buffer);n.elementsCount++;g(c);g._reglType="elements";g._elements=b;g.subdata=function(a,b){q.subdata(a,b);return g};g.destroy=function(){t(b)};return g},createStream:function(a){var c=k.pop();c||(c=new r(h.create(null,34963,!0,!1)._buffer));z(c,a,35040,-1,-1,0,0);return c},destroyStream:function(a){k.push(a)},getElements:function(a){return"function"===typeof a&&a._elements instanceof r?a._elements:null},clear:function(){g(H).forEach(t)}}}},
{"./constants/primitives.json":6,"./constants/usage.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/values":31}],11:[function(h,n,r){n.exports=function(l,a){function g(a){a=a.toLowerCase();var d;try{d=h[a]=l.getExtension(a)}catch(g){}return!!d}for(var h={},d=0;d<a.extensions.length;++d){var m=a.extensions[d];if(!g(m))return a.onDestroy(),a.onDone('"'+m+'" extension is not supported by the current WebGL context, try upgrading your system or a different browser'),null}a.optionalExtensions.forEach(g);
return{extensions:h,restore:function(){Object.keys(h).forEach(function(a){if(!g(a))throw Error("(regl): error restoring extension "+a);})}}}},{}],12:[function(h,n,r){var l=h("./util/values"),a=h("./util/extend"),g=[];g[6408]=4;var C=[];C[5121]=1;C[5126]=4;C[36193]=2;n.exports=function(d,m,c,h,n,r){function z(a,b,c){this.target=a;this.texture=b;this.renderbuffer=c;var d=a=0;b?(a=b.width,d=b.height):c&&(a=c.width,d=c.height);this.width=a;this.height=d}function t(a){a&&(a.texture&&a.texture._texture.decRef(),
a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function H(a,b,c){a&&(a.texture?a.texture._texture.refCount+=1:a.renderbuffer._renderbuffer.refCount+=1)}function v(a,b){b?b.texture?d.framebufferTexture2D(36160,a,b.target,b.texture._texture.texture,0):d.framebufferRenderbuffer(36160,a,36161,b.renderbuffer._renderbuffer.renderbuffer):d.framebufferTexture2D(36160,a,3553,null,0)}function D(a){var b=3553,c=null,d=null,f=a;"object"===typeof a&&(f=a.data,"target"in a&&(b=a.target|0));a=f._reglType;
"texture2d"===a?c=f:"textureCube"===a?c=f:"renderbuffer"===a&&(d=f,b=36161);return new z(b,c,d)}function k(a,b,c,d,f){if(c)return a=h.create2D({width:a,height:b,format:d,type:f}),a._texture.refCount=0,new z(3553,a,null);a=n.create({width:a,height:b,format:d});a._renderbuffer.refCount=0;return new z(36161,null,a)}function f(a){return a&&(a.texture||a.renderbuffer)}function B(a,b,c){a&&(a.texture?a.texture.resize(b,c):a.renderbuffer&&a.renderbuffer.resize(b,c))}function A(){this.id=la++;N[this.id]=
this;this.framebuffer=d.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=null}function q(a){a.colorAttachments.forEach(t);t(a.depthAttachment);t(a.stencilAttachment);t(a.depthStencilAttachment)}function b(a){d.deleteFramebuffer(a.framebuffer);a.framebuffer=null;r.framebufferCount--;delete N[a.id]}function F(a){var b;d.bindFramebuffer(36160,a.framebuffer);var f=a.colorAttachments;for(b=0;b<f.length;++b)v(36064+
b,f[b]);for(b=f.length;b<c.maxColorAttachments;++b)v(36064+b,null);v(36096,a.depthAttachment);v(36128,a.stencilAttachment);v(33306,a.depthStencilAttachment);d.checkFramebufferStatus(36160);d.bindFramebuffer(36160,ja.next);ja.cur=ja.next;d.getError()}function sa(c,d){function m(a,b){var c,d=0,l=0,h=!0,t=!0;c=null;var v=!0,w="rgba",n="uint8",z=1,r=null,B=null,I=null,G=!1;if("number"===typeof a)d=a|0,l=b|0||d;else if(a){"shape"in a?(l=a.shape,d=l[0],l=l[1]):("radius"in a&&(d=l=a.radius),"width"in a&&
(d=a.width),"height"in a&&(l=a.height));if("color"in a||"colors"in a)c=a.color||a.colors,Array.isArray(c);if(!c){"colorCount"in a&&(z=a.colorCount|0);"colorTexture"in a&&(v=!!a.colorTexture,w="rgba4");if("colorType"in a&&(n=a.colorType,!v))if("half float"===n||"float16"===n)w="rgba16f";else if("float"===n||"float32"===n)w="rgba32f";"colorFormat"in a&&(w=a.colorFormat,0<=Fa.indexOf(w)?v=!0:0<=za.indexOf(w)&&(v=!1))}if("depthTexture"in a||"depthStencilTexture"in a)G=!(!a.depthTexture&&!a.depthStencilTexture);
"depth"in a&&("boolean"===typeof a.depth?h=a.depth:(r=a.depth,t=!1));"stencil"in a&&("boolean"===typeof a.stencil?t=a.stencil:(B=a.stencil,h=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?h=t=a.depthStencil:(I=a.depthStencil,t=h=!1))}else d=l=1;var A=null,sa=null,J=null,ja=null;if(Array.isArray(c))A=c.map(D);else if(c)A=[D(c)];else for(A=Array(z),c=0;c<z;++c)A[c]=k(d,l,v,w,n);d=d||A[0].width;l=l||A[0].height;r?sa=D(r):h&&!t&&(sa=k(d,l,G,"depth","uint32"));B?J=D(B):t&&!h&&(J=k(d,l,!1,
"stencil","uint8"));I?ja=D(I):!r&&!B&&t&&h&&(ja=k(d,l,G,"depth stencil","depth stencil"));h=null;for(c=0;c<A.length;++c)H(A[c],d,l),A[c]&&A[c].texture&&(t=g[A[c].texture._texture.format]*C[A[c].texture._texture.type],null===h&&(h=t));H(sa,d,l);H(J,d,l);H(ja,d,l);q(p);p.width=d;p.height=l;p.colorAttachments=A;p.depthAttachment=sa;p.stencilAttachment=J;p.depthStencilAttachment=ja;m.color=A.map(f);m.depth=f(sa);m.stencil=f(J);m.depthStencil=f(ja);m.width=p.width;m.height=p.height;F(p);return m}var p=
new A;r.framebufferCount++;m(c,d);return a(m,{resize:function(a,b){var c=a|0,d=b|0||c;if(c===p.width&&d===p.height)return m;for(var f=p.colorAttachments,k=0;k<f.length;++k)B(f[k],c,d);B(p.depthAttachment,c,d);B(p.stencilAttachment,c,d);B(p.depthStencilAttachment,c,d);p.width=m.width=c;p.height=m.height=d;F(p);return m},_reglType:"framebuffer",_framebuffer:p,destroy:function(){b(p);q(p)}})}var ja={cur:null,next:null,dirty:!1},Fa=["rgba"],za=["rgba4","rgb565","rgb5 a1"];m.ext_srgb&&za.push("srgba");
m.ext_color_buffer_half_float&&za.push("rgba16f","rgb16f");m.webgl_color_buffer_float&&za.push("rgba32f");var ka=["uint8"];m.oes_texture_half_float&&ka.push("half float","float16");m.oes_texture_float&&ka.push("float","float32");var la=0,N={};return a(ja,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof A)?a:null},create:sa,createCube:function(b){function c(b){var f,k={color:null},g=0,m=null;f="rgba";var l="uint8",q=1;if("number"===
typeof b)g=b|0;else if(b){"shape"in b?g=b.shape[0]:("radius"in b&&(g=b.radius|0),"width"in b?g=b.width|0:"height"in b&&(g=b.height|0));if("color"in b||"colors"in b)m=b.color||b.colors,Array.isArray(m);m||("colorCount"in b&&(q=b.colorCount|0),"colorType"in b&&(l=b.colorType),"colorFormat"in b&&(f=b.colorFormat));"depth"in b&&(k.depth=b.depth);"stencil"in b&&(k.stencil=b.stencil);"depthStencil"in b&&(k.depthStencil=b.depthStencil)}else g=1;if(m)if(Array.isArray(m))for(b=[],f=0;f<m.length;++f)b[f]=m[f];
else b=[m];else for(b=Array(q),m={radius:g,format:f,type:l},f=0;f<q;++f)b[f]=h.createCube(m);k.color=Array(b.length);for(f=0;f<b.length;++f)q=b[f],g=g||q.width,k.color[f]={target:34069,data:b[f]};for(f=0;6>f;++f){for(q=0;q<b.length;++q)k.color[q].target=34069+f;0<f&&(k.depth=d[0].depth,k.stencil=d[0].stencil,k.depthStencil=d[0].depthStencil);if(d[f])d[f](k);else d[f]=sa(k)}return a(c,{width:g,height:g,color:b})}var d=Array(6);c(b);return a(c,{faces:d,resize:function(a){var b=a|0;if(b===c.width)return c;
