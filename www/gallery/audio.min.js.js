...
a)]},color:l,t:function(a){return.01*a.tick}},elements:null,instances:-1,count:1572864}),u={width:256,height:1,data:new Uint8Array(256)},n=new Uint8Array(256);b.frame(function(a){a=a.frameCount;b.updateTimer();a%=256;b.clear({color:[0,0,0,1],depth:1});m.getByteTimeDomainData(u.data);d.subimage(u,0,a);m.getByteFrequencyData(n);l.subimage(n);w()})}})},{"../regl":36,"gl-mat4/lookAt":34,"gl-mat4/perspective":35,resl:37}],2:[function(d,l,r){function b(){this.w=this.z=this.y=this.x=this.state=0;this.buffer=
null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}l.exports=function(k,p,c,a,h){k=c.maxAttributes;p=Array(k);for(c=0;c<k;++c)p[c]=new b;return{Record:b,scope:{},state:p}}},{}],3:[function(d,l,r){function b(a){return x[Object.prototype.toString.call(a)]|0}function k(a,b){for(var c=0;c<b.length;++c)a[c]=b[c]}function p(a,b,c,h,k,p,f){for(var m=0,d=0;d<c;++d)for(var g=0;g<h;++g)a[m++]=b[k*d+p*g+f]}function c(a,b,c){for(var h=0,k=0;k<b.length;++k)for(var p=b[k],
f=0;f<c;++f)a[h++]=p[f]}var a=d("./util/is-typed-array"),h=d("./util/is-ndarray"),m=d("./util/values"),A=d("./util/pool"),x=d("./constants/arraytypes.json"),w=d("./constants/dtypes.json"),u=d("./constants/usage.json");l.exports=function(n,d){function y(a){this.id=f++;this.buffer=n.createBuffer();this.type=a;this.usage=35044;this.byteLength=0;this.dimension=1;this.dtype=5121}function t(a,b,c){a.byteLength=b.byteLength;n.bufferData(a.type,b,c)}function l(g,f,d,n,m){g.usage=d;if(Array.isArray(f))g.dtype=
n||5126,0<f.length&&(Array.isArray(f[0])?(g.dimension=f[0].length,n=A.allocType(g.dtype,f.length*g.dimension),c(n,f,g.dimension),t(g,n,d),A.freeType(n)):"number"===typeof f[0]?(g.dimension=m,n=A.allocType(g.dtype,f.length),k(n,f),t(g,n,d),A.freeType(n)):a(f[0])&&(g.dimension=f[0].length,g.dtype=n||b(f[0])||5126,n=A.allocType(g.dtype,f.length*g.dimension),c(n,f,g.dimension),t(g,n,d),A.freeType(n)));else if(a(f))g.dtype=n||b(f),g.dimension=m,t(g,f,d);else if(h(f)){var u=f.shape,v=f.stride;m=f.offset;
var C=0,O=0,y=0,F=0;1===u.length?(C=u[0],O=1,y=v[0],F=0):2===u.length&&(C=u[0],O=u[1],y=v[0],F=v[1]);g.dtype=n||b(f.data)||5126;g.dimension=O;n=A.allocType(g.dtype,C*O);p(n,f.data,C,O,y,F,m);t(g,n,d);A.freeType(n)}}function I(a){d.bufferCount--;n.deleteBuffer(a.buffer);a.buffer=null;delete x[a.id]}var f=0,x={};y.prototype.bind=function(){n.bindBuffer(this.type,this.buffer)};y.prototype.destroy=function(){I(this)};var E=[];return{create:function(g,f,m){function t(b){var c=35044,g=null,f=0,k=0,p=1;
Array.isArray(b)||a(b)||h(b)?g=b:"number"===typeof b?f=b|0:b&&("data"in b&&(g=b.data),"usage"in b&&(c=u[b.usage]),"type"in b&&(k=w[b.type]),"dimension"in b&&(p=b.dimension|0),"length"in b&&(f=b.length|0));E.bind();g?l(E,g,c,k,p):(n.bufferData(E.type,f,c),E.dtype=k||5121,E.usage=c,E.dimension=p,E.byteLength=f);return t}d.bufferCount++;var E=new y(f);x[E.id]=E;m||t(g);t._reglType="buffer";t._buffer=E;t.subdata=function(g,f){var d=(f||0)|0;E.bind();if(Array.isArray(g)){if(0<g.length)if("number"===typeof g[0]){var m=
A.allocType(E.dtype,g.length);k(m,g);n.bufferSubData(E.type,d,m);A.freeType(m)}else if(Array.isArray(g[0])||a(g[0])){var m=g[0].length,u=A.allocType(E.dtype,g.length*m);c(u,g,m);n.bufferSubData(E.type,d,u);A.freeType(u)}}else if(a(g))n.bufferSubData(E.type,d,g);else if(h(g)){var F=g.shape,y=g.stride,I=u=m=0,l=0;1===F.length?(m=F[0],u=1,I=y[0],l=0):2===F.length&&(m=F[0],u=F[1],I=y[0],l=y[1]);F=Array.isArray(g.data)?E.dtype:b(g.data);F=A.allocType(F,m*u);p(F,g.data,m,u,I,l,g.offset);n.bufferSubData(E.type,
d,F);A.freeType(F)}return t};t.destroy=function(){I(E)};return t},createStream:function(a,b){var c=E.pop();c||(c=new y(a),c.buffer=n.createBuffer());c.bind();l(c,b,35040,0,1);return c},destroyStream:function(a){E.push(a)},clear:function(){m(x).forEach(I)},getBuffer:function(a){return a&&a._buffer instanceof y?a._buffer:null},_initBuffer:l}}},{"./constants/arraytypes.json":4,"./constants/dtypes.json":5,"./constants/usage.json":7,"./util/is-ndarray":25,"./util/is-typed-array":26,"./util/pool":28,"./util/values":31}],
...
line:1,"line loop":2,"line strip":3,triangles:4,triangle:4,"triangle strip":5,"triangle fan":6}},{}],7:[function(d,l,r){l.exports={"static":35044,dynamic:35048,stream:35040}},{}],8:[function(d,l,r){function b(a){return Array.isArray(a)||x(a)||w(a)}function k(a){return a.sort(function(a,b){return"viewport"===a?-1:"viewport"===b?1:a<b?-1:1})}function p(a,b,c,f){this.thisDep=a;this.contextDep=b;this.propDep=c;this.append=f}function c(a){return a&&!(a.thisDep||a.contextDep||a.propDep)}function a(a){return new p(!1,
!1,!1,a)}function h(a,b){var c=a.type;return 0===c?(c=a.data.length,new p(!0,1<=c,2<=c,b)):new p(3===c,2===c,1===c,b)}var m=d("./util/codegen"),A=d("./util/loop"),x=d("./util/is-typed-array"),w=d("./util/is-ndarray"),u=d("./util/is-array-like"),n=d("./constants/primitives.json"),G=d("./constants/dtypes.json"),y=["x","y","z","w"],t={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,
...
function(a){return c[a]}),"]")})):q=a(function(a){return a.link(c)});q.value=c;f[e]=q});Object.keys(c).forEach(function(a){var e=c[a];f[a]=h(e,function(a,b){return a.invoke(b,e)})});return f}function U(e){var c=e["static"],f=e.dynamic,k={};Object.keys(c).forEach(function(e){var q=c[e],f=g.id(e),h=new ma;if(b(q))h.state=1,h.buffer=x.getBuffer(x.create(q,34962,!1)),h.type=h.buffer.dtype;else{var z=x.getBuffer(q);if(z)h.state=1,h.buffer=z,h.type=z.dtype;else if(q.constant){var S=q.constant;h.state=2;
"number"===typeof S?h.x=S:y.forEach(function(a,e){e<S.length&&(h[a]=S[e])})}else{var z=x.getBuffer(q.buffer),n=q.offset|0,d=q.stride|0,m=q.size|0,B=!!q.normalized,v=0;"type"in q&&(v=G[q.type]);q=q.divisor|0;h.buffer=z;h.state=1;h.size=m;h.normalized=B;h.type=v||z.dtype;h.offset=n;h.stride=d;h.divisor=q}}k[e]=a(function(a,e){var b=a.attribCache;if(f in b)return b[f];var c={isStream:!1};Object.keys(h).forEach(function(a){c[a]=h[a]});h.buffer&&(c.buffer=a.link(h.buffer));return b[f]=c})});Object.keys(f).forEach(function(a){var e=
f[a];k[a]=h(e,function(a,b){function c(a){b(h[a],"=",q,".",a,"|0;")}var q=a.invoke(b,e),f=a.shared,g=f.isBufferArgs,k=f.buffer,h={isStream:b.def(!1)},Z=new ma;Z.state=1;Object.keys(Z).forEach(function(a){h[a]=b.def(""+Z[a])});var z=h.buffer,S=h.type;b("if(",g,"(",q,")){",h.isStream,"=true;",z,"=",k,".createStream(",34962,",",q,");",S,"=",z,".dtype;","}else{",z,"=",k,".getBuffer(",q,");","if(",z,"){",S,"=",z,".dtype;","}else if(",q,".constant){",h.state,"=",2,";",y.map(function(a,e){return h[a]+"="+
...
d,".bindBuffer(",34962,",",v,".buffer);",d,".vertexAttribPointer(",[n,h,c,g.normalized,g.stride,g.offset],");",B,".type=",c,";",B,".size=",h,";",S.map(function(a){return B+"."+a+"="+g[a]+";"}).join(""),"}");e&&(c=g.divisor,b("if(",B,".divisor!==",c,"){",a.instancing,".vertexAttribDivisorANGLE(",[n,c],");",B,".divisor=",c,";}"))}function m(){b("if(",B,".pointer){",d,".disableVertexAttribArray(",n,");",B,".pointer=false;","}if(",y.map(function(a,e){return B+"."+a+"!=="+p[e]}).join("||"),"){",d,".vertexAttrib4f(",
n,",",p,");",y.map(function(a,e){return B+"."+a+"="+p[e]+";"}).join(""),"}")}var d=z.gl,n=b.def(c,".location"),B=b.def(z.attributes,"[",n,"]");c=g.state;var v=g.buffer,p=[g.x,g.y,g.z,g.w],S=["buffer","normalized","offset","stride"];1===c?k():2===c?m():(b("if(",c,"===",1,"){"),k(),b("}else{"),m(),b("}"))}var z=a.shared;f.forEach(function(e){var f=e.name,z=c.attributes[f],d;if(z){if(!g(z))return;d=z.append(a,b)}else{if(!g(W))return;var m=a.scopeAttrib(f);d={};Object.keys(new ma).forEach(function(a){d[a]=
b.def(m,".",a)})}h(a.link(e),k(e.info.type),d)})}function ca(a,e,b,f,k){for(var h=a.shared,z=h.gl,d,m=0;m<f.length;++m){var n=f[m],B=n.name,v=n.info.type,p=b.uniforms[B],n=a.link(n)+".location",t;if(p){if(!k(p))continue;if(c(p)){B=p.value;if(35678===v||35680===v)v=a.link(B._texture),e(z,".uniform1i(",n,",",v+".bind());"),e.exit(v,".unbind();");else if(35674===v||35675===v||35676===v)B=a.global.def("new Float32Array(["+Array.prototype.slice.call(B)+"])"),p=2,35675===v?p=3:35676===v&&(p=4),e(z,".uniformMatrix",
p,"fv(",n,",false,",B,");");else{switch(v){case 5126:d="1f";break;case 35664:d="2f";break;case 35665:d="3f";break;case 35666:d="4f";break;case 35670:d="1i";break;case 5124:d="1i";break;case 35671:d="2i";break;case 35667:d="2i";break;case 35672:d="3i";break;case 35668:d="3i";break;case 35673:d="4i";break;case 35669:d="4i"}e(z,".uniform",d,"(",n,",",u(B)?Array.prototype.slice.call(B):B,");")}continue}else t=p.append(a,e)}else{if(!k(W))continue;t=e.def(h.uniforms,"[",g.id(B),"]")}B=1;switch(v){case 35678:case 35680:v=
e.def(t,"._texture");e(z,".uniform1i(",n,",",v,".bind());");e.exit(v,".unbind();");continue;case 5124:case 35670:d="1i";break;case 35667:case 35671:d="2i";B=2;break;case 35668:case 35672:d="3i";B=3;break;case 35669:case 35673:d="4i";B=4;break;case 5126:d="1f";break;case 35664:d="2f";B=2;break;case 35665:d="3f";B=3;break;case 35666:d="4f";B=4;break;case 35674:d="Matrix2fv";break;case 35675:d="Matrix3fv";break;case 35676:d="Matrix4fv"}e(z,".uniform",d,"(",n,",");if("M"===d.charAt(0)){var n=Math.pow(v-
35674+2,2),y=a.global.def("new Float32Array(",n,")");e("false,(Array.isArray(",t,")||",t," instanceof Float32Array)?",t,":(",A(n,function(a){return y+"["+a+"]="+t+"["+a+"]"}),",",y,")")}else 1<B?e(A(B,function(a){return t+"["+a+"]"})):e(t);e(");")}}function ya(a,b,f,g){function k(e){var c=m[e];return c?c.contextDep&&g.contextDynamic||c.propDep?c.append(a,f):c.append(a,b):b.def(n,".",e)}function h(){function a(){f(A,".drawElementsInstancedANGLE(",[p,u,l,t+"<<(("+l+"-5121)>>1)",y],");")}function e(){f(A,
".drawArraysInstancedANGLE(",[p,t,u,y],");")}v?F?a():(f("if(",v,"){"),a(),f("}else{"),e(),f("}")):e()}function d(){function a(){f(B+".drawElements("+[p,u,l,t+"<<(("+l+"-5121)>>1)"]+");")}function e(){f(B+".drawArrays("+[p,t,u]+");")}v?F?a():(f("if(",v,"){"),a(),f("}else{"),e(),f("}")):e()}var z=a.shared,B=z.gl,n=z.draw,m=g.draw,v=function(){var e=m.elements,c=b;if(e){if(e.contextDep&&g.contextDynamic||e.propDep)c=f;e=e.append(a,c)}else e=c.def(n,".","elements");e&&c("if("+e+")"+B+".bindBuffer(34963,"+
e+".buffer.buffer);");return e}(),p=k("primitive"),t=k("offset"),u=function(){var e=m.count,c=b;if(e){if(e.contextDep&&g.contextDynamic||e.propDep)c=f;e=e.append(a,c)}else e=c.def(n,".","count");return e}();if("number"===typeof u){if(0===u)return}else f("if(",u,"){"),f.exit("}");var y,A;e&&(y=k("instances"),A=a.instancing);var l=v+".type",F=m.elements&&c(m.elements);e&&("number"!==typeof y||0<=y)?"string"===typeof y?(f("if(",y,">0){"),h(),f("}else if(",y,"<0){"),d(),f("}")):h():d()}function va(a,
...
a.stats,h=c.def(d,".getNumPendingQueries()-1");c(d,".pushScopeStats(",z,",",h,",",B,");")}}var ma=O.Record,Y={add:32774,subtract:32778,"reverse subtract":32779};l.ext_blend_minmax&&(Y.min=32775,Y.max=32776);var e=l.angle_instanced_arrays,B=l.webgl_draw_buffers,z={dirty:!0},xa={},za=[],oa={},pa={};M("dither",3024);M("blend.enable",3042);H("blend.color","blendColor",[0,0,0,0]);H("blend.equation","blendEquationSeparate",[32774,32774]);H("blend.func","blendFuncSeparate",[1,0,1,0]);M("depth.enable",2929,
!0);H("depth.func","depthFunc",513);H("depth.range","depthRange",[0,1]);H("depth.mask","depthMask",!0);H("colorMask","colorMask",[!0,!0,!0,!0]);M("cull.enable",2884);H("cull.face","cullFace",1029);H("frontFace","frontFace",2305);H("lineWidth","lineWidth",1);M("polygonOffset.enable",32823);H("polygonOffset.offset","polygonOffset",[0,0]);M("sample.alpha",32926);M("sample.enable",32928);H("sample.coverage","sampleCoverage",[1,!1]);M("stencil.enable",2960);H("stencil.mask","stencilMask",-1);H("stencil.func",
"stencilFunc",[519,0,-1]);H("stencil.opFront","stencilOpSeparate",[1028,7680,7680,7680]);H("stencil.opBack","stencilOpSeparate",[1029,7680,7680,7680]);M("scissor.enable",3089);H("scissor.box","scissor",[0,0,d.drawingBufferWidth,d.drawingBufferHeight]);H("viewport","viewport",[0,0,d.drawingBufferWidth,d.drawingBufferHeight]);var Ha={gl:d,context:da,strings:g,next:xa,current:z,draw:F,elements:J,buffer:x,shader:X,attributes:O.state,uniforms:C,framebuffer:v,extensions:l,timer:la,isBufferArgs:b},Aa={primTypes:n,
compareFuncs:K,blendFuncs:t,blendEquations:Y,stencilOps:I,glTypes:G,orientationType:f};B&&(Aa.backBuffer=[1029],Aa.drawBuffer=A(w.maxDrawbuffers,function(a){return 0===a?[0]:A(a,function(a){return 36064+a})}));var Ka=0;return{next:xa,current:z,procs:function(){var a=T(),e=a.proc("poll"),b=a.proc("refresh"),c=a.block();e(c);b(c);var f=a.shared,g=f.gl,h=f.next,k=f.current;c(k,".dirty=false;");Q(a,e);b(f.framebuffer,".dirty=true;");Q(a,b);Object.keys(oa).forEach(function(f){var d=oa[f],z=c.def(h,".",
f),B=a.block();B("if(",z,"){",g,".enable(",d,")}else{",g,".disable(",d,")}",k,".",f,"=",z,";");b(B);e("if(",z,"!==",k,".",f,"){",B,"}")});Object.keys(pa).forEach(function(f){var d=pa[f],B=z[f],n,m,v=a.block();v(g,".",d,"(");u(B)?(d=B.length,n=a.global.def(h,".",f),m=a.global.def(k,".",f),v(A(d,function(a){return n+"["+a+"]"}),");",A(d,function(a){return m+"["+a+"]="+n+"["+a+"];"}).join("")),e("if(",A(d,function(a){return n+"["+a+"]!=="+m+"["+a+"]"}).join("||"),"){",v,"}")):(n=c.def(h,".",f),m=c.def(k,
".",f),v(n,");",k,".",f,"=",n,";"),e("if(",n,"!==",m,"){",v,"}"));b(v)});return a.compile()}(),compile:function(a,e,b,c,f){var g=T();g.stats=g.link(f);f=ha(a);var h=qa(a,f),k=ia(a),d=ra(a);a=sa(a);var z=h.viewport;z&&(d.viewport=z);z=P("scissor.box");(h=h[z])&&(d[z]=h);h=0<Object.keys(d).length;f={framebuffer:f,draw:k,shader:a,state:d,dirty:h};f.uniforms=na(b);f.attributes=U(e);f.context=fa(c);Da(g,f);wa(g,f);Ga(g,f);return g.compile()}}}},{"./constants/dtypes.json":5,"./constants/primitives.json":6,
...
128)return new b(a.type&-129,p(c))}else if("function"===typeof a)return new b(0,a);return a},accessor:p}},{}],10:[function(d,l,r){var b=d("./util/is-typed-array"),k=d("./util/is-ndarray"),p=d("./util/values"),c=d("./constants/primitives.json"),a=d("./constants/usage.json");l.exports=function(h,d,A,l){function w(a){this.id=y++;G[this.id]=this;this.buffer=a;this.primType=4;this.type=this.vertCount=0}function u(a,c,h,n,g,p,u){(p=u)||b(c)&&(!k(c)||b(c.data))||(p=d.oes_element_index_uint?5125:5123);a.buffer.bind();
A._initBuffer(a.buffer,c,h,p,3);c=u;if(!u){switch(a.buffer.dtype){case 5121:case 5120:c=5121;break;case 5123:case 5122:c=5123;break;case 5125:case 5124:c=5125}a.buffer.dtype=c}a.type=c;0>g&&(g=a.buffer.byteLength,5123===c?g>>=1:5125===c&&(g>>=2));a.vertCount=g;g=n;0>n&&(g=4,n=a.buffer.dimension,1===n&&(g=0),2===n&&(g=1),3===n&&(g=4));a.primType=g}function n(a){l.elementsCount--;delete G[a.id];a.buffer.destroy();a.buffer=null}var G={},y=0,t={uint8:5121,uint16:5123};d.oes_element_index_uint&&(t.uint32=
5125);w.prototype.bind=function(){this.buffer.bind()};var K=[];return{create:function(d){function f(g){if(g)if("number"===typeof g)m(g),p.primType=4,p.vertCount=g|0,p.type=5121;else{var d=null,n=35044,y=-1,l=-1,A=0,v=0;Array.isArray(g)||b(g)||k(g)?d=g:("data"in g&&(d=g.data),"usage"in g&&(n=a[g.usage]),"primitive"in g&&(y=c[g.primitive]),"count"in g&&(l=g.count|0),"length"in g&&(A=g.length|0),"type"in g&&(v=t[g.type]));d?u(p,d,n,y,l,A,v):(g=p.buffer,g.bind(),h.bufferData(34963,A,n),g.dtype=v||5121,
g.usage=n,g.dimension=3,g.byteLength=A,p.primType=0>y?4:y,p.vertCount=0>l?0:l,p.type=g.dtype)}else m(),p.primType=4,p.vertCount=0,p.type=5121;return f}var m=A.create(null,34963,!0),p=new w(m._buffer);l.elementsCount++;f(d);f._reglType="elements";f._elements=p;f.subdata=function(a,b){m.subdata(a,b);return f};f.destroy=function(){n(p)};return f},createStream:function(a){var b=K.pop();b||(b=new w(A.create(null,34963,!0)._buffer));u(b,a,35040,-1,-1,0,0);return b},destroyStream:function(a){K.push(a)},
...
b.getExtension(c)}catch(a){}})}var d={};k();return{extensions:d,refresh:k}}},{}],12:[function(d,l,r){var b=d("./util/values"),k=d("./util/extend");l.exports=function(d,c,a,h,m,l){function x(a,b,c){this.target=a;this.texture=b;this.renderbuffer=c;var f=a=0;b?(a=b.width,f=b.height):c&&(a=c.width,f=c.height);this.width=a;this.height=f}function w(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function u(a,b,c){a&&(a.texture?a.texture._texture.refCount+=
1:a.renderbuffer._renderbuffer.refCount+=1)}function n(a,b){b?b.texture?d.framebufferTexture2D(36160,a,b.target,b.texture._texture.texture,0):d.framebufferRenderbuffer(36160,a,36161,b.renderbuffer._renderbuffer.renderbuffer):d.framebufferTexture2D(36160,a,3553,null,0)}function G(a){var b=3553,c=null,f=null,g=a;"object"===typeof a&&(g=a.data);a=g._reglType;"texture2d"===a?c=g:"textureCube"===a?c=g:"renderbuffer"===a&&(f=g,b=36161);return new x(b,c,f)}function y(a,b,c,f,g){if(c)return a=h.create2D({width:a,
height:b,format:f,type:g}),a._texture.refCount=0,new x(3553,a,null);a=m.create({width:a,height:b,format:f});a._renderbuffer.refCount=0;return new x(36161,null,a)}function t(a){return a&&(a.texture||a.renderbuffer)}function K(a,b,c){a&&(a.texture?a.texture.resize(b,c):a.renderbuffer&&a.renderbuffer.resize(b,c))}function I(){this.id=J++;ga[this.id]=this;this.framebuffer=d.createFramebuffer();this.height=this.width=0;this.colorAttachments=[];this.depthStencilAttachment=this.stencilAttachment=this.depthAttachment=
...
d.bindFramebuffer(36160,g.next);g.current=g.next}var g={current:null,next:null,dirty:!1},Ja=["rgba"],N=["rgba4","rgb565","rgb5 a1"];c.ext_srgb&&N.push("srgba");c.ext_color_buffer_half_float&&N.push("rgba16f","rgb16f");c.webgl_color_buffer_float&&N.push("rgba32f");var ka=["uint8"];c.oes_texture_half_float&&ka.push("half float");c.oes_texture_float&&ka.push("float");var J=0,ga={};return k(g,{getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof
I)?a:null},create:function(a,b){function g(a,b){var h,d=0,n=0,m=!0,p=!0;h=null;var l=!0,A="rgba",v="uint8",x=1,w=null,I=null,K=null,r=!1;if("number"===typeof a)d=a|0,n=b|0||d;else if(a){"shape"in a?(n=a.shape,d=n[0],n=n[1]):("radius"in a&&(d=n=a.radius),"width"in a&&(d=a.width),"height"in a&&(n=a.height));if("color"in a||"colors"in a)h=a.color||a.colors,Array.isArray(h);h||("colorCount"in a&&(x=a.colorCount|0),"colorTexture"in a&&(l=!!a.colorTexture,A="rgba4"),"colorType"in a&&(v=a.colorType,l||("half float"===
v?c.ext_color_buffer_half_float&&(A="rgba16f"):"float"===v&&c.webgl_color_buffer_float&&(A="rgba32f"))),"colorFormat"in a&&(A=a.colorFormat,0<=Ja.indexOf(A)?l=!0:0<=N.indexOf(A)&&(l=!1)));if("depthTexture"in a||"depthStencilTexture"in a)r=!(!a.depthTexture&&!a.depthStencilTexture);"depth"in a&&("boolean"===typeof a.depth?m=a.depth:(w=a.depth,p=!1));"stencil"in a&&("boolean"===typeof a.stencil?p=a.stencil:(I=a.stencil,m=!1));"depthStencil"in a&&("boolean"===typeof a.depthStencil?m=p=a.depthStencil:
(K=a.depthStencil,p=m=!1))}else d=n=1;var C=null,J=null,W=null,aa=null;if(Array.isArray(h))C=h.map(G);else if(h)C=[G(h)];else for(C=Array(x),h=0;h<x;++h)C[h]=y(d,n,l,A,v);d=d||C[0].width;n=n||C[0].height;w?J=G(w):m&&!p&&(J=y(d,n,r,"depth","uint32"));I?W=G(I):p&&!m&&(W=y(d,n,!1,"stencil","uint8"));K?aa=G(K):!w&&!I&&p&&m&&(aa=y(d,n,r,"depth stencil","depth stencil"));for(h=0;h<C.length;++h)u(C[h],d,n);u(J,d,n);u(W,d,n);u(aa,d,n);f(k);k.width=d;k.height=n;k.colorAttachments=C;k.depthAttachment=J;k.stencilAttachment=
W;k.depthStencilAttachment=aa;g.color=C.map(t);g.depth=t(J);g.stencil=t(W);g.depthStencil=t(aa);g.width=k.width;g.height=k.height;E(k);return g}var k=new I;l.framebufferCount++;g(a,b);g.resize=function(a,b){var c=a|0,f=b|0||c;if(c===k.width&&f===k.height)return g;for(var h=k.colorAttachments,d=0;d<h.length;++d)K(h[d],c,f);K(k.depthAttachment,c,f);K(k.stencilAttachment,c,f);K(k.depthStencilAttachment,c,f);k.width=g.width=c;k.height=g.height=f;E(k);return g};g._reglType="framebuffer";g._framebuffer=
...
maxVaryingVectors:b.getParameter(36348),maxFragmentUniforms:b.getParameter(36349),glsl:b.getParameter(35724),renderer:b.getParameter(7937),vendor:b.getParameter(7936),version:b.getParameter(7938)}}},{}],14:[function(d,l,r){var b=d("./util/is-typed-array");l.exports=function(k,d,c){return function(a){var h=0,m=0,l=c.framebufferWidth,x=c.framebufferHeight,w=null;b(a)?w=a:2===arguments.length?(l=arguments[0]|0,x=arguments[1]|0):a&&(h=a.x|0,m=a.y|0,l=a.width||c.framebufferWidth,x=a.height||c.framebufferHeight,
w=a.data||null);d();w=w||new Uint8Array(l*x*4);k.pixelStorei(3333,4);k.readPixels(h,m,l,x,6408,5121,w);return w}}},{"./util/is-typed-array":26}],15:[function(d,l,r){var b=d("./util/values");l.exports=function(k,d,c,a){function h(a){this.id=x++;this.refCount=1;this.renderbuffer=a;this.format=32854;this.height=this.width=0}function m(b){var c=b.renderbuffer;k.bindRenderbuffer(36161,null);k.deleteRenderbuffer(c);b.renderbuffer=null;b.refCount=0;delete w[b.id];a.renderbufferCount--}var l={rgba4:32854,
rgb565:36194,"rgb5 a1":32855,depth:33189,stencil:36168,"depth stencil":34041};d.ext_srgb&&(l.srgba=35907);d.ext_color_buffer_half_float&&(l.rgba16f=34842,l.rgb16f=34843);d.webgl_color_buffer_float&&(l.rgba32f=34836);var x=0,w={};h.prototype.decRef=function(){0>=--this.refCount&&m(this)};return{create:function(b,c){function d(a,b){var c=0,f=0,h=32854;"object"===typeof a&&a?("shape"in a?(f=a.shape,c=f[0]|0,f=f[1]|0):("radius"in a&&(c=f=a.radius|0),"width"in a&&(c=a.width|0),"height"in a&&(f=a.height|
...
k.renderbufferStorage(36161,m.format,c,f);return d};d._reglType="renderbuffer";d._renderbuffer=m;d.destroy=function(){m.decRef()};return d},clear:function(){b(w).forEach(m)}}}},{"./util/values":31}],16:[function(d,l,r){var b=d("./util/values");l.exports=function(d,p,c){function a(a,b,c,d){this.name=a;this.id=b;this.location=c;this.info=d}function h(a,b){for(var c=0;c<a.length;++c)if(a[c].id===b.id){a[c].location=b.location;return}a.push(b)}function m(a,b,c){c=35632===a?x:w;var h=c[b];if(!h){var f=
p.str(b),h=d.createShader(a);d.shaderSource(h,f);d.compileShader(h);c[b]=h}return h}function l(a,b){this.id=G++;this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[]}var x={},w={},u={},n=[],G=0;return{clear:function(){var a=d.deleteShader.bind(d);b(x).forEach(a);x={};b(w).forEach(a);w={};n.forEach(function(a){d.deleteProgram(a.program)});n.length=0;u={};c.shaderCount=0},program:function(b,t,w){c.shaderCount++;(w=u[t])||(w=u[t]={});var x=w[b];if(!x){var f=x=new l(t,b),G,
E;G=m(35632,f.fragId);E=m(35633,f.vertId);t=f.program=d.createProgram();d.attachShader(t,G);d.attachShader(t,E);d.linkProgram(t);var g=d.getProgramParameter(t,35718),r=f.uniforms;for(G=0;G<g;++G)if(E=d.getActiveUniform(t,G))if(1<E.size)for(var N=0;N<E.size;++N){var ka=E.name.replace("[0]","["+N+"]");h(r,new a(ka,p.id(ka),d.getUniformLocation(t,ka),E))}else h(r,new a(E.name,p.id(E.name),d.getUniformLocation(t,E.name),E));g=d.getProgramParameter(t,35721);f=f.attributes;for(G=0;G<g;++G)(E=d.getActiveAttrib(t,
G))&&h(f,new a(E.name,p.id(E.name),d.getAttribLocation(t,E.name),E));w[b]=x;n.push(x)}return x},shader:m,frag:null,vert:null}}},{"./util/values":31}],17:[function(d,l,r){l.exports=function(){return{bufferCount:0,elementsCount:0,framebufferCount:0,shaderCount:0,textureCount:0,cubeCount:0,renderbufferCount:0}}},{}],18:[function(d,l,r){l.exports=function(){var b={"":0},d=[""];return{id:function(p){var c=b[p];if(c)return c;c=b[p]=d.length;d.push(p);return c},str:function(b){return d[b]}}}},{}],19:[function(d,
l,r){function b(a){return Array.isArray(a)&&(0===a.length||"number"===typeof a[0])}function k(a){return Array.isArray(a)&&0!==a.length&&n(a[0])?!0:!1}function p(a){return Object.prototype.toString.call(a)}function c(a){if(!a)return!1;var c=p(a);return 0<=I.indexOf(c)?!0:b(a)||k(a)||x(a)}function a(a,b){36193===a.type?(a.data=u(b),w.freeType(b)):a.data=b}var h=d("./util/extend"),m=d("./util/values"),A=d("./util/is-typed-array"),x=d("./util/is-ndarray"),w=d("./util/pool"),u=d("./util/to-half-float"),
n=d("./util/is-array-like");r=d("./constants/arraytypes.json");var G=d("./constants/arraytypes.json"),y=[9984,9986,9985,9987],t=[0,6409,6410,6407,6408],K={};K[6409]=K[6406]=K[6402]=1;K[34041]=K[6410]=2;K[6407]=3;K[6408]=4;var I=Object.keys(r).concat(["[object HTMLCanvasElement]","[object CanvasRenderingContext2D]","[object HTMLImageElement]","[object HTMLVideoElement]"]);l.exports=function(f,d,l,g,r,N){function I(){this.format=this.internalformat=6408;this.type=5121;this.flipY=this.premultiplyAlpha=
...
!("type"in b)&&(a.type=ja[c]),c in ca&&(a.compressed=!0),c=!0);!d&&c?a.channels=K[a.format]:d&&!c&&a.channels!==t[a.format]&&(a.format=a.internalformat=t[a.channels])}}function v(a){f.pixelStorei(37440,a.flipY);f.pixelStorei(37441,a.premultiplyAlpha);f.pixelStorei(37443,a.colorSpace);f.pixelStorei(3317,a.unpackAlignment)}function C(){I.call(this);this.yOffset=this.xOffset=0;this.data=null;this.needsFree=!1;this.element=null;this.needsCopy=!1}function O(e,f){var g=null;c(f)?g=f:f&&(ga(e,f),"x"in f&&
(e.xOffset=f.x|0),"y"in f&&(e.yOffset=f.y|0),c(f.data)&&(g=f.data));if(f.copy){var d=r.viewportWidth,h=r.viewportHeight;e.width=e.width||d-e.xOffset;e.height=e.height||h-e.yOffset;e.needsCopy=!0}else if(!g)e.width=e.width||1,e.height=e.height||1;else if(A(g))e.data=g,"type"in f||5121!==e.type||(e.type=G[Object.prototype.toString.call(g)]|0);else if(b(g)){d=g;h=e.width*e.height*e.channels;switch(e.type){case 5121:case 5123:case 5125:case 5126:h=w.allocType(e.type,h);h.set(d);e.data=h;break;case 36193:e.data=
u(d)}e.alignment=1;e.needsFree=!0}else if(x(g)){d=g.data;Array.isArray(d)||5121!==e.type||(e.type=G[Object.prototype.toString.call(d)]|0);var h=g.shape,m=g.stride,l,v,y,C;3===h.length?(y=h[2],C=m[2]):C=y=1;l=h[0];v=h[1];h=m[0];m=m[1];e.alignment=1;e.width=l;e.height=v;e.channels=y;e.format=e.internalformat=t[y];e.needsFree=!0;l=C;g=g.offset;y=e.width;C=e.height;v=e.channels;for(var q=w.allocType(36193===e.type?5126:e.type,y*C*v),E=0,N=0;N<C;++N)for(var J=0;J<y;++J)for(var F=0;F<v;++F)q[E++]=d[h*J+
...
g[0][0].length;y=w.allocType(36193===e.type?5126:e.type,d*h*l);for(v=C=0;v<h;++v)for(q=g[v],E=0;E<d;++E)for(N=q[E],J=0;J<l;++J)y[C++]=N[J];a(e,y)}else{l=w.allocType(36193===e.type?5126:e.type,d*h);for(C=y=0;C<h;++C)for(v=g[C],q=0;q<d;++q)l[y++]=v[q];a(e,l)}e.alignment=1;e.width=d;e.height=h;e.channels=m;e.format=e.internalformat=t[m];e.needsFree=!0}}function X(a,b,c,d,h){var k=a.element,n=a.data,m=a.internalformat,p=a.format,l=a.type,q=a.width,u=a.height;v(a);k?f.texSubImage2D(b,h,c,d,p,l,k):a.compressed?
f.compressedTexSubImage2D(b,h,c,d,m,q,u,n):a.needsCopy?(g(),f.copyTexSubImage2D(b,h,c,d,a.xOffset,a.yOffset,q,u)):f.texSubImage2D(b,h,c,d,q,u,p,l,n)}function F(){return Da.pop()||new C}function da(a){a.needsFree&&w.freeType(a.data);C.call(a);Da.push(a)}function la(){I.call(this);this.genMipmaps=!1;this.mipmapHint=4352;this.mipmask=0;this.images=Array(16)}function P(a,b,c){var g=a.images[0]=F();a.mipmask=1;g.width=a.width=b;g.height=a.height=c}function M(a,b){var g=null;if(c(b))g=a.images[0]=F(),J(g,
a),O(g,b),a.mipmask=1;else if(ga(a,b),Array.isArray(b.mipmap))for(var f=b.mipmap,d=0;d<f.length;++d)g=a.images[d]=F(),J(g,a),g.width>>=d,g.height>>=d,O(g,f[d]),a.mipmask|=1<<d;else g=a.images[0]=F(),J(g,a),O(g,b),a.mipmask=1;J(a,a.images[0])}function H(a,b){for(var c=a.images,d=0;d<c.length&&c[d];++d){var h=c[d],k=b,n=d,m=h.element,p=h.data,l=h.internalformat,u=h.format,A=h.type,y=h.width,t=h.height;v(h);m?f.texImage2D(k,n,u,u,A,m):h.compressed?f.compressedTexImage2D(k,n,l,y,t,0,p):h.needsCopy?(g(),
f.copyTexImage2D(k,n,u,h.xOffset,h.yOffset,y,t,0)):f.texImage2D(k,n,u,y,t,0,u,A,p)}}function T(){var a=Ea.pop()||new la;I.call(a);for(var b=a.mipmask=0;16>b;++b)a.images[b]=null;return a}function ha(a){for(var b=a.images,c=0;c<b.length;++c)b[c]&&da(b[c]),b[c]=null;Ea.push(a)}function qa(){this.magFilter=this.minFilter=9728;this.wrapT=this.wrapS=33071;this.anisotropic=1;this.genMipmaps=!1;this.mipmapHint=4352}function sa(a,b){"min"in b&&(a.minFilter=ta[b.min],0<=y.indexOf(a.minFilter)&&(a.genMipmaps=
...
9984)}}function ia(a,b){f.texParameteri(b,10241,a.minFilter);f.texParameteri(b,10240,a.magFilter);f.texParameteri(b,10242,a.wrapS);f.texParameteri(b,10243,a.wrapT);d.ext_texture_filter_anisotropic&&f.texParameteri(b,34046,a.anisotropic);a.genMipmaps&&(f.hint(33170,a.mipmapHint),f.generateMipmap(b))}function ra(){var a=ua.pop()||new qa;qa.call(a);return a}function na(a){I.call(this);this.mipmask=0;this.internalformat=6408;this.id=Ga++;this.refCount=1;this.target=a;this.texture=f.createTexture();this.unit=
...
(d.mipmask=(d.width<<1)-1);g.mipmask=d.mipmask;J(g,d);g.internalformat=d.internalformat;c.width=d.width;c.height=d.height;U(g);H(d,3553);ia(e,3553);fa();ua.push(e);ha(d);return c}var g=new na(3553);wa[g.id]=g;N.textureCount++;c(a,b);c.subimage=function(a,b,e,d){b|=0;e|=0;d|=0;var f=F();J(f,g);f.width>>=d;f.height>>=d;f.width-=b;f.height-=e;O(f,a);U(g);X(f,3553,b,e,d);fa();da(f);return c};c.resize=function(a,b){var e=a|0,d=b|0||e;if(e===g.width&&d===g.height)return c;c.width=g.width=e;c.height=g.height=
d;U(g);f.texImage2D(3553,0,g.format,e,d,0,g.format,g.type,null);fa();return c};c._reglType="texture2d";c._texture=g;c.destroy=function(){g.decRef()};return c},createCube:function(a,b,c,g,d,h){function k(a,b,c,e,g,d){var f,h=ra();for(f=0;6>f;++f)m[f]=T();if("number"===typeof a||!a)for(a=a|0||1,f=0;6>f;++f)P(m[f],a,a);else if("object"===typeof a)if(b)M(m[0],a),M(m[1],b),M(m[2],c),M(m[3],e),M(m[4],g),M(m[5],d);else if(sa(h,a),ga(n,a),"faces"in a)for(a=a.faces,f=0;6>f;++f)J(m[f],n),M(m[f],a[f]);else for(f=
0;6>f;++f)M(m[f],a);J(n,m[0]);n.mipmask=h.genMipmaps?(m[0].width<<1)-1:m[0].mipmask;n.internalformat=m[0].internalformat;k.width=m[0].width;k.height=m[0].height;U(n);for(f=0;6>f;++f)H(m[f],34069+f);ia(h,34067);fa();ua.push(h);for(f=0;6>f;++f)ha(m[f]);return k}var n=new na(34067);wa[n.id]=n;N.cubeCount++;var m=Array(6);k(a,b,c,g,d,h);k.subimage=function(a,b,c,e,g){c|=0;e|=0;g|=0;var f=F();J(f,n);f.width>>=g;f.height>>=g;f.width-=c;f.height-=e;O(f,b);U(n);X(f,34069+a,c,e,g);fa();da(f);return k};k.resize=
...
31<<15,x=(m<<1>>>24)-127,m=m>>13&1023;a[d]=-24>x?l:-14>x?l+(m+1024>>-14-x):15<x?l+31744:l+(x+15<<10)+m}return a}},{"./pool":28}],31:[function(d,l,r){l.exports=function(b){return Object.keys(b).map(function(d){return b[d]})}},{}],32:[function(d,l,r){function b(b,a){function d(){var a=window.innerWidth,h=window.innerHeight;b!==document.body&&(h=b.getBoundingClientRect(),a=h.right-h.left,h=h.top-h.bottom);m.width=x*a;m.height=x*h;p(m.style,{width:a+"px",height:h+"px"})}var m=document.createElement("canvas"),
l=k(m,a);p(m.style,{border:0,margin:0,padding:0,top:0,left:0});b.appendChild(m);b===document.body&&(m.style.position="absolute",p(b.style,{margin:0,padding:0}));var x=+l.options.pixelRatio;window.addEventListener("resize",d,!1);var w=l.options.onDestroy;l.options=p(p({},l.options),{onDestroy:function(){window.removeEventListener("resize",d);b.removeChild(m);w&&w()}});d();return l}function k(b,a){function d(a){try{return b.getContext(a,k)}catch(h){return null}}var k=a.glOptions||{};return{gl:d("webgl")||
...
d)};d=c[0]}return a.nodeName&&"CANVAS"===a.nodeName.toUpperCase()?k(a,d):b(a,d)}},{"./util/extend":23}],33:[function(d,l,r){l.exports=function(b){b[0]=1;b[1]=0;b[2]=0;b[3]=0;b[4]=0;b[5]=1;b[6]=0;b[7]=0;b[8]=0;b[9]=0;b[10]=1;b[11]=0;b[12]=0;b[13]=0;b[14]=0;b[15]=1;return b}},{}],34:[function(d,l,r){var b=d("./identity");l.exports=function(d,l,c,a){var h,m,A,x,w,u,n,r,y=l[0],t=l[1];l=l[2];A=a[0];x=a[1];m=a[2];n=c[0];a=c[1];h=c[2];if(1E-6>Math.abs(y-n)&&1E-6>Math.abs(t-a)&&1E-6>Math.abs(l-h))return b(d);
c=y-n;a=t-a;n=l-h;r=1/Math.sqrt(c*c+a*a+n*n);c*=r;a*=r;n*=r;h=x*n-m*a;m=m*c-A*n;A=A*a-x*c;(r=Math.sqrt(h*h+m*m+A*A))?(r=1/r,h*=r,m*=r,A*=r):A=m=h=0;x=a*A-n*m;w=n*h-c*A;u=c*m-a*h;(r=Math.sqrt(x*x+w*w+u*u))?(r=1/r,x*=r,w*=r,u*=r):u=w=x=0;d[0]=h;d[1]=x;d[2]=c;d[3]=0;d[4]=m;d[5]=w;d[6]=a;d[7]=0;d[8]=A;d[9]=u;d[10]=n;d[11]=0;d[12]=-(h*y+m*t+A*l);d[13]=-(x*y+w*t+u*l);d[14]=-(c*y+a*t+n*l);d[15]=1;return d}},{"./identity":33}],35:[function(d,l,r){l.exports=function(b,d,l,c,a){d=1/Math.tan(d/2);var h=1/(c-
a);b[0]=d/l;b[1]=0;b[2]=0;b[3]=0;b[4]=0;b[5]=d;b[6]=0;b[7]=0;b[8]=0;b[9]=0;b[10]=(a+c)*h;b[11]=-1;b[12]=0;b[13]=0;b[14]=2*a*c*h;b[15]=0;return b}},{}],36:[function(d,l,r){var b=d("./lib/util/extend"),k=d("./lib/dynamic"),p=d("./lib/util/raf"),c=d("./lib/util/clock"),a=d("./lib/strings"),h=d("./lib/webgl"),m=d("./lib/extension"),A=d("./lib/limits"),x=d("./lib/buffer"),w=d("./lib/elements"),u=d("./lib/texture"),n=d("./lib/renderbuffer"),G=d("./lib/framebuffer"),y=d("./lib/attribute"),t=d("./lib/shader"),
K=d("./lib/read"),I=d("./lib/core"),f=d("./lib/stats"),W=d("./lib/timer");l.exports=function(){function d(){R=p.next(d);H.tick+=1;H.time=(c()-la)/1E3;J();for(var a=0;a<Q.length;++a)(0,Q[a])(H,null,0);C.flush()}function g(a){}function l(a){}function r(a){function c(a){var b={},d={};Object.keys(a).forEach(function(c){var g=a[c];k.isDynamic(g)?d[c]=k.unbox(g,c):b[c]=g});return{dynamic:d,"static":b}}function d(a){for(;v.length<a;)v.push(null);return v}var g=c(a.context||{}),f=c(a.uniforms||{}),h=c(a.attributes||
{}),m=c(function(a){function c(a){if(a in d){var b=d[a];delete d[a];Object.keys(b).forEach(function(c){d[a+"."+c]=b[c]})}}var d=b({},a);delete d.uniforms;delete d.attributes;delete d.context;c("blend");c("depth");c("cull");c("stencil");c("polygonOffset");c("scissor");c("sample");return d}(a));a={gpuTime:0};var g=U.compile(m,h,f,g,a),l=g.draw,n=g.batch,p=g.scope,v=[];return b(function(a,b){var c;if("function"===typeof a)return p.call(this,null,a,0);if("function"===typeof b)if("number"===typeof a)for(c=
0;c<a;++c)p.call(this,null,b,c);else if(Array.isArray(a))for(c=0;c<a.length;++c)p.call(this,a[c],b,c);else return p.call(this,a,b,0);else if("number"===typeof a){if(0<a)return n.call(this,d(a|0),a|0)}else if(Array.isArray(a)){if(a.length)return n.call(this,a,a.length)}else return l.call(this,a)},{stats:a})}function ka(){var a=fa.viewport,b=fa.scissor_box;a[0]=a[1]=b[0]=b[1]=0;H.viewportWidth=H.framebufferWidth=H.drawingBufferWidth=a[2]=b[2]=C.drawingBufferWidth;H.viewportHeight=H.framebufferHeight=
H.drawingBufferHeight=a[3]=b[3]=C.drawingBufferHeight}function J(){ka();U.procs.poll()}function ga(){ka();U.procs.refresh()}var v=h(Array.prototype.slice.call(arguments)),C=v.gl,O=v.options,v=a(),X=f(),F=m(C).extensions,da=W(C,F),la=c(),P=C.drawingBufferWidth,M=C.drawingBufferHeight,H={tick:0,time:0,viewportWidth:P,viewportHeight:M,framebufferWidth:P,framebufferHeight:M,drawingBufferWidth:P,drawingBufferHeight:M,pixelRatio:O.pixelRatio},T=A(C,F),ha=x(C,X),qa=w(C,F,ha,X),P=y(C,F,T,ha,v),sa=t(C,v,X),
ia=u(C,F,T,J,H,X),ra=n(C,F,T,X),na=G(C,F,T,ia,ra,X),M=K(C,J,H),U=I(C,v,F,T,ha,qa,ia,na,{},P,sa,{elements:null,primitive:4,count:-1,offset:0,instances:-1},H,da),fa=U.next,V=C.canvas,Q=[],R=0;V&&(V.addEventListener("webglcontextlost",g,!1),V.addEventListener("webglcontextrestored",l,!1));ga();return b(r,{clear:function(a){var b=0;U.procs.poll();var c=a.color;c&&(C.clearColor(+c[0]||0,+c[1]||0,+c[2]||0,+c[3]||0),b|=16384);"depth"in a&&(C.clearDepth(+a.depth),b|=256);"stencil"in a&&(C.clearStencil(a.stencil|
0),b|=1024);C.clear(b)},prop:k.define.bind(null,1),context:k.define.bind(null,2),"this":k.define.bind(null,3),draw:r({}),buffer:function(a){return ha.create(a,34962)},elements:qa.create,texture:ia.create2D,cube:ia.createCube,renderbuffer:ra.create,framebuffer:na.create,framebufferCube:function(a){},attributes:C.getContextAttributes(),frame:function(a){Q.push(a);!R&&0<Q.length&&d();return{cancel:function(){var b=Q.find(function(b){return b===a});0>b||(Q.splice(b,1),0>=Q.length&&R&&(p.cancel(d),R=0))}}},
limits:T,hasExtension:function(a){return 0<=T.extensions.indexOf(a.toLowerCase())},read:M,destroy:function(){R&&(p.cancel(d),R=0);V&&(V.removeEventListener("webglcontextlost",g),V.removeEventListener("webglcontextrestored",l));sa.clear();na.clear();ra.clear();ia.clear();qa.clear();ha.clear();da&&da.clear();if(O.onDestroy)O.onDestroy()},_gl:C,_refresh:ga,stats:X,updateTimer:function(){da&&da.update()}})}},{"./lib/attribute":2,"./lib/buffer":3,"./lib/core":8,"./lib/dynamic":9,"./lib/elements":10,"./lib/extension":11,
"./lib/framebuffer":12,"./lib/limits":13,"./lib/read":14,"./lib/renderbuffer":15,"./lib/shader":16,"./lib/stats":17,"./lib/strings":18,"./lib/texture":19,"./lib/timer":20,"./lib/util/clock":21,"./lib/util/extend":23,"./lib/util/raf":29,"./lib/webgl":32}],37:[function(d,l,r){function b(a){throw Error("resl: "+a);}function k(a,c,d){Object.keys(a).forEach(function(a){0>c.indexOf(a)&&b('invalid parameter "'+a+'" in '+d)})}function p(a,b){this.state=0;this.ready=!1;this.progress=0;this.name=a;this.cancel=
b}var c=["manifest","onDone","onProgress","onError"],a=["type","src","stream","credentials","parser"],h=["onData","onDone"];l.exports=function(d){function l(a,c){if(a in d){var f=d[a];"function"!==typeof f&&b('invalid callback "'+a+'"');return f}return null}function r(a){function b(){if(!(2>k.readyState||1===l.state||-1===l.state)){if(200!==k.status)return u('error loading resource "'+a.name+'"');if(2<k.readyState&&0===l.state){var d;d="binary"===a.type?k.response:k.responseText;if(h.data)try{m=h.data(d)}catch(f){return u(f)}else m=
d}if(3<k.readyState&&0===l.state){if(h.done)try{m=h.done()}catch(f){return u(f)}l.state=1}I[c]=m;l.progress=.75*l.progress+.25;l.ready=a.stream&&!!m||1===l.state;n()}}var c=a.name,d=a.stream,f="binary"===a.type,h=a.parser,k=new XMLHttpRequest,m=null,l=new p(c,function(){1!==l.state&&-1!==l.state&&(k.onreadystatechange=null,k.abort(),l.state=-1)});k.onreadystatechange=d?b:function(){4===k.readyState&&b()};f&&(k.responseType="arraybuffer");a.credentials&&(k.withCredentials=!0);k.open("GET",a.src,!0);
k.send();return l}function w(a,b){function c(){if(0===r.state)if(m.data)try{t=m.data(b)}catch(a){return u(a)}else t=b}function d(b){c();I[l]=t;r.progress=b.lengthComputable?Math.max(r.progress,b.loaded/b.total):.75*r.progress+.25;r.ready=a.stream;n(l)}function f(){c();if(0===r.state){if(m.done)try{t=m.done()}catch(a){return u(a)}r.state=1}r.progress=1;r.ready=!0;I[l]=t;k();n("finish "+l)}function h(){u('error loading asset "'+l+'"')}function k(){a.stream&&b.removeEventListener("progress",d);"image"===
a.type?b.addEventListener("load",f):b.addEventListener("canplay",f);b.removeEventListener("error",h)}var l=a.name,m=a.parser,r=new p(l,function(){1!==r.state&&-1!==r.state&&(r.state=-1,k(),b.src="")}),t=b;a.stream&&b.addEventListener("progress",d);"image"===a.type?b.addEventListener("load",f):b.addEventListener("canplay",f);b.addEventListener("error",h);b.crossOrigin=a.credentials?"use-credentials":"anonymous";b.src=a.src;return r}function u(a){-1!==f&&1!==f&&(f=-1,E.forEach(function(a){a.cancel()}),
K?"string"===typeof a?K(Error("resl: "+a)):K(a):console.error("resl error:",a))}function n(a){if(-1!==f&&1!==f){var b=0,c=0;E.forEach(function(a){a.ready&&(c+=1);b+=a.progress});c===E.length?(f=1,y(I)):t&&t(b/E.length,a)}}"object"===typeof d&&d||b("invalid or missing configuration");k(d,c,"config");var G=d.manifest;"object"===typeof G&&G||b("missing manifest");var y=l("onDone");y||b("missing onDone() callback");var t=l("onProgress"),K=l("onError"),I={},f=0,W={text:r,binary:function(a){return r(a)},
image:function(a){return w(a,document.createElement("img"))},video:function(a){return w(a,document.createElement("video"))},audio:function(a){return w(a,document.createElement("audio"))}},E=Object.keys(G).map(function(c){function d(a,c){if(a in f.parser){var g=f.parser[a];"function"!==typeof g&&b("invalid parser callback "+a+' for asset "'+a+'"');return g}return c}var f=G[c];"string"===typeof f?f={src:f}:"object"===typeof f&&f||b('invalid asset definition "'+c+'"');k(f,a,'asset "'+c+'"');var l={};
"parser"in f&&("function"===typeof f.parser?l={data:f.parser}:"object"===typeof f.parser&&f.parser?(k(l,h,'parser for asset "'+c+'"'),"onData"in l||b('missing onData callback for parser in asset "'+c+'"'),l={data:d("onData"),done:d("onDone")}):b('invalid parser for asset "'+c+'"'));return{name:c,type:function(a,d,h){a in f&&(h=f[a]);0>d.indexOf(h)&&b("invalid "+a+' "'+h+'" for asset "'+c+'", possible values: '+d);return h}("type",Object.keys(W),"text"),stream:!!f.stream,credentials:!!f.credentials,
src:function(a,d,h){a in f?h=f[a]:d&&b("missing "+a+' for asset "'+c+'"');"string"!==typeof h&&b("invalid "+a+' for asset "'+c+'", must be a string');return h}("src",!0,""),parser:l}}).map(function(a){return W[a.type](a)})}},{}]},{},[1]);
