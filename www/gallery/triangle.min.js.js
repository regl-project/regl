(function e$$0(g,p,d){function n(b,f){if(!p[b]){if(!g[b]){var z="function"==typeof require&&require;if(!f&&z)return z(b,!0);if(a)return a(b,!0);z=Error("Cannot find module '"+b+"'");throw z.code="MODULE_NOT_FOUND",z;}z=p[b]={exports:{}};g[b][0].call(z.exports,function(a){var d=g[b][1][a];return n(d?d:a)},z,z.exports,e$$0,g,p,d)}return p[b].exports}for(var a="function"==typeof require&&require,b=0;b<d.length;b++)n(d[b]);return n})({1:[function(e,g,p){e=e("../regl")();e.clear({color:[1,0,0,1]});e({frag:"\n    void main() {\n      gl_FragColor = vec4(0, 0, 1, 1);\n    }",
vert:"\n    attribute vec4 position;\n    void main() {\n      gl_Position = position;\n    }",attributes:{position:e.buffer([[2,2,0,1],[2,-2,0,1],[-2,-2,0,1]])},count:3})()},{"../regl":33}],2:[function(e,g,p){var d=e("./constants/dtypes.json");g.exports=function(n,a,b,M,f){function z(){this.pointer=!1;this.w=this.z=this.y=this.x=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}function k(a){this.records=[];this.name=a}function e(b,c,h,d){d=h.size||
d;var m;m=c.pointer?h.pointer&&c.buffer===h.buffer&&c.size===d&&c.normalized===h.normalized&&c.type===(h.type||h.buffer.dtype||5126)&&c.offset===h.offset&&c.stride===h.stride&&c.divisor===h.divisor:!h.pointer&&c.x===h.x&&c.y===h.y&&c.z===h.z&&c.w===h.w;m||(h.pointer?(n.enableVertexAttribArray(b),h.buffer.bind(),n.vertexAttribPointer(b,d,h.type||h.buffer.dtype||5126,h.normalized,h.stride,h.offset),(m=a.angle_instanced_arrays)&&m.vertexAttribDivisorANGLE(b,h.divisor)):(n.disableVertexAttribArray(b),
n.vertexAttrib4f(b,h.x,h.y,h.z,h.w)),(c.pointer=h.pointer)?(c.buffer=h.buffer,c.size=d,c.normalized=h.normalized,c.type=h.type||h.buffer.dtype||5126,c.offset=h.offset,c.stride=h.stride,c.divisor=h.divisor):(c.x=h.x,c.y=h.y,c.z=h.z,c.w=h.w))}var g={};b=b.maxAttributes;for(var C=Array(b),m=0;m<b;++m)C[m]=new z;return{bindings:C,bind:function(a,c,h,b){h=h.records;e(a,c,h[h.length-1],b)},bindRecord:e,def:function(a){var c=f.id(a),h=g[c];h||(h=g[c]=new k(a));return h},box:function(a){var c=[new z];return{alloc:function(a){var b;
b=0>=c.length?new z:c.pop();if("number"===typeof a)b.pointer=!1,b.x=a,b.y=0,b.z=0,b.w=0;else if(Array.isArray(a))b.pointer=!1,b.x=a[0],b.y=a[1],b.z=a[2],b.w=a[3];else{var m=M.getBuffer(a),f=0,n=0,k=0,e=0,g=!1,A=0;m||(m=M.getBuffer(a.buffer),f=a.size||0,n=a.stride||0,k=a.offset||0,e=a.divisor||0,g=a.normalized||!1,A=0,"type"in a&&(A=d[a.type]));b.pointer=!0;b.buffer=m;b.size=f;b.offset=k;b.stride=n;b.divisor=e;b.normalized=g;b.type=A}return b},free:function(a){c.push(a)}}},state:g}}},{"./constants/dtypes.json":6}],
3:[function(e,g,p){function d(a,b){switch(a){case 5121:return new Uint8Array(b);case 5123:return new Uint16Array(b);case 5125:return new Uint32Array(b);case 5120:return new Int8Array(b);case 5122:return new Int16Array(b);case 5124:return new Int32Array(b);case 5126:return new Float32Array(b);default:return null}}var n=e("./util/is-typed-array"),a=e("./util/is-ndarray"),b=e("./constants/arraytypes.json"),M=e("./constants/dtypes.json"),f=e("./util/values"),z={"static":35044,dynamic:35048,stream:35040};
g.exports=function(k,e){function g(a,b){this.id=A++;this.buffer=a;this.type=b;this.usage=35044;this.byteLength=0;this.dimension=1;this.data=null;this.dtype=5121}function C(a){e(a);k.isBuffer(a.buffer)||(a.buffer=k.createBuffer());a.bind();k.bufferData(a.type,a.data||a.byteLength,a.usage)}function m(a){var b=a.buffer;e(a);k.isBuffer(b)&&k.deleteBuffer(b);a.buffer=null;delete c[a.id]}var A=0,c={};g.prototype.bind=function(){k.bindBuffer(this.type,this.buffer)};return{create:function(h,f,e){function A(c){var h=
c||{};if(Array.isArray(h)||n(h)||a(h))h={data:h};else if("number"===typeof h)h={length:h|0};else if(null===h||void 0===h)h={};B.usage="usage"in h?z[h.usage]:35044;c=0;"type"in h&&(c=M[h.type]);var m=h.dimension|0||1,f=0,k=null;if("data"in h)if(k=h.data,null===k)f=h.length|0;else{if(a(k)){var m=k.shape,f=k.stride,h=k.offset,e=0,g=0,l=0,P=0;1===m.length?(e=m[0],g=1,l=f[0],P=0):2===m.length&&(e=m[0],g=m[1],l=f[0],P=f[1]);c=c||b[Object.prototype.toString.call(k)]|0||5126;for(var m=g,f=d(c,e*g),k=k.data,
ma=0,T=0;T<e;++T)for(var aa=0;aa<g;++aa)f[ma++]=k[l*T+P*aa+h];k=f}else if(Array.isArray(k))if(0<k.length&&Array.isArray(k[0])){m=k[0].length;c=c||5126;h=d(c,k.length*m);f=k;k=m;for(e=P=0;e<f.length;++e)for(l=f[e],g=0;g<k;++g)h[P++]=l[g];k=h}else c=c||5126,k=d(c,k);else c=c||b[Object.prototype.toString.call(k)]|0;f=k.byteLength}else"length"in h&&(f=h.length|0);B.data=k;B.dtype=c||5121;B.byteLength=f;B.dimension=m;C(B);return A}var D=k.createBuffer(),B=new g(D,f);c[B.id]=B;e||A(h);A._reglType="buffer";
A._buffer=B;A.destroy=function(){m(B)};return A},clear:function(){f(c).forEach(m)},refresh:function(){f(c).forEach(C)},getBuffer:function(a){return a&&a._buffer instanceof g?a._buffer:null}}}},{"./constants/arraytypes.json":5,"./constants/dtypes.json":6,"./util/is-ndarray":24,"./util/is-typed-array":25,"./util/values":31}],4:[function(e,g,p){function d(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}
function n(a,b,d,f){var c,h=",";switch(b){case 5126:c="1f";break;case 35664:c="2fv";break;case 35665:c="3fv";break;case 35666:c="4fv";break;case 35670:case 5124:c="1i";break;case 35671:case 35667:c="2iv";break;case 35672:case 35668:c="3iv";break;case 35673:case 35669:c="4iv";break;case 35674:c="Matrix2fv";h=",false,";break;case 35675:c="Matrix3fv";h=",false,";break;case 35676:c="Matrix4fv",h=",false,"}return a+".uniform"+c+"("+d+h+f+");"}function a(a){return a+"["+a+".length-1]"}function b(a,b){return"framebuffer"===
a||a<b?-1:a>b?1:0}var M=e("./util/codegen"),f=e("./constants/primitives.json"),z={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,"constant color":32769,"one minus constant color":32770,"constant alpha":32771,"one minus constant alpha":32772,"src alpha saturate":776},k={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,
">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},D={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386};g.exports=function(e,g,m,A,c,h,I,O,E,p,B,S,U,la,V){function ja(c,l,g,A,W){function I(t){var a=qa[t];return a?a:a=qa[t]=y(Z[t])}function C(t){var a=t.id,c=ca[a];if(c)return c;switch(t.type){case 0:c=q.def(y(t.data),".call(this,",N,",",L,")");break;case 1:c=q.def(N,t.data);break;case 2:c=q.def(L,t.data);
break;case 3:c=q.def("this",t.data)}return ca[a]=c}function ha(t,a){for(var c=0;c<t.length;++c)if(t[c].name===a)return t[c];return null}function v(t){return J&&!(t in l||t in W)}var E=M(),y=E.link,q=E.proc("batch"),u=E.block(),F=q.def,fa=q.arg,x=y(e),r=y(c.program),Q=y(B.bind),na=y(B.bindRecord),L=y(la),Y=y(O),ba=y(U.count),ia=y(U.offset),pa=y(U.instances),R=y(U.primitive),qa={},w=y(h.elements),ba=F(a(ba)),ia=F(a(ia)),R=F(a(R)),w=F(a(w)),H,ga,S=m.angle_instanced_arrays;S&&(H=F(a(pa)),ga=y(S));var J=
"elements"in l,pa=fa(),fa=fa(),N=F(),V=F(),ca={};q(x,".useProgram(",r,");");c.uniforms.forEach(function(t){if(!(t.name in g)){var a=y(t.location),c=y(p.def(t.name)),c=c+"["+c+".length-1]";t=t.info.type;35678===t||35680===t?(t=F(c+"._texture"),q(n(x,5124,a,t+".bind()")),u(t,".unbind();")):q(n(x,t,a,c))}});c.attributes.forEach(function(t){if(!(t.name in A)){var a=y(B.def(t.name));q(Q,"(",t.location,",",y(B.bindings[t.location]),",",a,",",d(t.info.type),");")}});J||q("if(",w,")",x,".bindBuffer(",34963,
",",w,".buffer.buffer);");q("for(",V,"=0;",V,"<",pa,";++",V,"){",N,"=",fa,"[",V,"];",L,".batchId=",V,";");Object.keys(l).sort(b).forEach(function(t){function a(t){q("if(",c,"){",x,".enable(",t,");}else{",x,".disable(",t,");}")}var c=C(l[t]);switch(t){case "framebuffer":t=I("viewport");var b=I("scissor.box");q("if(",Y,".push(",c,"&&",c,"._framebuffer)){",Y,".poll();",t,".setDirty();",b,".setDirty();","}");break;case "cull.enable":a(2884);break;case "blend.enable":a(3042);break;case "dither":a(3024);
break;case "stencil.enable":a(2960);break;case "depth.enable":a(2929);break;case "scissor.enable":a(3089);break;case "polygonOffset.enable":a(32823);break;case "sample.alpha":a(32926);break;case "sample.enable":a(32928);break;case "depth.mask":q(x,".depthMask(",c,");");break;case "depth.func":t=y(k);q(x,".depthFunc(",t,"[",c,"]);");break;case "depth.range":q(x,".depthRange(",c,"[0],",c,"[1]);");break;case "blend.color":q(x,".blendColor(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "blend.equation":t=
y(K);q("if(typeof ",c,'==="string"){',x,".blendEquation(",t,"[",c,"]);","}else{",x,".blendEquationSeparate(",t,"[",c,".rgb],",t,"[",c,".alpha]);","}");break;case "blend.func":t=y(z);q(x,".blendFuncSeparate(",t,'["srcRGB" in ',c,"?",c,".srcRGB:",c,".src],",t,'["dstRGB" in ',c,"?",c,".dstRGB:",c,".dst],",t,'["srcAlpha" in ',c,"?",c,".srcAlpha:",c,".src],",t,'["dstAlpha" in ',c,"?",c,".dstAlpha:",c,".dst]);");break;case "stencil.mask":q(x,".stencilMask(",c,");");break;case "stencil.func":t=y(k);q(x,
".stencilFunc(",t,"[",c,'.cmp||"always"],',c,".ref|0,",'"mask" in ',c,"?",c,".mask:-1);");break;case "stencil.opFront":case "stencil.opBack":b=y(D);q(x,".stencilOpSeparate(","stencil.opFront"===t?1028:1029,",",b,"[",c,'.fail||"keep"],',b,"[",c,'.zfail||"keep"],',b,"[",c,'.pass||"keep"]);');break;case "polygonOffset.offset":q(x,".polygonOffset(",c,".factor||0,",c,".units||0);");break;case "cull.face":q(x,".cullFace(",c,'==="front"?',1028,":",1029,");");break;case "lineWidth":q(x,".lineWidth(",c,");");
break;case "frontFace":q(x,".frontFace(",c,'==="cw"?',2304,":",2305,");");break;case "colorMask":q(x,".colorMask(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "sample.coverage":q(x,".sampleCoverage(",c,".value,",c,".invert);");break;case "scissor.box":case "viewport":t=I(t),q(t,".push(",c,".x||0,",c,".y||0,",c,".w||-1,",c,".h||-1);")}});("viewport"in l||"framebuffer"in l)&&q(I("viewport"),".poll();");("scissor.box"in l||"framebuffer"in l)&&q(I("scissor.box"),".poll();");"framebuffer"in l&&q(Y,
".pop();");var da=c.uniforms,sa=[];Object.keys(g).forEach(function(t){var c=ha(da,t);if(c){var a=c.info.type,b=y(c.location);t=C(g[t]);35678===c.info.type||35680===c.info.type?(c=F(t+"._texture"),sa.push(c),q(n(x,5124,b,c+".bind()"))):q(n(x,a,b,t))}});sa.forEach(function(t){q(t,".unbind();")});var oa=c.attributes;Object.keys(A).forEach(function(t){var c=ha(oa,t);if(c){var a=y(B.box(t));t=C(A[t]);t=F(a+".alloc("+t+")");q(na,"(",c.location,",",y(B.bindings[c.location]),",",t,",",d(c.info.type),");");
u(a,".free(",t,");")}});l.count&&q(ba,"=",C(l.count),";");l.offset&&q(ia,"=",C(l.offset),";");l.primitive&&q(R,"=",y(f),"[",C(l.primitive),"];");S&&l.instances&&q(H,"=",C(l.instances),";");J&&(c=C(l.elements),q(w,"=",c,"?",c,"._elements:null;"));v("offset")&&q(ia,"=0;");q("if(",w,"){");v("count")&&q(ba,"=",w,".vertCount;");q("if(",ba,">0){");v("primitive")&&q(R,"=",w,".primType;");J&&q(x,".bindBuffer(",34963,",",w,".buffer.buffer);");S&&q("if(",H,">0){",ga,".drawElementsInstancedANGLE(",R,",",ba,
",",w,".type,",ia,",",H,");}else ");q(x,".drawElements(",R,",",ba,",",w,".type,",ia,");");q("}}else if(",ba,">0){");v("count")||(v("primitive")&&q(R,"=",4,";"),S&&q("if(",H,">0){",ga,".drawArraysInstancedANGLE(",R,",",ia,",",ba,",",H,");}else{"),q(x,".drawArrays(",R,",",ia,",",ba,");"),S&&q("}"));q("}}",u);return E.compile().batch}var Z=E.contextState,K={add:32774,subtract:32778,"reverse subtract":32779};m.ext_blend_minmax&&(K.min=32775,K.max=32776);var l=0;return{draw:function(c){var b=M(),f=b.link,
k=b.proc("draw"),l=k.def,g=f(e),z=f(c.program),A=f(B.bind),v=f(U.count),I=f(U.offset),y=f(U.instances),q=f(U.primitive),u=f(h.elements),C=[];k(g,".useProgram(",z,");");c.attributes.forEach(function(c){var a=f(B.def(c.name));k(A,"(",c.location,",",f(B.bindings[c.location]),",",a,",",d(c.info.type),");")});c.uniforms.forEach(function(c){var a=f(c.location),b=f(p.def(c.name)),b=b+"["+b+".length-1]";c=c.info.type;35678===c||35680===c?(c=l(b+"._texture"),C.push(c),k(n(g,5124,a,c+".bind()"))):k(n(g,c,a,
b))});C.forEach(function(c){k(c,".unbind();")});c=l(a(q));v=l(a(v));I=l(a(I));u=l(a(u));k("if(",v,"){");(z=m.angle_instanced_arrays)?(y=l(a(y)),z=f(z),k("if(",u,"){",u,".bind();","if(",y,">0){",z,".drawElementsInstancedANGLE(",c,",",v,",",u,".type,",I,",",y,");}else{",g,".drawElements(",c,",",v,",",u,".type,",I,");}","}else if(",y,">0){",z,".drawArraysInstancedANGLE(",c,",",I,",",v,",",y,");}else{",g,".drawArrays(",c,",",I,",",v,");}}")):k("if(",u,"){",u,".bind();",g,".drawElements(",c,",",v,",",
u,".type,",I,");","}else{",g,".drawArrays(",c,",",I,",",v,");}}");return b.compile().draw},command:function(c,a,d,m,n,e,A,I){function v(c){var a=qa[c];return a?a:a=qa[c]=u(Z[c])}function E(c,a){var b=v(c);w(b,".push(",a,");");H(b,".pop();")}function y(c){var a=c.id,b=ua[a];if(b)return b;switch(c.type){case 0:b=J.def(u(c.data),".call(this,",ga,",",R,")");break;case 1:b=J.def(ga,c.data);break;case 2:b=J.def(R,c.data);break;case 3:b=J.def("this",c.data)}return ua[a]=b}var q=M(),u=q.link,F=q.block,G=
q.proc,x=l++,r=u(V),Q=u(S),na=u(O),L={count:u(U.count),offset:u(U.offset),instances:u(U.instances),primitive:u(U.primitive)},Y=u(h.elements),ba=u(f),ia=u(k),pa=u(D),R=u(la),qa={},w=F(),H=F(),ga;I&&(ga=w.def());w(R,".batchId=0;");var ta=F();Object.keys(A["static"]).forEach(function(c){var a=w.def(R,".",c);ta(R,".",c,"=",u(A["static"][c]),";");H(R,".",c,"=",a,";")});Object.keys(A.dynamic).forEach(function(c){var a=w.def(R,".",c),b=w.def(),r=A.dynamic[c];ta(R,".",c,"=",b,";");switch(r.type){case 0:w(b,
...
w(b,".push(",r,");");H(b,".pop();");break;case "lineWidth":E(a,b);break;case "frontFace":r=0;"cw"===b?r=2304:"ccw"===b&&(r=2305);b=v(a);w(b,".push(",r,");");H(b,".pop();");break;case "colorMask":a=v(a);w(a,".push(",b.map(function(c){return!!c}).join(),");");H(a,".pop();");break;case "sample.coverage":r="value"in b?b.value:1;b=!!b.invert;a=v(a);w(a,".push(",r,",",b,");");H(a,".pop();");break;case "viewport":case "scissor.box":var r=b.x||0,d=b.y||0,m=-1,l=-1;"w"in b&&(m=b.w);"h"in b&&(l=b.h);b=v(a);
w(b,".push(",r,",",d,",",m,",",l,");");H(b,".pop();")}});Object.keys(a).forEach(function(c){var b=u(p.def(c));c=a[c];c="function"===typeof c&&c._reglType?u(c):Array.isArray(c)?u(c.slice()):+c;w(b,".push(",c,");");H(b,".pop();")});Object.keys(d).forEach(function(c){var a=d[c],b=u(B.def(c));c=u(B.box(c).alloc(a));w(b,".records.push(",c,");");H(b,".records.pop();")});var J=q.block(),N=q.block(),ua={};Object.keys(m).sort(b).forEach(function(a){var b=y(m[a]);switch(a){case "framebuffer":a=v("viewport");
