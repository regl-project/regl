...
vert:"\n  precision mediump float;\n  attribute vec2 position;\n  varying vec2 uv;\n  void main () {\n    uv = position;\n    gl_Position = vec4(1.0 - 2.0 * position, 0, 1);\n  }",attributes:{position:e.buffer([-2,0,0,-2,2,2])},uniforms:{tick:function(d,a){return.005*a.count},texture:e.texture({min:"nearest mipmap linear",mag:"nearest",wrap:"repeat",data:[[255,255,255,255,0,0,0,0],[255,255,255,255,0,0,0,0],[255,255,255,255,0,0,0,0],[255,255,255,255,0,0,0,0],[0,0,0,0,255,255,255,255],[0,0,0,0,255,
255,255,255],[0,0,0,0,255,255,255,255],[0,0,0,0,255,255,255,255]]})},count:3});e.frame(function(m,a){d()})},{"../regl":33}],2:[function(e,g,p){var d=e("./constants/dtypes.json");g.exports=function(m,a,b,M,f){function z(){this.pointer=!1;this.w=this.z=this.y=this.x=0;this.buffer=null;this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}function k(a){this.records=[];this.name=a}function e(b,c,h,d){d=h.size||d;var n;n=c.pointer?h.pointer&&c.buffer===h.buffer&&c.size===
d&&c.normalized===h.normalized&&c.type===(h.type||h.buffer.dtype||5126)&&c.offset===h.offset&&c.stride===h.stride&&c.divisor===h.divisor:!h.pointer&&c.x===h.x&&c.y===h.y&&c.z===h.z&&c.w===h.w;n||(h.pointer?(m.enableVertexAttribArray(b),h.buffer.bind(),m.vertexAttribPointer(b,d,h.type||h.buffer.dtype||5126,h.normalized,h.stride,h.offset),(n=a.angle_instanced_arrays)&&n.vertexAttribDivisorANGLE(b,h.divisor)):(m.disableVertexAttribArray(b),m.vertexAttrib4f(b,h.x,h.y,h.z,h.w)),(c.pointer=h.pointer)?(c.buffer=
h.buffer,c.size=d,c.normalized=h.normalized,c.type=h.type||h.buffer.dtype||5126,c.offset=h.offset,c.stride=h.stride,c.divisor=h.divisor):(c.x=h.x,c.y=h.y,c.z=h.z,c.w=h.w))}var g={};b=b.maxAttributes;for(var C=Array(b),n=0;n<b;++n)C[n]=new z;return{bindings:C,bind:function(a,c,h,b){h=h.records;e(a,c,h[h.length-1],b)},bindRecord:e,def:function(a){var c=f.id(a),h=g[c];h||(h=g[c]=new k(a));return h},box:function(a){var c=[new z];return{alloc:function(a){var b;b=0>=c.length?new z:c.pop();if("number"===
typeof a)b.pointer=!1,b.x=a,b.y=0,b.z=0,b.w=0;else if(Array.isArray(a))b.pointer=!1,b.x=a[0],b.y=a[1],b.z=a[2],b.w=a[3];else{var n=M.getBuffer(a),f=0,m=0,k=0,e=0,g=!1,A=0;n||(n=M.getBuffer(a.buffer),f=a.size||0,m=a.stride||0,k=a.offset||0,e=a.divisor||0,g=a.normalized||!1,A=0,"type"in a&&(A=d[a.type]));b.pointer=!0;b.buffer=n;b.size=f;b.offset=k;b.stride=m;b.divisor=e;b.normalized=g;b.type=A}return b},free:function(a){c.push(a)}}},state:g}}},{"./constants/dtypes.json":6}],3:[function(e,g,p){function d(a,
...
break;case 3:c=q.def("this",t.data)}return ca[a]=c}function ha(t,a){for(var c=0;c<t.length;++c)if(t[c].name===a)return t[c];return null}function v(t){return J&&!(t in l||t in W)}var E=M(),y=E.link,q=E.proc("batch"),u=E.block(),F=q.def,fa=q.arg,x=y(e),r=y(c.program),Q=y(B.bind),na=y(B.bindRecord),L=y(la),Y=y(O),ba=y(U.count),ia=y(U.offset),pa=y(U.instances),R=y(U.primitive),qa={},w=y(h.elements),ba=F(a(ba)),ia=F(a(ia)),R=F(a(R)),w=F(a(w)),H,ga,S=n.angle_instanced_arrays;S&&(H=F(a(pa)),ga=y(S));var J=
"elements"in l,pa=fa(),fa=fa(),N=F(),V=F(),ca={};q(x,".useProgram(",r,");");c.uniforms.forEach(function(t){if(!(t.name in g)){var a=y(t.location),c=y(p.def(t.name)),c=c+"["+c+".length-1]";t=t.info.type;35678===t||35680===t?(t=F(c+"._texture"),q(m(x,5124,a,t+".bind()")),u(t,".unbind();")):q(m(x,t,a,c))}});c.attributes.forEach(function(t){if(!(t.name in A)){var a=y(B.def(t.name));q(Q,"(",t.location,",",y(B.bindings[t.location]),",",a,",",d(t.info.type),");")}});J||q("if(",w,")",x,".bindBuffer(",34963,
...
k=b.proc("draw"),l=k.def,g=f(e),z=f(c.program),A=f(B.bind),v=f(U.count),I=f(U.offset),y=f(U.instances),q=f(U.primitive),u=f(h.elements),C=[];k(g,".useProgram(",z,");");c.attributes.forEach(function(c){var a=f(B.def(c.name));k(A,"(",c.location,",",f(B.bindings[c.location]),",",a,",",d(c.info.type),");")});c.uniforms.forEach(function(c){var a=f(c.location),b=f(p.def(c.name)),b=b+"["+b+".length-1]";c=c.info.type;35678===c||35680===c?(c=l(b+"._texture"),C.push(c),k(m(g,5124,a,c+".bind()"))):k(m(g,c,a,
b))});C.forEach(function(c){k(c,".unbind();")});c=l(a(q));v=l(a(v));I=l(a(I));u=l(a(u));k("if(",v,"){");(z=n.angle_instanced_arrays)?(y=l(a(y)),z=f(z),k("if(",u,"){",u,".bind();","if(",y,">0){",z,".drawElementsInstancedANGLE(",c,",",v,",",u,".type,",I,",",y,");}else{",g,".drawElements(",c,",",v,",",u,".type,",I,");}","}else if(",y,">0){",z,".drawArraysInstancedANGLE(",c,",",I,",",v,",",y,");}else{",g,".drawArrays(",c,",",I,",",v,");}}")):k("if(",u,"){",u,".bind();",g,".drawElements(",c,",",v,",",
u,".type,",I,");","}else{",g,".drawArrays(",c,",",I,",",v,");}}");return b.compile().draw},command:function(c,a,d,n,m,e,A,I){function v(c){var a=qa[c];return a?a:a=qa[c]=u(Z[c])}function E(c,a){var b=v(c);w(b,".push(",a,");");H(b,".pop();")}function y(c){var a=c.id,b=ua[a];if(b)return b;switch(c.type){case 0:b=J.def(u(c.data),".call(this,",ga,",",R,")");break;case 1:b=J.def(ga,c.data);break;case 2:b=J.def(R,c.data);break;case 3:b=J.def("this",c.data)}return ua[a]=b}var q=M(),u=q.link,F=q.block,G=
...
u.refresh();F.refresh();ra.refresh();Q.refresh();if(P.onContextRestored)P.onContextRestored();e()}function ja(a){function b(a){var c={},d={};Object.keys(a).forEach(function(b){var f=a[b];E.isDynamic(f)?(e=!0,d[b]=E.unbox(f,b)):c[b]=f});return{dynamic:d,"static":c}}function c(a){for(;m.length<a;)m.push(null);return m}var e=!1,f=b(a.context||{}),g=b(a.uniforms||{}),h=b(a.attributes||{});a=b(function(a){function b(a){if(a in c){var d=c[a];delete c[a];Object.keys(d).forEach(function(b){c[a+"."+b]=d[b]})}}
var c=d({},a);delete c.uniforms;delete c.attributes;delete c.context;b("blend");b("depth");b("cull");b("stencil");b("polygonOffset");b("scissor");b("sample");return c}(a));var f=na.command(a["static"],g["static"],h["static"],a.dynamic,g.dynamic,h.dynamic,f,e),k=f.draw,l=f.batch,n=f.scope,m=[];return function(a,b){return"function"===typeof a?n.call(this,null,a):"function"===typeof b?n.call(this,a,b):"number"===typeof a?l.call(this,a|0,c(a|0)):Array.isArray(a)?l.call(this,a.length,a):k.call(this,a)}}
