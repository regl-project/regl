...
u[e];a(k,".",wa[e],"(",l,");",l.map(function(d,a){return m+"["+a+"]="+d}).join(";"),";")}else a(k,".",wa[e],"(",l,");",v,".",e,"=",l,";")}})}function V(d,a){Da&&(d.instancing=a.def(d.shared.extensions,".angle_instanced_arrays"))}function Z(d,a,b,c,e){function f(){return"undefined"===typeof performance?"Date.now()":"performance.now()"}function u(d){g=a.def();d(g,"=",f(),";");"string"===typeof e?d(r,".count+=",e,";"):d(r,".count++;");ba&&(c?(I=a.def(),d(I,"=",h,".getNumPendingQueries();")):d(h,".beginQuery(",
r,");"))}function v(d){d(r,".cpuTime+=",f(),"-",g,";");ba&&(c?d(h,".pushScopeStats(",I,",",h,".getNumPendingQueries(),",r,");"):d(h,".endQuery();"))}function l(d){var b=a.def(m,".profile");a(m,".profile=",d,";");a.exit(m,".profile=",b,";")}var k=d.shared,r=d.stats,m=k.current,h=k.timer;b=b.profile;var g,I;if(b){if(n(b)){b.enable?(u(a),v(a.exit),l("true")):l("false");return}b=b.append(d,a);l(b)}else b=a.def(m,".profile");k=d.block();u(k);a("if(",b,"){",k,"}");d=d.block();v(d);a.exit("if(",b,"){",d,
