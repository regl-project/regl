(function e$$0(g,p,d){function n(b,f){if(!p[b]){if(!g[b]){var z="function"==typeof require&&require;if(!f&&z)return z(b,!0);if(a)return a(b,!0);z=Error("Cannot find module '"+b+"'");throw z.code="MODULE_NOT_FOUND",z;}z=p[b]={exports:{}};g[b][0].call(z.exports,function(a){var d=g[b][1][a];return n(d?d:a)},z,z.exports,e$$0,g,p,d)}return p[b].exports}for(var a="function"==typeof require&&require,b=0;b<d.length;b++)n(d[b]);return n})({1:[function(e,g,p){e=e("../regl")();e.clear({color:[0,0,0,1],depth:1});
e({frag:"\n  precision mediump float;\n  uniform vec4 color;\n  void main () {\n    gl_FragColor = color;\n  }",vert:"\n  precision mediump float;\n  attribute vec2 position;\n  void main () {\n    gl_Position = vec4(position, 0, 1);\n  }",attributes:{position:e.buffer([-1,0,0,-1,1,1])},uniforms:{color:[1,0,0,1]},count:3})()},{"../regl":33}],2:[function(e,g,p){var d=e("./constants/dtypes.json");g.exports=function(n,a,b,M,f){function z(){this.pointer=!1;this.w=this.z=this.y=this.x=0;this.buffer=null;
this.size=0;this.normalized=!1;this.type=5126;this.divisor=this.stride=this.offset=0}function k(a){this.records=[];this.name=a}function e(b,c,h,d){d=h.size||d;var m;m=c.pointer?h.pointer&&c.buffer===h.buffer&&c.size===d&&c.normalized===h.normalized&&c.type===(h.type||h.buffer.dtype||5126)&&c.offset===h.offset&&c.stride===h.stride&&c.divisor===h.divisor:!h.pointer&&c.x===h.x&&c.y===h.y&&c.z===h.z&&c.w===h.w;m||(h.pointer?(n.enableVertexAttribArray(b),h.buffer.bind(),n.vertexAttribPointer(b,d,h.type||
h.buffer.dtype||5126,h.normalized,h.stride,h.offset),(m=a.angle_instanced_arrays)&&m.vertexAttribDivisorANGLE(b,h.divisor)):(n.disableVertexAttribArray(b),n.vertexAttrib4f(b,h.x,h.y,h.z,h.w)),(c.pointer=h.pointer)?(c.buffer=h.buffer,c.size=d,c.normalized=h.normalized,c.type=h.type||h.buffer.dtype||5126,c.offset=h.offset,c.stride=h.stride,c.divisor=h.divisor):(c.x=h.x,c.y=h.y,c.z=h.z,c.w=h.w))}var g={};b=b.maxAttributes;for(var C=Array(b),m=0;m<b;++m)C[m]=new z;return{bindings:C,bind:function(a,c,
h,b){h=h.records;e(a,c,h[h.length-1],b)},bindRecord:e,def:function(a){var c=f.id(a),h=g[c];h||(h=g[c]=new k(a));return h},box:function(a){var c=[new z];return{alloc:function(a){var b;b=0>=c.length?new z:c.pop();if("number"===typeof a)b.pointer=!1,b.x=a,b.y=0,b.z=0,b.w=0;else if(Array.isArray(a))b.pointer=!1,b.x=a[0],b.y=a[1],b.z=a[2],b.w=a[3];else{var m=M.getBuffer(a),f=0,n=0,k=0,e=0,g=!1,A=0;m||(m=M.getBuffer(a.buffer),f=a.size||0,n=a.stride||0,k=a.offset||0,e=a.divisor||0,g=a.normalized||!1,A=0,
"type"in a&&(A=d[a.type]));b.pointer=!0;b.buffer=m;b.size=f;b.offset=k;b.stride=n;b.divisor=e;b.normalized=g;b.type=A}return b},free:function(a){c.push(a)}}},state:g}}},{"./constants/dtypes.json":6}],3:[function(e,g,p){function d(a,b){switch(a){case 5121:return new Uint8Array(b);case 5123:return new Uint16Array(b);case 5125:return new Uint32Array(b);case 5120:return new Int8Array(b);case 5122:return new Int16Array(b);case 5124:return new Int32Array(b);case 5126:return new Float32Array(b);default:return null}}
var n=e("./util/is-typed-array"),a=e("./util/is-ndarray"),b=e("./constants/arraytypes.json"),M=e("./constants/dtypes.json"),f=e("./util/values"),z={"static":35044,dynamic:35048,stream:35040};g.exports=function(k,e){function g(a,b){this.id=A++;this.buffer=a;this.type=b;this.usage=35044;this.byteLength=0;this.dimension=1;this.data=null;this.dtype=5121}function C(a){e(a);k.isBuffer(a.buffer)||(a.buffer=k.createBuffer());a.bind();k.bufferData(a.type,a.data||a.byteLength,a.usage)}function m(a){var b=a.buffer;
e(a);k.isBuffer(b)&&k.deleteBuffer(b);a.buffer=null;delete c[a.id]}var A=0,c={};g.prototype.bind=function(){k.bindBuffer(this.type,this.buffer)};return{create:function(h,f,e){function A(c){var h=c||{};if(Array.isArray(h)||n(h)||a(h))h={data:h};else if("number"===typeof h)h={length:h|0};else if(null===h||void 0===h)h={};B.usage="usage"in h?z[h.usage]:35044;c=0;"type"in h&&(c=M[h.type]);var m=h.dimension|0||1,f=0,k=null;if("data"in h)if(k=h.data,null===k)f=h.length|0;else{if(a(k)){var m=k.shape,f=k.stride,
h=k.offset,e=0,g=0,l=0,P=0;1===m.length?(e=m[0],g=1,l=f[0],P=0):2===m.length&&(e=m[0],g=m[1],l=f[0],P=f[1]);c=c||b[Object.prototype.toString.call(k)]|0||5126;for(var m=g,f=d(c,e*g),k=k.data,ma=0,T=0;T<e;++T)for(var aa=0;aa<g;++aa)f[ma++]=k[l*T+P*aa+h];k=f}else if(Array.isArray(k))if(0<k.length&&Array.isArray(k[0])){m=k[0].length;c=c||5126;h=d(c,k.length*m);f=k;k=m;for(e=P=0;e<f.length;++e)for(l=f[e],g=0;g<k;++g)h[P++]=l[g];k=h}else c=c||5126,k=d(c,k);else c=c||b[Object.prototype.toString.call(k)]|
0;f=k.byteLength}else"length"in h&&(f=h.length|0);B.data=k;B.dtype=c||5121;B.byteLength=f;B.dimension=m;C(B);return A}var D=k.createBuffer(),B=new g(D,f);c[B.id]=B;e||A(h);A._reglType="buffer";A._buffer=B;A.destroy=function(){m(B)};return A},clear:function(){f(c).forEach(m)},refresh:function(){f(c).forEach(C)},getBuffer:function(a){return a&&a._buffer instanceof g?a._buffer:null}}}},{"./constants/arraytypes.json":5,"./constants/dtypes.json":6,"./util/is-ndarray":24,"./util/is-typed-array":25,"./util/values":31}],
4:[function(e,g,p){function d(a){switch(a){case 35664:case 35667:case 35671:return 2;case 35665:case 35668:case 35672:return 3;case 35666:case 35669:case 35673:return 4;default:return 1}}function n(a,b,d,f){var c,h=",";switch(b){case 5126:c="1f";break;case 35664:c="2fv";break;case 35665:c="3fv";break;case 35666:c="4fv";break;case 35670:case 5124:c="1i";break;case 35671:case 35667:c="2iv";break;case 35672:case 35668:c="3iv";break;case 35673:case 35669:c="4iv";break;case 35674:c="Matrix2fv";h=",false,";
break;case 35675:c="Matrix3fv";h=",false,";break;case 35676:c="Matrix4fv",h=",false,"}return a+".uniform"+c+"("+d+h+f+");"}function a(a){return a+"["+a+".length-1]"}function b(a,b){return"framebuffer"===a||a<b?-1:a>b?1:0}var M=e("./util/codegen"),f=e("./constants/primitives.json"),z={0:0,1:1,zero:0,one:1,"src color":768,"one minus src color":769,"src alpha":770,"one minus src alpha":771,"dst color":774,"one minus dst color":775,"dst alpha":772,"one minus dst alpha":773,"constant color":32769,"one minus constant color":32770,
"constant alpha":32771,"one minus constant alpha":32772,"src alpha saturate":776},k={never:512,less:513,"<":513,equal:514,"=":514,"==":514,"===":514,lequal:515,"<=":515,greater:516,">":516,notequal:517,"!=":517,"!==":517,gequal:518,">=":518,always:519},D={0:0,zero:0,keep:7680,replace:7681,increment:7682,decrement:7683,"increment wrap":34055,"decrement wrap":34056,invert:5386};g.exports=function(e,g,m,A,c,h,I,O,E,p,B,S,U,la,V){function ja(c,l,g,A,W){function I(t){var a=qa[t];return a?a:a=qa[t]=y(Z[t])}
function C(t){var a=t.id,c=ca[a];if(c)return c;switch(t.type){case 0:c=q.def(y(t.data),".call(this,",N,",",L,")");break;case 1:c=q.def(N,t.data);break;case 2:c=q.def(L,t.data);break;case 3:c=q.def("this",t.data)}return ca[a]=c}function ha(t,a){for(var c=0;c<t.length;++c)if(t[c].name===a)return t[c];return null}function v(t){return J&&!(t in l||t in W)}var E=M(),y=E.link,q=E.proc("batch"),u=E.block(),F=q.def,fa=q.arg,x=y(e),r=y(c.program),Q=y(B.bind),na=y(B.bindRecord),L=y(la),Y=y(O),ba=y(U.count),
ia=y(U.offset),pa=y(U.instances),R=y(U.primitive),qa={},w=y(h.elements),ba=F(a(ba)),ia=F(a(ia)),R=F(a(R)),w=F(a(w)),H,ga,S=m.angle_instanced_arrays;S&&(H=F(a(pa)),ga=y(S));var J="elements"in l,pa=fa(),fa=fa(),N=F(),V=F(),ca={};q(x,".useProgram(",r,");");c.uniforms.forEach(function(t){if(!(t.name in g)){var a=y(t.location),c=y(p.def(t.name)),c=c+"["+c+".length-1]";t=t.info.type;35678===t||35680===t?(t=F(c+"._texture"),q(n(x,5124,a,t+".bind()")),u(t,".unbind();")):q(n(x,t,a,c))}});c.attributes.forEach(function(t){if(!(t.name in
A)){var a=y(B.def(t.name));q(Q,"(",t.location,",",y(B.bindings[t.location]),",",a,",",d(t.info.type),");")}});J||q("if(",w,")",x,".bindBuffer(",34963,",",w,".buffer.buffer);");q("for(",V,"=0;",V,"<",pa,";++",V,"){",N,"=",fa,"[",V,"];",L,".batchId=",V,";");Object.keys(l).sort(b).forEach(function(t){function a(t){q("if(",c,"){",x,".enable(",t,");}else{",x,".disable(",t,");}")}var c=C(l[t]);switch(t){case "framebuffer":t=I("viewport");var b=I("scissor.box");q("if(",Y,".push(",c,"&&",c,"._framebuffer)){",
Y,".poll();",t,".setDirty();",b,".setDirty();","}");break;case "cull.enable":a(2884);break;case "blend.enable":a(3042);break;case "dither":a(3024);break;case "stencil.enable":a(2960);break;case "depth.enable":a(2929);break;case "scissor.enable":a(3089);break;case "polygonOffset.enable":a(32823);break;case "sample.alpha":a(32926);break;case "sample.enable":a(32928);break;case "depth.mask":q(x,".depthMask(",c,");");break;case "depth.func":t=y(k);q(x,".depthFunc(",t,"[",c,"]);");break;case "depth.range":q(x,
".depthRange(",c,"[0],",c,"[1]);");break;case "blend.color":q(x,".blendColor(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "blend.equation":t=y(K);q("if(typeof ",c,'==="string"){',x,".blendEquation(",t,"[",c,"]);","}else{",x,".blendEquationSeparate(",t,"[",c,".rgb],",t,"[",c,".alpha]);","}");break;case "blend.func":t=y(z);q(x,".blendFuncSeparate(",t,'["srcRGB" in ',c,"?",c,".srcRGB:",c,".src],",t,'["dstRGB" in ',c,"?",c,".dstRGB:",c,".dst],",t,'["srcAlpha" in ',c,"?",c,".srcAlpha:",c,".src],",
t,'["dstAlpha" in ',c,"?",c,".dstAlpha:",c,".dst]);");break;case "stencil.mask":q(x,".stencilMask(",c,");");break;case "stencil.func":t=y(k);q(x,".stencilFunc(",t,"[",c,'.cmp||"always"],',c,".ref|0,",'"mask" in ',c,"?",c,".mask:-1);");break;case "stencil.opFront":case "stencil.opBack":b=y(D);q(x,".stencilOpSeparate(","stencil.opFront"===t?1028:1029,",",b,"[",c,'.fail||"keep"],',b,"[",c,'.zfail||"keep"],',b,"[",c,'.pass||"keep"]);');break;case "polygonOffset.offset":q(x,".polygonOffset(",c,".factor||0,",
c,".units||0);");break;case "cull.face":q(x,".cullFace(",c,'==="front"?',1028,":",1029,");");break;case "lineWidth":q(x,".lineWidth(",c,");");break;case "frontFace":q(x,".frontFace(",c,'==="cw"?',2304,":",2305,");");break;case "colorMask":q(x,".colorMask(",c,"[0],",c,"[1],",c,"[2],",c,"[3]);");break;case "sample.coverage":q(x,".sampleCoverage(",c,".value,",c,".invert);");break;case "scissor.box":case "viewport":t=I(t),q(t,".push(",c,".x||0,",c,".y||0,",c,".w||-1,",c,".h||-1);")}});("viewport"in l||
"framebuffer"in l)&&q(I("viewport"),".poll();");("scissor.box"in l||"framebuffer"in l)&&q(I("scissor.box"),".poll();");"framebuffer"in l&&q(Y,".pop();");var da=c.uniforms,sa=[];Object.keys(g).forEach(function(t){var c=ha(da,t);if(c){var a=c.info.type,b=y(c.location);t=C(g[t]);35678===c.info.type||35680===c.info.type?(c=F(t+"._texture"),sa.push(c),q(n(x,5124,b,c+".bind()"))):q(n(x,a,b,t))}});sa.forEach(function(t){q(t,".unbind();")});var oa=c.attributes;Object.keys(A).forEach(function(t){var c=ha(oa,
t);if(c){var a=y(B.box(t));t=C(A[t]);t=F(a+".alloc("+t+")");q(na,"(",c.location,",",y(B.bindings[c.location]),",",t,",",d(c.info.type),");");u(a,".free(",t,");")}});l.count&&q(ba,"=",C(l.count),";");l.offset&&q(ia,"=",C(l.offset),";");l.primitive&&q(R,"=",y(f),"[",C(l.primitive),"];");S&&l.instances&&q(H,"=",C(l.instances),";");J&&(c=C(l.elements),q(w,"=",c,"?",c,"._elements:null;"));v("offset")&&q(ia,"=0;");q("if(",w,"){");v("count")&&q(ba,"=",w,".vertCount;");q("if(",ba,">0){");v("primitive")&&
q(R,"=",w,".primType;");J&&q(x,".bindBuffer(",34963,",",w,".buffer.buffer);");S&&q("if(",H,">0){",ga,".drawElementsInstancedANGLE(",R,",",ba,",",w,".type,",ia,",",H,");}else ");q(x,".drawElements(",R,",",ba,",",w,".type,",ia,");");q("}}else if(",ba,">0){");v("count")||(v("primitive")&&q(R,"=",4,";"),S&&q("if(",H,">0){",ga,".drawArraysInstancedANGLE(",R,",",ia,",",ba,",",H,");}else{"),q(x,".drawArrays(",R,",",ia,",",ba,");"),S&&q("}"));q("}}",u);return E.compile().batch}var Z=E.contextState,K={add:32774,
subtract:32778,"reverse subtract":32779};m.ext_blend_minmax&&(K.min=32775,K.max=32776);var l=0;return{draw:function(c){var b=M(),f=b.link,k=b.proc("draw"),l=k.def,g=f(e),z=f(c.program),A=f(B.bind),v=f(U.count),I=f(U.offset),y=f(U.instances),q=f(U.primitive),u=f(h.elements),C=[];k(g,".useProgram(",z,");");c.attributes.forEach(function(c){var a=f(B.def(c.name));k(A,"(",c.location,",",f(B.bindings[c.location]),",",a,",",d(c.info.type),");")});c.uniforms.forEach(function(c){var a=f(c.location),b=f(p.def(c.name)),
b=b+"["+b+".length-1]";c=c.info.type;35678===c||35680===c?(c=l(b+"._texture"),C.push(c),k(n(g,5124,a,c+".bind()"))):k(n(g,c,a,b))});C.forEach(function(c){k(c,".unbind();")});c=l(a(q));v=l(a(v));I=l(a(I));u=l(a(u));k("if(",v,"){");(z=m.angle_instanced_arrays)?(y=l(a(y)),z=f(z),k("if(",u,"){",u,".bind();","if(",y,">0){",z,".drawElementsInstancedANGLE(",c,",",v,",",u,".type,",I,",",y,");}else{",g,".drawElements(",c,",",v,",",u,".type,",I,");}","}else if(",y,">0){",z,".drawArraysInstancedANGLE(",c,",",
I,",",v,",",y,");}else{",g,".drawArrays(",c,",",I,",",v,");}}")):k("if(",u,"){",u,".bind();",g,".drawElements(",c,",",v,",",u,".type,",I,");","}else{",g,".drawArrays(",c,",",I,",",v,");}}");return b.compile().draw},command:function(c,a,d,m,n,e,A,I){function v(c){var a=qa[c];return a?a:a=qa[c]=u(Z[c])}function E(c,a){var b=v(c);w(b,".push(",a,");");H(b,".pop();")}function y(c){var a=c.id,b=ua[a];if(b)return b;switch(c.type){case 0:b=J.def(u(c.data),".call(this,",ga,",",R,")");break;case 1:b=J.def(ga,
c.data);break;case 2:b=J.def(R,c.data);break;case 3:b=J.def("this",c.data)}return ua[a]=b}var q=M(),u=q.link,F=q.block,G=q.proc,x=l++,r=u(V),Q=u(S),na=u(O),L={count:u(U.count),offset:u(U.offset),instances:u(U.instances),primitive:u(U.primitive)},Y=u(h.elements),ba=u(f),ia=u(k),pa=u(D),R=u(la),qa={},w=F(),H=F(),ga;I&&(ga=w.def());w(R,".batchId=0;");var ta=F();Object.keys(A["static"]).forEach(function(c){var a=w.def(R,".",c);ta(R,".",c,"=",u(A["static"][c]),";");H(R,".",c,"=",a,";")});Object.keys(A.dynamic).forEach(function(c){var a=
w.def(R,".",c),b=w.def(),r=A.dynamic[c];ta(R,".",c,"=",b,";");switch(r.type){case 0:w(b,"=",u(r.data),".call(this,",ga,",",R,");");break;case 1:w(b,"=",ga,r.data,";");break;case 2:w(b,"=",R,r.data,";");break;case 3:w(b,"=","this",r.data,";")}H(R,".",c,"=",a,";")});w(ta);Object.keys(c).sort(b).forEach(function(a){var b=c[a];switch(a){case "frag":case "vert":b=g.id(b);S.shader("frag"===a?35632:35633,b);w(Q,".",a,".push(",b,");");H(Q,".",a,".pop();");break;case "framebuffer":O.getFramebuffer(b);a=v("viewport");
var r=v("scissor.box");w("if(",na,".push(",u(b&&b._framebuffer),")){",a,".setDirty();",r,".setDirty();","}");H("if(",na,".pop()){",a,".setDirty();",r,".setDirty();","}");break;case "count":case "offset":case "instances":w(L[a],".push(",b,");");H(L[a],".pop();");break;case "primitive":w(L.primitive,".push(",f[b],");");H(L.primitive,".pop();");break;case "elements":r=h.getElements(b);b=!("primitive"in c);a=!("count"in c);r?(r=u(r),w(Y,".push(",r,");"),b&&w(L.primitive,".push(",r,".primType);"),a&&w(L.count,
".push(",r,".vertCount);")):(w(Y,".push(null);"),b&&w(L.primitive,".push(",4,");"),a&&w(L.count,".push(0);"));b&&H(L.primitive,".pop();");a&&H(L.count,".pop();");"offset"in c||(w(L.offset,".push(0);"),H(L.offset,".pop();"));H(Y,".pop();");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "depth.mask":E(a,b);break;case "depth.func":E(a,k[b]);break;case "depth.range":a=
v(a);w(a,".push(",b[0],",",b[1],");");H(a,".pop();");break;case "blend.func":a=v(a);w(a,".push(",z["srcRGB"in b?b.srcRGB:b.src],",",z["dstRGB"in b?b.dstRGB:b.dst],",",z["srcAlpha"in b?b.srcAlpha:b.src],",",z["dstAlpha"in b?b.dstAlpha:b.dst],");");H(a,".pop();");break;case "blend.equation":a=v(a);"string"===typeof b?w(a,".push(",K[b],",",K[b],");"):"object"===typeof b&&w(a,".push(",K[b.rgb],",",K[b.alpha],");");H(a,".pop();");break;case "blend.color":a=v(a);w(a,".push(",b[0],",",b[1],",",b[2],",",
b[3],");");H(a,".pop();");break;case "stencil.mask":a=v(a);w(a,".push(",b,");");H(a,".pop();");break;case "stencil.func":var r=b.cmp||"keep",d=b.ref||0,b="mask"in b?b.mask:-1;a=v(a);w(a,".push(",k[r],",",d,",",b,");");H(a,".pop();");break;case "stencil.opFront":case "stencil.opBack":r=b.fail||"keep";d=b.zfail||"keep";b=b.pass||"keep";a=v(a);w(a,".push(",D[r],",",D[d],",",D[b],");");H(a,".pop();");break;case "polygonOffset.offset":r=b.factor||0;b=b.units||0;a=v(a);w(a,".push(",r,",",b,");");H(a,".pop();");
break;case "cull.face":r=0;"front"===b?r=1028:"back"===b&&(r=1029);b=v(a);w(b,".push(",r,");");H(b,".pop();");break;case "lineWidth":E(a,b);break;case "frontFace":r=0;"cw"===b?r=2304:"ccw"===b&&(r=2305);b=v(a);w(b,".push(",r,");");H(b,".pop();");break;case "colorMask":a=v(a);w(a,".push(",b.map(function(c){return!!c}).join(),");");H(a,".pop();");break;case "sample.coverage":r="value"in b?b.value:1;b=!!b.invert;a=v(a);w(a,".push(",r,",",b,");");H(a,".pop();");break;case "viewport":case "scissor.box":var r=
b.x||0,d=b.y||0,m=-1,l=-1;"w"in b&&(m=b.w);"h"in b&&(l=b.h);b=v(a);w(b,".push(",r,",",d,",",m,",",l,");");H(b,".pop();")}});Object.keys(a).forEach(function(c){var b=u(p.def(c));c=a[c];c="function"===typeof c&&c._reglType?u(c):Array.isArray(c)?u(c.slice()):+c;w(b,".push(",c,");");H(b,".pop();")});Object.keys(d).forEach(function(c){var a=d[c],b=u(B.def(c));c=u(B.box(c).alloc(a));w(b,".records.push(",c,");");H(b,".records.pop();")});var J=q.block(),N=q.block(),ua={};Object.keys(m).sort(b).forEach(function(a){var b=
y(m[a]);switch(a){case "framebuffer":a=v("viewport");var r=v("scissor.box");J("if(",na,".push(",b,"&&",b,"._framebuffer)){",a,".setDirty();",r,".setDirty();","}");N("if(",na,".pop()){",a,".setDirty();",r,".setDirty();","}");break;case "cull.enable":case "blend.enable":case "dither":case "stencil.enable":case "depth.enable":case "scissor.enable":case "polygonOffset.enable":case "sample.alpha":case "sample.enable":case "lineWidth":case "depth.mask":a=v(a);J(a,".push(",b,");");N(a,".pop();");break;case "count":case "offset":case "instances":a=
...
case "sample.coverage":a=v(a);J(a,".push(",b,".value,",b,".invert);");N(a,".pop();");break;case "scissor.box":case "viewport":a=v(a);J(a,".push(",b,".x||0,",b,".y||0,",'"w" in ',b,"?",b,".w:-1,",'"h" in ',b,"?",b,".h:-1);");N(a,".pop();");break;case "elements":a=!("primitive"in m)&&!("primitive"in c);var r=!("count"in m)&&!("count"in c),d=!("offset"in m)&&!("offset"in c),h=J.def();J("if(",b,"){",h,"=",b,"._elements;",Y,".push(",h,");",a?L.primitive+".push("+h+".primType);":"",r?L.count+".push("+h+
".vertCount);":"",d?L.offset+".push("+h+".offset);":"","}else{",Y,".push(null);","}");N(Y,".pop();","if(",b,"){",a?L.primitive+".pop();":"",r?L.count+".pop();":"",d?L.offset+".pop();":"","}")}});Object.keys(n).forEach(function(a){var b=u(p.def(a));a=y(n[a]);J(b,".push(",a,");");N(b,".pop();")});Object.keys(e).forEach(function(a){var b=u(B.def(a)),c=y(e[a]);a=u(B.box(a));J(b,".records.push(",a,".alloc(",c,"));");N(a,".free(",b,".records.pop());")});var ca=G("scope"),da=ca.arg(),sa=ca.arg();I&&ca(ga,
"=",da,";");ca(w);I&&ca(J);ca(sa,"(",da,",",R,");",I?N:"",H);ca=F();F=ca.def();c.frag&&c.vert?(da=c.frag,ca(F,"=",u(S.program(g.id(c.vert),g.id(da))),";")):ca(F,"=",Q,".program","(",Q,".vert[",Q,".vert.length-1]",",",Q,".frag[",Q,".frag.length-1]",");");da=G("draw");I&&da(ga,"=",da.arg(),";");da(w,ca);I&&da(J);da(r,"();","if(",F,")",F,".draw.call(this",I?","+ga:"",");",I?N:"",H);var oa=G("batch"),G=oa.arg(),da=oa.arg();I&&oa(ga,"=",da,"[0];");oa(w,ca);I=u(function(a,b,r){var h=a.batchCache[x];h||
(h=a.batchCache[x]=ja(a,m,n,e,c));return h.call(this,b,r)});oa("if(",F,"){",r,"();",I,".call(this,",F,",",G,",",da,");");Object.keys(m).forEach(function(a){(a=qa[a])&&oa(a,".setDirty();")});oa("}",H);return q.compile()}}}},{"./constants/primitives.json":7,"./util/codegen":22}],5:[function(e,g,p){g.exports={"[object Int8Array]":5120,"[object Int16Array]":5122,"[object Int32Array]":5124,"[object Uint8Array]":5121,"[object Uint8ClampedArray]":5121,"[object Uint16Array]":5123,"[object Uint32Array]":5125,
...
this.data=d}function n(a){if(0===a.length)return[];var b=a.charAt(0),d=a.charAt(a.length-1);if(1<a.length&&b===d&&('"'===b||"'"===b))return['"'+a.substr(1,a.length-2).replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];if(b=/\[(false|true|null|\d+|'[^']*'|"[^"]*")\]/.exec(a))return n(a.substr(0,b.index)).concat(n(b[1])).concat(n(a.substr(b.index+b[0].length)));b=a.split(".");if(1===b.length)return['"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"')+'"'];a=[];for(d=0;d<b.length;++d)a=a.concat(n(b[d]));return a}
function a(a){return"["+n(a).join("][")+"]"}var b=0;g.exports={define:function(b,f){switch(typeof f){case "boolean":case "number":case "string":return new d(b,a(f+""));case "undefined":return new d(b|128,null)}},isDynamic:function(a){return"function"===typeof a&&!a._reglType||a instanceof d},unbox:function(b,f){if(b instanceof d){if(b.type&128)return new d(b.type&-129,a(f))}else if("function"===typeof b)return new d(0,b);return b},accessor:a}},{}],10:[function(e,g,p){var d=e("./util/is-typed-array"),
n=e("./util/is-ndarray"),a=e("./constants/primitives.json");g.exports=function(b,e,f){function g(){this.buffer=null;this.primType=4;this.type=this.vertCount=0}g.prototype.bind=function(){this.buffer.bind()};return{create:function(b){function D(b){var k=e.oes_element_index_uint;if(b)if("number"===typeof b)C(b);else{var c=null,h="static",f=0;Array.isArray(b)||d(b)||n(b)?c=b:("data"in b&&(c=b.data),"usage"in b&&(h=b.usage),"length"in b&&(f=b.length));Array.isArray(c)||n(c)&&"array"===c.dtype||"type"in
b?C({type:b.type||(k?"uint32":"uint16"),usage:h,data:c,length:f}):C({usage:h,data:c,length:f});if(Array.isArray(c)||d(c))C.dimension=3}else C();k=G.buffer.byteLength;c=0;switch(G.buffer.dtype){case 5121:case 5120:c=5121;break;case 5123:case 5122:c=5123;k>>=1;break;case 5125:case 5124:c=5125,k>>=2}h=4;f=G.buffer.dimension;1===f&&(h=0);2===f&&(h=1);3===f&&(h=4);"object"===typeof b&&("primitive"in b&&(h=a[b.primitive]),"count"in b&&(k=b.vertCount|0));G.primType=h;G.vertCount=k;G.type=c;return D}var G=
new g,C=f.create(null,34963,!0);G.buffer=C._buffer;D(b);D._reglType="elements";D._elements=G;D.destroy=function(){C.destroy();G.buffer=null};return D},elements:[null],getElements:function(a){return a&&a._elements instanceof g?a._elements:null}}}},{"./constants/primitives.json":7,"./util/is-ndarray":24,"./util/is-typed-array":25}],11:[function(e,g,p){g.exports=function(d){function e(){"oes_texture_float oes_texture_float_linear oes_texture_half_float oes_texture_half_float_linear oes_standard_derivatives oes_element_index_uint oes_fbo_render_mipmap webgl_depth_texture webgl_draw_buffers webgl_color_buffer_float ext_texture_filter_anisotropic ext_frag_depth ext_blend_minmax ext_shader_texture_lod ext_color_buffer_half_float ext_srgb angle_instanced_arrays webgl_compressed_texture_s3tc webgl_compressed_texture_atc webgl_compressed_texture_pvrtc webgl_compressed_texture_etc1".split(" ").forEach(function(b){try{a[b]=
d.getExtension(b)}catch(e){}})}var a={};e();return{extensions:a,refresh:e}}},{}],12:[function(e,g,p){var d=e("./util/values"),n=e("./util/extend"),a=[1029];g.exports=function(b,e,f,g,k){function D(a,b,c,d){this.target=a;this.level=b;this.texture=c;this.renderbuffer=d}function G(a){a&&(a.texture&&a.texture._texture.decRef(),a.renderbuffer&&a.renderbuffer._renderbuffer.decRef())}function C(a,b){var c=b.width,d=b.height;if(a.texture)var h=a.texture._texture,k=Math.max(1,h.params.width>>a.level),f=Math.max(1,
h.params.height>>a.level),c=c||k,d=d||f;else h=a.renderbuffer._renderbuffer,c=c||h.width,d=d||h.height;h.refCount+=1;b.width=c;b.height=d}function m(a,c){c?c.texture?b.framebufferTexture2D(36160,a,c.target,c.texture._texture.texture,c.level):b.framebufferRenderbuffer(36160,a,36161,c.renderbuffer._renderbuffer.renderbuffer):b.framebufferTexture2D(36160,a,3553,null,0)}function A(a){var b=3553,c=0,d=null,h=null;"object"===typeof a&&("level"in a&&(c=a.level|0),"target"in a&&(b=a.target|0));var k=a._reglType;
...
d=0;d<c.length;++d)m(36064+d,c[d]);for(d=c.length;d<f.maxColorAttachments;++d)m(36064+d,null);m(36096,a.depthAttachment);m(36128,a.stencilAttachment);m(33306,a.depthStencilAttachment);e.webgl_draw_buffers&&e.webgl_draw_buffers.drawBuffersWEBGL(la[c.length]);b.checkFramebufferStatus(36160)}function O(a){a=a.framebuffer;b.isFramebuffer(a)&&b.deleteFramebuffer(a)}function E(){return Z[Z.length-1]}var p={rgba:6408},B={rgba4:32854,rgb565:36194,"rgb5 a1":32855};e.ext_srgb&&(B.srgba=35907);e.ext_color_buffer_half_float&&
(B.rgba16f=34842,B.rgb16f=34843);e.webgl_color_buffer_float&&(B.rgba32f=34836);var S=[],U=[];e.webgl_depth_texture&&(S.push(6402),U.push(34041));n(n({},p),B);d(p);d(B);B=5121;S={uint8:5121};e.oes_texture_half_float&&(B=S["half float"]=36193);e.oes_texture_float&&(B=S["float"]=5126);S.best=B;var la=function(){for(var a=Array(f.maxDrawbuffers),b=0;b<=f.maxDrawbuffers;++b)for(var c=a[b]=Array(b),d=0;d<b;++d)c[d]=36064+d;return a}(),V=0,ja={},Z=[null],K=!0;return{top:E,dirty:function(){return K},push:function(a){a=
a||null;K=K||a!==E();Z.push(a);return K},pop:function(){var a=E();Z.pop();return K=K||a!==E()},getFramebuffer:function(a){return"function"===typeof a&&"framebuffer"===a._reglType&&(a=a._framebuffer,a instanceof h)?a:null},poll:function(){if(K){var c=Z[Z.length-1],d=e.webgl_draw_buffers;c?(b.bindFramebuffer(36160,c.framebuffer),d&&d.drawBuffersWEBGL(la[c.colorAttachments.length])):(b.bindFramebuffer(36160,null),d&&d.drawBuffersWEBGL(a));K=!1}},create:function(a){function d(a){var h,e=a||{},m=a=0;if("shape"in
e){var n=e.shape;a=n[0];m=n[1]}else"radius"in e&&(a=m=e.radius),"width"in e&&(a=e.width),"height"in e&&(m=e.height);var l=null,n=!1;if("colorBuffers"in e||"colorBuffer"in e){l=e.colorBuffers||e.colorBuffer;Array.isArray(l)||(l=[l]);f.width=a;f.height=m;l=l.map(A);for(h=0;h<l.length;++h)C(l[h],f);a=f.width;m=f.height}else{var v=!0,M="rgba",y="uint8",q=1,n=!0;f.width=a=a||b.drawingBufferWidth;f.height=m=m||b.drawingBufferHeight;"format"in e&&(M=e.format,v=M in p);"type"in e&&(y=e.type);"colorCount"in
e&&(q=e.colorCount|0);if(f.ownsColor)for(l=f.colorAttachments;l.length>q;)G(l.pop());else l=[];for(h=0;h<l.length;++h){var u;a:{u=l[h];var O=v,E=M,x=a,r=m;if(u.texture){var Q=u.texture;if(O){Q({format:E,type:y,width:x,height:r});Q._texture.refCount+=1;u=!0;break a}}else if(Q=u.renderbuffer,!O){Q({format:E,width:x,height:r});Q._renderbuffer.refCount+=1;u=!0;break a}G(u);u=!1}u||(l[h--]=l[l.length-1],l.pop())}for(;l.length<q;)v?l.push(new D(3553,0,g.create({format:M,type:y,width:a,height:m},3553),null)):
l.push(new D(36161,0,null,k.create({format:M,width:a,height:m})))}f.width=a;f.height=m;M=v=h=null;y=!1;"depthBuffer"in e&&(h=A(e.depthBuffer));"stencilBuffer"in e&&(v=A(e.stencilBuffer));"depthStencilBuffer"in e&&(M=A(e.depthStencilBuffer));if(h||v||M)C(h||v||M,f);else if(q=!0,O=u=!1,"depth"in e&&(q=!!e.depth),"stencil"in e&&(u=!!e.stencil),"depthTexture"in e&&(O=!!e.depthTexture),e=f.depthAttachment||f.stencilAttachment||f.depthStencilAttachment,E=null,q||u)y=!0,O?(O=u?"depth stencil":"depth",f.ownsDepthStencil&&
e.texture?(e.texture({format:O,width:a,height:m}),e.texture._texture.refCount+=1,E=e):E=new D(3553,0,g.create({format:O,width:a,height:m},3553),null)):(O=q?u?"depth stencil":"depth":"stencil",f.ownsDepthStencil&&e.renderbuffer?(e.renderbuffer({format:O,width:a,height:m}),e.renderbuffer._renderbuffer.refCount+=1,E=e):E=new D(36161,0,null,k.create({format:O,width:a,height:m}))),q?u?M=E:h=E:v=E;a=f;a.colorAttachments.forEach(G);G(a.depthAttachment);G(a.stencilAttachment);G(a.depthStencilAttachment);
f.colorAttachments=l;f.depthAttachment=h;f.stencilAttachment=v;f.depthStencilAttachment=M;f.ownsColor=n;f.ownsDepthStencil=y;d.color=l.map(c);d.depth=c(h);d.stencil=c(v);d.depthStencil=c(M);I(f);d.width=f.width;d.height=f.height;return d}var f=new h;d(a);d._reglType="framebuffer";d._framebuffer=f;d._destroy=function(){O(f)};return d},clear:function(){d(ja).forEach(O)},refresh:function(){d(ja).forEach(I)}}}},{"./util/extend":23,"./util/values":31}],13:[function(e,g,p){g.exports=function(d,e){var a=
...
depth:33189,stencil:36168,"depth stencil":34041};a.ext_srgb&&(k.srgba=35907);a.ext_color_buffer_half_float&&(k.rgba16f=34842,k.rgb16f=34843);a.webgl_color_buffer_float&&(k.rgba32f=34836);var D=0,p={};g.prototype.decRef=function(){0===--this.refCount&&z(this)};return{create:function(a){function b(a){a=a||{};var h=0,e=0;"shape"in a?(e=a.shape,h=e[0]|0,e=e[1]|0):("radius"in a&&(h=e=a.radius|0),"width"in a&&(h=a.width|0),"height"in a&&(e=a.height|0));b.width=d.width=Math.max(h,1);b.height=d.height=Math.max(e,
1);d.format=32854;"format"in a&&(d.format=k[a.format]);f(d);return b}var d=new g;p[d.id]=d;b(a);b._reglType="renderbuffer";b._renderbuffer=d;b.destroy=function(){d.decRef()};return b},refresh:function(){d(p).forEach(f)},clear:function(){d(p).forEach(z)}}}},{"./util/values":31}],16:[function(e,g,p){function d(a,b,d,e){this.name=a;this.id=b;this.location=d;this.info=e}var n=e("./util/values");g.exports=function(a,b,e,f,g){function k(b,c){var d=35632===b?C:m,e=d[c];if(!e){var f=g.str(c),e=a.createShader(b);
a.shaderSource(e,f);a.compileShader(e);d[c]=e}return e}function D(a,b){this.fragId=a;this.vertId=b;this.program=null;this.uniforms=[];this.attributes=[];this.draw=function(){};this.batchCache={}}function p(c){var m,n;m=k(35632,c.fragId);n=k(35633,c.vertId);var A=c.program=a.createProgram();a.attachShader(A,m);a.attachShader(A,n);a.linkProgram(A);var D=a.getProgramParameter(A,35718),B=c.uniforms=[];for(m=0;m<D;++m)if(n=a.getActiveUniform(A,m))if(1<n.size)for(var C=0;C<n.size;++C){var G=n.name.replace("[0]",
"["+C+"]");e.def(G);B.push(new d(G,g.id(G),a.getUniformLocation(A,G),n))}else e.def(n.name),B.push(new d(n.name,g.id(n.name),a.getUniformLocation(A,n.name),n));D=a.getProgramParameter(A,35721);B=c.attributes=[];for(m=0;m<D;++m)if(n=a.getActiveAttrib(A,m))b.def(n.name),B.push(new d(n.name,g.id(n.name),a.getAttribLocation(A,n.name),n));c.draw=f(c);c.batchCache={}}var C={},m={},A={},c=[];return{clear:function(){var b=a.deleteShader.bind(a);n(C).forEach(b);C={};n(m).forEach(b);m={};c.forEach(function(b){a.deleteProgram(b.program)});
c.length=0;A={}},refresh:function(){C={};m={};c.forEach(p)},program:function(a,b){var d=A[b];d||(d=A[b]={});var e=d[a];e||(e=new D(b,a),p(e),d[a]=e,c.push(e));return e},shader:k,frag:[-1],vert:[-1]}}},{"./util/values":31}],17:[function(e,g,p){var d=e("./util/stack"),n=e("./util/codegen");g.exports=function(a,b,e){function f(b,e){var c=d([!!e],function(c){c?a.enable(b):a.disable(b)});c.flag=b;return c}var g={dither:f(3024),"blend.enable":f(3042),"blend.color":d([0,0,0,0],function(b,d,c,e){a.blendColor(b,
...
y,x[y]=a))}function ja(a){function b(a,c,d){var r=m(d);r.pixels.forEach(function(b){var d=new ka(r.cube?b.target:a);d.channels=r.channels;d.compressed=r.compressed;d.type=r.type;d.internalformat=r.format;d.format=ra[r.format];d.width=b.width;d.height=b.height;d.miplevel=b.miplevel||c;d.data=b.data;e.push(d)})}function c(){for(var f=0;f<e.length;++f){var k=e[f],h=k.image,g=k.video,n=k.xhr;h&&h.complete?(k.width=h.naturalWidth,k.height=h.naturalHeight):g&&2<g.readyState?(k.width=g.width,k.height=g.height):
n&&4===n.readyState&&(e[f]=e[e.length-1],e.pop(),n.removeEventListener("readystatechange",V),b(k.target,k.miplevel,n.response))}S(d,e);V(a)}var d=a.params,e=a.pixels;e.forEach(function(a){a.image&&!a.image.complete?a.image.addEventListener("load",c):a.video&&1>a.readyState?a.video.addEventListener("progress",c):a.xhr&&a.xhr.addEventListener("readystatechange",c)});a.cancelPending=function(){e.forEach(function(a){a.image?a.image.removeEventListener("load",c):a.video?a.video.removeEventListener("progress",
...
this.parseFlags(c);var h=c.data;if("string"===typeof h||h&&(k(h)||d(h)||D(h)||b(h)||M(h)||"[object HTMLImageElement]"===a(h)||"[object HTMLVideoElement]"===a(h)||n(h)))f=c.data;break;case "undefined":return}"string"===typeof f&&(f=G(f,this.crossOrigin));var h=null,g=!1;if(null!==f)if(k(f))this.data=f;else if(d(f))h=f,g=!0;else if(D(f)){Array.isArray(f.data)?(h=f.data,g=!0):this.data=f.data;var l=f.shape;this.width=l[0];this.height=l[1];this.channels=3===l.length?l[2]:1;l=f.stride;this.strideX=f.stride[0];
...
else if("[object HTMLVideoElement]"===a(f))this.video=f,1<f.readyState?(this.width=f.width,this.height=f.height):(this.width=this.width||f.width,this.height=this.height||f.height,this.needsListeners=!0),this.needsPoll=!0,this.setDefaultFormat();else if("[object XMLHttpRequest]"===a(f))this.xhr=f,this.needsListeners=!0;else if(n(f)){var g=f[0].length,l=f.length,m=1,q,z,u,w;if(Array.isArray(f[0][0]))for(m=f[0][0].length,h=Array(g*l*m),z=w=0;z<l;++z)for(q=0;q<g;++q)for(u=0;u<m;++u)h[w++]=f[z][q][u];
else for(h=Array(g*l),z=w=0;z<l;++z)for(q=0;q<g;++q)h[w++]=f[z][q];this.width=g;this.height=l;this.channels=m;g=!0}else c.copy&&(this.copy=!0,this.x|=0,this.y|=0,this.width=(this.width||E.width)|0,this.height=(this.height||E.height)|0,this.setDefaultFormat());!this.type&&this.data&&(6402===this.format?this.data instanceof Uint16Array?this.type=5123:this.data instanceof Uint32Array&&(this.type=5125):this.data instanceof Float32Array&&(this.type=5126));this.internalformat||(this.internalformat=[6409,
6410,6407,6408][(this.channels=this.channels||4)-1]);f=this.internalformat;l=this.format=ra[f];if(!this.channels)switch(l){case 6409:case 6406:case 6402:this.channels=1;break;case 34041:case 6410:this.channels=2;break;case 6407:this.channels=3;break;default:this.channels=4}l=this.type;5126!==l&&36193!==l&&(l||(l=6402===f?5125:5121));this.type=l;if(g)switch(l){case 5121:this.data=new Uint8Array(h);break;case 5123:this.data=new Uint16Array(h);break;case 5125:this.data=new Uint32Array(h);break;case 5126:this.data=
new Float32Array(h);break;case 36193:this.data=C(h)}if(this.data&&this.needsTranspose){h=this.data;f=this.width;g=this.height;l=this.channels;m=this.strideX;q=this.strideY;z=this.strideC;u=this.offset;w=new h.constructor(f*g*l);for(var v=0,p=0;p<g;++p)for(var y=0;y<f;++y)for(var x=0;x<l;++x)w[v++]=h[q*p+m*y+z*x+u];this.data=w}this.needsTranspose=!1},setDefaultFormat:function(){this.format=this.internalformat=6408;this.type=5121;this.channels=4;this.compressed=!1},upload:function(a){c.pixelStorei(37440,
this.flipY);c.pixelStorei(37441,this.premultiplyAlpha);c.pixelStorei(37443,this.colorSpace);c.pixelStorei(3317,this.unpackAlignment);var b=this.target,d=this.miplevel,e=this.image,f=this.canvas,h=this.video,k=this.data,g=this.internalformat,n=this.format,l=this.type,m=this.width||Math.max(1,a.width>>d);a=this.height||Math.max(1,a.height>>d);h&&2<h.readyState?c.texImage2D(b,d,n,n,l,h):e&&e.complete?c.texImage2D(b,d,n,n,l,e):f?c.texImage2D(b,d,n,n,l,f):this.compressed?c.compressedTexImage2D(b,d,g,m,
a,0,k):this.copy?(p(),c.copyTexImage2D(b,d,n,this.x,this.y,m,a,0)):k?c.texImage2D(b,d,n,m,a,0,n,l,k):c.texImage2D(b,d,n,m||1,a||1,0,n,l,null)}});f(B.prototype,{parse:function(a){if("object"===typeof a&&a){"min"in a&&(this.minFilter=T[a.min]);"mag"in a&&(this.magFilter=ma[a.mag]);var b=this.wrapS,c=this.wrapT;if("wrap"in a){var d=a.wrap;"string"===typeof d?b=c=P[d]:Array.isArray(d)&&(b=P[d[0]],c=P[d[1]])}else"wrapS"in a&&(b=P[a.wrapS]),"wrapT"in a&&(c=P[a.wrapT]);this.wrapS=b;this.wrapT=c;"anisotropic"in
...
var y=0,q=0,u={},F=[],fa=g.maxTextureUnits,x=Array(fa).map(function(){return null});f(U.prototype,{bind:function(){this.bindCount+=1;var a=this.unit;if(0>a){for(var b=0;b<fa;++b){var d=x[b];if(d){if(0<d.bindCount)continue;d.unit=-1}x[b]=this;a=b;break}this.unit=a;c.activeTexture(33984+a);c.bindTexture(this.target,this.texture);y=a}return a},unbind:function(){--this.bindCount},decRef:function(){0===--this.refCount&&K(this)}});return{create:function(a,b){function c(a,e,f,h,k,g){var n=a||{};34067===
b&&6===arguments.length&&(n=[a,e,f,h,k,g]);la(d,n);c.width=d.params.width;c.height=d.params.height;return c}var d=new U(b);u[d.id]=d;c(a);c._reglType="texture";c._texture=d;c.destroy=function(){d.decRef()};return c},refresh:function(){z(u).forEach(V);for(var a=0;a<fa;++a)x[a]=null;y=0;c.activeTexture(33984)},clear:function(){for(var a=0;a<fa;++a)c.activeTexture(33984+a),c.bindTexture(3553,null),x[a]=null;c.activeTexture(33984);y=0;z(u).forEach(K)},poll:function(){F.forEach(V)},getTexture:function(a){return null}}}},
...
function Z(){F.poll();Q.poll()}var K=n(Array.prototype.slice.call(arguments)),l=K.gl,P=K.options,K=a(),ma=b(l),T=ma.extensions,aa={width:l.drawingBufferWidth,height:l.drawingBufferHeight},W=M(l,T),X=f(l,function(a){for(var b=0;b<v.bindings.length;++b){var c=v.bindings[b];c.pointer&&c.buffer===a&&(c.pointer=!1,c.buffer=null,c.x=c.y=c.z=c.w=NaN,l.disableVertexAttribArray(b))}}),ea=z(l,T,X),ha=C(K),v=m(l,T,W,X,K),ra=A(l,v,ha,function(a){return na.draw(a)},K),y=c(l,T,X),q=k(l,T,W,Z,aa),u=D(l,T,W),F=G(l,
